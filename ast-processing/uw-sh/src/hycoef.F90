...
! Subprogram not used subroutine init_restart_hycoef(File, vdimids)    
! Subprogram not used     
! Subprogram not used    type(file_desc_t), intent(inout) :: File
! Subprogram not used    integer,           intent(out)   :: vdimids(:)
! Subprogram not used 
! Subprogram not used    ! PIO traps errors internally, no need to check ierr
! Subprogram not used 
! Subprogram not used    integer :: ierr
! Subprogram not used 
! Subprogram not used    ierr = PIO_Def_Dim(File, 'lev',  plev,  vdimids(1))
! Subprogram not used    ierr = PIO_Def_Dim(File, 'ilev', plevp, vdimids(2))
! Subprogram not used     
! Subprogram not used    ierr = pio_def_var(File, 'hyai', pio_double, vdimids(2:2), hyai_desc)
! Subprogram not used    ierr = pio_def_var(File, 'hyam', pio_double, vdimids(1:1), hyam_desc)
! Subprogram not used    ierr = pio_def_var(File, 'hybi', pio_double, vdimids(2:2), hybi_desc)
! Subprogram not used    ierr = pio_def_var(File, 'hybm', pio_double, vdimids(1:1), hybm_desc)
! Subprogram not used 
! Subprogram not used end subroutine init_restart_hycoef

!=======================================================================

! Subprogram not used subroutine write_restart_hycoef(file)
! Subprogram not used 
! Subprogram not used    type(file_desc_t), intent(inout) :: File
! Subprogram not used 
! Subprogram not used    ! PIO traps errors internally, no need to check ierr
...
! Subprogram not used    integer :: ierr
! Subprogram not used     
! Subprogram not used    ierr = pio_put_var(File, hyai_desc, hyai)
! Subprogram not used    ierr = pio_put_var(File, hyam_desc, hyam)
! Subprogram not used    ierr = pio_put_var(File, hybi_desc, hybi)
! Subprogram not used    ierr = pio_put_var(File, hybm_desc, hybm)
! Subprogram not used 
! Subprogram not used end subroutine write_restart_hycoef
