...
!-------------------------------------------------------------------
! Subprogram not used   subroutine init_prescribed_ghg_restart( piofile )
...
! Subprogram not used 
! Subprogram not used     call init_trc_restart( 'prescribed_ghg', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine init_prescribed_ghg_restart
!-------------------------------------------------------------------
! Subprogram not used   subroutine write_prescribed_ghg_restart( piofile )
...
! Subprogram not used 
! Subprogram not used   end subroutine write_prescribed_ghg_restart

!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine read_prescribed_ghg_restart( pioFile )
...
! Subprogram not used     type(file_desc_t) :: piofile
! Subprogram not used 
! Subprogram not used     call read_trc_restart( 'prescribed_ghg', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine read_prescribed_ghg_restart
!-------------------------------------------------------------------
...
! Subprogram not used     do i = 1,N_GHG
! Subprogram not used       if ( trim(name) == trim(ghg_names(i)) ) then
