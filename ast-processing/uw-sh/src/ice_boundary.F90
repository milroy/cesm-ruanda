...
! Subprogram not used  subroutine ice_HaloUpdate_stress(array1, array2, halo, &
! Subprogram not used                                fieldLoc, fieldKind,     &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  This routine updates ghost cells for an input array using
! Subprogram not used !  a second array as needed by the stress fields.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
! Subprogram not used ! !USER:
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type (ice_halo), intent(in) :: &
! Subprogram not used       halo                 ! precomputed halo structure containing all
! Subprogram not used                            !  information needed for halo update
! Subprogram not used 
! Subprogram not used    integer (int_kind), intent(in) :: &
! Subprogram not used       fieldKind,          &! id for type of field (scalar, vector, angle)
! Subprogram not used       fieldLoc             ! id for location on horizontal grid
! Subprogram not used                            !  (center, NEcorner, Nface, Eface)
! Subprogram not used 
! Subprogram not used    real (dbl_kind), intent(in), optional :: &
! Subprogram not used       fillValue            ! optional value to put in ghost cells
! Subprogram not used                            !  where neighbor points are unknown
! Subprogram not used                            !  (e.g. eliminated land blocks or
! Subprogram not used                            !   closed boundaries)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    real (dbl_kind), dimension(:,:,:), intent(inout) :: &
! Subprogram not used       array1           ,&  ! array containing field for which halo
! Subprogram not used                            ! needs to be updated
! Subprogram not used       array2               ! array containing field for which halo
! Subprogram not used                            ! in array1 needs to be updated
! Subprogram not used 
...
! Subprogram not used       i,j,n,nmsg,                &! dummy loop indices
! Subprogram not used       ierr,                      &! error or status flag for MPI,alloc
! Subprogram not used       nxGlobal,                  &! global domain size in x (tripole)
! Subprogram not used       iSrc,jSrc,                 &! source addresses for message
! Subprogram not used       iDst,jDst,                 &! dest   addresses for message
! Subprogram not used       srcBlock,                  &! local block number for source
! Subprogram not used       dstBlock,                  &! local block number for destination
! Subprogram not used       ioffset, joffset,          &! address shifts for tripole
! Subprogram not used       isign                       ! sign factor for tripole grids
! Subprogram not used 
! Subprogram not used    integer (int_kind), dimension(:), allocatable :: &
! Subprogram not used       sndRequest,      &! MPI request ids
! Subprogram not used       rcvRequest        ! MPI request ids
! Subprogram not used 
! Subprogram not used    integer (int_kind), dimension(:,:), allocatable :: &
! Subprogram not used       sndStatus,       &! MPI status flags
! Subprogram not used       rcvStatus         ! MPI status flags
! Subprogram not used 
! Subprogram not used    real (dbl_kind) :: &
! Subprogram not used       fill,            &! value to use for unknown points
! Subprogram not used       x1,x2,xavg        ! scalars for enforcing symmetry at U pts
! Subprogram not used 
! Subprogram not used    integer (int_kind) ::  len  ! length of messages
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  initialize error code and fill value
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (present(fillValue)) then
! Subprogram not used       fill = fillValue
! Subprogram not used    else
! Subprogram not used       fill = 0.0_dbl_kind
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    nxGlobal = 0
! Subprogram not used    if (allocated(bufTripoleR8)) then
! Subprogram not used       nxGlobal = size(bufTripoleR8,dim=1)
! Subprogram not used       bufTripoleR8 = fill
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  allocate request and status arrays for messages
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    allocate(sndRequest(halo%numMsgSend), &
! Subprogram not used             rcvRequest(halo%numMsgRecv), &
! Subprogram not used             sndStatus(MPI_STATUS_SIZE,halo%numMsgSend), &
! Subprogram not used             rcvStatus(MPI_STATUS_SIZE,halo%numMsgRecv), stat=ierr)
! Subprogram not used 
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate_stress: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  post receives
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    do nmsg=1,halo%numMsgRecv
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)
! Subprogram not used       call MPI_IRECV(bufRecvR8(1:len,nmsg), len, mpiR8, &
! Subprogram not used                      halo%recvTask(nmsg),               &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg),  &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  fill send buffer and post sends
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    do nmsg=1,halo%numMsgSend
! Subprogram not used 
! Subprogram not used       do n=1,halo%sizeSend(nmsg)
! Subprogram not used          iSrc     = halo%sendAddr(1,n,nmsg)
! Subprogram not used          jSrc     = halo%sendAddr(2,n,nmsg)
! Subprogram not used          srcBlock = halo%sendAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          bufSendR8(n,nmsg) = array2(iSrc,jSrc,srcBlock)
! Subprogram not used       end do
! Subprogram not used       do n=halo%sizeSend(nmsg)+1,bufSizeSend
! Subprogram not used          bufSendR8(n,nmsg) = fill  ! fill remainder of buffer
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)
! Subprogram not used       call MPI_ISEND(bufSendR8(1:len,nmsg), len, mpiR8, &
! Subprogram not used                      halo%sendTask(nmsg),               &
! Subprogram not used                      mpitagHalo + my_task,              &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  while messages are being communicated,
! Subprogram not used !  do NOT zero the halo out, this halo update just updates
! Subprogram not used !  the tripole zipper as needed for stresses.  if you zero
! Subprogram not used !  it out, all halo values will be wiped out.
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !   do j = 1,nghost
! Subprogram not used !      array1(1:nx_block,           j,:) = fill
! Subprogram not used !      array1(1:nx_block,ny_block-j+1,:) = fill
! Subprogram not used !   enddo
! Subprogram not used !   do i = 1,nghost
! Subprogram not used !      array1(i,           1:ny_block,:) = fill
! Subprogram not used !      array1(nx_block-i+1,1:ny_block,:) = fill
! Subprogram not used !   enddo
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  do local copies while waiting for messages to complete
! Subprogram not used !  if srcBlock is zero, that denotes an eliminated land block or a 
! Subprogram not used !    closed boundary where ghost cell values are undefined
! Subprogram not used !  if srcBlock is less than zero, the message is a copy out of the
! Subprogram not used !    tripole buffer and will be treated later
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    do nmsg=1,halo%numLocalCopies
! Subprogram not used       iSrc     = halo%srcLocalAddr(1,nmsg)
! Subprogram not used       jSrc     = halo%srcLocalAddr(2,nmsg)
! Subprogram not used       srcBlock = halo%srcLocalAddr(3,nmsg)
! Subprogram not used       iDst     = halo%dstLocalAddr(1,nmsg)
! Subprogram not used       jDst     = halo%dstLocalAddr(2,nmsg)
! Subprogram not used       dstBlock = halo%dstLocalAddr(3,nmsg)
! Subprogram not used 
! Subprogram not used       if (srcBlock > 0) then
! Subprogram not used          if (dstBlock < 0) then ! tripole copy into buffer
! Subprogram not used             bufTripoleR8(iDst,jDst) = &
! Subprogram not used             array2(iSrc,jSrc,srcBlock)
! Subprogram not used          endif
! Subprogram not used       else if (srcBlock == 0) then
! Subprogram not used          array1(iDst,jDst,dstBlock) = fill
! Subprogram not used      endif
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  wait for receives to finish and then unpack the recv buffer into
! Subprogram not used !  ghost cells
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    call MPI_WAITALL(halo%numMsgRecv, rcvRequest, rcvStatus, ierr)
! Subprogram not used 
! Subprogram not used    do nmsg=1,halo%numMsgRecv
! Subprogram not used       do n=1,halo%sizeRecv(nmsg)
! Subprogram not used          iDst     = halo%recvAddr(1,n,nmsg)
! Subprogram not used          jDst     = halo%recvAddr(2,n,nmsg)
! Subprogram not used          dstBlock = halo%recvAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          if (dstBlock < 0) then !tripole
! Subprogram not used             bufTripoleR8(iDst,jDst) = bufRecvR8(n,nmsg)
! Subprogram not used          endif
! Subprogram not used       end do
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  take care of northern boundary in tripole case
! Subprogram not used !  bufTripole array contains the top haloWidth+1 rows of physical
! Subprogram not used !    domain for entire (global) top row 
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (nxGlobal > 0) then
! Subprogram not used 
! Subprogram not used       select case (fieldKind)
...
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate_stress: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       select case (fieldLoc)
! Subprogram not used       case (field_loc_center)   ! cell center location
! Subprogram not used 
! Subprogram not used          ioffset = 0
! Subprogram not used          joffset = 0
! Subprogram not used 
! Subprogram not used       case (field_loc_NEcorner)   ! cell corner location
! Subprogram not used 
! Subprogram not used          ioffset = 1
! Subprogram not used          joffset = 1
! Subprogram not used 
! Subprogram not used       case (field_loc_Eface) 
! Subprogram not used 
! Subprogram not used          ioffset = 1
! Subprogram not used          joffset = 0
! Subprogram not used 
! Subprogram not used       case (field_loc_Nface) 
! Subprogram not used 
! Subprogram not used          ioffset = 0
! Subprogram not used          joffset = 1
! Subprogram not used 
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used                'ice_HaloUpdate_stress: Unknown field location')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       !*** copy out of global tripole buffer into local
! Subprogram not used       !*** ghost cells
! Subprogram not used 
! Subprogram not used       !*** look through local copies to find the copy out
! Subprogram not used       !*** messages (srcBlock < 0)
! Subprogram not used 
! Subprogram not used       do nmsg=1,halo%numLocalCopies
! Subprogram not used          srcBlock = halo%srcLocalAddr(3,nmsg)
! Subprogram not used 
! Subprogram not used          if (srcBlock < 0) then
! Subprogram not used 
! Subprogram not used             iSrc     = halo%srcLocalAddr(1,nmsg) ! tripole buffer addr
! Subprogram not used             jSrc     = halo%srcLocalAddr(2,nmsg)
! Subprogram not used 
! Subprogram not used             iDst     = halo%dstLocalAddr(1,nmsg) ! local block addr
! Subprogram not used             jDst     = halo%dstLocalAddr(2,nmsg)
! Subprogram not used             dstBlock = halo%dstLocalAddr(3,nmsg)
! Subprogram not used 
! Subprogram not used             !*** correct for offsets
! Subprogram not used             iSrc = iSrc - ioffset
! Subprogram not used             jSrc = jSrc - joffset
! Subprogram not used             if (iSrc == 0) iSrc = nxGlobal
! Subprogram not used  
! Subprogram not used             !*** for center and Eface, do not need to replace
! Subprogram not used             !*** top row of physical domain, so jSrc should be
! Subprogram not used             !*** out of range and skipped
! Subprogram not used             !*** otherwise do the copy
! Subprogram not used 
! Subprogram not used             if (jSrc <= nghost+1) then
! Subprogram not used                array1(iDst,jDst,dstBlock) = isign*bufTripoleR8(iSrc,jSrc)
! Subprogram not used             endif
! Subprogram not used 
! Subprogram not used          endif
! Subprogram not used       end do
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  wait for sends to complete and deallocate arrays
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    call MPI_WAITALL(halo%numMsgSend, sndRequest, sndStatus, ierr)
! Subprogram not used 
! Subprogram not used    deallocate(sndRequest, rcvRequest, sndStatus, rcvStatus, stat=ierr)
! Subprogram not used 
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate_stress: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used  end subroutine ice_HaloUpdate_stress
...
! Subprogram not used  subroutine ice_HaloUpdate2DR4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  This routine updates ghost cells for an input array and is a
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 2d horizontal arrays of single precision.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used                            !  (center, NEcorner, Nface, Eface)
! Subprogram not used 
! Subprogram not used    real (real_kind), intent(in), optional :: &
! Subprogram not used       fillValue            ! optional value to put in ghost cells
! Subprogram not used                            !  where neighbor points are unknown
! Subprogram not used                            !  (e.g. eliminated land blocks or
! Subprogram not used                            !   closed boundaries)
...
! Subprogram not used       array                ! array containing field for which halo
! Subprogram not used                            ! needs to be updated
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
...
! Subprogram not used       fill = fillValue
! Subprogram not used    else
! Subprogram not used       fill = 0.0_real_kind
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    nxGlobal = 0
! Subprogram not used    if (allocated(bufTripoleR4)) then
! Subprogram not used       nxGlobal = size(bufTripoleR4,dim=1)
! Subprogram not used       bufTripoleR4 = fill
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate2DR4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)
! Subprogram not used       call MPI_IRECV(bufRecvR4(1:len,nmsg), len, mpiR4, &
! Subprogram not used                      halo%recvTask(nmsg),               &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg),  &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used          srcBlock = halo%sendAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          bufSendR4(n,nmsg) = array(iSrc,jSrc,srcBlock)
! Subprogram not used       end do
! Subprogram not used       do n=halo%sizeSend(nmsg)+1,bufSizeSend
! Subprogram not used          bufSendR4(n,nmsg) = fill  ! fill remainder of buffer
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)
! Subprogram not used       call MPI_ISEND(bufSendR4(1:len,nmsg), len, mpiR4, &
! Subprogram not used                      halo%sendTask(nmsg),               &
! Subprogram not used                      mpitagHalo + my_task,              &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used !
! Subprogram not used !  while messages are being communicated,
! Subprogram not used !  fill out halo region, needed for masked halos to ensure
! Subprogram not used !  halo values are fill for halo gridcells that are not updated
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    do j = 1,nghost
! Subprogram not used       array(1:nx_block,           j,:) = fill
! Subprogram not used       array(1:nx_block,ny_block-j+1,:) = fill
! Subprogram not used    enddo
! Subprogram not used    do i = 1,nghost
! Subprogram not used       array(i,           1:ny_block,:) = fill
! Subprogram not used       array(nx_block-i+1,1:ny_block,:) = fill
! Subprogram not used    enddo
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used       if (srcBlock > 0) then
! Subprogram not used          if (dstBlock > 0) then
! Subprogram not used             array(iDst,jDst,dstBlock) = &
! Subprogram not used             array(iSrc,jSrc,srcBlock)
! Subprogram not used          else if (dstBlock < 0) then ! tripole copy into buffer
! Subprogram not used             bufTripoleR4(iDst,jDst) = &
! Subprogram not used             array(iSrc,jSrc,srcBlock)
! Subprogram not used          endif
! Subprogram not used       else if (srcBlock == 0) then
! Subprogram not used          array(iDst,jDst,dstBlock) = fill
! Subprogram not used       endif
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used          if (dstBlock > 0) then
! Subprogram not used             array(iDst,jDst,dstBlock) = bufRecvR4(n,nmsg)
! Subprogram not used          else if (dstBlock < 0) then !tripole
! Subprogram not used             bufTripoleR4(iDst,jDst) = bufRecvR4(n,nmsg)
! Subprogram not used          endif
! Subprogram not used       end do
! Subprogram not used    end do
! Subprogram not used 
...
! Subprogram not used !
! Subprogram not used !  take care of northern boundary in tripole case
! Subprogram not used !  bufTripole array contains the top nghost+1 rows (u-fold) or nghost+2 rows
! Subprogram not used !  (T-fold) of physical domain for entire (global) top row
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (nxGlobal > 0) then
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate2DR4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
! Subprogram not used         select case (fieldLoc)
! Subprogram not used         case (field_loc_center)   ! cell center location
! Subprogram not used   
...
! Subprogram not used            joffset = 0
! Subprogram not used   
! Subprogram not used            !*** top row is degenerate, so must enforce symmetry
! Subprogram not used            !***   use average of two degenerate points for value
! Subprogram not used   
! Subprogram not used            do i = 2,nxGlobal/2
! Subprogram not used               iDst = nxGlobal - i + 2
! Subprogram not used               x1 = bufTripoleR4(i   ,halo%tripoleRows)
! Subprogram not used               x2 = bufTripoleR4(iDst,halo%tripoleRows)
! Subprogram not used               xavg = 0.5_real_kind*(x1 + isign*x2)
! Subprogram not used               bufTripoleR4(i   ,halo%tripoleRows) = xavg
! Subprogram not used               bufTripoleR4(iDst,halo%tripoleRows) = isign*xavg
! Subprogram not used            end do
! Subprogram not used   
! Subprogram not used         case (field_loc_NEcorner)   ! cell corner location
! Subprogram not used   
...
! Subprogram not used            joffset = 1
! Subprogram not used   
! Subprogram not used         case (field_loc_Eface)   ! cell center location
! Subprogram not used   
! Subprogram not used            ioffset = 0
! Subprogram not used            joffset = 0
! Subprogram not used   
...
! Subprogram not used            !***   use average of two degenerate points for value
! Subprogram not used   
! Subprogram not used            do i = 1,nxGlobal/2
! Subprogram not used               iDst = nxGlobal + 1 - i
! Subprogram not used               x1 = bufTripoleR4(i   ,halo%tripoleRows)
! Subprogram not used               x2 = bufTripoleR4(iDst,halo%tripoleRows)
! Subprogram not used               xavg = 0.5_real_kind*(x1 + isign*x2)
! Subprogram not used               bufTripoleR4(i   ,halo%tripoleRows) = xavg
...
! Subprogram not used            end do
! Subprogram not used   
! Subprogram not used         case (field_loc_Nface)   ! cell corner (velocity) location
! Subprogram not used   
! Subprogram not used            ioffset = -1
! Subprogram not used            joffset = 1
! Subprogram not used   
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate2DR4: Unknown field location')
! Subprogram not used         end select        
! Subprogram not used 
! Subprogram not used       else ! tripole u-fold
! Subprogram not used   
! Subprogram not used         select case (fieldLoc)
! Subprogram not used         case (field_loc_center)   ! cell center location
! Subprogram not used   
...
! Subprogram not used            !***   use average of two degenerate points for value
! Subprogram not used   
! Subprogram not used            do i = 1,nxGlobal/2 - 1
! Subprogram not used               iDst = nxGlobal - i
! Subprogram not used               x1 = bufTripoleR4(i   ,halo%tripoleRows)
! Subprogram not used               x2 = bufTripoleR4(iDst,halo%tripoleRows)
! Subprogram not used               xavg = 0.5_real_kind*(x1 + isign*x2)
! Subprogram not used               bufTripoleR4(i   ,halo%tripoleRows) = xavg
...
! Subprogram not used             jSrc = jSrc - joffset
! Subprogram not used             if (iSrc == 0) iSrc = nxGlobal
! Subprogram not used             if (iSrc > nxGlobal) iSrc = iSrc - nxGlobal
! Subprogram not used 
! Subprogram not used             !*** for center and Eface on u-fold, and NE corner and Nface
! Subprogram not used             !*** on T-fold, do not need to replace
! Subprogram not used             !*** top row of physical domain, so jSrc should be
! Subprogram not used             !*** out of range and skipped
! Subprogram not used             !*** otherwise do the copy
! Subprogram not used 
! Subprogram not used             if (jSrc <= halo%tripoleRows .and. jSrc>0 .and. jDst>0) then
! Subprogram not used                array(iDst,jDst,dstBlock) = isign*bufTripoleR4(iSrc,jSrc)
! Subprogram not used             endif
! Subprogram not used 
! Subprogram not used          endif
! Subprogram not used       end do
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate2DR4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate2DR4
...
! Subprogram not used  subroutine ice_HaloUpdate2DI4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
...
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 2d horizontal integer arrays.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used       fill = fillValue
! Subprogram not used    else
! Subprogram not used       fill = 0_int_kind
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    nxGlobal = 0
! Subprogram not used    if (allocated(bufTripoleI4)) then
! Subprogram not used       nxGlobal = size(bufTripoleI4,dim=1)
! Subprogram not used       bufTripoleI4 = fill
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate2DI4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)
! Subprogram not used       call MPI_IRECV(bufRecvI4(1:len,nmsg), len, MPI_INTEGER, &
! Subprogram not used                      halo%recvTask(nmsg),                     &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg),        &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used          srcBlock = halo%sendAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          bufSendI4(n,nmsg) = array(iSrc,jSrc,srcBlock)
! Subprogram not used       end do
! Subprogram not used       do n=halo%sizeSend(nmsg)+1,bufSizeSend
! Subprogram not used          bufSendI4(n,nmsg) = fill  ! fill remainder of buffer
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)
! Subprogram not used       call MPI_ISEND(bufSendI4(1:len,nmsg), len, MPI_INTEGER, &
! Subprogram not used                      halo%sendTask(nmsg),                     &
! Subprogram not used                      mpitagHalo + my_task,                    &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used             array(iSrc,jSrc,srcBlock)
! Subprogram not used          else if (dstBlock < 0) then ! tripole copy into buffer
! Subprogram not used             bufTripoleI4(iDst,jDst) = &
! Subprogram not used             array(iSrc,jSrc,srcBlock)
! Subprogram not used          endif
! Subprogram not used       else if (srcBlock == 0) then
! Subprogram not used          array(iDst,jDst,dstBlock) = fill
...
! Subprogram not used 
! Subprogram not used          if (dstBlock > 0) then
! Subprogram not used             array(iDst,jDst,dstBlock) = bufRecvI4(n,nmsg)
! Subprogram not used          else if (dstBlock < 0) then !tripole
! Subprogram not used             bufTripoleI4(iDst,jDst) = bufRecvI4(n,nmsg)
! Subprogram not used          endif
! Subprogram not used       end do
! Subprogram not used    end do
! Subprogram not used 
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate2DI4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
...
! Subprogram not used            do i = 2,nxGlobal/2
! Subprogram not used               iDst = nxGlobal - i + 2
! Subprogram not used               x1 = bufTripoleI4(i   ,halo%tripoleRows)
! Subprogram not used               x2 = bufTripoleI4(iDst,halo%tripoleRows)
! Subprogram not used               xavg = nint(0.5_dbl_kind*(x1 + isign*x2))
! Subprogram not used               bufTripoleI4(i   ,halo%tripoleRows) = xavg
! Subprogram not used               bufTripoleI4(iDst,halo%tripoleRows) = isign*xavg
! Subprogram not used            end do
! Subprogram not used   
! Subprogram not used         case (field_loc_NEcorner)   ! cell corner location
! Subprogram not used   
...
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate2DI4: Unknown field location')
! Subprogram not used         end select
! Subprogram not used 
! Subprogram not used       else ! tripole u-fold  
! Subprogram not used   
...
! Subprogram not used 
! Subprogram not used             if (jSrc <= halo%tripoleRows .and. jSrc>0 .and. jDst>0) then
! Subprogram not used                array(iDst,jDst,dstBlock) = isign*bufTripoleI4(iSrc,jSrc)
! Subprogram not used             endif
! Subprogram not used 
! Subprogram not used          endif
! Subprogram not used       end do
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate2DI4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate2DI4
...
! Subprogram not used  subroutine ice_HaloUpdate3DR4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
...
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 3d horizontal arrays of single precision.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    integer (int_kind) ::           &
! Subprogram not used       i,j,k,n,nmsg,              &! dummy loop indices
! Subprogram not used       ierr,                      &! error or status flag for MPI,alloc
! Subprogram not used       nxGlobal,                  &! global domain size in x (tripole)
! Subprogram not used       nz,                        &! size of array in 3rd dimension
! Subprogram not used       iSrc,jSrc,                 &! source addresses for message
! Subprogram not used       iDst,jDst,                 &! dest   addresses for message
! Subprogram not used       srcBlock,                  &! local block number for source
! Subprogram not used       dstBlock,                  &! local block number for destination
...
! Subprogram not used       bufSend, bufRecv            ! 3d send,recv buffers
! Subprogram not used 
! Subprogram not used    real (real_kind), dimension(:,:,:), allocatable :: &
! Subprogram not used       bufTripole                  ! 3d tripole buffer
! Subprogram not used 
! Subprogram not used    integer (int_kind) :: len ! length of message 
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  initialize error code and fill value
...
! Subprogram not used 
! Subprogram not used    nxGlobal = 0
! Subprogram not used    if (allocated(bufTripoleR4)) nxGlobal = size(bufTripoleR4,dim=1)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  allocate request and status arrays for messages
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DR4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  allocate 3D buffers
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nz = size(array, dim=3)
! Subprogram not used 
! Subprogram not used    allocate(bufSend(bufSizeSend*nz, halo%numMsgSend),  &
! Subprogram not used             bufRecv(bufSizeRecv*nz, halo%numMsgRecv),  &
! Subprogram not used             bufTripole(nxGlobal, halo%tripoleRows, nz), &
! Subprogram not used             stat=ierr)
! Subprogram not used 
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DR4: error allocating buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    bufTripole = fill
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  post receives
...
! Subprogram not used    do nmsg=1,halo%numMsgRecv
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)*nz
! Subprogram not used       call MPI_IRECV(bufRecv(1:len,nmsg), len, mpiR4,   &
! Subprogram not used                      halo%recvTask(nmsg),               &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg),  &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used          srcBlock = halo%sendAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          do k=1,nz
! Subprogram not used             i = i + 1
! Subprogram not used             bufSend(i,nmsg) = array(iSrc,jSrc,k,srcBlock)
! Subprogram not used          end do
! Subprogram not used       end do
! Subprogram not used       do n=i+1,bufSizeSend*nz
! Subprogram not used          bufSend(n,nmsg) = fill  ! fill remainder of buffer
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)*nz
! Subprogram not used       call MPI_ISEND(bufSend(1:len,nmsg), len, mpiR4, &
! Subprogram not used                      halo%sendTask(nmsg),             &
! Subprogram not used                      mpitagHalo + my_task,            &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used          if (dstBlock > 0) then
! Subprogram not used             do k=1,nz
! Subprogram not used                array(iDst,jDst,k,dstBlock) = &
! Subprogram not used                array(iSrc,jSrc,k,srcBlock)
! Subprogram not used             end do
! Subprogram not used          else if (dstBlock < 0) then ! tripole copy into buffer
! Subprogram not used             do k=1,nz
! Subprogram not used                bufTripole(iDst,jDst,k) = &
! Subprogram not used                array(iSrc,jSrc,k,srcBlock)
! Subprogram not used             end do
! Subprogram not used          endif
! Subprogram not used       else if (srcBlock == 0) then
! Subprogram not used          do k=1,nz
! Subprogram not used             array(iDst,jDst,k,dstBlock) = fill
! Subprogram not used          end do
! Subprogram not used       endif
! Subprogram not used    end do
! Subprogram not used 
...
! Subprogram not used             do k=1,nz
! Subprogram not used                i = i + 1
! Subprogram not used                array(iDst,jDst,k,dstBlock) = bufRecv(i,nmsg)
! Subprogram not used             end do
! Subprogram not used          else if (dstBlock < 0) then !tripole
! Subprogram not used             do k=1,nz
! Subprogram not used                i = i + 1
! Subprogram not used                bufTripole(iDst,jDst,k) = bufRecv(i,nmsg)
! Subprogram not used             end do
! Subprogram not used          endif
! Subprogram not used       end do
! Subprogram not used    end do
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate3DR4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
...
! Subprogram not used            do i = 2,nxGlobal/2
! Subprogram not used               iDst = nxGlobal - i + 2
! Subprogram not used               x1 = bufTripole(i   ,halo%tripoleRows,k)
! Subprogram not used               x2 = bufTripole(iDst,halo%tripoleRows,k)
! Subprogram not used               xavg = 0.5_real_kind*(x1 + isign*x2)
! Subprogram not used               bufTripole(i   ,halo%tripoleRows,k) = xavg
! Subprogram not used               bufTripole(iDst,halo%tripoleRows,k) = isign*xavg
! Subprogram not used            end do
! Subprogram not used            end do
! Subprogram not used   
! Subprogram not used         case (field_loc_NEcorner)   ! cell corner location
...
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate3DR4: Unknown field location')
! Subprogram not used         end select  
! Subprogram not used   
! Subprogram not used       else ! tripole u-fold  
! Subprogram not used   
...
! Subprogram not used             if (jSrc <= halo%tripoleRows .and. jSrc>0 .and. jDst>0) then
! Subprogram not used                do k=1,nz
! Subprogram not used                   array(iDst,jDst,k,dstBlock) = isign*    &
! Subprogram not used                                   bufTripole(iSrc,jSrc,k)
! Subprogram not used                end do
! Subprogram not used             endif
! Subprogram not used 
! Subprogram not used          endif
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DR4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    deallocate(bufSend, bufRecv, bufTripole, stat=ierr)
! Subprogram not used 
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DR4: error deallocating 3d buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate3DR4
...
! Subprogram not used  subroutine ice_HaloUpdate3DI4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
...
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 3d horizontal arrays of double precision.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    nxGlobal = 0
! Subprogram not used    if (allocated(bufTripoleI4)) nxGlobal = size(bufTripoleI4,dim=1)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  allocate request and status arrays for messages
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DI4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DI4: error allocating buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    bufTripole = fill
...
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)*nz
! Subprogram not used       call MPI_IRECV(bufRecv(1:len,nmsg), len, MPI_INTEGER, &
! Subprogram not used                      halo%recvTask(nmsg),                   &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg),      &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)*nz
! Subprogram not used       call MPI_ISEND(bufSend(1:len,nmsg), len, MPI_INTEGER, &
! Subprogram not used                      halo%sendTask(nmsg),                   &
! Subprogram not used                      mpitagHalo + my_task,                  &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
! Subprogram not used    end do
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate3DI4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
...
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate3DI4: Unknown field location')
! Subprogram not used         end select
! Subprogram not used   
! Subprogram not used       else ! tripole u-fold  
! Subprogram not used 
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DI4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    deallocate(bufSend, bufRecv, bufTripole, stat=ierr)
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate3DI4: error deallocating 3d buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate3DI4
...
! Subprogram not used  subroutine ice_HaloUpdate4DR4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
...
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 4d horizontal arrays of single precision.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    integer (int_kind) ::           &
! Subprogram not used       i,j,k,l,n,nmsg,            &! dummy loop indices
! Subprogram not used       ierr,                      &! error or status flag for MPI,alloc
! Subprogram not used       nxGlobal,                  &! global domain size in x (tripole)
! Subprogram not used       nz, nt,                    &! size of array in 3rd,4th dimensions
! Subprogram not used       iSrc,jSrc,                 &! source addresses for message
! Subprogram not used       iDst,jDst,                 &! dest   addresses for message
! Subprogram not used       srcBlock,                  &! local block number for source
! Subprogram not used       dstBlock,                  &! local block number for destination
...
! Subprogram not used 
! Subprogram not used    real (real_kind), dimension(:,:), allocatable :: &
! Subprogram not used       bufSend, bufRecv            ! 4d send,recv buffers
! Subprogram not used 
! Subprogram not used    real (real_kind), dimension(:,:,:,:), allocatable :: &
! Subprogram not used       bufTripole                  ! 4d tripole buffer
! Subprogram not used 
! Subprogram not used    integer (int_kind) :: len ! length of message
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DR4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  allocate 4D buffers
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nz = size(array, dim=3)
! Subprogram not used    nt = size(array, dim=4)
! Subprogram not used 
! Subprogram not used    allocate(bufSend(bufSizeSend*nz*nt, halo%numMsgSend),   &
! Subprogram not used             bufRecv(bufSizeRecv*nz*nt, halo%numMsgRecv),   &
! Subprogram not used             bufTripole(nxGlobal, halo%tripoleRows, nz, nt), &
! Subprogram not used             stat=ierr)
! Subprogram not used 
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DR4: error allocating buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    bufTripole = fill
...
! Subprogram not used    do nmsg=1,halo%numMsgRecv
! Subprogram not used 
! Subprogram not used       len = halo%SizeRecv(nmsg)*nz*nt
! Subprogram not used       call MPI_IRECV(bufRecv(1:len,nmsg), len, mpiR4,  &
! Subprogram not used                      halo%recvTask(nmsg),              &
! Subprogram not used                      mpitagHalo + halo%recvTask(nmsg), &
! Subprogram not used                      halo%communicator, rcvRequest(nmsg), ierr)
...
! Subprogram not used          srcBlock = halo%sendAddr(3,n,nmsg)
! Subprogram not used 
! Subprogram not used          do l=1,nt
! Subprogram not used          do k=1,nz
! Subprogram not used             i = i + 1
! Subprogram not used             bufSend(i,nmsg) = array(iSrc,jSrc,k,l,srcBlock)
! Subprogram not used          end do
! Subprogram not used          end do
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       do n=i+1,bufSizeSend*nz*nt
! Subprogram not used          bufSend(n,nmsg) = fill  ! fill remainder of buffer
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       len = halo%SizeSend(nmsg)*nz*nt
! Subprogram not used       call MPI_ISEND(bufSend(1:len,nmsg), len, mpiR4, &
! Subprogram not used                      halo%sendTask(nmsg),             &
! Subprogram not used                      mpitagHalo + my_task,            &
! Subprogram not used                      halo%communicator, sndRequest(nmsg), ierr)
...
! Subprogram not used             do l=1,nt
! Subprogram not used             do k=1,nz
! Subprogram not used                array(iDst,jDst,k,l,dstBlock) = &
! Subprogram not used                array(iSrc,jSrc,k,l,srcBlock)
! Subprogram not used             end do
! Subprogram not used             end do
! Subprogram not used          else if (dstBlock < 0) then ! tripole copy into buffer
! Subprogram not used             do l=1,nt
! Subprogram not used             do k=1,nz
! Subprogram not used                bufTripole(iDst,jDst,k,l) = &
! Subprogram not used                array(iSrc,jSrc,k,l,srcBlock)
! Subprogram not used             end do
! Subprogram not used             end do
! Subprogram not used          endif
...
! Subprogram not used          do l=1,nt
! Subprogram not used          do k=1,nz
! Subprogram not used             array(iDst,jDst,k,l,dstBlock) = fill
! Subprogram not used          end do
! Subprogram not used          end do
! Subprogram not used       endif
! Subprogram not used    end do
...
! Subprogram not used             do k=1,nz
! Subprogram not used                i = i + 1
! Subprogram not used                array(iDst,jDst,k,l,dstBlock) = bufRecv(i,nmsg)
! Subprogram not used             end do
! Subprogram not used             end do
! Subprogram not used          else if (dstBlock < 0) then !tripole
! Subprogram not used             do l=1,nt
! Subprogram not used             do k=1,nz
! Subprogram not used                i = i + 1
! Subprogram not used                bufTripole(iDst,jDst,k,l) = bufRecv(i,nmsg)
! Subprogram not used             end do
! Subprogram not used             end do
! Subprogram not used          endif
! Subprogram not used       end do
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate4DR4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
...
! Subprogram not used            do i = 2,nxGlobal/2
! Subprogram not used               iDst = nxGlobal - i + 2
! Subprogram not used               x1 = bufTripole(i   ,halo%tripoleRows,k,l)
! Subprogram not used               x2 = bufTripole(iDst,halo%tripoleRows,k,l)
! Subprogram not used               xavg = 0.5_real_kind*(x1 + isign*x2)
! Subprogram not used               bufTripole(i   ,halo%tripoleRows,k,l) = xavg
! Subprogram not used               bufTripole(iDst,halo%tripoleRows,k,l) = isign*xavg
! Subprogram not used            end do
! Subprogram not used            end do
! Subprogram not used            end do
! Subprogram not used   
...
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate4DR4: Unknown field location')
! Subprogram not used         end select  
! Subprogram not used   
! Subprogram not used       else ! tripole u-fold  
! Subprogram not used 
...
! Subprogram not used                do l=1,nt
! Subprogram not used                do k=1,nz
! Subprogram not used                   array(iDst,jDst,k,l,dstBlock) = isign*    &
! Subprogram not used                                   bufTripole(iSrc,jSrc,k,l)
! Subprogram not used                end do
! Subprogram not used                end do
! Subprogram not used             endif
! Subprogram not used 
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DR4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    deallocate(bufSend, bufRecv, bufTripole, stat=ierr)
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DR4: error deallocating 4d buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate4DR4
...
! Subprogram not used  subroutine ice_HaloUpdate4DI4(array, halo,                    &
! Subprogram not used                                fieldLoc, fieldKind, &
! Subprogram not used                                fillValue)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
...
! Subprogram not used !  member of a group of routines under the generic interface
! Subprogram not used !  ice\_HaloUpdate.  This routine is the specific interface
! Subprogram not used !  for 4d horizontal integer arrays.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DI4: error allocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DI4: error allocating buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    bufTripole = fill
...
! Subprogram not used       case default
! Subprogram not used          call abort_ice( &
! Subprogram not used             'ice_HaloUpdate4DI4: Unknown field kind')
! Subprogram not used       end select
! Subprogram not used 
! Subprogram not used       if (halo%tripoleTFlag) then
! Subprogram not used 
...
! Subprogram not used         case default
! Subprogram not used            call abort_ice( &
! Subprogram not used               'ice_HaloUpdate4DI4: Unknown field location')
! Subprogram not used         end select 
! Subprogram not used   
! Subprogram not used       else ! tripole u-fold  
! Subprogram not used 
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DI4: error deallocating req,status arrays')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    deallocate(bufSend, bufRecv, bufTripole, stat=ierr)
...
! Subprogram not used    if (ierr > 0) then
! Subprogram not used       call abort_ice( &
! Subprogram not used          'ice_HaloUpdate4DI4: error deallocating 4d buffers')
! Subprogram not used       return
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloUpdate4DI4
...
! Subprogram not used  subroutine ice_HaloExtrapolate2DR8(ARRAY,dist,ew_bndy_type,ns_bndy_type)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  This subroutine extrapolates ARRAY values into the first row or column 
! Subprogram not used !  of ghost cells, and is intended for grid variables whose ghost cells 
! Subprogram not used !  would otherwise be set using the default boundary conditions (Dirichlet 
! Subprogram not used !  or Neumann).
! Subprogram not used !  Note: This routine will need to be modified for nghost > 1.
! Subprogram not used !        We assume padding occurs only on east and north edges.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used !
! Subprogram not used ! !REMARKS:
! Subprogram not used !  This is the specific interface for double precision arrays 
! Subprogram not used !  corresponding to the generic interface ice_HaloExtrapolate
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used 
! Subprogram not used    use ice_blocks
! Subprogram not used    use ice_constants
! Subprogram not used    use ice_distribution
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used     character (char_len) :: &
! Subprogram not used        ew_bndy_type,    &! type of domain bndy in each logical
! Subprogram not used        ns_bndy_type      !    direction (ew is i, ns is j)
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    integer (int_kind) :: &
! Subprogram not used      i,j,iblk,           &! dummy loop indices
! Subprogram not used      numBlocks,       &! number of local blocks
! Subprogram not used      blockID,            &! block location
! Subprogram not used      ibc,                &! ghost cell column or row
! Subprogram not used      npad                 ! padding column/row counter
! Subprogram not used 
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !  Linear extrapolation
! Subprogram not used !
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    do iblk = 1, numBlocks
! Subprogram not used       call ice_distributionGetBlockID(dist, iblk, blockID)
! Subprogram not used       this_block = get_block(blockID, blockID)
! Subprogram not used 
! Subprogram not used       if (this_block%iblock == 1) then              ! west edge
! Subprogram not used          if (trim(ew_bndy_type) /= 'cyclic') then
! Subprogram not used             do j = 1, ny_block
! Subprogram not used                ARRAY(1,j,iblk) = c2*ARRAY(2,j,iblk) - ARRAY(3,j,iblk)
! Subprogram not used             enddo
! Subprogram not used          endif
! Subprogram not used 
! Subprogram not used       elseif (this_block%iblock == nblocks_x) then  ! east edge
! Subprogram not used          if (trim(ew_bndy_type) /= 'cyclic') then
! Subprogram not used             ! locate ghost cell column (avoid padding)
! Subprogram not used             ibc = nx_block
! Subprogram not used             do i = nx_block, 1, - 1
! Subprogram not used                if (this_block%i_glob(i) == 0) ibc = ibc - 1
! Subprogram not used             enddo
! Subprogram not used             do j = 1, ny_block
! Subprogram not used                ARRAY(ibc,j,iblk) = c2*ARRAY(ibc-1,j,iblk) - ARRAY(ibc-2,j,iblk)
! Subprogram not used             enddo
! Subprogram not used          endif
! Subprogram not used       endif
! Subprogram not used 
! Subprogram not used       if (this_block%jblock == 1) then              ! south edge
! Subprogram not used          if (trim(ns_bndy_type) /= 'cyclic') then
! Subprogram not used             do i = 1, nx_block
! Subprogram not used                ARRAY(i,1,iblk) = c2*ARRAY(i,2,iblk) - ARRAY(i,3,iblk)
! Subprogram not used             enddo
! Subprogram not used          endif
! Subprogram not used 
! Subprogram not used       elseif (this_block%jblock == nblocks_y) then  ! north edge
! Subprogram not used          if (trim(ns_bndy_type) /= 'cyclic' .and. &
! Subprogram not used              trim(ns_bndy_type) /= 'tripole' .and. &
! Subprogram not used              trim(ns_bndy_type) /= 'tripoleT' ) then
! Subprogram not used             ! locate ghost cell column (avoid padding)
! Subprogram not used             ibc = ny_block
! Subprogram not used             do j = ny_block, 1, - 1
! Subprogram not used                if (this_block%j_glob(j) == 0) ibc = ibc - 1
! Subprogram not used             enddo
! Subprogram not used             do i = 1, nx_block
! Subprogram not used                ARRAY(i,ibc,iblk) = c2*ARRAY(i,ibc-1,iblk) - ARRAY(i,ibc-2,iblk)
! Subprogram not used             enddo
! Subprogram not used          endif
! Subprogram not used       endif
! Subprogram not used 
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used  end subroutine ice_HaloExtrapolate2DR8
