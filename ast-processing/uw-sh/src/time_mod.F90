...
! Subprogram not used   subroutine TimeLevel_init_copy(tl, tin)
! Subprogram not used     type (TimeLevel_t), intent(in) :: tin
! Subprogram not used     type (TimeLevel_t), intent(out) :: tl
! Subprogram not used     tl%nm1   = tin%nm1
! Subprogram not used     tl%n0    = tin%n0
! Subprogram not used     tl%np1   = tin%np1
! Subprogram not used     tl%nstep = tin%nstep
! Subprogram not used     tl%nstep0= tin%nstep0
! Subprogram not used   end subroutine TimeLevel_init_copy

! Subprogram not used   subroutine TimeLevel_init_specific(tl,n0,n1,n2,nstep)
! Subprogram not used     type (TimeLevel_t) :: tl
! Subprogram not used     integer, intent(in) :: n0,n1,n2,nstep
! Subprogram not used     tl%nm1= n0
! Subprogram not used     tl%n0 = n1
! Subprogram not used     tl%np1= n2
! Subprogram not used     tl%nstep= nstep
! Subprogram not used   end subroutine TimeLevel_init_specific
