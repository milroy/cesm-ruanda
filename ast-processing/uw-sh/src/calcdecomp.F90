...
! Subprogram not used   subroutine pio_set_blocksize(newsize)
! Subprogram not used     integer, intent(in) :: newsize
! Subprogram not used 
! Subprogram not used     if(newsize<0) then
! Subprogram not used        call piodie("calcdecomp.F90",38,'bad value to blocksize: ',newsize)
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     blocksize=newsize
! Subprogram not used 
! Subprogram not used 
! Subprogram not used   end subroutine pio_set_blocksize
