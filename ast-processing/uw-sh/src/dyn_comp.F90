...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Subprogram not used   subroutine dyn_final(DYN_STATE, RESTART_FILE)
! Subprogram not used 
! Subprogram not used     type (elem_state_t), target     :: DYN_STATE
! Subprogram not used     character(LEN=*)   , intent(IN) :: RESTART_FILE
! Subprogram not used 
! Subprogram not used 
! Subprogram not used 
! Subprogram not used   end subroutine dyn_final
