...
!
  ...
  public cnst_cam_outfld      ! Returns true if default 1 output was specified in the cnst_add calls.

! Public data

  integer, parameter, public :: pcnst  = 25      ! number of advected constituents (including water vapor)
...
! Private data
  ...
  logical :: cam_outfld_(pcnst)            ! true  => default 1 output of constituents in kg/kg
...
!
    ...
    logical,          intent(in), optional :: &
       cam_outfld  ! true => default 1 output of constituent in kg/kg
    logical,          intent(in), optional :: &
...
! Subprogram not used   function cnst_num_avail()
! Subprogram not used 
! Subprogram not used      ! return number of available slots in the constituent array
! Subprogram not used 
! Subprogram not used      integer cnst_num_avail
! Subprogram not used 
! Subprogram not used      cnst_num_avail = pcnst - padv
! Subprogram not used 
! Subprogram not used   end function cnst_num_avail
...
! Subprogram not used   character*3 function cnst_get_type_byname (name)
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used ! 
! Subprogram not used ! Purpose: Get the type of a constituent 
! Subprogram not used ! 
...
! Subprogram not used ! 
! Subprogram not used ! Author:  P. J. Rasch
! Subprogram not used ! 
...
! Subprogram not used     integer :: m                                   ! tracer index
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     do m = 1, pcnst
! Subprogram not used        if (name == cnst_name(m)) then
! Subprogram not used           cnst_get_type_byname = cnst_type(m)
! Subprogram not used           return
! Subprogram not used        end if
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used ! Unrecognized name
! Subprogram not used     write(iulog,*) 'CNST_GET_TYPE_BYNAME, name:', name,  ' not found in list:', cnst_name(:)
! Subprogram not used     call endrun
! Subprogram not used 
! Subprogram not used   end function cnst_get_type_byname
...
! 
! Purpose:
! Query whether default 1 outfld calls should be made.
! 
!----------------------------------------------------------------------- 
   integer, intent(in) :: m                ! constituent index
   logical             :: cnst_cam_outfld  ! true => use default 1 outfld calls
!-----------------------------------------------------------------------
