...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_140626/shr/shr_orb_mod.F90 $
!===============================================================================
...
! Subprogram not used SUBROUTINE shr_orb_print( iyear_AD, eccen, obliq, mvelp )
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used ! Print out the information on the Earths input orbital characteristics
! Subprogram not used !
! Subprogram not used !---------------------------Code history----------------------------------------
! Subprogram not used !
! Subprogram not used ! Original version:  Erik Kluzek
! Subprogram not used ! Date:              Oct/1997
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    !---------------------------Arguments----------------------------------------
! Subprogram not used    integer(SHR_KIND_IN),intent(in) :: iyear_AD ! requested Year (AD)
! Subprogram not used    real   (SHR_KIND_R8),intent(in) :: eccen    ! eccentricity (unitless) 
! Subprogram not used                                                ! (typically 0 to 0.1)
! Subprogram not used    real   (SHR_KIND_R8),intent(in) :: obliq    ! obliquity (-90 to +90 degrees) 
! Subprogram not used                                                ! typically 22-26
! Subprogram not used    real   (SHR_KIND_R8),intent(in) :: mvelp    ! moving vernal equinox at perhel
! Subprogram not used                                                ! (0 to 360 degrees)
! Subprogram not used    !-------------------------- Formats -----------------------------------------
! Subprogram not used    character(len=*),parameter :: F00 = "('(shr_orb_print) ',4a)"
! Subprogram not used    character(len=*),parameter :: F01 = "('(shr_orb_print) ',a,i9.4)"
! Subprogram not used    character(len=*),parameter :: F02 = "('(shr_orb_print) ',a,f6.3)"
! Subprogram not used    character(len=*),parameter :: F03 = "('(shr_orb_print) ',a,es14.6)"
! Subprogram not used    !----------------------------------------------------------------------------
! Subprogram not used  
! Subprogram not used    if (s_loglev > 0) then
! Subprogram not used    if ( iyear_AD .ne. SHR_ORB_UNDEF_INT ) then
! Subprogram not used      if ( iyear_AD > 0 ) then
! Subprogram not used        write(s_logunit,F01) 'Orbital parameters calculated for year: AD ',iyear_AD
! Subprogram not used      else
! Subprogram not used        write(s_logunit,F01) 'Orbital parameters calculated for year: BC ',iyear_AD
! Subprogram not used      end if
! Subprogram not used    else if ( obliq /= SHR_ORB_UNDEF_REAL ) then
! Subprogram not used      write(s_logunit,F03) 'Orbital parameters: '
! Subprogram not used      write(s_logunit,F03) 'Obliquity (degree):              ', obliq
! Subprogram not used      write(s_logunit,F03) 'Eccentricity (unitless):         ', eccen
! Subprogram not used      write(s_logunit,F03) 'Long. of moving Perhelion (deg): ', mvelp
! Subprogram not used    else
! Subprogram not used      write(s_logunit,F03) 'Orbit parameters not set!'
! Subprogram not used    end if
! Subprogram not used    endif
! Subprogram not used  
! Subprogram not used END SUBROUTINE shr_orb_print
!===============================================================================
