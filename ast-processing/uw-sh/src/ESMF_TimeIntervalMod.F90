...
! Subprogram not used 
! Subprogram not used       D = iS / SECONDS_PER_DAY
! Subprogram not used       H = mod( iS, SECONDS_PER_DAY ) / SECONDS_PER_HOUR
! Subprogram not used       M = mod( iS, SECONDS_PER_HOUR) / SECONDS_PER_MINUTE
! Subprogram not used       S = mod( iS, SECONDS_PER_MINUTE )
! Subprogram not used 
