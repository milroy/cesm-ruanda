...
! Subprogram not used integer function phys_debug_col(chunk)
! Subprogram not used 
! Subprogram not used    integer,  intent(in) :: chunk
! Subprogram not used    !-----------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (chunk == debchunk) then
! Subprogram not used       phys_debug_col = debcol
! Subprogram not used    else
! Subprogram not used       phys_debug_col = 0
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used end function phys_debug_col
