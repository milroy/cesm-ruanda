...
! Subprogram not used   subroutine physics_state_check(state, name)
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used ! Check a physics_state object for invalid data (e.g NaNs, negative
! Subprogram not used ! temperatures).
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     use shr_infnan_mod, only: shr_infnan_inf_type, assignment(=), &
! Subprogram not used                               shr_infnan_posinf, shr_infnan_neginf
! Subprogram not used     use shr_assert_mod, only: shr_assert, shr_assert_in_domain
! Subprogram not used     use physconst,      only: pi
! Subprogram not used     use constituents,   only: pcnst, qmin
! Subprogram not used 
! Subprogram not used !------------------------------Arguments--------------------------------
! Subprogram not used     ! State to check.
! Subprogram not used     type(physics_state), intent(in)           :: state
! Subprogram not used     ! Name of the package responsible for this state.
! Subprogram not used     character(len=*),    intent(in), optional :: name
! Subprogram not used 
! Subprogram not used !---------------------------Local storage-------------------------------
! Subprogram not used     ! Shortened name for ncol.
! Subprogram not used     integer :: ncol
! Subprogram not used     ! Double precision positive/negative infinity.
! Subprogram not used     real(r8) :: posinf_r8, neginf_r8
! Subprogram not used     ! Canned message.
! Subprogram not used     character(len=64) :: msg
! Subprogram not used     ! Constituent index
...
! Subprogram not used 
! Subprogram not used     posinf_r8 = shr_infnan_posinf
! Subprogram not used     neginf_r8 = shr_infnan_neginf
! Subprogram not used 
! Subprogram not used     ! It may be reasonable to check some of the integer components of the
! Subprogram not used     ! state as well, but this is not yet implemented.
! Subprogram not used 
! Subprogram not used     ! Check for NaN first to avoid any IEEE exceptions.
! Subprogram not used 
! Subprogram not used     if (present(name)) then
! Subprogram not used        msg = "NaN produced in physics_state by package "// &
! Subprogram not used             trim(name)//"."
! Subprogram not used     else
! Subprogram not used        msg = "NaN found in physics_state."
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     ! 1-D variables
! Subprogram not used     call shr_assert_in_domain(state%ps(:ncol),          is_nan=.false., &
! Subprogram not used          varname="state%ps",        msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%psdry(:ncol),       is_nan=.false., &
! Subprogram not used          varname="state%psdry",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%phis(:ncol),        is_nan=.false., &
! Subprogram not used          varname="state%phis",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%te_ini(:ncol),      is_nan=.false., &
! Subprogram not used          varname="state%te_ini",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%te_cur(:ncol),      is_nan=.false., &
! Subprogram not used          varname="state%te_cur",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%tw_ini(:ncol),      is_nan=.false., &
! Subprogram not used          varname="state%tw_ini",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%tw_cur(:ncol),      is_nan=.false., &
! Subprogram not used          varname="state%tw_cur",    msg=msg)
! Subprogram not used 
! Subprogram not used     ! 2-D variables (at midpoints)
! Subprogram not used     call shr_assert_in_domain(state%t(:ncol,:),         is_nan=.false., &
! Subprogram not used          varname="state%t",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%u(:ncol,:),         is_nan=.false., &
! Subprogram not used          varname="state%u",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%v(:ncol,:),         is_nan=.false., &
! Subprogram not used          varname="state%v",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%s(:ncol,:),         is_nan=.false., &
! Subprogram not used          varname="state%s",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%omega(:ncol,:),     is_nan=.false., &
! Subprogram not used          varname="state%omega",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pmid(:ncol,:),      is_nan=.false., &
! Subprogram not used          varname="state%pmid",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pmiddry(:ncol,:),   is_nan=.false., &
! Subprogram not used          varname="state%pmiddry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pdel(:ncol,:),      is_nan=.false., &
! Subprogram not used          varname="state%pdel",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pdeldry(:ncol,:),   is_nan=.false., &
! Subprogram not used          varname="state%pdeldry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%rpdel(:ncol,:),     is_nan=.false., &
! Subprogram not used          varname="state%rpdel",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%rpdeldry(:ncol,:),  is_nan=.false., &
! Subprogram not used          varname="state%rpdeldry",  msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpmid(:ncol,:),    is_nan=.false., &
! Subprogram not used          varname="state%lnpmid",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpmiddry(:ncol,:), is_nan=.false., &
! Subprogram not used          varname="state%lnpmiddry", msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%exner(:ncol,:),     is_nan=.false., &
! Subprogram not used          varname="state%exner",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%zm(:ncol,:),        is_nan=.false., &
! Subprogram not used          varname="state%zm",        msg=msg)
! Subprogram not used 
! Subprogram not used     ! 2-D variables (at interfaces)
! Subprogram not used     call shr_assert_in_domain(state%pint(:ncol,:),      is_nan=.false., &
! Subprogram not used          varname="state%pint",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pintdry(:ncol,:),   is_nan=.false., &
! Subprogram not used          varname="state%pintdry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpint(:ncol,:),    is_nan=.false., &
! Subprogram not used          varname="state%lnpint",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpintdry(:ncol,:), is_nan=.false., &
! Subprogram not used          varname="state%lnpintdry", msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%zi(:ncol,:),        is_nan=.false., &
! Subprogram not used          varname="state%zi",        msg=msg)
! Subprogram not used 
! Subprogram not used     ! 3-D variables
! Subprogram not used     call shr_assert_in_domain(state%q(:ncol,:,:),       is_nan=.false., &
! Subprogram not used          varname="state%q",         msg=msg)
! Subprogram not used 
! Subprogram not used     ! Now run other checks (i.e. values are finite and within a range that
! Subprogram not used     ! is physically meaningful).
! Subprogram not used 
! Subprogram not used     if (present(name)) then
! Subprogram not used        msg = "Invalid value produced in physics_state by package "// &
! Subprogram not used             trim(name)//"."
! Subprogram not used     else
! Subprogram not used        msg = "Invalid value found in physics_state."
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     ! 1-D variables
! Subprogram not used     call shr_assert_in_domain(state%ps(:ncol),          lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%ps",        msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%psdry(:ncol),       lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%psdry",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%phis(:ncol),        lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%phis",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%te_ini(:ncol),      lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%te_ini",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%te_cur(:ncol),      lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%te_cur",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%tw_ini(:ncol),      lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%tw_ini",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%tw_cur(:ncol),      lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%tw_cur",    msg=msg)
! Subprogram not used 
! Subprogram not used     ! 2-D variables (at midpoints)
! Subprogram not used     call shr_assert_in_domain(state%t(:ncol,:),         lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%t",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%u(:ncol,:),         lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%u",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%v(:ncol,:),         lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%v",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%s(:ncol,:),         lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%s",         msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%omega(:ncol,:),     lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%omega",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pmid(:ncol,:),      lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%pmid",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pmiddry(:ncol,:),   lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%pmiddry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pdel(:ncol,:),      lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%pdel",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pdeldry(:ncol,:),   lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%pdeldry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%rpdel(:ncol,:),     lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%rpdel",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%rpdeldry(:ncol,:),  lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%rpdeldry",  msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpmid(:ncol,:),    lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%lnpmid",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpmiddry(:ncol,:), lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%lnpmiddry", msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%exner(:ncol,:),     lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%exner",     msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%zm(:ncol,:),        lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%zm",        msg=msg)
! Subprogram not used 
! Subprogram not used     ! 2-D variables (at interfaces)
! Subprogram not used     call shr_assert_in_domain(state%pint(:ncol,:),      lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%pint",      msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%pintdry(:ncol,:),   lt=posinf_r8, gt=0._r8, &
! Subprogram not used          varname="state%pintdry",   msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpint(:ncol,:),    lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%lnpint",    msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%lnpintdry(:ncol,:), lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%lnpintdry", msg=msg)
! Subprogram not used     call shr_assert_in_domain(state%zi(:ncol,:),        lt=posinf_r8, gt=neginf_r8, &
! Subprogram not used          varname="state%zi",        msg=msg)
! Subprogram not used 
! Subprogram not used     ! 3-D variables
! Subprogram not used     do m = 1,pcnst
! Subprogram not used        call shr_assert_in_domain(state%q(:ncol,:,m),    lt=posinf_r8, ge=qmin(m), &
! Subprogram not used             varname="state%q ("//trim(cnst_name(m))//")", msg=msg)
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end subroutine physics_state_check
...
! Subprogram not used subroutine physics_ptend_copy(ptend, ptend_cp)
! Subprogram not used 
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used    ! Copy a physics_ptend object.  Allocate ptend_cp internally before copy.
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    type(physics_ptend), intent(in)    :: ptend    ! ptend source
! Subprogram not used    type(physics_ptend), intent(out)   :: ptend_cp ! copy of ptend
! Subprogram not used 
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    ptend_cp%name      = ptend%name
! Subprogram not used 
! Subprogram not used    ptend_cp%ls = ptend%ls
! Subprogram not used    ptend_cp%lu = ptend%lu
! Subprogram not used    ptend_cp%lv = ptend%lv
! Subprogram not used    ptend_cp%lq = ptend%lq
! Subprogram not used 
! Subprogram not used    call physics_ptend_alloc(ptend_cp, ptend%psetcols)
! Subprogram not used 
! Subprogram not used    ptend_cp%top_level = ptend%top_level
! Subprogram not used    ptend_cp%bot_level = ptend%bot_level
! Subprogram not used 
! Subprogram not used    if (ptend_cp%ls) then
! Subprogram not used       ptend_cp%s = ptend%s
! Subprogram not used       ptend_cp%hflux_srf = ptend%hflux_srf
! Subprogram not used       ptend_cp%hflux_top = ptend%hflux_top
! Subprogram not used    end if
! Subprogram not used    
! Subprogram not used    if (ptend_cp%lu) then
! Subprogram not used       ptend_cp%u = ptend%u
! Subprogram not used       ptend_cp%taux_srf  = ptend%taux_srf
! Subprogram not used       ptend_cp%taux_top  = ptend%taux_top
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    if (ptend_cp%lv) then
! Subprogram not used       ptend_cp%v = ptend%v
! Subprogram not used       ptend_cp%tauy_srf  = ptend%tauy_srf
! Subprogram not used       ptend_cp%tauy_top  = ptend%tauy_top
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    if (any(ptend_cp%lq(:))) then
! Subprogram not used       ptend_cp%q = ptend%q
! Subprogram not used       ptend_cp%cflx_srf  = ptend%cflx_srf
! Subprogram not used       ptend_cp%cflx_top  = ptend%cflx_top
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used end subroutine physics_ptend_copy
...
! Subprogram not used   subroutine physics_tend_init(tend)
! Subprogram not used     
...
! Subprogram not used     !
! Subprogram not used 
! Subprogram not used     if (.not. allocated(tend%dtdt)) then
! Subprogram not used        call endrun('physics_tend_init: tend must be allocated before it can be initialized')
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     tend%dtdt    = 0._r8
! Subprogram not used     tend%dudt    = 0._r8
! Subprogram not used     tend%dvdt    = 0._r8
! Subprogram not used     tend%flx_net = 0._r8
! Subprogram not used     tend%te_tnd  = 0._r8
! Subprogram not used     tend%tw_tnd  = 0._r8
! Subprogram not used     
! Subprogram not used end subroutine physics_tend_init
...
! Subprogram not used subroutine physics_tend_dealloc(tend)
! Subprogram not used 
! Subprogram not used ! deallocate the individual tend components
! Subprogram not used 
! Subprogram not used   type(physics_tend), intent(inout)  :: tend
! Subprogram not used   integer :: psetcols
! Subprogram not used   integer :: ierr = 0
! Subprogram not used 
! Subprogram not used   deallocate(tend%dtdt, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%dtdt')
! Subprogram not used 
! Subprogram not used   deallocate(tend%dudt, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%dudt')
! Subprogram not used 
! Subprogram not used   deallocate(tend%dvdt, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%dvdt')
! Subprogram not used 
! Subprogram not used   deallocate(tend%flx_net, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%flx_net')
! Subprogram not used 
! Subprogram not used   deallocate(tend%te_tnd, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%te_tnd')
! Subprogram not used 
! Subprogram not used   deallocate(tend%tw_tnd, stat=ierr)
! Subprogram not used   if ( ierr /= 0 ) call endrun('physics_tend_dealloc error: deallocation error for tend%tw_tnd')
! Subprogram not used end subroutine physics_tend_dealloc
