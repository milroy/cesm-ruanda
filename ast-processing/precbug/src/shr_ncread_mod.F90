...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_140626/shr/shr_ncread_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_varDimSizeName(fileName, varName, dimName,  ns, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)        ,intent(in)           :: fileName ! nc file name
! Subprogram not used    character(*)        ,intent(in)           :: varName  ! name of variable
! Subprogram not used    character(*)        ,intent(in)           :: dimName  ! name of dimension
! Subprogram not used    integer(SHR_KIND_IN),intent(out)          :: ns       ! number of dims of var
...
! Subprogram not used    integer(SHR_KIND_IN) :: rCode
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_varDimSizeName)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_varDimSizeName) ',4a)"
! Subprogram not used    character(*),parameter :: F01     = "('(shr_ncread_varDimSizeName) ',a,i6)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    call shr_ncread_dimSizeName(fileName,dimName,ns,rCode)
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_varDimSizeName
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_dimSizeName(fileName, dimName, ns, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used    character(*)        ,intent(in)           :: fileName ! nc file name
! Subprogram not used    character(*)        ,intent(in)           :: dimName  ! name of dimension
! Subprogram not used    integer(SHR_KIND_IN),intent(out)          :: ns       ! size of dimension
! Subprogram not used    integer(SHR_KIND_IN),intent(out),optional :: rc       ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    integer(SHR_KIND_IN) :: fid       ! file id
! Subprogram not used    integer(SHR_KIND_IN) :: did       ! dim id
! Subprogram not used    integer(SHR_KIND_IN) :: rCode     ! error code
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_dimSizeName)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_dimSizeName) ',4a)"
! Subprogram not used    character(*),parameter :: F01     = "('(shr_ncread_dimSizeName) ',a,i6)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    call shr_ncread_open(fileName,fid,rCode)
! Subprogram not used 
! Subprogram not used    !--- read coordinate dimensions ---
! Subprogram not used    rcode = nf90_inq_dimid        (fid, trim(dimName), did)  ! size of dimension
! Subprogram not used    call shr_ncread_handleErr(rCode, subName//" ERROR inq dimid")
! Subprogram not used    rcode = nf90_inquire_dimension(fid,did,len=ns)
! Subprogram not used    call shr_ncread_handleErr(rCode, subName//" ERROR inquire dimension")
! Subprogram not used    if (debug > 1 .and. s_loglev > 0) write(s_logunit,F01) trim(dimName)//' dimension has size = ',ns
! Subprogram not used 
! Subprogram not used    call shr_ncread_close(fid,rCode)
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_dimSizeName
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_tField2dR8(fn, tIndex, fldName, fld, dim1, dim2, tName, fidi, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)        ,intent(in)           :: fn       ! nc file name
! Subprogram not used    integer(SHR_KIND_IN),intent(in)           :: tIndex   ! time-coord index
! Subprogram not used    character(*)        ,intent(in)           :: fldName  ! name of field
! Subprogram not used    real(SHR_KIND_R8)   ,intent(out)          :: fld(:,:) ! field array
! Subprogram not used    character(*)        ,intent(in) ,optional :: dim1     ! name of dim1 in fld
! Subprogram not used    character(*)        ,intent(in) ,optional :: dim2     ! name of dim2 in fld
! Subprogram not used    character(*)        ,intent(in) ,optional :: tName    ! name of tIndex dim
! Subprogram not used    integer(SHR_KIND_IN),intent(in) ,optional :: fidi     ! file id
! Subprogram not used    integer(SHR_KIND_IN),intent(out),optional :: rc       ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    real(SHR_KIND_R8),allocatable :: lfld(:,:,:,:)   ! local 4d array
! Subprogram not used    integer(SHR_KIND_IN) :: rCode                    ! error code
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_tField2dR8)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_tField2dR8) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used    allocate(lfld(size(fld,1),size(fld,2),1,1))
! Subprogram not used 
! Subprogram not used    if (present(dim1).and.present(dim2).and.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=dim2,dim3=tName,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=dim2,dim3=tName,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(dim1).and.present(dim2)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=dim2,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=dim2,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim3=tName,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim3=tName,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (.not.present(dim1).and..not.present(dim2).and..not.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    else
! Subprogram not used      call shr_ncread_abort(subName//' ERROR argument combination not supported')
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    fld(:,:) = lfld(:,:,1,1)
! Subprogram not used    deallocate(lfld)
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_tField2dR8
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_tField1dR8(fn, tIndex, fldName, fld, dim1, tName, fidi, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_tField1dR8)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_tField1dR8) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    allocate(lfld(size(fld,1),1,1,1))
! Subprogram not used 
! Subprogram not used    if (present(dim1).and.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=tName,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2=tName,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(dim1)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim1=dim1,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim2=tName,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim2=tName,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (.not.present(dim1).and..not.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,rfld=lfld,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    else
! Subprogram not used      call shr_ncread_abort(subName//' ERROR argument combination not supported')
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    fld(:) = lfld(:,1,1,1)
! Subprogram not used    deallocate(lfld)
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_tField1dR8
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_tField2dIN(fn, tIndex, fldName, fld, dim1, dim2, tName, fidi, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used    integer(SHR_KIND_IN),intent(in)           :: tIndex   ! time-coord index
! Subprogram not used    character(*)        ,intent(in)           :: fldName  ! name of field
! Subprogram not used    integer(SHR_KIND_IN),intent(out)          :: fld(:,:) ! field array
! Subprogram not used    character(*)        ,intent(in) ,optional :: dim1     ! name of dim1 in fld
! Subprogram not used    character(*)        ,intent(in) ,optional :: dim2     ! name of dim2 in fld
! Subprogram not used    character(*)        ,intent(in) ,optional :: tName    ! name of tIndex dim
! Subprogram not used    integer(SHR_KIND_IN),intent(in) ,optional :: fidi     ! file id
...
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    integer(SHR_KIND_IN),allocatable :: lfld(:,:,:,:)  ! local 4d array
! Subprogram not used    integer(SHR_KIND_IN) :: rCode                      ! error code
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_tField2dIN)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_tField2dIN) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    if (present(dim1).and.present(dim2).and.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=dim2,dim3=tName,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=dim2,dim3=tName,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(dim1).and.present(dim2)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=dim2,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=dim2,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim3=tName,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim3=tName,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (.not.present(dim1).and..not.present(dim2).and..not.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim3i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim3i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    else
! Subprogram not used      call shr_ncread_abort(subName//' ERROR argument combination not supported')
! Subprogram not used    endif
...
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_tField2dIN
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_tField1dIN(fn, tIndex, fldName, fld, dim1, tName, fidi, rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = "(shr_ncread_tField1dIN)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_ncread_tField1dIN) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    if (present(dim1).and.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=tName,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2=tName,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(dim1)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim1=dim1,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim2=tName,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim2=tName,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    elseif (.not.present(dim1).and..not.present(tName)) then
! Subprogram not used      if (.not.present(fidi)) then
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim2i=tIndex,rc=rCode)
! Subprogram not used      else
! Subprogram not used        call shr_ncread_field4dG(fn,fldName,ifld=lfld,dim2i=tIndex,fidi=fidi,rc=rCode)
! Subprogram not used      endif
! Subprogram not used    else
! Subprogram not used      call shr_ncread_abort(subName//' ERROR argument combination not supported')
! Subprogram not used    endif
...
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_tField1dIN
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_setAbort(flag)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used   !--- formats ---
! Subprogram not used   character(*),parameter :: subName = "('shr_ncread_setAbort') "
! Subprogram not used   character(*),parameter :: F00     = "('(shr_ncread_setAbort) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_setAbort
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used subroutine shr_ncread_abort(string)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used   character(*),parameter :: subName =   "(shr_ncread_abort)"
! Subprogram not used   character(*),parameter :: F00     = "('(shr_ncread_abort) ',a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used end subroutine shr_ncread_abort
!===============================================================================
!===============================================================================
