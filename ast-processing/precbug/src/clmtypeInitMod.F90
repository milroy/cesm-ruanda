...
!
! !INTERFACE:
! Subprogram not used   subroutine init_pft_DGVMecophys_constants()
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Initialize pft physical state
! Subprogram not used !
...
! Subprogram not used !------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     allocate(dgv_pftcon%crownarea_max(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%tcmin(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%tcmax(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%gddmin(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%twmax(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%reinickerp(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%allom1(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%allom2(0:numpft))
! Subprogram not used     allocate(dgv_pftcon%allom3(0:numpft))
! Subprogram not used 
! Subprogram not used     dgv_pftcon%crownarea_max(:) = nan
! Subprogram not used     dgv_pftcon%tcmin(:) = nan
! Subprogram not used     dgv_pftcon%tcmax(:) = nan
! Subprogram not used     dgv_pftcon%gddmin(:) = nan
! Subprogram not used     dgv_pftcon%twmax(:) = nan
! Subprogram not used     dgv_pftcon%reinickerp(:) = nan
! Subprogram not used     dgv_pftcon%allom1(:) = nan
! Subprogram not used     dgv_pftcon%allom2(:) = nan
! Subprogram not used     dgv_pftcon%allom3(:) = nan
! Subprogram not used 
! Subprogram not used   end subroutine init_pft_DGVMecophys_constants
...
!
! !INTERFACE:
! Subprogram not used   subroutine init_pft_pdgvstate_type(beg, end, pdgvs)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Initialize pft DGVM state variables
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used     implicit none
! Subprogram not used     integer, intent(in) :: beg, end
! Subprogram not used     type (pft_dgvstate_type), intent(inout):: pdgvs
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Mariana Vertenstein
! Subprogram not used !
...
! Subprogram not used !------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     allocate(pdgvs%agddtw(beg:end))
! Subprogram not used     allocate(pdgvs%agdd(beg:end))
! Subprogram not used     allocate(pdgvs%t_mo(beg:end))
! Subprogram not used     allocate(pdgvs%t_mo_min(beg:end))
! Subprogram not used     allocate(pdgvs%prec365(beg:end))
! Subprogram not used     allocate(pdgvs%present(beg:end))
! Subprogram not used     allocate(pdgvs%pftmayexist(beg:end))
! Subprogram not used     allocate(pdgvs%nind(beg:end))
! Subprogram not used     allocate(pdgvs%lm_ind(beg:end))
! Subprogram not used     allocate(pdgvs%lai_ind(beg:end))
! Subprogram not used     allocate(pdgvs%fpcinc(beg:end))
! Subprogram not used     allocate(pdgvs%fpcgrid(beg:end))
! Subprogram not used     allocate(pdgvs%fpcgridold(beg:end))
! Subprogram not used     allocate(pdgvs%crownarea(beg:end))
! Subprogram not used     allocate(pdgvs%greffic(beg:end))
! Subprogram not used     allocate(pdgvs%heatstress(beg:end))
! Subprogram not used 
! Subprogram not used     pdgvs%agddtw(beg:end)           = nan
! Subprogram not used     pdgvs%agdd(beg:end)             = nan
! Subprogram not used     pdgvs%t_mo(beg:end)             = nan
! Subprogram not used     pdgvs%t_mo_min(beg:end)         = nan
! Subprogram not used     pdgvs%prec365(beg:end)          = nan
! Subprogram not used     pdgvs%present(beg:end)          = .false.
! Subprogram not used     pdgvs%pftmayexist(beg:end)      = .true.
! Subprogram not used     pdgvs%nind(beg:end)             = nan
! Subprogram not used     pdgvs%lm_ind(beg:end)           = nan
! Subprogram not used     pdgvs%lai_ind(beg:end)          = nan
! Subprogram not used     pdgvs%fpcinc(beg:end)           = nan
! Subprogram not used     pdgvs%fpcgrid(beg:end)          = nan
! Subprogram not used     pdgvs%fpcgridold(beg:end)       = nan
! Subprogram not used     pdgvs%crownarea(beg:end)        = nan
! Subprogram not used     pdgvs%greffic(beg:end)          = nan
! Subprogram not used     pdgvs%heatstress(beg:end)       = nan
! Subprogram not used 
! Subprogram not used   end subroutine init_pft_pdgvstate_type
...
!
! !INTERFACE:
! Subprogram not used   subroutine init_gridcell_dgvstate_type(beg, end, gps)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Initialize gridcell DGVM variables
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used     implicit none
! Subprogram not used     integer, intent(in) :: beg, end
! Subprogram not used     type (gridcell_dgvstate_type), intent(inout):: gps
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Mariana Vertenstein
! Subprogram not used !
...
! Subprogram not used !------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     allocate(gps%agdd20(beg:end))
! Subprogram not used     allocate(gps%tmomin20(beg:end))
! Subprogram not used     allocate(gps%t10min(beg:end))
! Subprogram not used 
! Subprogram not used     gps%agdd20(beg:end) = nan
! Subprogram not used     gps%tmomin20(beg:end) = nan
! Subprogram not used     gps%t10min(beg:end) = nan
! Subprogram not used 
! Subprogram not used   end subroutine init_gridcell_dgvstate_type
...
!
! !INTERFACE:
! Subprogram not used   subroutine init_gridcell_pstate_type(beg, end, gps)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Initialize gridcell physical state variables
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used     implicit none
! Subprogram not used     integer, intent(in) :: beg, end
! Subprogram not used     type (gridcell_pstate_type), intent(inout):: gps
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Mariana Vertenstein
! Subprogram not used !
...
! Subprogram not used     
! Subprogram not used     
! Subprogram not used     !allocate(gps%bcphiwet2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%bcphidry2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%bcphodry2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%ocphiwet2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%ocphidry2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%ocphodry2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx01wd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx01dd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx02wd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx02dd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx03wd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx03dd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx04wd2t(beg:end,1:2))
! Subprogram not used     !allocate(gps%dstx04dd2t(beg:end,1:2))
! Subprogram not used     
! Subprogram not used     !gps%bcphiwet2t(beg:end,1:2) = nan
! Subprogram not used     !gps%bcphidry2t(beg:end,1:2) = nan
! Subprogram not used     !gps%bcphodry2t(beg:end,1:2) = nan
! Subprogram not used     !gps%ocphiwet2t(beg:end,1:2) = nan
! Subprogram not used     !gps%ocphidry2t(beg:end,1:2) = nan
! Subprogram not used     !gps%ocphodry2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx01wd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx01dd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx02wd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx02dd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx03wd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx03dd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx04wd2t(beg:end,1:2) = nan
! Subprogram not used     !gps%dstx04dd2t(beg:end,1:2) = nan
! Subprogram not used 
! Subprogram not used   end subroutine init_gridcell_pstate_type
