...
! Subprogram not used   function prep_atm_get_l2x_ax()
! Subprogram not used     type(mct_aVect), pointer :: prep_atm_get_l2x_ax(:)
! Subprogram not used     prep_atm_get_l2x_ax => l2x_ax(:)   
! Subprogram not used   end function prep_atm_get_l2x_ax

! Subprogram not used   function prep_atm_get_i2x_ax()
! Subprogram not used     type(mct_aVect), pointer :: prep_atm_get_i2x_ax(:)
! Subprogram not used     prep_atm_get_i2x_ax => i2x_ax(:)   
! Subprogram not used   end function prep_atm_get_i2x_ax

! Subprogram not used   function prep_atm_get_o2x_ax()
! Subprogram not used     type(mct_aVect), pointer :: prep_atm_get_o2x_ax(:)
! Subprogram not used     prep_atm_get_o2x_ax => o2x_ax(:)   
! Subprogram not used   end function prep_atm_get_o2x_ax
...
! Subprogram not used   function prep_atm_get_mapper_Sl2a()
! Subprogram not used     type(seq_map), pointer :: prep_atm_get_mapper_Sl2a
! Subprogram not used     prep_atm_get_mapper_Sl2a => mapper_Sl2a  
! Subprogram not used   end function prep_atm_get_mapper_Sl2a
...
! Subprogram not used   function prep_atm_get_mapper_Si2a()
! Subprogram not used     type(seq_map), pointer :: prep_atm_get_mapper_Si2a
! Subprogram not used     prep_atm_get_mapper_Si2a => mapper_Si2a  
! Subprogram not used   end function prep_atm_get_mapper_Si2a
