...
! Subprogram not used     subroutine rSortn_(n,indx,keys,descend,stat)
! Subprogram not used       use m_realkinds,only : SP
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used       integer,intent(in) :: n
! Subprogram not used       integer, dimension(n), intent(inout) :: indx
! Subprogram not used       real(SP),dimension(n), intent(in) :: keys
! Subprogram not used       logical, optional, intent(in)  :: descend
! Subprogram not used       integer, optional, intent(out) :: stat
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !	15Mar00	- Jing Guo
! Subprogram not used !		. initial prototype/prolog/code
! Subprogram not used !		. redefined for the original interface
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::rSortn_'
! Subprogram not used 
! Subprogram not used   call rSort_(indx(1:n),keys(1:n),descend,stat)
! Subprogram not used end subroutine rSortn_
...
! Subprogram not used     subroutine cSortn_(n,indx,keys,descend,stat)
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used       integer,intent(in) :: n
! Subprogram not used       integer, dimension(n), intent(inout) :: indx
! Subprogram not used       character(len=*), dimension(n), intent(in) :: keys
! Subprogram not used       logical, optional, intent(in)  :: descend
! Subprogram not used       integer, optional, intent(out) :: stat
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::cSortn_'
! Subprogram not used 
! Subprogram not used   call cSort_(indx(1:n),keys(1:n),descend,stat)
! Subprogram not used end subroutine cSortn_
...
! Subprogram not used     subroutine rSort_(indx,keys,descend,stat)
! Subprogram not used       use m_stdio, only : stderr
! Subprogram not used       use m_die,   only : die
! Subprogram not used       use m_realkinds,only : SP
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used       integer, dimension(:), intent(inout) :: indx
! Subprogram not used       real(SP),dimension(:), intent(in) :: keys
! Subprogram not used       logical, optional, intent(in)  :: descend
! Subprogram not used       integer, optional, intent(out) :: stat
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !	15Mar00	- Jing Guo
! Subprogram not used !		. Modified the interface, by removing the explicit size
! Subprogram not used !	02Feb99 - Jing Guo <guo@thunder> - Added if(present(stat)) ...
! Subprogram not used ! 	04Jan99 - Jing Guo <guo@thunder> - revised the prolog
! Subprogram not used ! 	09Sep97 - Jing Guo <guo@thunder> - initial prototype/prolog/code
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   logical :: dsnd
! Subprogram not used   integer :: ierr
! Subprogram not used   integer, dimension(:),allocatable :: mtmp
! Subprogram not used   integer :: n
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::rSort_'
! Subprogram not used 
! Subprogram not used   if(present(stat)) stat=0
! Subprogram not used 
! Subprogram not used   n=size(indx)
! Subprogram not used 
! Subprogram not used   allocate(mtmp(n),stat=ierr)
! Subprogram not used   if(ierr /= 0) then
! Subprogram not used     write(stderr,'(2a,i4)') myname_,	&
! Subprogram not used 	': allocate(mtmp(:)) error, stat =',ierr
! Subprogram not used     if(.not.present(stat)) call die(myname_)
! Subprogram not used     stat=ierr
! Subprogram not used     return
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   dsnd=.false.
! Subprogram not used   if(present(descend)) dsnd=descend
! Subprogram not used 
! Subprogram not used   call MergeSort_()
! Subprogram not used 
! Subprogram not used   deallocate(mtmp)
! Subprogram not used 
! Subprogram not used contains
! Subprogram not used subroutine MergeSort_()
! Subprogram not used   implicit none
! Subprogram not used   integer :: mstep,lstep
! Subprogram not used   integer :: lb,lm,le
! Subprogram not used 
! Subprogram not used   mstep=1
! Subprogram not used   do while(mstep < n)
! Subprogram not used     lstep=mstep*2
! Subprogram not used 
! Subprogram not used     lb=1
! Subprogram not used     do while(lb < n)
! Subprogram not used       lm=lb+mstep
! Subprogram not used       le=min(lm-1+mstep,n)
! Subprogram not used 
! Subprogram not used       call merge_(lb,lm,le)
! Subprogram not used       indx(lb:le)=mtmp(lb:le)
! Subprogram not used       lb=le+1
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used     mstep=lstep
! Subprogram not used   end do
! Subprogram not used end subroutine MergeSort_
...
! Subprogram not used subroutine merge_(lb,lm,le)
! Subprogram not used   integer,intent(in) :: lb,lm,le
! Subprogram not used   integer :: l1,l2,l
! Subprogram not used 
! Subprogram not used   l1=lb
! Subprogram not used   l2=lm
! Subprogram not used   do l=lb,le
! Subprogram not used     if(l2.gt.le) then
! Subprogram not used       mtmp(l)=indx(l1)
! Subprogram not used       l1=l1+1
! Subprogram not used     elseif(l1.ge.lm) then
! Subprogram not used       mtmp(l)=indx(l2)
! Subprogram not used       l2=l2+1
! Subprogram not used     else
! Subprogram not used       if(dsnd) then
! Subprogram not used         if(keys(indx(l1)) .ge. keys(indx(l2))) then
! Subprogram not used           mtmp(l)=indx(l1)
! Subprogram not used           l1=l1+1
! Subprogram not used         else
! Subprogram not used           mtmp(l)=indx(l2)
...
! Subprogram not used         endif
! Subprogram not used       else
! Subprogram not used         if(keys(indx(l1)) .le. keys(indx(l2))) then
! Subprogram not used           mtmp(l)=indx(l1)
! Subprogram not used           l1=l1+1
! Subprogram not used         else
! Subprogram not used           mtmp(l)=indx(l2)
...
! Subprogram not used     endif
! Subprogram not used   end do
! Subprogram not used end subroutine merge_
...
! Subprogram not used     subroutine cSort_(indx,keys,descend,stat)
! Subprogram not used       use m_stdio, only : stderr
! Subprogram not used       use m_die,   only : die
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used       integer, dimension(:), intent(inout) :: indx
! Subprogram not used       character(len=*), dimension(:), intent(in) :: keys
! Subprogram not used       logical, optional, intent(in)  :: descend
! Subprogram not used       integer, optional, intent(out) :: stat
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used   integer :: n
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::cSort_'
! Subprogram not used 
! Subprogram not used   if(present(stat)) stat=0
! Subprogram not used 
! Subprogram not used   n=size(indx)
...
! Subprogram not used     else
! Subprogram not used       if(dsnd) then
! Subprogram not used         if(keys(ikey,indx(l1)) .ge. keys(ikey,indx(l2))) then
! Subprogram not used           mtmp(l)=indx(l1)
! Subprogram not used           l1=l1+1
! Subprogram not used         else
! Subprogram not used           mtmp(l)=indx(l2)
...
! Subprogram not used         endif
! Subprogram not used       else
! Subprogram not used         if(keys(ikey,indx(l1)) .le. keys(ikey,indx(l2))) then
! Subprogram not used           mtmp(l)=indx(l1)
! Subprogram not used           l1=l1+1
! Subprogram not used         else
! Subprogram not used           mtmp(l)=indx(l2)
