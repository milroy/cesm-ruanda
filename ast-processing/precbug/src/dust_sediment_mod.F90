...
!===============================================================================
! Subprogram not used   subroutine dust_sediment_vel (ncol,                               &
! Subprogram not used        icefrac , landfrac, ocnfrac , pmid    , pdel    , t       , &
! Subprogram not used        dustmr  , pvdust   )
! Subprogram not used 
! Subprogram not used !----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used ! Compute gravitational sedimentation velocities for dust
! Subprogram not used 
...
! Subprogram not used     real(r8), intent(in)  :: dustmr(pcols,pver)     ! dust (kg/kg)
! Subprogram not used 
! Subprogram not used     real(r8), intent(out) :: pvdust (pcols,pverp)    ! vertical velocity of dust (Pa/s)
...
! Subprogram not used     real (r8) :: vfall(pcols)                       ! settling velocity of dust particles (m/s)
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !--------------------- dust fall velocity ----------------------------
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     do k = 1,pver
! Subprogram not used        do i = 1,ncol
! Subprogram not used 
! Subprogram not used           ! merge the dust fall velocities for land and ocean (cm/s)
! Subprogram not used           ! SHOULD ALSO ACCOUNT FOR ICEFRAC
! Subprogram not used           vfall(i) = vland*landfrac(i) + vocean*(1._r8-landfrac(i))
! Subprogram not used           !!         vfall(i) = vland*landfrac(i) + vocean*ocnfrac(i) + vseaice*icefrac(i)
! Subprogram not used 
! Subprogram not used           ! fall velocity (assume positive downward)
! Subprogram not used           pvdust(i,k+1) = vfall(i)     
! Subprogram not used        end do
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used     return
! Subprogram not used   end subroutine dust_sediment_vel
