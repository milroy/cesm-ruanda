...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_140626/shr/shr_string_mod.F90 $
!===============================================================================
!===============================================================================
!BOP ===========================================================================
!
...
! Subprogram not used function shr_string_getParentDir(str)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used    character(len=*), intent(in) :: str      ! String to convert to lower case
! Subprogram not used    character(len=len(str))      :: shr_string_getParentDir
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    integer(SHR_KIND_IN) :: i       ! Index
! Subprogram not used    integer(SHR_KIND_IN) :: nlen    ! Length of string
! Subprogram not used    integer(SHR_KIND_IN) :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_getParentDir) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_getParentDir) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    nlen = len_trim(str)
! Subprogram not used    if ( str(nlen:nlen) == "/" ) nlen = nlen - 1
! Subprogram not used    i = index( str(1:nlen), "/", back=.true. )
! Subprogram not used    if ( i == 0 )then
! Subprogram not used       shr_string_getParentDir = str
! Subprogram not used    else
! Subprogram not used       shr_string_getParentDir = str(1:i-1)
! Subprogram not used    end if
! Subprogram not used    
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end function shr_string_getParentDir
...
! Subprogram not used integer function shr_string_endIndex(string,substr,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)        ,intent(in)           :: string ! string to search
! Subprogram not used    character(*)        ,intent(in)           :: substr ! sub-string to search for
! Subprogram not used    integer(SHR_KIND_IN),intent(out),optional :: rc     ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    integer(SHR_KIND_IN)   :: i       ! generic index
! Subprogram not used    integer(SHR_KIND_IN)       :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_endIndex) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_endIndex) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used ! * returns zero if substring not found, uses len_trim() intrinsic
! Subprogram not used ! * very similar to: i = index(str,substr,back=.true.) 
! Subprogram not used ! * do we need this function?
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    i = index(trim(string),trim(substr))
! Subprogram not used    if ( i == 0 ) then
! Subprogram not used       shr_string_endIndex = 0  ! substr is not in string
! Subprogram not used    else
! Subprogram not used       shr_string_endIndex = i + len_trim(substr) - 1
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used !  -------------------------------------------------------------------
! Subprogram not used !  i = index(trim(string),trim(substr),back=.true.)
! Subprogram not used !  if (i == len(string)+1) i = 0
! Subprogram not used !  shr_string_endIndex = i
! Subprogram not used !  -------------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end function shr_string_endIndex
...
! Subprogram not used subroutine shr_string_alphanum(str,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)        ,intent(inout)          :: str
! Subprogram not used    integer(SHR_KIND_IN),intent(out)  ,optional :: rc   ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
...
! Subprogram not used    integer(SHR_KIND_IN) :: n,icnt ! counters
! Subprogram not used    integer(SHR_KIND_IN) :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_alphaNum) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_alphaNum) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    icnt = 0
! Subprogram not used    do n=1,len_trim(str)
! Subprogram not used      if ((str(n:n) >= 'a' .and. str(n:n) <= 'z') .or.  &
! Subprogram not used          (str(n:n) >= 'A' .and. str(n:n) <= 'Z') .or.  &
! Subprogram not used          (str(n:n) >= '0' .and. str(n:n) <= '9')) then
! Subprogram not used        icnt = icnt + 1
! Subprogram not used        str(icnt:icnt) = str(n:n)
! Subprogram not used      endif
! Subprogram not used    enddo
! Subprogram not used    do n=icnt+1,len(str)
! Subprogram not used      str(n:n) = ' '
! Subprogram not used    enddo
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = 0
! Subprogram not used 
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_alphanum
...
! Subprogram not used subroutine shr_string_betweenTags(string,startTag,endTag,substr,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)        ,intent(in)  :: string      ! string to search
! Subprogram not used    character(*)        ,intent(in)  :: startTag    ! start tag
! Subprogram not used    character(*)        ,intent(in)  :: endTag      ! end tag
! Subprogram not used    character(*)        ,intent(out) :: substr      ! sub-string between tags
! Subprogram not used    integer(SHR_KIND_IN),intent(out),optional :: rc ! retrun code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    integer(SHR_KIND_IN)   :: iStart  ! substring start index
! Subprogram not used    integer(SHR_KIND_IN)   :: iEnd    ! substring end   index
! Subprogram not used    integer(SHR_KIND_IN)   :: rCode   ! return code
! Subprogram not used    integer(SHR_KIND_IN)       :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_betweenTags) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_betweenTags) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used ! * assumes the leading/trailing white space is not part of start & end tags
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    iStart = shr_string_endIndex(string,trim(adjustL(startTag))) ! end of start tag
! Subprogram not used    iEnd   =               index(string,trim(adjustL(endTag  ))) ! start of end tag
! Subprogram not used 
! Subprogram not used    rCode = 0
! Subprogram not used    substr = ""
! Subprogram not used 
! Subprogram not used    if (iStart < 1) then
! Subprogram not used       if (s_loglev > 0) then
! Subprogram not used          write(s_logunit,F00) "ERROR: can't find start tag in string"
! Subprogram not used          write(s_logunit,F00) "ERROR: start tag = ",trim(startTag)
! Subprogram not used          write(s_logunit,F00) "ERROR: string    = ",trim(string)
! Subprogram not used       endif
! Subprogram not used       rCode = 1
! Subprogram not used    else if (iEnd < 1) then
! Subprogram not used       if (s_loglev > 0) then
! Subprogram not used          write(s_logunit,F00) "ERROR: can't find end tag in string"
! Subprogram not used          write(s_logunit,F00) "ERROR: end   tag = ",trim(  endTag)
! Subprogram not used          write(s_logunit,F00) "ERROR: string    = ",trim(string)
! Subprogram not used       endif
! Subprogram not used       rCode = 2
! Subprogram not used    else if ( iEnd <= iStart) then
! Subprogram not used       if (s_loglev > 0) then
! Subprogram not used          write(s_logunit,F00) "ERROR: start tag not before end tag"
! Subprogram not used          write(s_logunit,F00) "ERROR: start tag = ",trim(startTag)
! Subprogram not used          write(s_logunit,F00) "ERROR: end   tag = ",trim(  endTag)
! Subprogram not used          write(s_logunit,F00) "ERROR: string    = ",trim(string)
! Subprogram not used       endif
! Subprogram not used       rCode = 3
! Subprogram not used    else if ( iStart+1 == iEnd ) then
! Subprogram not used       substr = ""
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F00) "WARNING: zero-length substring found in ",trim(string)
! Subprogram not used    else
! Subprogram not used       substr = string(iStart+1:iEnd-1)
! Subprogram not used       if (len_trim(substr) == 0 .and. s_loglev > 0) &
! Subprogram not used          & write(s_logunit,F00) "WARNING: white-space substring found in ",trim(string)
! Subprogram not used    end if
! Subprogram not used 
...
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_betweenTags
...
! Subprogram not used subroutine shr_string_listUnion(list1,list2,listout,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)                 ,intent(in)  :: list1   ! list/string
! Subprogram not used    character(*)                 ,intent(in)  :: list2   ! list/string
! Subprogram not used    character(*)                 ,intent(out) :: listout ! list/string
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc      ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    integer(SHR_KIND_IN)   :: nf,n1,n2 ! counters
! Subprogram not used    character(SHR_KIND_CS) :: name     ! field name
! Subprogram not used    integer(SHR_KIND_IN)   :: rCode    ! return code
! Subprogram not used    integer(SHR_KIND_IN) :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_listUnion) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_listUnion) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    rCode = 0
! Subprogram not used 
! Subprogram not used    call shr_string_clean(listout)
! Subprogram not used 
! Subprogram not used    nf = shr_string_listGetNum(list1)
! Subprogram not used    do n1 = 1,nf
! Subprogram not used      call shr_string_listGetName(list1,n1,name,rCode)
! Subprogram not used      n2 = shr_string_listGetIndexF(listout,name)
! Subprogram not used      if (n2 < 1) then
! Subprogram not used        call shr_string_listAppend(listout,name)
! Subprogram not used      endif
! Subprogram not used    enddo
! Subprogram not used 
! Subprogram not used    nf = shr_string_listGetNum(list2)
! Subprogram not used    do n1 = 1,nf
! Subprogram not used      call shr_string_listGetName(list2,n1,name,rCode)
! Subprogram not used      n2 = shr_string_listGetIndexF(listout,name)
! Subprogram not used      if (n2 < 1) then
! Subprogram not used        call shr_string_listAppend(listout,name)
! Subprogram not used      endif
...
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_listUnion
...
! Subprogram not used subroutine shr_string_listMerge(list1,list2,listout,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    character(SHR_KIND_CX) :: l1,l2   ! local char strings
! Subprogram not used    integer(SHR_KIND_IN)   :: rCode   ! return code
! Subprogram not used    integer(SHR_KIND_IN)   :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_listMerge) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_listMerge) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used ! - no input or output string should be longer than SHR_KIND_CX
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used    rCode = 0
! Subprogram not used 
! Subprogram not used    !--- make sure temp strings are large enough ---
! Subprogram not used    if ( (len(l1) < len_trim(list1)) .or. (len(l2) < len_trim(list2))) then
! Subprogram not used       call shr_string_abort(subName//'ERROR: temp string not large enough')
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    call shr_string_clean(l1)
! Subprogram not used    call shr_string_clean(l2)
! Subprogram not used    call shr_string_clean(listout)
! Subprogram not used    l1 = trim(list1)
! Subprogram not used    l2 = trim(list2)
! Subprogram not used    call shr_string_leftAlign(l1,rCode)
! Subprogram not used    call shr_string_leftAlign(l2,rCode)
! Subprogram not used    if (len_trim(l1)+len_trim(l2)+1 > len(listout)) &
! Subprogram not used       call shr_string_abort(subName//'ERROR: output list string not large enough')
! Subprogram not used    if (len_trim(l1) == 0) then
! Subprogram not used      listout = trim(l2)
! Subprogram not used    else
! Subprogram not used      listout = trim(l1)//":"//trim(l2)
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_listMerge
...
! Subprogram not used subroutine shr_string_listPrepend(listadd,list,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(*)                 ,intent(in)    :: listadd ! list/string
! Subprogram not used    character(*)                 ,intent(inout) :: list   ! list/string
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out)   :: rc      ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    character(SHR_KIND_CX) :: l1      ! local string
! Subprogram not used    integer(SHR_KIND_IN)   :: rCode   ! return code
! Subprogram not used    integer(SHR_KIND_IN)   :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_listPrepend) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_listPrepend) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used ! - no input or output string should be longer than SHR_KIND_CX
...
! Subprogram not used    rCode = 0
! Subprogram not used 
! Subprogram not used    !--- make sure temp string is large enough ---
! Subprogram not used    if (len(l1) < len_trim(listAdd)) then
! Subprogram not used       call shr_string_abort(subName//'ERROR: temp string not large enough')
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    call shr_string_clean(l1)
! Subprogram not used    l1 = trim(listadd)
! Subprogram not used    call shr_string_leftAlign(l1,rCode)
! Subprogram not used    call shr_string_leftAlign(list,rCode)
! Subprogram not used    if (len_trim(list)+len_trim(l1)+1 > len(list)) &
! Subprogram not used       call shr_string_abort(subName//'ERROR: output list string not large enough')
! Subprogram not used    if (len_trim(l1) == 0) then
! Subprogram not used      list = trim(list)
! Subprogram not used    else
! Subprogram not used      list = trim(l1)//":"//trim(list)
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_listPrepend
...
! Subprogram not used subroutine shr_string_listSetDel(cflag)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    character(len=1),intent(in) :: cflag
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN) :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_listSetDel) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_listSetDel) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    if (debug > 0 .and. s_loglev > 0) write(s_logunit,F00) 'changing listDel from '//trim(listDel)//' to '//trim(cflag)
! Subprogram not used    listDel = trim(cflag)
! Subprogram not used    listDel2 = listDel//listDel
! Subprogram not used 
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_listSetDel
...
! Subprogram not used subroutine shr_string_listGetDel(del)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used   character(*),intent(out) :: del
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN) :: t01 = 0 ! timer
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_listGetDel) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_listGetDel) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    del = trim(listDel)
! Subprogram not used 
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_listGetDel
...
! Subprogram not used subroutine shr_string_setAbort(flag)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_setAbort) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_setAbort) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (debug>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used    if (debug > 0 .and. s_loglev > 0) then
! Subprogram not used       if (flag) then
! Subprogram not used          write(s_logunit,F00) 'setting abort to true'
! Subprogram not used       else
! Subprogram not used          write(s_logunit,F00) 'setting abort to false'
! Subprogram not used       endif
! Subprogram not used    endif
! Subprogram not used 
...
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_setAbort
...
! Subprogram not used subroutine shr_string_setDebug(iFlag)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in) :: iFlag ! requested debug level
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
...
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_setDebug) "
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_setDebug) ',a) "
! Subprogram not used    character(*),parameter :: F01     = "('(shr_string_setDebug) ',a,i3,a,i3) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! NTOE: write statement can be expensive if called many times.
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (iFlag>1 .and. t01<1) call shr_timer_get(t01,subName)
! Subprogram not used    if (iFlag>1) call shr_timer_start(t01)
! Subprogram not used 
! Subprogram not used !   if (s_loglev > 0) write(s_logunit,F01) 'changing debug level from ',debug,' to ',iflag
! Subprogram not used    debug = iFlag
! Subprogram not used 
! Subprogram not used    if (iFlag>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_setDebug

!===============================================================================
!===============================================================================

! Subprogram not used subroutine shr_string_abort(string)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    character(SHR_KIND_CX) :: lstring
! Subprogram not used    character(*),parameter :: subName =   "(shr_string_abort)"
! Subprogram not used    character(*),parameter :: F00     = "('(shr_string_abort) ',a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used       call shr_sys_abort(trim(lstring))
! Subprogram not used    else
! Subprogram not used       write(s_logunit,F00) ' no abort:'//trim(lstring)
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    if (debug>1) call shr_timer_stop (t01)
! Subprogram not used 
! Subprogram not used end subroutine shr_string_abort
