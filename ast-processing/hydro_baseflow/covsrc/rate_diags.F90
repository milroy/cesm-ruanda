...
!-------------------------------------------------------------------
! Subprogram not used   function lookup_tag_ndx( name ) result( ndx )
! Subprogram not used     character(len=*) :: name
! Subprogram not used     integer :: ndx
! Subprogram not used 
! Subprogram not used     integer :: i
! Subprogram not used 
! Subprogram not used     ndx = -1
! Subprogram not used 
! Subprogram not used     findloop: do i = 1,rxt_tag_cnt
! Subprogram not used        if (trim(name) .eq. trim(rate_names(i)(3:))) then
! Subprogram not used           ndx = i
! Subprogram not used           return
! Subprogram not used        endif
! Subprogram not used     end do findloop
! Subprogram not used 
! Subprogram not used   end function lookup_tag_ndx
