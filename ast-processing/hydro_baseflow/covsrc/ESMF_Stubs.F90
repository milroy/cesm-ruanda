...
! NOOP
! Subprogram not used    SUBROUTINE ESMF_LogWrite( msg, MsgType, line, file, method, log, rc )
! Subprogram not used       USE ESMF_BaseMod
! Subprogram not used       CHARACTER(LEN=*), INTENT(IN) :: msg
! Subprogram not used       TYPE(ESMF_MsgType), INTENT(IN) :: msgtype
! Subprogram not used       INTEGER, INTENT(IN), OPTIONAL :: line
! Subprogram not used       CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: file
! Subprogram not used       CHARACTER(LEN=*), INTENT(IN), OPTIONAL :: method
! Subprogram not used       TYPE(ESMF_LOG),TARGET,OPTIONAL :: log
! Subprogram not used       INTEGER, INTENT(OUT),OPTIONAL :: rc
! Subprogram not used       IF ( PRESENT( rc ) ) rc = ESMF_SUCCESS
! Subprogram not used    END SUBROUTINE ESMF_LogWrite
