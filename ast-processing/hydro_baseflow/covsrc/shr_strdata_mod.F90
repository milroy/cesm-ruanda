...
!===============================================================================
! Subprogram not used   subroutine shr_strdata_clean(SDAT)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used   type(shr_strdata_type),intent(inout) :: SDAT
! Subprogram not used 
! Subprogram not used   integer(IN) :: n
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used   character(len=*),parameter :: subname = "(shr_strdata_clean) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   if (SDAT%nxg * SDAT%nyg == 0) then
! Subprogram not used      return
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   SDAT%nxg = 0
! Subprogram not used   SDAT%nyg = 0
! Subprogram not used   SDAT%strnxg = 0
! Subprogram not used   SDAT%strnyg = 0
! Subprogram not used 
! Subprogram not used   SDAT%nstreams = 0
! Subprogram not used   SDAT%nvectors = 0
! Subprogram not used   SDAT%ustrm = 0
! Subprogram not used   SDAT%vstrm = 0
! Subprogram not used 
! Subprogram not used   SDAT%dofill = .false.
! Subprogram not used   SDAT%domaps = .false.
! Subprogram not used 
! Subprogram not used   call mct_ggrid_clean(SDAT%grid)
! Subprogram not used   call mct_gsmap_clean(SDAT%gsmap)
! Subprogram not used   do n = 1,nStrMax
! Subprogram not used      ! need clean SDAT%stream(n) method
! Subprogram not used      call mct_avect_clean(SDAT%avs(n))
! Subprogram not used      call mct_avect_clean(SDAT%avRLB(n))
! Subprogram not used      call mct_avect_clean(SDAT%avRUB(n))
! Subprogram not used      call mct_avect_clean(SDAT%avFLB(n))
! Subprogram not used      call mct_avect_clean(SDAT%avFUB(n))
! Subprogram not used      call mct_ggrid_clean(SDAT%gridR(n))
! Subprogram not used      call mct_sMatP_clean(SDAT%sMatPf(n))
! Subprogram not used      call mct_sMatP_clean(SDAT%sMatPs(n))
! Subprogram not used      call mct_gsmap_clean(SDAT%gsmapR(n))
! Subprogram not used   enddo
! Subprogram not used 
! Subprogram not used   end subroutine shr_strdata_clean

!===============================================================================
!===============================================================================
! Subprogram not used   subroutine shr_strdata_restWrite(filename,SDAT,mpicom,str1,str2)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
...
! Subprogram not used   character(len=*)      ,intent(in)    :: str1
! Subprogram not used   character(len=*)      ,intent(in)    :: str2
! Subprogram not used 
! Subprogram not used   !--- local ----
! Subprogram not used   type(shr_stream_streamtype),pointer :: streams(:)
! Subprogram not used   integer(IN) :: n,my_task,ier
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used   character(len=*),parameter :: subname = "(shr_strdata_restWrite) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   call MPI_COMM_RANK(mpicom,my_task,ier)
! Subprogram not used 
! Subprogram not used   if (my_task == 0) then
! Subprogram not used      call shr_stream_restWrite(SDAT%stream,trim(filename),trim(str1),trim(str2),SDAT%nstreams)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   end subroutine shr_strdata_restWrite

!===============================================================================
!===============================================================================
! Subprogram not used   subroutine shr_strdata_restRead(filename,SDAT,mpicom)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used   character(len=*)      ,intent(in)    :: filename
...
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used   character(len=*),parameter :: subname = "(shr_strdata_restRead) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used   if (my_task == 0) then
! Subprogram not used      call shr_stream_restRead(SDAT%stream,trim(filename),SDAT%nstreams)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   end subroutine shr_strdata_restRead

!===============================================================================
!===============================================================================
! Subprogram not used   subroutine shr_strdata_setOrbs(SDAT,eccen,mvelpp,lambm0,obliqr,modeldt)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used   type(shr_strdata_type),intent(inout) :: SDAT
! Subprogram not used   real(R8),intent(in) :: eccen
! Subprogram not used   real(R8),intent(in) :: mvelpp
! Subprogram not used   real(R8),intent(in) :: lambm0
! Subprogram not used   real(R8),intent(in) :: obliqr
! Subprogram not used   integer(IN),intent(in) :: modeldt
! Subprogram not used 
! Subprogram not used   !----- formats -----
! Subprogram not used   character(len=*),parameter :: subname = "(shr_strdata_setOrbs) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   SDAT%eccen   = eccen
! Subprogram not used   SDAT%mvelpp  = mvelpp
! Subprogram not used   SDAT%lambm0  = lambm0
! Subprogram not used   SDAT%obliqr  = obliqr
! Subprogram not used   SDAT%modeldt = modeldt
! Subprogram not used 
! Subprogram not used   end subroutine shr_strdata_setOrbs
...
! Subprogram not used subroutine shr_strdata_setlogunit(nu)
! Subprogram not used 
! Subprogram not used   integer(IN),intent(in) :: nu
! Subprogram not used   character(len=*),parameter :: subname = "(shr_strdata_setlogunit) "
! Subprogram not used 
! Subprogram not used   ! tcx DOES NOTHING, REMOVE
! Subprogram not used 
! Subprogram not used end subroutine shr_strdata_setlogunit
