...
!--------------------------------------------------------------
! Subprogram not used   function cloy( q, pcols, ncol )
! Subprogram not used 
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used !       ... dummy arguments
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used     integer,  intent(in) :: pcols
! Subprogram not used     integer,  intent(in) :: ncol
! Subprogram not used     real(r8), intent(in) :: q(pcols,pver,gas_pcnst)
! Subprogram not used 
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used !       ... function declaration
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used     real(r8) :: cloy(ncol,pver)
! Subprogram not used 
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used !       ... local variables
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used     real(r8) :: wrk(ncol)
! Subprogram not used     integer  :: k
! Subprogram not used 
! Subprogram not used     do k = 1,pver
! Subprogram not used        wrk(:) = q(:ncol,k,id_cl)           /adv_mass(id_cl) &
! Subprogram not used               + q(:ncol,k,id_clo)          /adv_mass(id_clo) &
! Subprogram not used               + q(:ncol,k,id_hocl)         /adv_mass(id_hocl) &
! Subprogram not used               + 2._r8*( q(:ncol,k,id_cl2)  /adv_mass(id_cl2) &
! Subprogram not used                       + q(:ncol,k,id_cl2o2)/adv_mass(id_cl2o2) ) &
! Subprogram not used               + q(:ncol,k,id_oclo)         /adv_mass(id_oclo) &
! Subprogram not used               + q(:ncol,k,id_hcl)          /adv_mass(id_hcl) &
! Subprogram not used               + q(:ncol,k,id_clono2)       /adv_mass(id_clono2) 
! Subprogram not used        cloy(:,k) = adv_mass(id_cl) * wrk(:)
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end function cloy

!--------------------------------------------------------------
! compute the mass mixing retio of BrOy
!--------------------------------------------------------------
! Subprogram not used   function broy( q, pcols, ncol )
! Subprogram not used 
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used !       ... dummy arguments
! Subprogram not used !--------------------------------------------------------------
...
! Subprogram not used !       ... function declaration
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used     real(r8) :: broy(ncol,pver)
! Subprogram not used 
! Subprogram not used !--------------------------------------------------------------
! Subprogram not used !       ... local variables
! Subprogram not used !--------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used     do k = 1,pver
! Subprogram not used        wrk(:) = q(:ncol,k,id_br)    /adv_mass(id_br) &
! Subprogram not used               + q(:ncol,k,id_bro)   /adv_mass(id_bro) &
! Subprogram not used               + q(:ncol,k,id_hbr)   /adv_mass(id_hbr) &
! Subprogram not used               + q(:ncol,k,id_brono2)/adv_mass(id_brono2) &
! Subprogram not used               + q(:ncol,k,id_brcl)  /adv_mass(id_brcl) &
! Subprogram not used               + q(:ncol,k,id_hobr)  /adv_mass(id_hobr)
! Subprogram not used        broy(:,k) = adv_mass(id_br) * wrk(:)
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end function broy
