...
! Subprogram not used function tracers_implements_cnst(name)
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used ! 
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   use tracers_suite, only: get_tracer_name
! Subprogram not used   
! Subprogram not used   implicit none
! Subprogram not used !-----------------------------Arguments---------------------------------
! Subprogram not used   
! Subprogram not used   character(len=*), intent(in) :: name   ! constituent name
! Subprogram not used   logical :: tracers_implements_cnst        ! return value
! Subprogram not used !---------------------------Local workspace-----------------------------
! Subprogram not used    integer :: m
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    tracers_implements_cnst = .false.
! Subprogram not used    if ( tracers_flag ) then 
! Subprogram not used       do m = 1, trac_ncnst
! Subprogram not used          if (name == get_tracer_name(m)) then
! Subprogram not used             tracers_implements_cnst = .true.
! Subprogram not used             return
! Subprogram not used          end if
! Subprogram not used       end do
! Subprogram not used    end if
! Subprogram not used end function tracers_implements_cnst

!===============================================================================
! Subprogram not used subroutine tracers_init_cnst(name, q, gcid)
! Subprogram not used 
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used !
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   use tracers_suite,   only: init_cnst_tr, get_tracer_name
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used   character(len=*), intent(in) :: name
! Subprogram not used   real(r8), intent(out), dimension(:,:) :: q    ! kg tracer/kg dry air (gcol,plev)
...
! Subprogram not used      do m = 1, trac_ncnst
! Subprogram not used         if (name ==  get_tracer_name(m))  then
! Subprogram not used            call init_cnst_tr(m,q, gcid)
! Subprogram not used         endif
! Subprogram not used      end do
! Subprogram not used   end if
! Subprogram not used 
! Subprogram not used end subroutine tracers_init_cnst
