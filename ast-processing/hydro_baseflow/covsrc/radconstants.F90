...
!------------------------------------------------------------------------------
! Subprogram not used subroutine get_ref_total_solar_irrad(tsi)
! Subprogram not used    ! provide Total Solar Irradiance assumed by RRTMG
! Subprogram not used 
! Subprogram not used    real(r8), intent(out) :: tsi
! Subprogram not used 
! Subprogram not used    tsi = sum(solar_ref_band_irradiance)
! Subprogram not used 
! Subprogram not used end subroutine get_ref_total_solar_irrad
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
! Subprogram not used subroutine get_lw_spectral_boundaries(low_boundaries, high_boundaries, units)
! Subprogram not used    ! provide spectral boundaries of each longwave band
! Subprogram not used 
! Subprogram not used    real(r8), intent(out) :: low_boundaries(nlwbands), high_boundaries(nlwbands)
! Subprogram not used    character(*), intent(in) :: units ! requested units
! Subprogram not used 
! Subprogram not used    select case (units)
! Subprogram not used    case ('inv_cm','cm^-1','cm-1')
! Subprogram not used       low_boundaries  = wavenumber1_longwave
! Subprogram not used       high_boundaries = wavenumber2_longwave
! Subprogram not used    case('m','meter','meters')
! Subprogram not used       low_boundaries  = 1.e-2_r8/wavenumber2_longwave
! Subprogram not used       high_boundaries = 1.e-2_r8/wavenumber1_longwave
! Subprogram not used    case('nm','nanometer','nanometers')
! Subprogram not used       low_boundaries  = 1.e7_r8/wavenumber2_longwave
! Subprogram not used       high_boundaries = 1.e7_r8/wavenumber1_longwave
! Subprogram not used    case('um','micrometer','micrometers','micron','microns')
! Subprogram not used       low_boundaries  = 1.e4_r8/wavenumber2_longwave
! Subprogram not used       high_boundaries = 1.e4_r8/wavenumber1_longwave
! Subprogram not used    case('cm','centimeter','centimeters')
! Subprogram not used       low_boundaries  = 1._r8/wavenumber2_longwave
! Subprogram not used       high_boundaries = 1._r8/wavenumber1_longwave
! Subprogram not used    case default
! Subprogram not used       call endrun('get_lw_spectral_boundaries: spectral units not acceptable'//units)
! Subprogram not used    end select
! Subprogram not used 
! Subprogram not used end subroutine get_lw_spectral_boundaries
