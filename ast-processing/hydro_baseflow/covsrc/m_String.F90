...
! Subprogram not used  subroutine inits_(oStr, iStr)
! Subprogram not used  
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die, only : die
! Subprogram not used       use m_mall,only : mall_mci,mall_ison
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),  intent(in)  :: iStr
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),  intent(out) :: oStr
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	07Feb00	- Jing Guo <guo@dao.gsfc.nasa.gov>
...
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::inits_'
! Subprogram not used   integer :: ln,ier,i
! Subprogram not used 
! Subprogram not used   ln=size(iStr%c)
! Subprogram not used 
! Subprogram not used 	allocate(oStr%c(ln),stat=ier)
! Subprogram not used 		if(ier /= 0) call die(myname_,'allocate()',ier)
! Subprogram not used 
! Subprogram not used 	if(mall_ison()) call mall_mci(oStr%c,myname)
! Subprogram not used 
! Subprogram not used   do i=1,ln
! Subprogram not used     oStr%c(i)=iStr%c(i)
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used  end subroutine inits_
...
! Subprogram not used  subroutine mci0_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_ci
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),     intent(in) :: marg
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mci0_'
! Subprogram not used 
! Subprogram not used   call mall_ci(1,thread)
! Subprogram not used 
! Subprogram not used  end subroutine mci0_
...
! Subprogram not used  subroutine mco0_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_co
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used       type(String),    intent(in) :: marg
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mco0_'
! Subprogram not used 
! Subprogram not used   call mall_co(1,thread)
! Subprogram not used 
! Subprogram not used  end subroutine mco0_
...
! Subprogram not used  subroutine mci1_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_ci
...
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),     dimension(:), intent(in) :: marg
! Subprogram not used       character(len=*),               intent(in) :: thread
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	07Feb00	- Jing Guo <guo@dao.gsfc.nasa.gov>
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mci1_'
! Subprogram not used 
! Subprogram not used   call mall_ci(size(marg),thread)
! Subprogram not used 
! Subprogram not used  end subroutine mci1_
...
! Subprogram not used  subroutine mco1_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_co
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mco1_'
! Subprogram not used 
! Subprogram not used   call mall_co(size(marg),thread)
! Subprogram not used 
! Subprogram not used  end subroutine mco1_
...
! Subprogram not used  subroutine mci2_(marg, thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_ci
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mci2_'
! Subprogram not used 
! Subprogram not used   call mall_ci(size(marg),thread)
! Subprogram not used 
! Subprogram not used  end subroutine mci2_
...
! Subprogram not used  subroutine mco2_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_co
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mco2_'
! Subprogram not used 
! Subprogram not used   call mall_co(size(marg),thread)
! Subprogram not used 
! Subprogram not used  end subroutine mco2_
...
! Subprogram not used  subroutine mci3_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_ci
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mci3_'
! Subprogram not used 
! Subprogram not used   call mall_ci(size(marg),thread)
! Subprogram not used 
! Subprogram not used  end subroutine mci3_
...
! Subprogram not used  subroutine mco3_(marg,thread)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_mall, only : mall_co
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::mco3_'
! Subprogram not used 
! Subprogram not used   call mall_co(size(marg),thread)
! Subprogram not used 
! Subprogram not used   end subroutine mco3_
...
! Subprogram not used  integer function len_(str)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),intent(in) :: str
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	10Apr00	- Jing Guo <guo@dao.gsfc.nasa.gov>
! Subprogram not used !		- initial prototype/prolog/code
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::len_'
! Subprogram not used 
! Subprogram not used   len_=size(str%c)
! Subprogram not used 
! Subprogram not used  end function len_
...
! Subprogram not used  function ptr_chars_(str)
! Subprogram not used 
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used ! No external modules are used by this function.
...
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       character(len=1), dimension(:), pointer    :: ptr_chars_
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	10Apr00	- Jing Guo <guo@dao.gsfc.nasa.gov>
! Subprogram not used !		- initial prototype/prolog/code
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::ptr_chars_'
! Subprogram not used 
! Subprogram not used   ptr_chars_ => str%c
! Subprogram not used 
! Subprogram not used  end function ptr_chars_
