...
!======================================================================
  subroutine open_mesh_file() 
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 110)
...
!======================================================================
  ...
  subroutine close_mesh_file() 
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 125)
...
!======================================================================
  ...
  function get_number_of_elements() result(number_elements)
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 162)

    ! How many values for 'num_elem' are there?
    status = nf90_inquire_dimension(p_ncid, number_of_elements_id, len = number_elements)
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 166)
...
!======================================================================
  function get_number_of_element_blocks() result(number_element_blocks)
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 202)
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 206)
...
!======================================================================
    ...
    if (p_number_blocks == 0)  then
       ...
       if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 239)
       status = nf90_inquire_dimension(p_ncid, dimension_id, len =  num_nodes_per_elem)
       if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 241)
       ...
       if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 245)
       status = nf90_inquire_dimension(p_ncid, dimension_id, len = number_elements_in_face)
       if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 247)
...
!======================================================================
  subroutine get_face_connectivity() 
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 282)
    status = nf90_get_var(p_ncid, var_id, p_connectivity)
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 284)
...
!======================================================================
  subroutine get_node_coordinates ()
    ...
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 334)
    status = nf90_get_var(p_ncid, var_id, p_node_coordinates)
    if(status /= nf90_NoErr) call handle_error(status, "<stdin>", 336)
