...
! !DESCRIPTION:
!
! Opens an unformatted file for reading \! nbits indicates whether the file is sequential or direct access
!
! !REVISION HISTORY:
!
! author: Tony Craig, NCAR
...
! !DESCRIPTION:
!
! Read an unformatted file \! Just like ice_read except that it returns a global array \! work_g is a real array, atype indicates the format of the data
!
! !REVISION HISTORY:
...
! !DESCRIPTION:
!
! Writes an unformatted file \! work is a real array, atype indicates the format of the data
!
! !REVISION HISTORY:
!
! author: Tony Craig, NCAR
...
! !DESCRIPTION:
!
! Writes a field to a netcdf file \! work is a real array, atype indicates the format of the data
!
! !REVISION HISTORY:
!
...
! !DESCRIPTION:
!
! Read a netcdf file \! Just like ice_read_nc except that it returns a global array \! work_g is a real array
!
! !REVISION HISTORY:
! Adapted by William Lipscomb, LANL, from ice_read
