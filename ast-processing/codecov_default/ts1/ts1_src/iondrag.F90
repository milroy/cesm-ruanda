...
contains
  ...
  !================================================================================================
! Subprogram not used   subroutine iondrag_calc_ions( lchnk, ncol, state, ptend, pbuf, delt )
! Subprogram not used 
! Subprogram not used     !-------------------------------------------------------------------------------
! Subprogram not used     ! dummy arguments
! Subprogram not used     !-------------------------------------------------------------------------------
! Subprogram not used     integer,intent(in)   :: lchnk               ! current chunk index
...
! Subprogram not used     type(physics_ptend), intent(out)   :: ptend   ! Physics tendencies
! Subprogram not used     type(physics_buffer_desc), pointer :: pbuf(:) ! physics buffer
! Subprogram not used 
! Subprogram not used   end subroutine iondrag_calc_ions
