...
! !INTERFACE:
!
! Subprogram not used       subroutine init_orbit
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !
! Subprogram not used ! Uses share routines to compute orbital parameters
! Subprogram not used ! for the specified date.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !
! Subprogram not used ! author:  Bruce P. Briegleb, NCAR 
! Subprogram not used !
! Subprogram not used ! !USES: none
! Subprogram not used !
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS: none
! Subprogram not used !
! Subprogram not used !EOP
! Subprogram not used !
! Subprogram not used       iyear_AD  = 1950
! Subprogram not used       log_print = .false.   ! if true, write out orbital parameters
! Subprogram not used !
! Subprogram not used       call shr_orb_params( iyear_AD , eccen  , obliq , mvelp     , &
! Subprogram not used                            obliqr   , lambm0 , mvelpp, log_print )
! Subprogram not used  
! Subprogram not used       end subroutine init_orbit
