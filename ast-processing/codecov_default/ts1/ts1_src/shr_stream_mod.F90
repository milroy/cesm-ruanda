...
! Subprogram not used subroutine shr_stream_getFileFieldList(stream,list,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType)  ,intent(in)  :: stream  ! stream in question
! Subprogram not used    character(*)                 ,intent(out) :: list    ! field list
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc      ! return code
! Subprogram not used 
...
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_getFileFieldList) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_getFileFieldList) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used    list = stream%fldListFile
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getFileFieldList
...
! Subprogram not used subroutine shr_stream_getModelFieldName(stream,k,name,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType)  ,intent(in)  :: stream  ! stream in question
! Subprogram not used    integer(SHR_KIND_IN)         ,intent(in)  :: k       ! index of field
! Subprogram not used    character(*)                 ,intent(out) :: name    ! k-th name in list
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc      ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_getModelFieldName) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_getModelFieldName) ',4a)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    rCode = 0
! Subprogram not used 
! Subprogram not used    call shr_string_listGetName(stream%fldListModel,k,name,rCode)
! Subprogram not used 
! Subprogram not used    if (present(rc)) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getModelFieldName
...
! Subprogram not used subroutine shr_stream_getDataSource(strm,str)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType),intent(in)  :: strm      ! data stream
! Subprogram not used    character(*)               ,intent(out) :: str       ! meta data
! Subprogram not used  
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    str = strm%dataSource
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getDataSource
...
!   for files on an nfs-mounted file system (available via 1 cp), 
...
! Subprogram not used subroutine shr_stream_getFirstFileName(strm,file,path)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType),intent(in)  :: strm      ! data stream
! Subprogram not used    character(*)               ,intent(out) :: file      ! file name
! Subprogram not used    character(*),optional      ,intent(out) :: path      ! file path
! Subprogram not used  
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (present(path)) path = strm%filePath
! Subprogram not used    file = strm%file(1)%name
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getFirstFileName
...
! Subprogram not used    subroutine shr_stream_getNextFileName(strm,fn,fnNext,path,rc)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType),intent(in)    :: strm   ! data stream
! Subprogram not used    character(*)               ,intent(in)    :: fn     ! file name
! Subprogram not used    character(*)               ,intent(out)   :: fnNext ! next file name
! Subprogram not used    character(*),optional      ,intent(out)   :: path   ! file path
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc     ! return code
! Subprogram not used  
! Subprogram not used !EOP
...
! Subprogram not used    !--- local ---
! Subprogram not used    integer  (SHR_KIND_IN) :: rCode   ! return code
! Subprogram not used    integer(SHR_KIND_IN) :: n      ! loop index
! Subprogram not used    logical              :: found  ! file name found?
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_getNextFileName) ' 
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_getNextFileName) ',8a)" 
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Note: will wrap-around data loop if lvd & gvd are known
! Subprogram not used ! otherwise may return file name = "unknown"
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    rCode = 0
! Subprogram not used    if (present(path)) path = strm%filePath
! Subprogram not used 
! Subprogram not used    !--- locate input file in the stream's list of files ---
! Subprogram not used    found = .false.
! Subprogram not used    do n = 1,strm%nFiles
! Subprogram not used       if ( trim(fn) == trim(strm%file(n)%name)) then
...
! Subprogram not used       write(s_logunit,F00) "ERROR: input file name is not in stream: ",trim(fn)
! Subprogram not used       call shr_stream_abort(subName//"ERROR: file name not in stream: "//trim(fn))
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    !--- get next file name ---
! Subprogram not used    n = n+1  ! next in list
! Subprogram not used    if (strm%found_lvd .and. strm%found_gvd) then
! Subprogram not used       if (n > strm%k_gvd)  n = strm%k_lvd ! wrap-around to lvd
! Subprogram not used    else if (strm%found_lvd ) then
! Subprogram not used       if (n > strm%nFiles) n = strm%k_lvd ! wrap-around to lvd
! Subprogram not used    else if (n > strm%nFiles ) then
! Subprogram not used       n = 1                               ! wrap-around to 1st file
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    fnNext = trim(strm%file(n)%name)
! Subprogram not used    if ( present(rc) ) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getNextFileName
...
! Subprogram not used    subroutine shr_stream_getPrevFileName(strm,fn,fnPrev,path,rc)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType)  ,intent(in)  :: strm   ! data stream
! Subprogram not used    character(*)                 ,intent(in)  :: fn     ! file name
! Subprogram not used    character(*)                 ,intent(out) :: fnPrev ! preciding file name
! Subprogram not used    character(*),optional        ,intent(out) :: path   ! file path
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc     ! return code
! Subprogram not used  
! Subprogram not used !EOP
...
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_getPrevFileName) ' 
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_getPrevFileName) ',8a)" 
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Note: will wrap-around data loop if lvd & gvd are known
! Subprogram not used ! otherwise may return file name = "unknown"
...
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    !--- get previous file name ---
! Subprogram not used    n = n-1  ! previous in list
! Subprogram not used    if (strm%found_lvd .and. strm%found_gvd) then
! Subprogram not used       if ( n < strm%k_lvd) n = strm%k_gvd ! do wrap-around ---
! Subprogram not used    end if
! Subprogram not used    if (n>0) then
! Subprogram not used       fnPrev = trim(strm%file(n)%name)
! Subprogram not used    else
! Subprogram not used       fnPrev = "unknown "
! Subprogram not used    end if
! Subprogram not used    if ( present(rc) ) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getPrevFileName
...
! Subprogram not used subroutine  shr_stream_restWrite(strm,fileName,caseName,caseDesc,nstrms,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType)  ,intent(in)  :: strm(:)    ! vector of data streams
! Subprogram not used    character(*)                 ,intent(in)  :: fileName   ! name of restart file
! Subprogram not used    character(*)                 ,intent(in)  :: caseName   ! case name
! Subprogram not used    character(*)                 ,intent(in)  :: caseDesc   ! case description
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(in)  :: nstrms     ! number of streams
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out) :: rc         ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    integer  (SHR_KIND_IN) :: rCode       ! return code
! Subprogram not used    integer(SHR_KIND_IN)   :: nStreams    ! number of streams 
! Subprogram not used    integer(SHR_KIND_IN)   :: k,n         ! generic loop index
! Subprogram not used    character( 8)          :: dStr        ! F90 wall clock date str yyyymmdd
! Subprogram not used    character(10)          :: tStr        ! F90 wall clock time str hhmmss.sss
! Subprogram not used    character(SHR_KIND_CS) :: str         ! generic text string
! Subprogram not used    integer(SHR_KIND_IN)   :: nUnit       ! a file unit number
! Subprogram not used    integer(SHR_KIND_IN)   :: nt          ! number of time samples
! Subprogram not used    character(SHR_KIND_CS) :: tInterpAlgo ! for backwards compatability
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_restWrite) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_restWrite) ',16a) "
! Subprogram not used    character(*),parameter :: F01   = "('(shr_stream_restWrite) ',a,i5,a,5a) "
! Subprogram not used    character(*),parameter :: F02   = "('(shr_stream_restWrite) ',a,i5,a,5i8) "
! Subprogram not used    character(*),parameter :: F03   = "('(shr_stream_restWrite) ',a,i5,a,5l3) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    rCode = 0
! Subprogram not used    tInterpAlgo = 'unused'
! Subprogram not used 
! Subprogram not used    if (present(nstrms)) then
! Subprogram not used       if (size(strm) < nstrms) then
! Subprogram not used          write(s_logunit,F02) "ERROR: nstrms too large for strm",size(strm),nstrms
! Subprogram not used          call shr_stream_abort(subname//": ERROR: nstrms too large for strm")
! Subprogram not used       endif
! Subprogram not used       nStreams = nstrms
! Subprogram not used    else
! Subprogram not used       nStreams = size(strm)
! Subprogram not used    endif
! Subprogram not used    call date_and_time(dStr,tStr)
! Subprogram not used 
! Subprogram not used    !--- log info to stdout ---
! Subprogram not used    if (s_loglev > 0) then
! Subprogram not used       write(s_logunit,F00) "case name        : ",trim(caseName)
! Subprogram not used       write(s_logunit,F00) "case description : ",trim(caseDesc)
! Subprogram not used       write(s_logunit,F00) "File created     : ",dStr(1:4)//'-'//dStr(5:6)//'-'//dStr(7:8)//' '  &
! Subprogram not used                               &     //tStr(1:2)//':'//tStr(3:4)//':'//tStr(5:6)
! Subprogram not used       write(s_logunit,F01) "Number of streams ",nStreams
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    !----------------------------------------------------------------------------
! Subprogram not used    ! write the  data
! Subprogram not used    !----------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nUnit = shr_file_getUnit() ! get an unused unit number
! Subprogram not used    open(nUnit,file=trim(fileName),form="unformatted",action="write")
! Subprogram not used 
! Subprogram not used    str =        "case name        : "//caseName
! Subprogram not used    write(nUnit) str
! Subprogram not used    str =        "case description : "//caseDesc
! Subprogram not used    write(nUnit) str
! Subprogram not used    str =        'File created     : '//dStr(1:4)//'-'//dStr(5:6)//'-'//dStr(7:8)//' '  &
! Subprogram not used                               &      //tStr(1:2)//':'//tStr(3:4)//':'//tStr(5:6)
! Subprogram not used    write(nUnit) str
! Subprogram not used 
! Subprogram not used    write(nUnit) nStreams
! Subprogram not used    do k = 1,nStreams
! Subprogram not used       if (.not. shr_stream_isInit(strm(k))) then  ! has stream been initialized?
! Subprogram not used          rCode = 1
! Subprogram not used          write(s_logunit,F01) "ERROR: can't write uninitialized stream to a restart file, k = ",k
! Subprogram not used          call shr_stream_abort(subName//": ERROR: given uninitialized stream")
! Subprogram not used       end if         
! Subprogram not used 
! Subprogram not used       write(nUnit) strm(k)%init         ! has stream been initialized?
! Subprogram not used       write(nUnit) strm(k)%nFiles       ! number of data files
! Subprogram not used       write(nUnit) strm(k)%dataSource   ! meta data identifying data source
! Subprogram not used       write(nUnit) strm(k)%filePath     ! remote location of files
! Subprogram not used 
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F01) "* stream ",k," first file name = ",trim(strm(k)%file(1)%name)
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F03) "* stream ",k," first have data = ",strm(k)%file(1)%haveData
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F02) "* stream ",k," first nt        = ",strm(k)%file(1)%nt
! Subprogram not used       nt = strm(k)%file(1)%nt
! Subprogram not used       if (strm(k)%file(1)%haveData) then
! Subprogram not used          if (s_loglev > 0) write(s_logunit,F02) "* stream ",k," first date secs = ", &
! Subprogram not used                                                 strm(k)%file(1)%date(1),strm(k)%file(1)%secs(1)
! Subprogram not used          if (s_loglev > 0) write(s_logunit,F02) "* stream ",k," last  date secs = ", &
! Subprogram not used                                                 strm(k)%file(1)%date(nt),strm(k)%file(1)%secs(nt)
! Subprogram not used       endif
! Subprogram not used       do n=1,strm(k)%nFiles                      ! data specific to each file...
! Subprogram not used          write(nUnit) strm(k)%file(n)%name       ! the file name
! Subprogram not used          write(nUnit) strm(k)%file(n)%haveData   ! has t-coord data been read in?
! Subprogram not used          write(nUnit) strm(k)%file(n)%nt         ! size of time dimension
! Subprogram not used          if (strm(k)%file(n)%haveData) then      ! ie. if arrays have been allocated
! Subprogram not used             write(nUnit) strm(k)%file(n)%date(:) ! t-coord date: yyyymmdd
! Subprogram not used             write(nUnit) strm(k)%file(n)%secs(:) ! t-coord secs: elapsed on date
! Subprogram not used          end if
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       write(nUnit) strm(k)%yearFirst    ! first year to use in t-axis (yyyymmdd)
! Subprogram not used       write(nUnit) strm(k)%yearLast     ! last  year to use in t-axis (yyyymmdd)
! Subprogram not used       write(nUnit) strm(k)%yearAlign    ! align yearFirst with this model year
! Subprogram not used       write(nUnit) strm(k)%offset       ! time axis offset
! Subprogram not used !     write(nUnit) strm(k)%taxMode      ! time axis cycling mode
! Subprogram not used 
! Subprogram not used       write(nUnit) strm(k)%k_lvd        ! file        of least valid date
! Subprogram not used       write(nUnit) strm(k)%n_lvd        !      sample of least valid date
! Subprogram not used       write(nUnit) strm(k)%found_lvd    ! T <=> k_lvd,n_lvd have been set
! Subprogram not used       write(nUnit) strm(k)%k_gvd        ! file        of greatest valid date
! Subprogram not used       write(nUnit) strm(k)%n_gvd        !      sample of greatest valid date
! Subprogram not used       write(nUnit) strm(k)%found_gvd    ! T <=> k_gvd,n_gvd have been set
! Subprogram not used 
! Subprogram not used       write(nUnit) strm(k)%fldListFile  ! field list: file's  field names
! Subprogram not used       write(nUnit) strm(k)%fldListModel ! field list: model's field names
! Subprogram not used       write(nUnit) tInterpAlgo          ! unused
! Subprogram not used       write(nUnit) strm(k)%domFileName  ! domain file: name
! Subprogram not used       write(nUnit) strm(k)%domFilePath  ! domain file: path
! Subprogram not used       write(nUnit) strm(k)%domTvarName  ! domain file: time-dim var name
! Subprogram not used       write(nUnit) strm(k)%domXvarName  ! domain file: x-dim var name
! Subprogram not used       write(nUnit) strm(k)%domYvarName  ! domain file: y-dim var ame
! Subprogram not used       write(nUnit) strm(k)%domAreaName  ! domain file: area  var name
! Subprogram not used       write(nUnit) strm(k)%domMaskName  ! domain file: mask  var name
! Subprogram not used 
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used    close(nUnit)
! Subprogram not used    call shr_file_freeUnit(nUnit)
! Subprogram not used    if ( present(rc) ) rc = rCode
! Subprogram not used    
! Subprogram not used end subroutine  shr_stream_restWrite
...
! Subprogram not used subroutine  shr_stream_restRead(strm,fileName,nstrms,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType)  ,intent(inout) :: strm(:)  ! vector of data streams
! Subprogram not used    character(*)                 ,intent(in)    :: fileName ! name of restart file
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(in)    :: nstrms   ! number of streams in strm
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out)   :: rc       ! return code
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
...
! Subprogram not used    character(SHR_KIND_CS) :: str         ! generic text string
! Subprogram not used    integer(SHR_KIND_IN)   :: nUnit       ! a file unit number
! Subprogram not used    integer(SHR_KIND_IN)   :: inpi        ! input integer
! Subprogram not used    real(SHR_KIND_R8)      :: inpr        ! input real
! Subprogram not used    character(SHR_KIND_CXX):: inpcx       ! input char
! Subprogram not used    character(SHR_KIND_CL) :: inpcl       ! input char
! Subprogram not used    character(SHR_KIND_CS) :: inpcs       ! input char
! Subprogram not used    integer(SHR_KIND_IN)   :: nt          ! size of time dimension
! Subprogram not used    character(SHR_KIND_CS) :: tInterpAlgo ! for backwards compatability
! Subprogram not used    character(SHR_KIND_CL) :: name                            ! local variables
! Subprogram not used    integer(SHR_KIND_IN)   :: nFiles                          ! local variables
! Subprogram not used    integer(SHR_KIND_IN)   :: k_lvd, n_lvd, k_gvd, n_gvd      ! local variables
! Subprogram not used    logical                :: found_lvd, found_gvd, haveData  ! local variables
! Subprogram not used    integer(SHR_KIND_IN),pointer :: date(:),secs(:)           ! local variables
! Subprogram not used    logical                :: abort       ! abort the restart read
! Subprogram not used    logical                :: readok      ! read of restarts ok
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_restRead) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_restRead) ',16a) "
! Subprogram not used    character(*),parameter :: F01   = "('(shr_stream_restRead) ',a,i5,a,5a) "
! Subprogram not used    character(*),parameter :: F02   = "('(shr_stream_restRead) ',a,i5,a,5i8) "
! Subprogram not used    character(*),parameter :: F03   = "('(shr_stream_restRead) ',a,i5,a,5l3) "
! Subprogram not used    character(*),parameter :: F04   = "('(shr_stream_restRead) ',a,4i8) "
! Subprogram not used    character(*),parameter :: F05   = "('(shr_stream_restRead) ',a,2i8,6a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    rCode = 0
! Subprogram not used    tInterpAlgo = 'unused'
! Subprogram not used    abort = .false.
! Subprogram not used    inpcl = ' '
! Subprogram not used 
! Subprogram not used    !----------------------------------------------------------------------------
! Subprogram not used    ! read the  data
! Subprogram not used    !----------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nUnit = shr_file_getUnit() ! get an unused unit number 
! Subprogram not used    open(nUnit,file=trim(fileName),form="unformatted",status="old",action="read", iostat=rCode)
! Subprogram not used    if ( rCode /= 0 )then
! Subprogram not used       call shr_file_freeUnit(nUnit)
! Subprogram not used       call shr_stream_abort(subName//": ERROR: error opening file: "//trim(fileName) )
! Subprogram not used       if ( present(rc) ) rc = rCode
! Subprogram not used       return
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used    read(nUnit) str         ! case name
! Subprogram not used    if (s_loglev > 0) write(s_logunit,F00) trim(str)  
! Subprogram not used    read(nUnit) str         ! case description
! Subprogram not used    if (s_loglev > 0) write(s_logunit,F00) trim(str)  
! Subprogram not used    read(nUnit) str         ! file creation date
! Subprogram not used    if (s_loglev > 0) write(s_logunit,F00) trim(str)  
! Subprogram not used 
! Subprogram not used    read(nUnit) nStreams
! Subprogram not used    if (present(nstrms)) then
! Subprogram not used       if (nstrms /= nStreams) then
! Subprogram not used          write(s_logunit,F02) "ERROR: nstrms ne nStreams on restart",nstrms,' ',nStreams
! Subprogram not used          call shr_stream_abort(subname//": ERROR: nstrms ne nStreams on restart")
! Subprogram not used       endif
! Subprogram not used       nStreams = nstrms
! Subprogram not used    endif
! Subprogram not used    if (s_loglev > 0) write(s_logunit,F01) "Number of streams ",nStreams
! Subprogram not used 
! Subprogram not used    do k = 1,nStreams
! Subprogram not used       read(nUnit) strm(k)%init         ! has stream been initialized? 
! Subprogram not used       if (.not. strm(k)%init) then 
! Subprogram not used          rCode = 1
! Subprogram not used          write(s_logunit,F01) "ERROR: uninitialized stream in restart file, k = ",k
! Subprogram not used          call shr_stream_abort(subName//": ERROR: reading uninitialized stream")
! Subprogram not used       end if         
! Subprogram not used       call shr_stream_setInit(strm(k))
! Subprogram not used 
! Subprogram not used       readok = .true.
! Subprogram not used 
! Subprogram not used       ! tcraig, don't overwrite these from input
! Subprogram not used       read(nUnit) nFiles       ! number of data files
! Subprogram not used       read(nUnit) inpcs  ! dataSource   ! meta data identifying data source
! Subprogram not used       read(nUnit) inpcl  ! filePath     ! remote location of files
! Subprogram not used 
! Subprogram not used       do n=1,nFiles                     ! data specific to each file...
! Subprogram not used          read(nUnit) name       ! the file name
! Subprogram not used          read(nUnit) haveData   ! has t-coord data been read in?
! Subprogram not used          read(nUnit) nt         ! size of time dimension
! Subprogram not used 
! Subprogram not used          if (haveData) then     ! ie. if arrays have been allocated
! Subprogram not used             allocate(date(nt))
! Subprogram not used             allocate(secs(nt))
! Subprogram not used             read(nUnit) date(:) ! t-coord date: yyyymmdd
! Subprogram not used             read(nUnit) secs(:) ! t-coord secs: elapsed on date
! Subprogram not used             if (strm(k)%nFiles >= n) then
! Subprogram not used             if (trim(name) == trim(strm(k)%file(n)%name)) then
! Subprogram not used                write(s_logunit,F05) "reading time axis for stream restart filename ",k,n, &
! Subprogram not used                     ' ',trim(name),' ',trim(strm(k)%file(n)%name)
! Subprogram not used                strm(k)%file(n)%nt = nt
! Subprogram not used                strm(k)%file(n)%haveData = haveData
! Subprogram not used                allocate(strm(k)%file(n)%date(nt))
! Subprogram not used                allocate(strm(k)%file(n)%secs(nt))
! Subprogram not used                strm(k)%file(n)%date(1:nt) = date(1:nt)
! Subprogram not used                strm(k)%file(n)%secs(1:nt) = secs(1:nt)
! Subprogram not used             else
! Subprogram not used                write(s_logunit,F05) "WARNING, skip time axis for stream restart filename ",k,n,&
! Subprogram not used                     ' ',trim(name),' ',trim(strm(k)%file(n)%name)
! Subprogram not used                readok = .false.
! Subprogram not used             endif  ! filenames consistent
! Subprogram not used             endif  ! strm nfiles
! Subprogram not used             deallocate(date)
! Subprogram not used             deallocate(secs)
! Subprogram not used          end if
! Subprogram not used       end do
! Subprogram not used 
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F01) "* stream ",k," first file name = ",trim(strm(k)%file(1)%name)
...
! Subprogram not used       endif
! Subprogram not used 
! Subprogram not used ! tcraig, apr 2 2012, offset is the only field that should not change here for time axis
! Subprogram not used !      read(nUnit) strm(k)%yearFirst     ! last  year to use in t-axis (yyyymmdd)
! Subprogram not used !      read(nUnit) strm(k)%yearLast     ! last  year to use in t-axis (yyyymmdd)
! Subprogram not used !      read(nUnit) strm(k)%yearAlign    ! align yearFirst with this model year
! Subprogram not used !      read(nUnit) strm(k)%offset       ! time axis offset
! Subprogram not used       read(nUnit) inpi   ! first year to use in t-axis (yyyymmdd)
! Subprogram not used !      if (inpi /= strm(k)%yearFirst) then
! Subprogram not used !         write(s_logunit,F04) " ERROR: yearFirst disagrees ",k,strm(k)%yearFirst,inpi
! Subprogram not used !         abort=.true.
! Subprogram not used !      endif
! Subprogram not used       read(nUnit) inpi   ! last year to use in t-axis (yyyymmdd)
! Subprogram not used !      if (inpi /= strm(k)%yearLast) then
! Subprogram not used !         write(s_logunit,F04) " ERROR: yearLast disagrees ",k,strm(k)%yearLast,inpi
! Subprogram not used !         abort=.true.
! Subprogram not used !      endif
! Subprogram not used       read(nUnit) inpi   ! align year to use in t-axis (yyyymmdd)
! Subprogram not used !      if (inpi /= strm(k)%yearAlign) then
! Subprogram not used !         write(s_logunit,F04) " ERROR: yearAlign disagrees ",k,strm(k)%yearAlign,inpi
! Subprogram not used !         abort=.true.
! Subprogram not used !      endif
! Subprogram not used       read(nUnit) inpi   ! time axis offset
! Subprogram not used       if (inpi /= strm(k)%offset) then
! Subprogram not used          write(s_logunit,F04) " ERROR: offset disagrees ",k,strm(k)%offset,inpi
! Subprogram not used          abort=.true.
! Subprogram not used       endif
! Subprogram not used 
! Subprogram not used !     read(nUnit) strm(k)%taxMode      ! time axis cycling mode
! Subprogram not used 
! Subprogram not used       read(nUnit) k_lvd        ! file        of least valid date
! Subprogram not used       read(nUnit) n_lvd        !      sample of least valid date
! Subprogram not used       read(nUnit) found_lvd    ! T <=> k_lvd,n_lvd have been set
! Subprogram not used       read(nUnit) k_gvd        ! file        of greatest valid date
! Subprogram not used       read(nUnit) n_gvd        !      sample of greatest valid date
! Subprogram not used       read(nUnit) found_gvd    ! T <=> k_gvd,n_gvd have been set
! Subprogram not used       ! tcraig, april 2012, only overwrite if restart read is ok
! Subprogram not used       if (readok) then
! Subprogram not used          write(s_logunit,F05) "setting k n and found lvd gvd on restart ",k,n,' ',trim(name)
! Subprogram not used          strm(k)%k_lvd     = k_lvd
! Subprogram not used          strm(k)%n_lvd     = n_lvd
! Subprogram not used          strm(k)%found_lvd = found_lvd
! Subprogram not used          strm(k)%k_gvd     = k_gvd
! Subprogram not used          strm(k)%n_gvd     = n_gvd
! Subprogram not used          strm(k)%found_gvd = found_gvd
! Subprogram not used       endif
! Subprogram not used 
! Subprogram not used       ! tcraig, april 2012, don't overwrite these from input
! Subprogram not used       read(nUnit) inpcx !  fldListFile  ! field list: file's  field names
! Subprogram not used       read(nUnit) inpcx !  fldListModel ! field list: model's field names
! Subprogram not used       read(nUnit) inpcs !  tInterpAlgo          ! unused
! Subprogram not used       read(nUnit) inpcl !  domFileName  ! domain file: name
! Subprogram not used       read(nUnit) inpcl !  domFilePath  ! domain file: path
! Subprogram not used       read(nUnit) inpcs !  domTvarName  ! domain file: time-dim var name
! Subprogram not used       read(nUnit) inpcs !  domXvarName  ! domain file: x-dim var name
! Subprogram not used       read(nUnit) inpcs !  domYvarName  ! domain file: y-dim var ame
! Subprogram not used       read(nUnit) inpcs !  domAreaName  ! domain file: area  var name
! Subprogram not used       read(nUnit) inpcs !  domMaskName  ! domain file: mask  var name
! Subprogram not used 
! Subprogram not used    end do
! Subprogram not used 
! Subprogram not used    if (abort) then
! Subprogram not used       write(s_logunit,F00) "ERRORS Detected ABORTING NOW"
! Subprogram not used       call shr_stream_abort(subName//": ERRORS Detected ABORTING NOW")
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    close(nUnit)
! Subprogram not used    call shr_file_freeUnit(nUnit)
! Subprogram not used    if ( present(rc) ) rc = rCode
! Subprogram not used 
! Subprogram not used end subroutine  shr_stream_restRead
...
! Subprogram not used subroutine shr_stream_dataDump(strm)
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType),intent(in) :: strm      ! data stream
...
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    integer(SHR_KIND_IN)   :: k ! generic loop index
! Subprogram not used 
! Subprogram not used    !----- formats -----
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_dataDump) ' 
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_dataDump) ',8a)" 
! Subprogram not used    character(*),parameter :: F01   = "('(shr_stream_dataDump) ',a,3i5)" 
! Subprogram not used    character(*),parameter :: F02   = "('(shr_stream_dataDump) ',a,365i9.8)" 
! Subprogram not used    character(*),parameter :: F03   = "('(shr_stream_dataDump) ',a,365i6)" 
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! notes: 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (s_loglev <= 0) return
! Subprogram not used 
! Subprogram not used    write(s_logunit,F00) "dump internal data for debugging..."
! Subprogram not used 
! Subprogram not used    !-----------------------------------------------------------------------------  
! Subprogram not used    ! dump internal data
! Subprogram not used    !-----------------------------------------------------------------------------  
! Subprogram not used    write(s_logunit,F01) "nFiles        = ", strm%nFiles            
! Subprogram not used    write(s_logunit,F00) "filePath      = ", trim(strm%filePath)
! Subprogram not used    do k=1,strm%nFiles
! Subprogram not used       write(s_logunit,F01) "data for file k = ",k
! Subprogram not used       write(s_logunit,F00)    "* file(k)%name    = ", trim(strm%file(k)%name)
! Subprogram not used       if ( strm%file(k)%haveData ) then
! Subprogram not used          write(s_logunit,F01) "* file(k)%nt      = ", strm%file(k)%nt
! Subprogram not used          write(s_logunit,F02) "* file(k)%date(:) = ", strm%file(k)%date(:)    
! Subprogram not used          write(s_logunit,F03) "* file(k)%Secs(:) = ", strm%file(k)%secs(:)    
! Subprogram not used       else
! Subprogram not used          write(s_logunit,F00) "* time coord data not read in yet for this file"
! Subprogram not used       end if
! Subprogram not used    end do
! Subprogram not used    write(s_logunit,F01) "yearF/L/A    = ", strm%yearFirst,strm%yearLast,strm%yearAlign
! Subprogram not used    write(s_logunit,F01) "offset       = ", strm%offset
! Subprogram not used    write(s_logunit,F00) "taxMode      = ", trim(strm%taxMode)
! Subprogram not used 
! Subprogram not used    write(s_logunit,F00) "fldListFile  = ", trim(strm%fldListFile)
! Subprogram not used    write(s_logunit,F00) "fldListModel = ", trim(strm%fldListModel)
! Subprogram not used    write(s_logunit,F00) "domFileName  = ", trim(strm%domFileName)
! Subprogram not used    write(s_logunit,F00) "domFilePath  = ", trim(strm%domFilePath)
! Subprogram not used    write(s_logunit,F00) "domTvarName  = ", trim(strm%domTvarName)
! Subprogram not used    write(s_logunit,F00) "domXvarName  = ", trim(strm%domXvarName)
! Subprogram not used    write(s_logunit,F00) "domYvarName  = ", trim(strm%domYvarName)
! Subprogram not used    write(s_logunit,F00) "domAreaName  = ", trim(strm%domAreaName)
! Subprogram not used    write(s_logunit,F00) "domMaskName  = ", trim(strm%domMaskName)
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_dataDump
...
! Subprogram not used subroutine shr_stream_setDebug(level)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer,intent(in) :: level
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_setDebug) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_setDebug) ',a) "
! Subprogram not used    character(*),parameter :: F01   = "('(shr_stream_setDebug) ',a,i4) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    debug = level
! Subprogram not used    if (s_loglev > 0) write(s_logunit,F01) "debug level reset to ",level
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_setDebug
...
! Subprogram not used subroutine shr_stream_getDebug(level)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer,intent(out) :: level
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_getDebug) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_getDebug) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    level = debug
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_getDebug
...
! Subprogram not used subroutine shr_stream_setAbort(flag)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_setAbort) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_setAbort
...
! Subprogram not used subroutine shr_stream_abort( msg )
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used    character(len=*), optional, intent(IN) :: msg  ! Message to describe error
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    character(SHR_KIND_CL) :: lmsg
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_abort) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_abort) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   lmsg = ' '
! Subprogram not used   if (present(msg)) lmsg= msg
! Subprogram not used 
! Subprogram not used   if (doabort) then
! Subprogram not used     call shr_sys_abort(lmsg)
! Subprogram not used   else
! Subprogram not used     write(s_logunit,F00) trim(lmsg)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_abort
...
! Subprogram not used subroutine shr_stream_bcast(stream,comm,rc)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(shr_stream_streamType),  intent(inout) :: stream
! Subprogram not used    integer(SHR_KIND_IN),         intent(in)    :: comm
! Subprogram not used    integer(SHR_KIND_IN),optional,intent(out)   :: rc
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- locals ---
! Subprogram not used    integer :: n,nt
! Subprogram not used    integer :: pid
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = '(shr_stream_bcast) '
! Subprogram not used    character(*),parameter :: F00   = "('(shr_stream_bcast) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    call shr_mpi_commRank(comm,pid,subName)
! Subprogram not used 
! Subprogram not used    call shr_mpi_bcast(stream%init        ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%nFiles      ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%dataSource  ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%filePath    ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%yearFirst   ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%yearLast    ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%yearAlign   ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%offset      ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%taxMode     ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%k_lvd       ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%n_lvd       ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%found_lvd   ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%k_gvd       ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%n_gvd       ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%found_gvd   ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%fldListFile ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%fldListModel,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domFileName ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domFilePath ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domTvarName ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domXvarName ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domYvarName ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%domMaskName ,comm,subName)
! Subprogram not used    call shr_mpi_bcast(stream%calendar    ,comm,subName)
! Subprogram not used 
! Subprogram not used    do n = 1,stream%nFiles
! Subprogram not used       call shr_mpi_bcast(stream%file(n)%name    ,comm,subName)
! Subprogram not used       call shr_mpi_bcast(stream%file(n)%haveData,comm,subName)
! Subprogram not used       call shr_mpi_bcast(stream%file(n)%nt      ,comm,subName)
! Subprogram not used       nt = stream%file(n)%nt
! Subprogram not used       if (pid /= 0) allocate(stream%file(n)%date(nt),stream%file(n)%secs(nt))
! Subprogram not used       call shr_mpi_bcast(stream%file(n)%date    ,comm,subName)
! Subprogram not used       call shr_mpi_bcast(stream%file(n)%secs    ,comm,subName)
! Subprogram not used    enddo
! Subprogram not used 
! Subprogram not used end subroutine shr_stream_bcast
