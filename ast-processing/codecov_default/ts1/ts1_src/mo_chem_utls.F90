...
! Subprogram not used   integer function get_het_ndx( het_name )
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !     ... return overall het process index associated with spc_name
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     use gas_wetdep_opts,only : gas_wetdep_method, gas_wetdep_list, gas_wetdep_cnt
! Subprogram not used 
...
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     character(len=*), intent(in) :: het_name
! Subprogram not used 
! Subprogram not used     !-----------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used     get_het_ndx=-1
! Subprogram not used 
! Subprogram not used     do m=1,gas_wetdep_cnt
! Subprogram not used 
! Subprogram not used        if( trim( het_name ) == trim( gas_wetdep_list(m) ) ) then
! Subprogram not used           get_het_ndx = get_spc_ndx( gas_wetdep_list(m) )
! Subprogram not used           return
! Subprogram not used        endif
! Subprogram not used   
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used   end function get_het_ndx
