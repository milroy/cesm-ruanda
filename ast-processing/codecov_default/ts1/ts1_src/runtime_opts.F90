...
!----------------------------------------------------------------------- 
! 
! Purpose: This module is responsible for reading 1 namelist cam_inparm 
...
!                      in tracers_suite.F90 must agree with 25
!
...
!=======================================================================
  ...
  subroutine read_namelist(single_column_in, scmlon_in, scmlat_in, nlfilename_in )
   ...
   ! interfaces should be refined via review by other 1 developers.  
...
! ***NOTE*** If a namelist option is not described in the 1 Users Guide,
!            it is not supported.  
...
!
! The cpp 1 definition provides for the funnelling of all program i/o
