...
! !INTERFACE:
!
! Subprogram not used       subroutine shortwave_ccsm3 (nx_block, ny_block, &
! Subprogram not used                                   icells,             &
! Subprogram not used                                   indxi,    indxj,    &
! Subprogram not used                                   aicen,    vicen,    &
! Subprogram not used                                   vsnon,    Tsfcn,    &
! Subprogram not used                                   swvdr,    swvdf,    &
! Subprogram not used                                   swidr,    swidf,    &
! Subprogram not used                                   alvdrn,   alidrn,   &
! Subprogram not used                                   alvdfn,   alidfn,   &
! Subprogram not used                                   fswsfc,   fswint,   &
! Subprogram not used                                   fswthru,  Iswabs,   &
! Subprogram not used                                   albin,    albsn)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !
! Subprogram not used ! Driver for basic solar radiation from CCSM3.  Albedos and absorbed solar.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !
! Subprogram not used ! authors:  same as module
! Subprogram not used !
...
! Subprogram not used          icells              ! number of ice-covered grid cells
! Subprogram not used 
! Subprogram not used       integer (kind=int_kind), dimension (nx_block*ny_block), &
! Subprogram not used          intent(in) :: &
! Subprogram not used          indxi    , & ! indices for ice-covered cells
! Subprogram not used          indxj
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block), &
! Subprogram not used          intent(in) :: &
! Subprogram not used          aicen    , & ! concentration of ice per category
! Subprogram not used          vicen    , & ! volume of ice per category
! Subprogram not used          vsnon    , & ! volume of ice per category
! Subprogram not used          Tsfcn    , & ! surface temperature
! Subprogram not used          swvdr    , & ! sw down, visible, direct  (W/m^2)
! Subprogram not used          swvdf    , & ! sw down, visible, diffuse (W/m^2)
! Subprogram not used          swidr    , & ! sw down, near IR, direct  (W/m^2)
! Subprogram not used          swidf        ! sw down, near IR, diffuse (W/m^2)
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block), &
! Subprogram not used          intent(out) :: &
! Subprogram not used          alvdrn   , & ! visible, direct, avg   (fraction)
! Subprogram not used          alidrn   , & ! near-ir, direct, avg   (fraction)
! Subprogram not used          alvdfn   , & ! visible, diffuse, avg  (fraction)
! Subprogram not used          alidfn   , & ! near-ir, diffuse, avg  (fraction)
! Subprogram not used          fswsfc   , & ! SW absorbed at ice/snow surface (W m-2)
! Subprogram not used          fswint   , & ! SW absorbed in ice interior, below surface (W m-2)
! Subprogram not used          fswthru  , & ! SW through ice to ocean (W m-2)
! Subprogram not used          albin    , & ! bare ice albedo
! Subprogram not used          albsn        ! snow albedo
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block,nilyr), &
! Subprogram not used            intent(out) :: &
! Subprogram not used          Iswabs       ! SW absorbed in particular layer (W m-2)
! Subprogram not used !
! Subprogram not used !EOP
! Subprogram not used !
! Subprogram not used       ! ice and snow albedo for each category
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block):: &
! Subprogram not used          alvdrni, & ! visible, direct, ice    (fraction)
! Subprogram not used          alidrni, & ! near-ir, direct, ice    (fraction)
! Subprogram not used          alvdfni, & ! visible, diffuse, ice   (fraction)
! Subprogram not used          alidfni, & ! near-ir, diffuse, ice   (fraction)
! Subprogram not used          alvdrns, & ! visible, direct, snow   (fraction)
! Subprogram not used          alidrns, & ! near-ir, direct, snow   (fraction)
! Subprogram not used          alvdfns, & ! visible, diffuse, snow  (fraction)
! Subprogram not used          alidfns    ! near-ir, diffuse, snow  (fraction)
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! Compute albedos for ice and snow.
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used       if (trim(albedo_type) == 'constant') then
! Subprogram not used          call constant_albedos (nx_block,   ny_block, &
! Subprogram not used                                 icells,               &
! Subprogram not used                                 indxi,      indxj,    &
! Subprogram not used                                 aicen,                &
! Subprogram not used                                 vsnon,      Tsfcn,    &
! Subprogram not used                                 alvdrni,    alidrni,  &
! Subprogram not used                                 alvdfni,    alidfni,  &
! Subprogram not used                                 alvdrns,    alidrns,  &
! Subprogram not used                                 alvdfns,    alidfns,  &
! Subprogram not used                                 alvdrn,     alidrn,   &
! Subprogram not used                                 alvdfn,     alidfn,   &
! Subprogram not used                                 albin,      albsn)
! Subprogram not used       else ! default
! Subprogram not used          call compute_albedos (nx_block,   ny_block, &
! Subprogram not used                                icells,               &
! Subprogram not used                                indxi,      indxj,    &
! Subprogram not used                                aicen,      vicen,    &
! Subprogram not used                                vsnon,      Tsfcn,    &
...
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! Compute solar radiation absorbed in ice and penetrating to ocean.
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used       call absorbed_solar  (nx_block,   ny_block, &
! Subprogram not used                             icells,               &
! Subprogram not used                             indxi,      indxj,    &
! Subprogram not used                             aicen,                &
...
! Subprogram not used                             swvdr,      swvdf,    &
! Subprogram not used                             swidr,      swidf,    &
! Subprogram not used                             alvdrni,    alvdfni,  &
! Subprogram not used                             alidrni,    alidfni,  &
! Subprogram not used                             alvdrns,    alvdfns,  &
! Subprogram not used                             alidrns,    alidfns,  &
! Subprogram not used                             fswsfc,     fswint,   &
! Subprogram not used                             fswthru,    Iswabs)
! Subprogram not used 
! Subprogram not used       end subroutine shortwave_ccsm3
...
! !INTERFACE:
!
! Subprogram not used       subroutine compute_albedos (nx_block, ny_block, &
! Subprogram not used                                   icells,             &
! Subprogram not used                                   indxi,    indxj,    &
! Subprogram not used                                   aicen,    vicen,    &
! Subprogram not used                                   vsnon,    Tsfcn,    &
...
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !
! Subprogram not used ! Compute albedos for each thickness category
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !
! Subprogram not used ! authors:  same as module
...
! Subprogram not used       integer (kind=int_kind), dimension (nx_block*ny_block), &
! Subprogram not used          intent(in) :: &
! Subprogram not used          indxi   , & ! compressed indices for ice-covered cells
! Subprogram not used          indxj
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block), &
! Subprogram not used          intent(in) :: &
...
! Subprogram not used          alvdfn   , & ! visible, diffuse, avg  (fraction)
! Subprogram not used          alidfn   , & ! near-ir, diffuse, avg  (fraction)
! Subprogram not used          albin    , & ! bare ice 
! Subprogram not used          albsn        ! snow 
! Subprogram not used !
! Subprogram not used !EOP
! Subprogram not used !
! Subprogram not used       real (kind=dbl_kind), parameter :: &
! Subprogram not used          ahmax     = p5          , & ! thickness above which ice albedo 
! Subprogram not used                                      ! is constant (m)
! Subprogram not used          dT_mlt    = c1          , & ! change in temp to give dalb_mlt 
! Subprogram not used                                      ! albedo change
! Subprogram not used          dalb_mlt  = -0.075_dbl_kind, & ! albedo change per dT_mlt change
! Subprogram not used                                      ! in temp for ice
! Subprogram not used          dalb_mltv = -p1         , & ! albedo vis change per dT_mlt change
! Subprogram not used                                      ! in temp for snow
! Subprogram not used          dalb_mlti = -p15            ! albedo nir change per dT_mlt change
! Subprogram not used                                      ! in temp for snow
! Subprogram not used 
...
! Subprogram not used          hi  , & ! ice thickness  (m)
! Subprogram not used          hs  , & ! snow thickness  (m)
! Subprogram not used          albo, & ! effective ocean albedo, function of ice thickness
! Subprogram not used          fh  , & ! piecewise linear function of thickness
! Subprogram not used          fT  , & ! piecewise linear function of surface temperature
! Subprogram not used          dTs , & ! difference of Tsfc and Timelt
! Subprogram not used          fhtan,& ! factor used in albedo dependence on ice thickness
! Subprogram not used          asnow   ! fractional area of snow cover
! Subprogram not used 
! Subprogram not used       integer (kind=int_kind) :: &
! Subprogram not used          ij      ! horizontal index, combines i and j loops
! Subprogram not used 
! Subprogram not used       fhtan = atan(ahmax*c4)
! Subprogram not used 
! Subprogram not used       do j = 1, ny_block
! Subprogram not used       do i = 1, nx_block
! Subprogram not used          alvdrni(i,j) = albocn
! Subprogram not used          alidrni(i,j) = albocn
! Subprogram not used          alvdfni(i,j) = albocn
! Subprogram not used          alidfni(i,j) = albocn
! Subprogram not used 
! Subprogram not used          alvdrns(i,j) = albocn
! Subprogram not used          alidrns(i,j) = albocn
! Subprogram not used          alvdfns(i,j) = albocn
! Subprogram not used          alidfns(i,j) = albocn
! Subprogram not used 
! Subprogram not used          alvdrn(i,j) = albocn
! Subprogram not used          alidrn(i,j) = albocn
! Subprogram not used          alvdfn(i,j) = albocn
! Subprogram not used          alidfn(i,j) = albocn
! Subprogram not used 
! Subprogram not used          albin(i,j) = c0
! Subprogram not used          albsn(i,j) = c0
! Subprogram not used       enddo         
! Subprogram not used       enddo         
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! Compute albedo for each thickness category.
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used          hi = vicen(i,j) / aicen(i,j)
! Subprogram not used          hs = vsnon(i,j) / aicen(i,j)            
! Subprogram not used 
! Subprogram not used          ! bare ice, thickness dependence
! Subprogram not used          fh = min(atan(hi*c4)/fhtan,c1)
! Subprogram not used          albo = albocn*(c1-fh)
! Subprogram not used          alvdfni(i,j) = albicev*fh + albo
! Subprogram not used          alidfni(i,j) = albicei*fh + albo
! Subprogram not used 
! Subprogram not used          ! bare ice, temperature dependence
! Subprogram not used          dTs = Timelt - Tsfcn(i,j)
! Subprogram not used          fT = min(dTs/dT_mlt-c1,c0)
! Subprogram not used          alvdfni(i,j) = alvdfni(i,j) - dalb_mlt*fT
! Subprogram not used          alidfni(i,j) = alidfni(i,j) - dalb_mlt*fT
! Subprogram not used 
! Subprogram not used          ! avoid negative albedos for thin, bare, melting ice
! Subprogram not used          alvdfni(i,j) = max (alvdfni(i,j), albocn)
! Subprogram not used          alidfni(i,j) = max (alidfni(i,j), albocn)
! Subprogram not used 
! Subprogram not used          if (hs > puny) then
! Subprogram not used 
! Subprogram not used             alvdfns(i,j) = albsnowv
! Subprogram not used             alidfns(i,j) = albsnowi
! Subprogram not used 
! Subprogram not used             ! snow on ice, temperature dependence
! Subprogram not used             alvdfns(i,j) = alvdfns(i,j) - dalb_mltv*fT
! Subprogram not used             alidfns(i,j) = alidfns(i,j) - dalb_mlti*fT
! Subprogram not used 
! Subprogram not used          endif                  ! hs > puny
! Subprogram not used 
! Subprogram not used          ! direct albedos (same as diffuse for now)
! Subprogram not used          alvdrni(i,j) = alvdfni(i,j)
! Subprogram not used          alidrni(i,j) = alidfni(i,j)
! Subprogram not used          alvdrns(i,j) = alvdfns(i,j)
! Subprogram not used          alidrns(i,j) = alidfns(i,j)
! Subprogram not used 
! Subprogram not used 
! Subprogram not used          ! fractional area of snow cover
! Subprogram not used          if (hs > puny) then
! Subprogram not used             asnow = hs / (hs + snowpatch)
! Subprogram not used          else
! Subprogram not used             asnow = c0
! Subprogram not used          endif
! Subprogram not used 
! Subprogram not used          ! combine ice and snow albedos (for coupler)
! Subprogram not used          alvdfn(i,j) = alvdfni(i,j)*(c1-asnow) + &
! Subprogram not used                        alvdfns(i,j)*asnow
! Subprogram not used          alidfn(i,j) = alidfni(i,j)*(c1-asnow) + &
! Subprogram not used                        alidfns(i,j)*asnow
! Subprogram not used          alvdrn(i,j) = alvdrni(i,j)*(c1-asnow) + &
! Subprogram not used                        alvdrns(i,j)*asnow
! Subprogram not used          alidrn(i,j) = alidrni(i,j)*(c1-asnow) + &
! Subprogram not used                        alidrns(i,j)*asnow
! Subprogram not used 
! Subprogram not used          ! save ice and snow albedos (for history)
! Subprogram not used          albin(i,j) = awtvdr*alvdrni(i,j) + awtidr*alidrni(i,j) &
! Subprogram not used                     + awtvdf*alvdfni(i,j) + awtidf*alidfni(i,j) 
! Subprogram not used          albsn(i,j) = awtvdr*alvdrns(i,j) + awtidr*alidrns(i,j) &
! Subprogram not used                     + awtvdf*alvdfns(i,j) + awtidf*alidfns(i,j) 
! Subprogram not used 
! Subprogram not used       enddo                     ! ij
! Subprogram not used 
! Subprogram not used       end subroutine compute_albedos
...
! !INTERFACE:
!
! Subprogram not used       subroutine constant_albedos (nx_block, ny_block, &
! Subprogram not used                                   icells,             &
! Subprogram not used                                   indxi,    indxj,    &
! Subprogram not used                                   aicen,              &
! Subprogram not used                                   vsnon,    Tsfcn,    &
...
! Subprogram not used !
! Subprogram not used       real (kind=dbl_kind), parameter :: &
! Subprogram not used          warmice  = 0.68_dbl_kind, &
! Subprogram not used          coldice  = 0.70_dbl_kind, &
! Subprogram not used          warmsnow = 0.77_dbl_kind, &
! Subprogram not used          coldsnow = 0.81_dbl_kind
! Subprogram not used 
! Subprogram not used       integer (kind=int_kind) :: &
! Subprogram not used          i, j, n
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used          if (hs > puny) then
! Subprogram not used             ! snow, temperature dependence
! Subprogram not used             if (Tsfcn(i,j) >= -c2*puny) then
! Subprogram not used                alvdfn(i,j) = warmsnow
! Subprogram not used                alidfn(i,j) = warmsnow
! Subprogram not used             else
! Subprogram not used                alvdfn(i,j) = coldsnow
! Subprogram not used                alidfn(i,j) = coldsnow
! Subprogram not used             endif
! Subprogram not used          else      ! hs < puny
! Subprogram not used             ! bare ice, temperature dependence
! Subprogram not used             if (Tsfcn(i,j) >= -c2*puny) then
! Subprogram not used                alvdfn(i,j) = warmice
! Subprogram not used                alidfn(i,j) = warmice
! Subprogram not used             else
! Subprogram not used                alvdfn(i,j) = coldice
! Subprogram not used                alidfn(i,j) = coldice
! Subprogram not used             endif
! Subprogram not used          endif                  ! hs > puny
! Subprogram not used 
! Subprogram not used          ! direct albedos (same as diffuse for now)
! Subprogram not used          alvdrn (i,j) = alvdfn(i,j)
! Subprogram not used          alidrn (i,j) = alidfn(i,j)
! Subprogram not used 
! Subprogram not used          alvdrni(i,j) = alvdrn(i,j)
! Subprogram not used          alidrni(i,j) = alidrn(i,j)
! Subprogram not used          alvdrns(i,j) = alvdrn(i,j)
! Subprogram not used          alidrns(i,j) = alidrn(i,j)
! Subprogram not used          alvdfni(i,j) = alvdfn(i,j)
! Subprogram not used          alidfni(i,j) = alidfn(i,j)
! Subprogram not used          alvdfns(i,j) = alvdfn(i,j)
! Subprogram not used          alidfns(i,j) = alidfn(i,j)
! Subprogram not used 
! Subprogram not used          ! save ice and snow albedos (for history)
! Subprogram not used          albin(i,j) = awtvdr*alvdrni(i,j) + awtidr*alidrni(i,j) &
! Subprogram not used                     + awtvdf*alvdfni(i,j) + awtidf*alidfni(i,j) 
...
! Subprogram not used       enddo                     ! ij
! Subprogram not used 
! Subprogram not used       end subroutine constant_albedos
...
! !INTERFACE:
!
! Subprogram not used       subroutine absorbed_solar (nx_block, ny_block, &
! Subprogram not used                                  icells,             &
! Subprogram not used                                  indxi,    indxj,    &
! Subprogram not used                                  aicen,              &
! Subprogram not used                                  vicen,    vsnon,    &
...
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used 	use ice_therm_vertical, only: heat_capacity
! Subprogram not used !
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used !
! Subprogram not used       integer (kind=int_kind), intent(in) :: &
...
! Subprogram not used          vicen       , & ! ice volume
! Subprogram not used          vsnon       , & ! snow volume
! Subprogram not used          swvdr       , & ! sw down, visible, direct  (W/m^2)
! Subprogram not used          swvdf       , & ! sw down, visible, diffuse (W/m^2)
! Subprogram not used          swidr       , & ! sw down, near IR, direct  (W/m^2)
! Subprogram not used          swidf       , & ! sw down, near IR, diffuse (W/m^2)
! Subprogram not used          alvdrni     , & ! visible, direct albedo,ice
! Subprogram not used          alidrni     , & ! near-ir, direct albedo,ice
! Subprogram not used          alvdfni     , & ! visible, diffuse albedo,ice
! Subprogram not used          alidfni     , & ! near-ir, diffuse albedo,ice
! Subprogram not used          alvdrns     , & ! visible, direct albedo, snow
! Subprogram not used          alidrns     , & ! near-ir, direct albedo, snow
! Subprogram not used          alvdfns     , & ! visible, diffuse albedo, snow
! Subprogram not used          alidfns         ! near-ir, diffuse albedo, snow
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block), &
! Subprogram not used          intent(out):: &
! Subprogram not used          fswsfc      , & ! SW absorbed at ice/snow surface (W m-2)
...
! Subprogram not used !
! Subprogram not used       real (kind=dbl_kind), parameter :: &
! Subprogram not used          i0vis = 0.70_dbl_kind  ! fraction of penetrating solar rad (visible)
! Subprogram not used 
! Subprogram not used       integer (kind=int_kind) :: &
...
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block) :: &
! Subprogram not used          fswpen      , & ! SW penetrating beneath surface (W m-2)
! Subprogram not used          trantop     , & ! transmitted frac of penetrating SW at layer top
! Subprogram not used          tranbot         ! transmitted frac of penetrating SW at layer bot
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind) :: &
! Subprogram not used          swabs       , & ! net SW down at surface (W m-2)
! Subprogram not used          swabsv      , & ! swabs in vis (wvlngth < 700nm)  (W/m^2)
! Subprogram not used          swabsi      , & ! swabs in nir (wvlngth > 700nm)  (W/m^2)
! Subprogram not used          fswpenvdr   , & ! penetrating SW, vis direct
! Subprogram not used          fswpenvdf   , & ! penetrating SW, vis diffuse
! Subprogram not used          hi          , & ! ice thickness (m)
! Subprogram not used          hs          , & ! snow thickness (m)
! Subprogram not used          hilyr       , & ! ice layer thickness
! Subprogram not used          asnow           ! fractional area of snow cover
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
...
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used       rnilyr = real(nilyr,kind=dbl_kind)
! Subprogram not used 
! Subprogram not used       do j = 1, ny_block
! Subprogram not used       do i = 1, nx_block
! Subprogram not used          fswsfc (i,j) = c0
! Subprogram not used          fswint (i,j) = c0
! Subprogram not used          fswthru(i,j) = c0
! Subprogram not used          fswpen (i,j) = c0
! Subprogram not used          trantop(i,j) = c0
! Subprogram not used          tranbot(i,j) = c0
! Subprogram not used       enddo
! Subprogram not used       enddo
! Subprogram not used       Iswabs (:,:,:) = c0
! Subprogram not used 
! Subprogram not used       do ij = 1, icells
! Subprogram not used          i = indxi(ij)
! Subprogram not used          j = indxj(ij)
...
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! Fractional snow cover
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used          if (hs > puny) then
! Subprogram not used             asnow = hs / (hs + snowpatch)
! Subprogram not used          else
...
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! Shortwave flux absorbed at surface, absorbed internally,
! Subprogram not used       !  and penetrating to mixed layer.
! Subprogram not used       ! This parameterization assumes that all IR is absorbed at the
! Subprogram not used       !  surface; only visible is absorbed in the ice interior or
! Subprogram not used       !  transmitted to the ocean.
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used          swabsv  = swvdr(i,j) * ( (c1-alvdrni(i,j))*(c1-asnow) &
! Subprogram not used                                 + (c1-alvdrns(i,j))*asnow ) &
! Subprogram not used                  + swvdf(i,j) * ( (c1-alvdfni(i,j))*(c1-asnow) &
! Subprogram not used                                 + (c1-alvdfns(i,j))*asnow )
! Subprogram not used 
! Subprogram not used          swabsi  = swidr(i,j) * ( (c1-alidrni(i,j))*(c1-asnow) &
! Subprogram not used                                 + (c1-alidrns(i,j))*asnow ) &
! Subprogram not used                  + swidf(i,j) * ( (c1-alidfni(i,j))*(c1-asnow) &
! Subprogram not used                                 + (c1-alidfns(i,j))*asnow )
! Subprogram not used 
! Subprogram not used          swabs   = swabsv + swabsi
! Subprogram not used 
! Subprogram not used          fswpenvdr = swvdr(i,j) * (c1-alvdrni(i,j)) * (c1-asnow) * i0vis
! Subprogram not used          fswpenvdf = swvdf(i,j) * (c1-alvdfni(i,j)) * (c1-asnow) * i0vis
! Subprogram not used 
! Subprogram not used           ! no penetrating radiation in near IR
! Subprogram not used !         fswpenidr = swidr(i,j) * (c1-alidrni(i,j)) * (c1-asnow) * i0nir
! Subprogram not used !         fswpenidf = swidf(i,j) * (c1-alidfni(i,j)) * (c1-asnow) * i0nir  
! Subprogram not used 
! Subprogram not used          fswpen(i,j) = fswpenvdr + fswpenvdf
! Subprogram not used                       
! Subprogram not used          fswsfc(i,j) = swabs - fswpen(i,j)
! Subprogram not used 
! Subprogram not used          trantop(i,j) = c1  ! transmittance at top of ice
! Subprogram not used 
! Subprogram not used       enddo                     ! ij
! Subprogram not used 
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used       ! penetrating SW absorbed in each ice layer
! Subprogram not used       !-----------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used             hi  = vicen(i,j) / aicen(i,j)
! Subprogram not used             hilyr = hi / rnilyr
! Subprogram not used 
! Subprogram not used             tranbot(i,j) = exp (-kappav * hilyr * real(k,kind=dbl_kind))
! Subprogram not used             Iswabs(i,j,k) = fswpen(i,j) * (trantop(i,j)-tranbot(i,j))
! Subprogram not used 
! Subprogram not used             ! bottom of layer k = top of layer k+1
! Subprogram not used             trantop(i,j) = tranbot(i,j)
! Subprogram not used 
! Subprogram not used          enddo                  ! ij
...
! Subprogram not used          j = indxj(ij)
! Subprogram not used 
! Subprogram not used          ! SW penetrating thru ice into ocean
! Subprogram not used          fswthru(i,j) = fswpen(i,j) * tranbot(i,j)
! Subprogram not used 
! Subprogram not used          ! SW absorbed in ice interior
! Subprogram not used          fswint(i,j)  = fswpen(i,j) - fswthru(i,j)
! Subprogram not used 
! Subprogram not used       enddo                     ! ij
! Subprogram not used 
! Subprogram not used       !----------------------------------------------------------------
! Subprogram not used       ! if zero-layer model (no heat capacity), no SW is absorbed in ice
! Subprogram not used       ! interior, so add to surface absorption
! Subprogram not used       !----------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used            j = indxj(ij)
! Subprogram not used 
! Subprogram not used            ! SW absorbed at snow/ice surface
! Subprogram not used            fswsfc(i,j) = fswsfc(i,j) + fswint(i,j)
! Subprogram not used 
! Subprogram not used            ! SW absorbed in ice interior (nilyr = 1)
! Subprogram not used            fswint(i,j)   = c0
! Subprogram not used            Iswabs(i,j,1) = c0
! Subprogram not used 
! Subprogram not used         enddo                     ! ij
! Subprogram not used 
! Subprogram not used       endif                       ! heat_capacity
! Subprogram not used 
! Subprogram not used       end subroutine absorbed_solar
...
!    ---------------------            ---------------------  0
!                                  0  \\\   snow SSL    \\!       snow layer 1                  ---------------------  1
!                                  1    rest of snow layer
!    +++++++++++++++++++++            +++++++++++++++++++++  2
!                                  2  \\\ sea ice SSL   \\!      sea ice layer 1                ---------------------  3
!                                  3      sea ice  DL
!    ---------------------            ---------------------  4
!
...
! !INTERFACE:
!
! Subprogram not used       subroutine shortwave_dEdd_set_pond(nx_block, ny_block, &
! Subprogram not used                                          icells,             &
! Subprogram not used                                          indxi,    indxj,    &
! Subprogram not used                                          aice,     Tsfc,     &
! Subprogram not used                                          fs,       fp,       &
! Subprogram not used                                          hp)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !
! Subprogram not used !   Set pond fraction and depth diagnostically for
! Subprogram not used !   the Delta-Eddington solar radiation method.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !
! Subprogram not used ! author:  Bruce P. Briegleb, NCAR 
! Subprogram not used !          8 February 2007
! Subprogram not used !
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used !
! Subprogram not used       integer (kind=int_kind), &
...
! Subprogram not used          Tsfc   , & ! surface temperature
! Subprogram not used          fs         ! horizontal coverage of snow
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), dimension (nx_block,ny_block), &
! Subprogram not used          intent(out) :: &
! Subprogram not used          fp     , & ! pond fractional coverage (0 to 1)
! Subprogram not used          hp         ! pond depth (m)
! Subprogram not used 
! Subprogram not used !      
! Subprogram not used !EOP
! Subprogram not used ! 
! Subprogram not used ! !LOCAL PARAMETERS:
! Subprogram not used !
! Subprogram not used 
! Subprogram not used       integer (kind=int_kind) :: &
! Subprogram not used          i   , & ! longitude index
! Subprogram not used          j   , & ! latitude index
! Subprogram not used          ij      ! horizontal index, combines i and j loops
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind) :: &
! Subprogram not used          fT  , & ! piecewise linear function of surface temperature
...
! Subprogram not used 
! Subprogram not used       real (kind=dbl_kind), parameter :: &
! Subprogram not used          dT_mlt    = c1   ! change in temp for pond fraction and depth
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used       do j = 1, ny_block
! Subprogram not used       do i = 1, nx_block
! Subprogram not used          fp(i,j) = c0
! Subprogram not used          hp(i,j) = c0
! Subprogram not used       enddo
! Subprogram not used       enddo
! Subprogram not used 
! Subprogram not used       ! find pond fraction and depth for ice points
! Subprogram not used !DIR$ CONCURRENT !Cray
! Subprogram not used !cdir nodep      !NEC
! Subprogram not used !ocl novrec      !Fujitsu
! Subprogram not used       do ij = 1, icells
...
! Subprogram not used            ! bare ice, temperature dependence
! Subprogram not used            dTs = Timelt - Tsfc(i,j)
! Subprogram not used            fT  = -min(dTs/dT_mlt-c1,c0)
! Subprogram not used            ! pond
! Subprogram not used            fp(i,j) = 0.3_dbl_kind*fT*(c1-fs(i,j))
! Subprogram not used            hp(i,j) = 0.3_dbl_kind*fT*(c1-fs(i,j))
! Subprogram not used          endif
! Subprogram not used       enddo          ! ij
! Subprogram not used 
! Subprogram not used       end subroutine shortwave_dEdd_set_pond
