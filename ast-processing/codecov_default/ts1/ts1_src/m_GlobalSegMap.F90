...
! Subprogram not used  subroutine initp1_(GSMap, comp_id, ngseg, gsize, all_arrays)
! Subprogram not used 
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used       integer,intent(in)              :: comp_id    ! component model ID
! Subprogram not used       integer,intent(in)              :: ngseg      ! global no. of segments
! Subprogram not used       integer,intent(in)              :: gsize      ! global vector size
! Subprogram not used       integer,dimension(:),intent(in) :: all_arrays ! packed array of length
! Subprogram not used                                                     ! 3*ngseg containing (in
! Subprogram not used                                                     ! this order):  start(:),
! Subprogram not used                                                     ! length(:), and pe_loc(:)
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used       type(GlobalSegMap),intent(out)  :: GSMap      ! Output GlobalSegMap
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	24Feb01 - J.W. Larson <larson@mcs.anl.gov> - Initial version.
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::initp1_'
! Subprogram not used   integer :: ierr, n
! Subprogram not used 
! Subprogram not used        ! Argument Checks -- Is comp_id positive?
! Subprogram not used 
! Subprogram not used   if(comp_id <= 0) then
! Subprogram not used      call die(myname_,'non-positive value of comp_id',comp_id)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Is gsize positive?
! Subprogram not used 
! Subprogram not used   if(gsize <= 0) then
! Subprogram not used      call die(myname_,'non-positive value of gsize',gsize)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used 
! Subprogram not used        ! Is ngseg positive?
! Subprogram not used 
! Subprogram not used   if(ngseg <= 0) then
! Subprogram not used      call die(myname_,'non-positive value of ngseg',ngseg)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Is the array all_arrays(:) the right length?
! Subprogram not used 
! Subprogram not used   if(size(all_arrays) /= 3*ngseg) then
! Subprogram not used      call die(myname_,'all_arrays(:)/3*ngseg size mismatch',ngseg)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Allocate index and location arrays for GSMap:
! Subprogram not used 
! Subprogram not used   allocate(GSMap%start(ngseg), GSMap%length(ngseg), GSMap%pe_loc(ngseg), &
! Subprogram not used            stat = ierr)
! Subprogram not used   if (ierr /= 0) then
! Subprogram not used      call die(myname_,'allocate(GSMap%start...',ngseg)
! Subprogram not used   endif
! Subprogram not used        
! Subprogram not used        ! Assign the components of GSMap:
! Subprogram not used 
! Subprogram not used   GSMap%comp_id = comp_id
! Subprogram not used   GSMap%ngseg = ngseg
! Subprogram not used   GSMap%gsize = gsize
! Subprogram not used 
! Subprogram not used   do n=1,ngseg
! Subprogram not used      GSMap%start(n) = all_arrays(n)
! Subprogram not used      GSMap%length(n) = all_arrays(ngseg + n)
! Subprogram not used      GSMap%pe_loc(n) = all_arrays(2*ngseg + n)
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used   end subroutine initp1_     
...
! Subprogram not used  subroutine initp0_(GSMap, comp_id, ngseg, gsize)
! Subprogram not used 
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used       integer,intent(in)              :: comp_id ! component model ID
! Subprogram not used       integer,intent(in)              :: ngseg   ! global number of segments
! Subprogram not used       integer,intent(in)              :: gsize   ! global vector size
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 13Aug03 - J.W. Larson <larson@mcs.anl.gov> - Initial version.
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::initp0_'
! Subprogram not used 
! Subprogram not used   integer :: ierr
! Subprogram not used 
! Subprogram not used   nullify(GSMap%start)
! Subprogram not used   nullify(GSMap%length)
! Subprogram not used   nullify(GSMap%pe_loc)
! Subprogram not used 
! Subprogram not used   GSMap%comp_id = comp_id
! Subprogram not used   GSMap%ngseg = ngseg
! Subprogram not used   GSMap%gsize = gsize
...
! Subprogram not used            stat=ierr)
! Subprogram not used   if(ierr /= 0) then
! Subprogram not used      write(stderr,'(3a,i8)') myname_, &
! Subprogram not used 	  ':: FATAL--allocate of segment information storage space failed.', &
! Subprogram not used 	  '  ierr = ',ierr
! Subprogram not used      call die(myname_)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used  end subroutine initp0_
...
! Subprogram not used     subroutine rank1_(GSMap, i_g, rank)
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
...
! Subprogram not used       integer,            intent(in)  :: i_g	 ! a global index
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used       integer,            intent(out) :: rank    ! the pe on which this
! Subprogram not used                                                  ! element resides
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	29Sep00 - J.W. Larson <larson@mcs.anl.gov> - initial prototype
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::rank1_'
! Subprogram not used   integer :: i,ilc,ile
! Subprogram not used 
! Subprogram not used         ! Initially, set the rank to -1 (invalid).
! Subprogram not used   rank=-1	
! Subprogram not used 
! Subprogram not used   do i=1,size(GSMap%start)
! Subprogram not used     ilc = GSMap%start(i)
! Subprogram not used     ile = ilc + GSMap%length(i) - 1
! Subprogram not used 
! Subprogram not used 		! If i_g in [ilc,ile].  Note that i_g := [1:..]
! Subprogram not used 
! Subprogram not used     if(ilc <= i_g .and. i_g <= ile) then
! Subprogram not used       rank = GSMap%pe_loc(i)
! Subprogram not used       return
! Subprogram not used     endif
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used  end subroutine rank1_
...
! Subprogram not used     subroutine rankm_(GSMap, i_g, num_loc, rank)
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
...
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used       integer,            intent(out) :: num_loc ! the number of processes
! Subprogram not used                                                  ! which own element i_g
! Subprogram not used       integer, dimension(:), pointer  :: rank    ! the process(es) on which 
! Subprogram not used                                                  ! element i_g resides
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	29Sep00 - J.W. Larson <larson@mcs.anl.gov> - initial prototype
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::rankm_'
! Subprogram not used   integer :: i, ilc, ile, ier, n
! Subprogram not used 
! Subprogram not used         ! First sweep:  determine the number of processes num_loc 
! Subprogram not used         ! that own the given datum:
! Subprogram not used 
! Subprogram not used   num_loc = 0
! Subprogram not used 
! Subprogram not used   do i=1,size(GSMap%start)
! Subprogram not used 
! Subprogram not used     ilc = GSMap%start(i)
...
! Subprogram not used 
! Subprogram not used     if(ilc <= i_g .and. i_g <= ile) then
! Subprogram not used       num_loc = num_loc + 1
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used   if(num_loc == 0) then
! Subprogram not used 
! Subprogram not used         ! If i_g is nowhere to be found in GSMap, set num_loc to
! Subprogram not used         ! unity and return a null value for rank
! Subprogram not used 
! Subprogram not used      num_loc = 1
! Subprogram not used      allocate(rank(num_loc), stat=ier)
! Subprogram not used      rank = -1	! null value
! Subprogram not used      return
! Subprogram not used 
! Subprogram not used   else
! Subprogram not used         ! Allocate output array rank(1:num_loc)
! Subprogram not used 
! Subprogram not used      allocate(rank(num_loc), stat=ier)
! Subprogram not used 
! Subprogram not used         ! Second sweep:  fill in the entries to rank(:)
! Subprogram not used 
! Subprogram not used      n = 0 ! counter
! Subprogram not used 
! Subprogram not used      do i=1,size(GSMap%start)
! Subprogram not used 
! Subprogram not used 	ilc = GSMap%start(i)
...
! Subprogram not used 	   rank(n) = GSMap%pe_loc(i)
! Subprogram not used 	endif
! Subprogram not used 
! Subprogram not used      end do
! Subprogram not used 
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used  end subroutine rankm_
...
! Subprogram not used     subroutine Sort_(GSMap, key1, key2, perm)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die ,          only : die
! Subprogram not used       use m_SortingTools , only : IndexSet
! Subprogram not used       use m_SortingTools , only : IndexSort
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used       type(GlobalSegMap),    intent(in)           :: GSMap ! input GlobalSegMap
! Subprogram not used       integer, dimension(:), intent(in)           :: key1  ! first sort key
! Subprogram not used       integer, dimension(:), intent(in), optional :: key2  ! second sort key
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used       integer, dimension(:), pointer :: perm    ! output index permutation
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 	02Feb01 - J.W. Larson <larson@mcs.anl.gov> - initial version
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::Sort_'
! Subprogram not used 
! Subprogram not used   integer :: ierr, length
! Subprogram not used 
! Subprogram not used   length = ngseg_(GSMap)
! Subprogram not used 
! Subprogram not used         ! Argument checking.  are key1 and key2 (if supplied) the
! Subprogram not used         ! same length as the components of GSMap?  If not, stop with
! Subprogram not used         ! an error.
! Subprogram not used 
! Subprogram not used   ierr = 0
! Subprogram not used 
! Subprogram not used   if(size(key1) /= length) then
! Subprogram not used      ierr = 1
! Subprogram not used      call die(myname_,'key1 GSMap size mismatch',ierr)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   if(present(key2)) then
! Subprogram not used      if(size(key2) /= length) then
! Subprogram not used         ierr = 2
! Subprogram not used 	call die(myname_,'key2 GSMap size mismatch',ierr)
! Subprogram not used      endif
! Subprogram not used      if(size(key1) /= size(key2)) then
! Subprogram not used         ierr = 3
! Subprogram not used 	call die(myname_,'key1 key2 size mismatch',ierr)
! Subprogram not used      endif
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used         ! allocate space for permutation array perm(:)
! Subprogram not used 
! Subprogram not used   allocate(perm(length), stat=ierr)
! Subprogram not used   if(ierr /= 0) call die(myname_,'allocate(perm)',ierr)
! Subprogram not used 
! Subprogram not used         ! Initialize perm(i)=i, for i=1,length
! Subprogram not used 
! Subprogram not used   call IndexSet(perm)
! Subprogram not used  
! Subprogram not used         ! Index permutation is achieved by successive calls to IndexSort(),
! Subprogram not used         ! with the keys supplied one at a time in the order reversed from
! Subprogram not used         ! the desired sort order.
! Subprogram not used 
! Subprogram not used   if(present(key2)) then
! Subprogram not used      call IndexSort(length, perm, key2, descend=.false.)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   call IndexSort(length, perm, key1, descend=.false.)
! Subprogram not used 
! Subprogram not used         ! Yes, it is that simple.  The desired index permutation is now
! Subprogram not used         ! stored in perm(:)
! Subprogram not used 
...
! Subprogram not used     subroutine PermuteInPlace_(GSMap, perm)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die ,          only : die
! Subprogram not used       use m_SortingTools , only : Permute
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used       type(GlobalSegMap), intent(inout) :: GSMap
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !       02Feb01 - J.W. Larson <larson@mcs.anl.gov> - initial version.
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::PermuteInPlace_'
! Subprogram not used 
! Subprogram not used   integer :: length, ierr
! Subprogram not used 
! Subprogram not used   length = ngseg_(GSMap)
! Subprogram not used 
! Subprogram not used         ! Argument checking.  Do the components of GSMap
! Subprogram not used         ! (e.g. GSMap%start) have the same length as the
! Subprogram not used         ! permutation array perm?  If not, stop with an error.
! Subprogram not used 
! Subprogram not used   ierr = 0
! Subprogram not used 
! Subprogram not used   if(size(perm) /= length) then
! Subprogram not used      ierr = 1
! Subprogram not used      call die(myname_,'perm GSMap size mismatch',ierr)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used         ! In-place index permutation using perm(:) :
! Subprogram not used 
! Subprogram not used   call Permute(GSMap%start,perm,length)
! Subprogram not used   call Permute(GSMap%length,perm,length)
! Subprogram not used   call Permute(GSMap%pe_loc,perm,length)
! Subprogram not used 
! Subprogram not used         ! Now, the components of GSMap are ordered according to
! Subprogram not used         ! perm(:).
! Subprogram not used 
! Subprogram not used  end subroutine PermuteInPlace_
...
! Subprogram not used     subroutine SortPermuteInPlace_(GSMap, key1, key2)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die ,          only : die
...
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used 
! Subprogram not used       integer, dimension(:), intent(in)           :: key1
! Subprogram not used       integer, dimension(:), intent(in), optional :: key2
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS: 
! Subprogram not used 
! Subprogram not used       type(GlobalSegMap),    intent(inout)        :: GSMap
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::SortPermuteInPlace_'
! Subprogram not used 
! Subprogram not used   integer :: length, ierr
...
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used         ! Generate desired index permutation:      
! Subprogram not used 
! Subprogram not used   if(present(key2)) then
! Subprogram not used      call Sort_(GSMap, key1, key2, perm)
! Subprogram not used   else
! Subprogram not used      call Sort_(GSMap, key1=key1, perm=perm)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used         ! Apply index permutation:      
! Subprogram not used 
! Subprogram not used   call PermuteInPlace_(GSMap, perm)
! Subprogram not used 
! Subprogram not used         ! Now the components of GSMap have been re-ordered.
! Subprogram not used         ! Deallocate the index permutation array perm(:)
! Subprogram not used 
! Subprogram not used   deallocate(perm, stat=ierr)
! Subprogram not used   if(ierr /= 0) call die(myname_,'deallocate(perm...)',ierr)
! Subprogram not used 
! Subprogram not used  end subroutine SortPermuteInPlace_
