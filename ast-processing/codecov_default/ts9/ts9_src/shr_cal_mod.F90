...
! Subprogram not used integer function shr_cal_numDaysInMonth(year,month,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: year,month  ! calendar year,month
! Subprogram not used    character(*)        ,intent(in)  :: calendar  ! calendar type
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    type(ESMF_time) :: time1,time2
! Subprogram not used    type(ESMF_timeInterval) :: timeint
! Subprogram not used    type(ESMF_CALKIND_FLAG) :: calkind
! Subprogram not used    integer(SHR_KIND_IN) :: eday
! Subprogram not used    character(len=shr_cal_calMaxLen) :: lcalendar
! Subprogram not used    integer :: rc
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_numDaysInMonth)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    lcalendar = shr_cal_calendarName(calendar)
! Subprogram not used 
! Subprogram not used    calkind = ESMF_CALKIND_NOLEAP
! Subprogram not used    if (trim(lcalendar) == trim(shr_cal_gregorian)) then
! Subprogram not used       calkind = ESMF_CALKIND_GREGORIAN
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    call ESMF_TimeSet(time1,yy=year,mm=month,dd=1,s=0,calkindflag=calkind,rc=rc)
! Subprogram not used    if(rc /= ESMF_SUCCESS) call ESMF_Finalize(rc=rc, endflag=ESMF_END_ABORT)
! Subprogram not used    if (month < 12) then
! Subprogram not used       call ESMF_TimeSet(time2,yy=year,mm=month+1,dd=1,s=0,calkindflag=calkind,rc=rc)
! Subprogram not used       if(rc /= ESMF_SUCCESS) call ESMF_Finalize(rc=rc, endflag=ESMF_END_ABORT)
! Subprogram not used    else
! Subprogram not used       call ESMF_TimeSet(time2,yy=year+1,mm=1,dd=1,s=0,calkindflag=calkind,rc=rc)
! Subprogram not used       if(rc /= ESMF_SUCCESS) call ESMF_Finalize(rc=rc, endflag=ESMF_END_ABORT)
! Subprogram not used    endif
! Subprogram not used    timeint = time2-time1
! Subprogram not used    call ESMF_TimeIntervalGet(timeint,StartTimeIn=time1,d=eday)
! Subprogram not used    shr_cal_numDaysInMonth = eday
! Subprogram not used 
! Subprogram not used end function shr_cal_numDaysInMonth
...
! Subprogram not used integer function shr_cal_numDaysInYear(year,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: year      ! calendar year
! Subprogram not used    character(*)        ,intent(in)  :: calendar  ! calendar type
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
...
! Subprogram not used    character(len=shr_cal_calMaxLen) :: lcalendar
! Subprogram not used    integer :: rc
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_numDaysInYear)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    call ESMF_TimeSet(time1,yy=year,mm=1,dd=1,s=0,calkindflag=calkind,rc=rc)
! Subprogram not used    if(rc /= ESMF_SUCCESS) call ESMF_Finalize(rc=rc, endflag=ESMF_END_ABORT)
! Subprogram not used    call ESMF_TimeSet(time2,yy=year+1,mm=1,dd=1,s=0,calkindflag=calkind,rc=rc)
! Subprogram not used    if(rc /= ESMF_SUCCESS) call ESMF_Finalize(rc=rc, endflag=ESMF_END_ABORT)
! Subprogram not used    timeint = time2-time1
! Subprogram not used    call ESMF_TimeIntervalGet(timeint,StartTimeIn=time1,d=eday)
! Subprogram not used    shr_cal_numDaysInYear = eday
! Subprogram not used 
! Subprogram not used end function shr_cal_numDaysInYear
...
! Subprogram not used integer function shr_cal_elapsDaysStrtMonth(year,month,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_elapsDaysStrtMonth)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    shr_cal_elapsDaysStrtMonth = 0
! Subprogram not used    do k = 1,month-1
! Subprogram not used       shr_cal_elapsDaysStrtMonth = shr_cal_elapsDaysStrtMonth + &
! Subprogram not used                                    shr_cal_numDaysInMonth(year,k,calendar)
! Subprogram not used    enddo
! Subprogram not used 
! Subprogram not used end function shr_cal_elapsDaysStrtMonth
...
! Subprogram not used subroutine shr_cal_date2julian(date,sec,jday,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: date            ! coded (yyyymmdd) calendar date
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: sec             ! seconds
! Subprogram not used    real   (SHR_KIND_R8),intent(out) :: jday            ! julian day of year
! Subprogram not used    character(*)        ,intent(in)  :: calendar        ! calendar type
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    integer(SHR_KIND_IN) :: year,month,day
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_date2julian)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! NOTE:
! Subprogram not used !   julian day of year since yy-01-01-00000
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug > 1) write(s_logunit,*) trim(subname),'_a ',date,sec
! Subprogram not used 
! Subprogram not used    call shr_cal_date2ymd(date,year,month,day)
! Subprogram not used    call shr_cal_ymd2julian(year,month,day,sec,jday,calendar)
! Subprogram not used 
! Subprogram not used    if (debug > 1) write(s_logunit,*) trim(subname),'_b ',jday
! Subprogram not used 
! Subprogram not used end subroutine shr_cal_date2julian
...
! Subprogram not used subroutine shr_cal_ymd2julian(year,month,day,sec,jday,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: year            ! year
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: month           ! month
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: day             ! day
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: sec             ! seconds
! Subprogram not used    real   (SHR_KIND_R8),intent(out) :: jday            ! julian day of year
! Subprogram not used    character(*)        ,intent(in)  :: calendar        ! calendar type
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_ymd2julian)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! NOTE:
! Subprogram not used !   julian day of year since yy-01-01-000000
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (debug > 1) write(s_logunit,*) trim(subname),'_a ',year,month,day,sec
! Subprogram not used 
! Subprogram not used    if (.not. shr_cal_validYMD(year,month,day,calendar)) then
! Subprogram not used       write(s_logunit,*) trim(subname),' ERROR: invalid ymd',year,month,day
! Subprogram not used       call shr_sys_abort(trim(subname)//' ERROR: invalid ymd')
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    jday = shr_cal_elapsDaysStrtMonth(year,month,calendar) + day + sec/SHR_CONST_CDAY
! Subprogram not used 
! Subprogram not used    if (debug > 1) write(s_logunit,*) trim(subname),'_b ',jday
! Subprogram not used 
! Subprogram not used end subroutine shr_cal_ymd2julian
...
! Subprogram not used subroutine shr_cal_advDateInt(delta,units,dateIN,secIN,dateOUT,secOUT,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN) ,intent(in)  :: delta     ! time increment
! Subprogram not used    character(*)         ,intent(in)  :: units     ! units of increment
! Subprogram not used    integer(SHR_KIND_IN) ,intent(in)  :: dateIN    ! base date, yyyymmdd
! Subprogram not used    integer(SHR_KIND_IN) ,intent(in)  :: secIN     ! base seconds
! Subprogram not used    integer(SHR_KIND_IN) ,intent(out) :: dateOUT   ! new date, yyyymmdd
! Subprogram not used    integer(SHR_KIND_IN) ,intent(out) :: secOUT    ! new seconds
! Subprogram not used    character(*)         ,intent(in)  :: calendar  ! calendar type
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    type(ESMF_time) :: timeIn, timeOut
! Subprogram not used    type(ESMF_timeInterval) :: dt
! Subprogram not used    integer(SHR_KIND_IN) :: year,month,day
! Subprogram not used    character(len=shr_cal_calMaxLen) :: lcalendar
! Subprogram not used    type(ESMF_CALKIND_FLAG) :: calkind
! Subprogram not used 
! Subprogram not used    !--- formats ---
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_advDateInt)"
! Subprogram not used    character(*),parameter :: F00 = "('(shr_cal_advDateInt) ',a,i5)"
! Subprogram not used    character(*),parameter :: F02 = "('(shr_cal_advDateInt) ',a,i8.8,f10.3)"
! Subprogram not used    
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! NOTE:
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    call shr_cal_date2ymd(dateIn,year,month,day)
! Subprogram not used    call ESMF_TimeSet(timeIN,yy=year,mm=month,dd=day,s=secIn,calkindflag=calkind)
! Subprogram not used 
! Subprogram not used    !--- calculate delta-time in seconds ---
! Subprogram not used    if     (trim(units) == 'days'   ) then
! Subprogram not used       call ESMF_TimeIntervalSet(dt,d=delta)
! Subprogram not used    elseif (trim(units) == 'hours'  ) then
! Subprogram not used       call ESMF_TimeIntervalSet(dt,h=delta)
! Subprogram not used    elseif (trim(units) == 'minutes') then
! Subprogram not used       call ESMF_TimeIntervalSet(dt,m=delta)
! Subprogram not used    elseif (trim(units) == 'seconds') then
! Subprogram not used       call ESMF_TimeIntervalSet(dt,s=delta)
! Subprogram not used    else
! Subprogram not used       call shr_sys_abort(trim(subname)//' ERROR: unrecognized time units '//trim(units))
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    timeOut = timeIn + dt
! Subprogram not used 
! Subprogram not used    call ESMF_TimeGet(timeOut,yy=year,mm=month,dd=day,s=secOut)
! Subprogram not used    call shr_cal_ymd2date(year,month,day,dateOut)
! Subprogram not used 
! Subprogram not used    if (debug>0) then
! Subprogram not used       if (s_loglev > 0) write(s_logunit,*) subName," units,delta,calendar=",trim(units),delta,' ',trim(calendar)
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F02) "dateIN ,secIN =",dateIN ,secIN
! Subprogram not used       if (s_loglev > 0) write(s_logunit,F02) "dateOUT,secOUT=",dateOUT,secOUT
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used end subroutine shr_cal_advDateInt
...
! Subprogram not used logical function shr_cal_validDate(date,calendar) 
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: date      ! coded (yyyymmdd) calendar date
! Subprogram not used    character(len=*)    ,intent(in ) :: calendar  ! calendar
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    integer(SHR_KIND_IN) :: year,month,day
! Subprogram not used    integer(SHR_KIND_IN) :: tdate
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_validDate)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    call shr_cal_date2ymd(date,year,month,day)
! Subprogram not used    shr_cal_validDate = shr_cal_validYMD(year,month,day,calendar)
! Subprogram not used 
! Subprogram not used end function shr_cal_validDate
...
! Subprogram not used logical function shr_cal_validYMD(year,month,day,calendar)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: year,month,day  ! year,month,day
! Subprogram not used    character(len=*)    ,intent(in ) :: calendar        ! calendar
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
...
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    shr_cal_validYMD = .true.
! Subprogram not used    if (year  < -999) shr_cal_validYMD = .false.
! Subprogram not used    if (year  > 9999) shr_cal_validYMD = .false.
! Subprogram not used    if (month <    1) shr_cal_validYMD = .false.
! Subprogram not used    if (month >   12) shr_cal_validYMD = .false.
! Subprogram not used    if (day   <    1) shr_cal_validYMD = .false.
! Subprogram not used    if (day   > shr_cal_numDaysInMonth(year,month,calendar)) &
! Subprogram not used                      shr_cal_validYMD = .false.
! Subprogram not used 
! Subprogram not used end function shr_cal_validYMD
...
! Subprogram not used logical function shr_cal_validHMS(hr,min,sec)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer(SHR_KIND_IN),intent(in ) :: hr, min, sec   ! hour, minute, second
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !--- local ---
! Subprogram not used    character(*),parameter :: subName = "(shr_cal_validHMS)"
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    shr_cal_validHMS = .true.
! Subprogram not used    if (hr  <    0) shr_cal_validHMS = .false.
! Subprogram not used    if (hr  >   23) shr_cal_validHMS = .false.
! Subprogram not used    if (min <    0) shr_cal_validHMS = .false.
! Subprogram not used    if (min >   59) shr_cal_validHMS = .false.
! Subprogram not used    if (sec <    0) shr_cal_validHMS = .false.
! Subprogram not used    if (sec >   60) shr_cal_validHMS = .false.
! Subprogram not used 
! Subprogram not used end function shr_cal_validHMS
...
! Subprogram not used subroutine shr_cal_setDebug(level)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used   !--- formats ---
! Subprogram not used   character(*),parameter :: subName =   "(shr_cal_setDebug) "
! Subprogram not used   character(*),parameter :: F00     = "('(shr_cal_setDebug) ',a) "
! Subprogram not used   character(*),parameter :: F01     = "('(shr_cal_setDebug) ',a,i4) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used end subroutine shr_cal_setDebug
...
! Subprogram not used subroutine shr_cal_getDebug(level)
! Subprogram not used 
! Subprogram not used   implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used   !--- formats ---
! Subprogram not used   character(*),parameter :: subName =   "(shr_cal_getDebug) "
! Subprogram not used   character(*),parameter :: F00     = "('(shr_cal_getDebug) ',a) "
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used !
! Subprogram not used !-------------------------------------------------------------------------------
...
! Subprogram not used 
! Subprogram not used end subroutine shr_cal_getDebug
