...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     !-------------------------------------
     if(Debug) print *,"iompi_mod.F90",218,' inside write_mpiio_int offset: ',File%offset
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,"iompi_mod.F90",218,' inside write_mpiio_real offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
!DBG     print *,'TEMPLATE_NAME(write_mpiio_): At the begining of subroutine: ',File%offset
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,"iompi_mod.F90",218,' inside write_mpiio_double offset: ',File%offset
     call MPI_File_set_view(File%fh,File%offset, iodesc%Write%elemTYPE, iodesc%Write%fileTYPE, 'native',File%iosystem%info,ierr)
...
! TYPE int,real,double
 integer function read_mpiio_int (File,IOBUF,varDesc, iodesc) result(ierr)
	...
	File%offset = INT(varDesc%rec-1,kind=PIO_OFFSET)*reclen
     ...
     ! Set file view for distributed array
     !-------------------------------------
     if(Debug) print *,"iompi_mod.F90",288,'IAM: ',File%iosystem%io_rank,' before set_view iodesc%Read%fileTYPE: ', &
...
!DBG     if(Debug) print *,"iompi_mod.F90",292,'IAM: ',File%iosystem%io_rank,' after set_view IODesc%Read%fileTYPE: ', &
!DBG     iodesc%Read%fileTYPE
     ...
     if(Debug) print *,"iompi_mod.F90",301,'IAM: ',File%iosystem%io_rank,'read_mpiio_int: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,"iompi_mod.F90",302,'IAM: ',File%iosystem%io_rank,'read_mpio_int: reclen is: ',reclen
...
!DBG     iodesc%Read%fileTYPE
     ...
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,"iompi_mod.F90",301,'IAM: ',File%iosystem%io_rank,'read_mpiio_real: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,"iompi_mod.F90",302,'IAM: ',File%iosystem%io_rank,'read_mpio_real: reclen is: ',reclen
...
!DBG     iodesc%Read%fileTYPE
     ...
     if(Debug) call MPI_get_count(fstatus,iodesc%Read%elemTYPE,cnt,ierr)
     if(Debug) print *,"iompi_mod.F90",301,'IAM: ',File%iosystem%io_rank,'read_mpiio_double: cnt is: ',iodesc%Read%n_elemTYPE, cnt
     if(Debug) print *,"iompi_mod.F90",302,'IAM: ',File%iosystem%io_rank,'read_mpio_double: reclen is: ',reclen
