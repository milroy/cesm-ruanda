...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine get_cnst_data_ptr(name, state, q, pbuf)
! Subprogram not used 
! Subprogram not used     use tracer_data,   only : get_fld_data, get_fld_ndx
! Subprogram not used     use physconst,     only : mwdry            ! molecular weight dry air ~ kg/kmole
! Subprogram not used     use chem_mods,     only : fix_mass
! Subprogram not used     use mo_chem_utls,  only : get_inv_ndx
...
! Subprogram not used     real(r8), pointer, dimension(:,:) :: q     ! constituent mass mixing ratio
...
! Subprogram not used     integer :: inv_id, idx
! Subprogram not used 
! Subprogram not used     lchnk = state%lchnk
! Subprogram not used     ncol  = state%ncol
! Subprogram not used 
! Subprogram not used     ! make sure the requested constituent can be provided
! Subprogram not used     inv_id = get_inv_ndx(name) 
! Subprogram not used     if (.not. inv_id > 0) then
! Subprogram not used        if (masterproc) then
! Subprogram not used           write(iulog,*) 'get_cnst_data_ptr: '//name//' is not a prescribed tracer constituent'
! Subprogram not used        endif
! Subprogram not used        return
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     call get_fld_ndx( fields, name, idx  )
! Subprogram not used     call get_fld_data( fields, name, data_q(:,:,idx,lchnk), ncol, lchnk, pbuf  )
! Subprogram not used 
! Subprogram not used     data_q(:ncol,:,idx,lchnk) = data_q(:ncol,:,idx,lchnk)*fix_mass(inv_id)/mwdry   ! vmr->mmr
! Subprogram not used     q => data_q(:,:,idx,lchnk)
! Subprogram not used 
! Subprogram not used   end subroutine get_cnst_data_ptr

!-------------------------------------------------------------------

! Subprogram not used   subroutine init_tracer_cnst_restart( piofile )
...
! Subprogram not used 
! Subprogram not used     call init_trc_restart( 'tracer_cnst', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine init_tracer_cnst_restart
!-------------------------------------------------------------------
! Subprogram not used   subroutine write_tracer_cnst_restart( piofile )
...
! Subprogram not used 
! Subprogram not used   end subroutine write_tracer_cnst_restart

!-------------------------------------------------------------------
! Subprogram not used   subroutine read_tracer_cnst_restart( pioFile )
...
! Subprogram not used     type(file_desc_t) :: piofile
! Subprogram not used 
! Subprogram not used     call read_trc_restart( 'tracer_cnst', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine read_tracer_cnst_restart
