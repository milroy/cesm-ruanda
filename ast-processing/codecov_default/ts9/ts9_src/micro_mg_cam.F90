...
! Subprogram not used   subroutine bad_version_endrun
! Subprogram not used     ! Endrun wrapper with a more useful error message.
! Subprogram not used     character(len=128) :: errstring
! Subprogram not used     write(errstring,*) "Invalid version number specified for MG microphysics: ", &
! Subprogram not used          micro_mg_version,".",micro_mg_sub_version
! Subprogram not used     call endrun(errstring)
! Subprogram not used   end subroutine bad_version_endrun
...
! Subprogram not used function micro_mg_cam_implements_cnst(name)
! Subprogram not used 
...
! Subprogram not used   logical :: micro_mg_cam_implements_cnst    ! return value
! Subprogram not used 
! Subprogram not used   ! Local workspace
! Subprogram not used   integer :: m
! Subprogram not used   !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   micro_mg_cam_implements_cnst = any(name == cnst_names)
! Subprogram not used 
! Subprogram not used end function micro_mg_cam_implements_cnst

!===============================================================================

! Subprogram not used subroutine micro_mg_cam_init_cnst(name, q, gcid)
! Subprogram not used 
...
! Subprogram not used   !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used   if (micro_mg_cam_implements_cnst(name)) q = 0.0_r8
! Subprogram not used 
! Subprogram not used end subroutine micro_mg_cam_init_cnst
