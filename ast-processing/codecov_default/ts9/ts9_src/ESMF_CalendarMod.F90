...
! Subprogram not used integer(esmf_kind_i8) function nsecondsinmonth( year,month,calkindflag)
! Subprogram not used   ! Compute number of days in month for year, month, cal
! Subprogram not used   IMPLICIT NONE
! Subprogram not used   INTEGER, INTENT(in) :: year,month
! Subprogram not used   type(ESMF_CalKind_Flag),intent(in) :: calkindflag
! Subprogram not used   ! locals
! Subprogram not used 
! Subprogram not used   nsecondsinmonth = ndaysinmonth(year,month,calkindflag)*86400_ESMF_KIND_I8
! Subprogram not used 
! Subprogram not used END function nsecondsinmonth
