...
! Subprogram not used subroutine wav_run_mct( EClock, cdata, x2d, d2x)
! Subprogram not used 
...
! Subprogram not used    type(mct_aVect)             ,intent(inout) :: x2d        
! Subprogram not used    type(mct_aVect)             ,intent(inout) :: d2x        
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used end subroutine wav_run_mct
