...
! get dimensions of 1 resolution
        plon = get_dyn_grid_parm('plon')
        plat = get_dyn_grid_parm('plat')
...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine get_fld_ndx( flds, field_name, idx  )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     type(trfld), intent(in) :: flds(:)
! Subprogram not used     character(len=*), intent(in) :: field_name
! Subprogram not used     integer, intent(out) :: idx    
! Subprogram not used     integer :: f, nflds
! Subprogram not used 
! Subprogram not used     idx = -1
! Subprogram not used     nflds = size(flds)
! Subprogram not used 
! Subprogram not used     do f = 1, nflds
! Subprogram not used        if ( trim(flds(f)%fldnam) == trim(field_name) ) then
! Subprogram not used           idx = f
! Subprogram not used           return
! Subprogram not used        endif
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used   end subroutine get_fld_ndx
...
!------------------------------------------------------------------------------
!------------------------------------------------------------------------------
! Subprogram not used   subroutine check_files( file, fids, itms, times_found)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     type(trfile),      intent(inout) :: file
! Subprogram not used     type(file_desc_t), intent(out)   :: fids(2) ! ids of files that contains these recs
! Subprogram not used     integer, optional, intent(out)   :: itms(2)
! Subprogram not used     logical, optional, intent(inout) :: times_found
! Subprogram not used 
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     ! 	... local variables
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     logical            :: list_cycled
! Subprogram not used 
! Subprogram not used     list_cycled = .false.
! Subprogram not used 
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used    !        If next time beyond the end of the time list,
! Subprogram not used    !        then increment the filename and move on to the next file
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used     if ((file%next_mod_time > file%curr_data_times(size(file%curr_data_times))).or.file%cyclical_list) then
! Subprogram not used        if (file%cyclical_list) then
! Subprogram not used           if ( associated(file%next_data_times) ) then
! Subprogram not used               if ((file%curr_mod_time > file%datatimep)) then
! Subprogram not used 
! Subprogram not used                call advance_file(file)
! Subprogram not used      
! Subprogram not used             endif
! Subprogram not used          endif
! Subprogram not used 
! Subprogram not used        endif
! Subprogram not used        if ( .not. associated(file%next_data_times) ) then
! Subprogram not used           ! open next file if not already opened...
! Subprogram not used           if (file%cyclical_list) then
! Subprogram not used               file%next_filename = incr_filename( file%curr_filename, filenames_list=file%filenames_list, datapath=file%pathname ,&
! Subprogram not used                                                   cyclical_list=file%cyclical_list, list_cycled=list_cycled)
! Subprogram not used           else
! Subprogram not used               file%next_filename = incr_filename( file%curr_filename, filenames_list=file%filenames_list, datapath=file%pathname)
! Subprogram not used           endif
! Subprogram not used           call open_trc_datafile( file%next_filename, file%pathname, file%next_fileid, file%next_data_times )
! Subprogram not used           file%next_data_times = file%next_data_times - file%offset_time
! Subprogram not used        endif
! Subprogram not used     endif
! Subprogram not used     
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !        If using next_data_times and the current is greater than or equal to the next, then
! Subprogram not used     !        close the current file, and set up for next file.
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     if ( associated(file%next_data_times) ) then
! Subprogram not used        if (file%cyclical_list .and. list_cycled) then    ! special case - list cycled 
! Subprogram not used 
! Subprogram not used           file%datatimem = file%curr_data_times(size(file%curr_data_times)) 
! Subprogram not used           itms(1)=size(file%curr_data_times)
! Subprogram not used           fids(1)=file%curr_fileid
! Subprogram not used 
! Subprogram not used           file%datatimep = file%next_data_times(1)
! Subprogram not used           itms(2)=1
! Subprogram not used           fids(2) = file%next_fileid
! Subprogram not used 
! Subprogram not used           times_found = .true.
! Subprogram not used 
! Subprogram not used        else if (file%curr_mod_time >= file%next_data_times(1)) then
! Subprogram not used 
! Subprogram not used           call advance_file(file)
! Subprogram not used 
! Subprogram not used        endif
...
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
! Subprogram not used   function incr_filename( filename, filenames_list, datapath, cyclical_list, list_cycled, abort )
! Subprogram not used 
! Subprogram not used     !-----------------------------------------------------------------------
...
! Subprogram not used     use shr_file_mod, only : shr_file_getunit, shr_file_freeunit
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     character(len=*),           intent(in)    :: filename ! present dynamical dataset filename
! Subprogram not used     character(len=*), optional, intent(in)    :: filenames_list 
! Subprogram not used     character(len=*), optional, intent(in)    :: datapath
! Subprogram not used     logical         , optional, intent(in)    :: cyclical_list  ! If true, allow list to cycle
! Subprogram not used     logical         , optional, intent(out)   :: list_cycled
! Subprogram not used     logical         , optional, intent(in)    :: abort
! Subprogram not used 
...
! Subprogram not used     character(len=shr_kind_cl) :: fn_new, line, filepath
! Subprogram not used     character(len=6)   :: seconds
! Subprogram not used     character(len=5)   :: num
! Subprogram not used     integer :: ios,unitnumber
! Subprogram not used     logical :: abort_run
! Subprogram not used  
! Subprogram not used     if (present(abort)) then 
! Subprogram not used        abort_run = abort
! Subprogram not used     else
! Subprogram not used        abort_run = .true.
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used     if (present(list_cycled)) list_cycled = .false.
! Subprogram not used 
! Subprogram not used     if (( .not. present(filenames_list)) .or.(len_trim(filenames_list) == 0)) then
! Subprogram not used        !-----------------------------------------------------------------------
! Subprogram not used        !	... ccm type filename
! Subprogram not used        !-----------------------------------------------------------------------
! Subprogram not used        pos = len_trim( filename )
! Subprogram not used        fn_new = filename(:pos)
! Subprogram not used        if ( masterproc ) write(iulog,*) 'incr_flnm: old filename = ',trim(fn_new)
...
! Subprogram not used        !-------------------------------------------------------------------
! Subprogram not used        if ( masterproc ) write(iulog,*) 'incr_flnm: old filename = ',trim(filename)
! Subprogram not used        if ( masterproc ) write(iulog,*) 'incr_flnm: open filenames_list : ',trim(filenames_list)
! Subprogram not used        unitnumber = shr_file_getUnit()
! Subprogram not used        if ( present(datapath) ) then
! Subprogram not used          filepath = trim(datapath) //'/'// trim(filenames_list)
! Subprogram not used        else
! Subprogram not used          filepath = trim(filenames_list)
! Subprogram not used        endif
! Subprogram not used 
! Subprogram not used        open( unit=unitnumber, file=filepath, iostat=ios, status="OLD")
! Subprogram not used        if (ios /= 0) then
! Subprogram not used           call endrun('not able to open filenames_list file: '//trim(filepath))
! Subprogram not used        endif
! Subprogram not used 
! Subprogram not used        !-------------------------------------------------------------------
! Subprogram not used        !  ...  read file names
! Subprogram not used        !-------------------------------------------------------------------
! Subprogram not used        read( unit=unitnumber, fmt='(A)', iostat=ios ) line 
! Subprogram not used        if (ios /= 0) then
! Subprogram not used           if (abort_run) then
! Subprogram not used              call endrun('not able to increment file name from filenames_list file: '//trim(filenames_list))
! Subprogram not used           else 
! Subprogram not used              fn_new = 'NOT_FOUND'
...
! Subprogram not used 
! Subprogram not used        !-------------------------------------------------------------------
! Subprogram not used        !      If current filename is '', then initialize with the first filename read in
! Subprogram not used        !      and skip this section.
! Subprogram not used        !-------------------------------------------------------------------
! Subprogram not used        if (filename /= '') then 
! Subprogram not used 
! Subprogram not used           !-------------------------------------------------------------------
! Subprogram not used           !       otherwise read until find current filename
! Subprogram not used           !-------------------------------------------------------------------
...
! Subprogram not used    
! Subprogram not used           !-------------------------------------------------------------------
! Subprogram not used           !      Read next filename
! Subprogram not used           !-------------------------------------------------------------------
! Subprogram not used           read( unit=unitnumber, fmt='(A)', iostat=ios ) line 
! Subprogram not used 
! Subprogram not used           !---------------------------------------------------------------------------------
! Subprogram not used           !       If cyclical_list, then an end of file is not an error, but rather 
! Subprogram not used           !       a signal to rewind and start over
! Subprogram not used           !---------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used           if (ios /= 0) then
! Subprogram not used              if (present(cyclical_list)) then
! Subprogram not used                 if (cyclical_list) then
! Subprogram not used                    list_cycled=.true.
! Subprogram not used                    rewind(unitnumber)
! Subprogram not used                    read( unit=unitnumber, fmt='(A)', iostat=ios ) line 
! Subprogram not used                      ! Error here should never happen, but check just in case
! Subprogram not used                    if (ios /= 0) then
! Subprogram not used                       call endrun('not able to increment file name from filenames_list file: '//trim(filenames_list))
! Subprogram not used                    endif
! Subprogram not used                 else
...
! Subprogram not used 
! Subprogram not used        !---------------------------------------------------------------------------------
! Subprogram not used        !     Assign the current filename and close the filelist
! Subprogram not used        !---------------------------------------------------------------------------------
! Subprogram not used        fn_new = trim(line)
! Subprogram not used 
! Subprogram not used        close(unit=unitnumber)
! Subprogram not used        call shr_file_freeUnit(unitnumber)
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used     !---------------------------------------------------------------------------------
! Subprogram not used     !      return the current filename 
! Subprogram not used     !---------------------------------------------------------------------------------
! Subprogram not used     incr_filename = trim(fn_new)
! Subprogram not used     if ( masterproc ) write(iulog,*) 'incr_flnm: new filename = ',trim(incr_filename)
! Subprogram not used 
...
! Subprogram not used   subroutine read_za_trc( fid, vid, loc_arr, strt, cnt, file, order )
! Subprogram not used     use interpolate_data, only : lininterp_init, lininterp, interp_type, lininterp_finish
! Subprogram not used     use phys_grid,        only : pcols, begchunk, endchunk, get_ncols_p, get_rlat_all_p, get_rlon_all_p	
! Subprogram not used     use mo_constants,     only : pi
! Subprogram not used     use dycore,           only : dycore_is		
! Subprogram not used     use polar_avg,        only : polar_average
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     type(file_desc_t), intent(in) :: fid
! Subprogram not used     type(var_desc_t),  intent(in) :: vid
! Subprogram not used     integer,           intent(in) :: strt(:), cnt(:)
! Subprogram not used     integer,           intent(in) :: order(2)
! Subprogram not used     real(r8),          intent(out):: loc_arr(:,:,:)
! Subprogram not used     type (trfile),     intent(in) :: file
! Subprogram not used 
! Subprogram not used     type(interp_type) :: lat_wgts
! Subprogram not used     real(r8) :: to_lats(pcols), to_lons(pcols), wrk(pcols)
! Subprogram not used     real(r8), allocatable, target :: wrk2d(:,:)
! Subprogram not used     real(r8), pointer :: wrk2d_in(:,:)
! Subprogram not used     integer :: c, k, ierr, ncols
! Subprogram not used 
! Subprogram not used      nullify(wrk2d_in)
! Subprogram not used      allocate( wrk2d(cnt(1),cnt(2)), stat=ierr )
! Subprogram not used      if( ierr /= 0 ) then
! Subprogram not used         write(iulog,*) 'read_2d_trc: wrk2d allocation error = ',ierr
! Subprogram not used         call endrun
! Subprogram not used      end if
! Subprogram not used 
! Subprogram not used      if(order(1)/=1 .or. order(2)/=2 .or. cnt(1)/=file%nlat .or. cnt(2)/=file%nlev) then
! Subprogram not used         allocate( wrk2d_in(file%nlat, file%nlev), stat=ierr )
! Subprogram not used         if( ierr /= 0 ) then
! Subprogram not used            write(iulog,*) 'read_2d_trc: wrk2d_in allocation error = ',ierr
! Subprogram not used            call endrun
! Subprogram not used         end if
! Subprogram not used      end if
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     ierr = pio_get_var( fid, vid, strt, cnt, wrk2d )
! Subprogram not used     if(associated(wrk2d_in)) then
! Subprogram not used        wrk2d_in = reshape( wrk2d(:,:),(/file%nlat,file%nlev/), order=order )
! Subprogram not used        deallocate(wrk2d)
! Subprogram not used     else
! Subprogram not used        wrk2d_in => wrk2d
! Subprogram not used     end if
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used        call lininterp_init(file%lats, file%nlat, to_lats, ncols, 1, lat_wgts)
! Subprogram not used        do k=1,file%nlev
! Subprogram not used           call lininterp(wrk2d_in(:,k), file%nlat, wrk(1:ncols), ncols, lat_wgts)    
! Subprogram not used           loc_arr(1:ncols,k,c-begchunk+1) = wrk(1:ncols)
! Subprogram not used        end do
! Subprogram not used        call lininterp_finish(lat_wgts)
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used     if(allocated(wrk2d)) then
! Subprogram not used        deallocate(wrk2d)
! Subprogram not used     else
! Subprogram not used        deallocate(wrk2d_in)
! Subprogram not used     end if
! Subprogram not used !    if(dycore_is('LR')) call polar_average(loc_arr)
! Subprogram not used   end subroutine read_za_trc
...
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
! Subprogram not used   subroutine set_cycle_indices( fileid, cyc_ndx_beg, cyc_ndx_end, cyc_yr )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     type(file_desc_t), intent(inout)  :: fileid
! Subprogram not used     integer, intent(out) :: cyc_ndx_beg
! Subprogram not used     integer, intent(out) :: cyc_ndx_end
! Subprogram not used     integer, intent(in)  :: cyc_yr
! Subprogram not used 
! Subprogram not used     integer, allocatable , dimension(:) :: dates, datesecs
! Subprogram not used     integer :: timesize, i, astat, year, ierr
! Subprogram not used     type(var_desc_T) :: dateid
! Subprogram not used     call get_dimension( fileid, 'time', timesize )
! Subprogram not used     cyc_ndx_beg=-1
! Subprogram not used 
! Subprogram not used     allocate( dates(timesize), stat=astat  )
! Subprogram not used     if( astat/= 0 ) then
! Subprogram not used        write(*,*) 'set_cycle_indices: failed to allocate dates array; error = ',astat
! Subprogram not used        call endrun
! Subprogram not used     end if
! Subprogram not used 
...
! Subprogram not used        if ( year == cyc_yr ) then
! Subprogram not used           if  (cyc_ndx_beg < 0)  then
! Subprogram not used              cyc_ndx_beg = i
! Subprogram not used           endif
! Subprogram not used           cyc_ndx_end = i
! Subprogram not used        endif
! Subprogram not used     enddo
! Subprogram not used     deallocate( dates, stat=astat  )
! Subprogram not used     if( astat/= 0 ) then
! Subprogram not used        write(*,*) 'set_cycle_indices: failed to deallocate dates array; error = ',astat
! Subprogram not used        call endrun
! Subprogram not used     end if
! Subprogram not used     if (cyc_ndx_beg < 0) then
! Subprogram not used        write(*,*) 'set_cycle_indices: cycle year not found : ' , cyc_yr
! Subprogram not used        call endrun('set_cycle_indices: cycle year not found')
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used   end subroutine set_cycle_indices
!-----------------------------------------------------------------------
...
! Subprogram not used   subroutine init_trc_restart( whence, piofile, tr_file )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     character(len=*), intent(in) :: whence
! Subprogram not used     type(file_desc_t), intent(inout) :: piofile
! Subprogram not used     type(trfile), intent(inout) :: tr_file
! Subprogram not used  
! Subprogram not used     character(len=32) :: name
! Subprogram not used     integer :: ioerr, mcdimid, maxlen
! Subprogram not used  
! Subprogram not used 
! Subprogram not used     ! Dimension should already be defined in restart file
! Subprogram not used     call pio_seterrorhandling(pioFile, PIO_BCAST_ERROR)
! Subprogram not used     ioerr = pio_inq_dimid(pioFile,'max_chars', mcdimid)
! Subprogram not used     call pio_seterrorhandling(pioFile, PIO_INTERNAL_ERROR)
! Subprogram not used     ! but define it if nessasary
! Subprogram not used     if(ioerr/= PIO_NOERR) then
! Subprogram not used        ioerr = pio_def_dim(pioFile, 'max_chars', SHR_KIND_CL, mcdimid)
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     if(len_trim(tr_file%curr_filename)>1) then
! Subprogram not used        allocate(tr_file%currfnameid)
! Subprogram not used        name = trim(whence)//'_curr_fname'
! Subprogram not used        ioerr = pio_def_var(pioFile, name,pio_char,  (/mcdimid/), tr_file%currfnameid)
! Subprogram not used        ioerr = pio_put_att(pioFile, tr_file%currfnameid, 'offset_time', tr_file%offset_time)
! Subprogram not used        maxlen = len_trim(tr_file%curr_filename)
! Subprogram not used        ioerr = pio_put_att(pioFile, tr_file%currfnameid, 'actual_len', maxlen)	
! Subprogram not used     else
! Subprogram not used        nullify(tr_file%currfnameid)
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     if(len_trim(tr_file%next_filename)>1) then
! Subprogram not used        allocate(tr_file%nextfnameid)
! Subprogram not used        name = trim(whence)//'_next_fname'
! Subprogram not used        ioerr = pio_def_var(pioFile, name,pio_char,  (/mcdimid/), tr_file%nextfnameid)
! Subprogram not used        maxlen = len_trim(tr_file%next_filename)
! Subprogram not used        ioerr = pio_put_att(pioFile, tr_file%nextfnameid, 'actual_len', maxlen)
! Subprogram not used     else
! Subprogram not used        nullify(tr_file%nextfnameid)
! Subprogram not used     end if
! Subprogram not used   end subroutine init_trc_restart
!-------------------------------------------------------------------------
! writes file names to restart file
!-------------------------------------------------------------------------
! Subprogram not used   subroutine write_trc_restart( piofile, tr_file )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     type(file_desc_t), intent(inout) :: piofile
! Subprogram not used     type(trfile), intent(inout) :: tr_file
! Subprogram not used 
! Subprogram not used     integer :: ioerr, slen   ! error status
! Subprogram not used     if(associated(tr_file%currfnameid)) then
! Subprogram not used        ioerr = pio_put_var(pioFile, tr_file%currfnameid, tr_file%curr_filename)
! Subprogram not used        deallocate(tr_file%currfnameid)
! Subprogram not used        nullify(tr_file%currfnameid)
! Subprogram not used     end if
! Subprogram not used     if(associated(tr_file%nextfnameid)) then
! Subprogram not used        ioerr = pio_put_var(pioFile, tr_file%nextfnameid, tr_file%next_filename)
! Subprogram not used        deallocate(tr_file%nextfnameid)
! Subprogram not used        nullify(tr_file%nextfnameid)
! Subprogram not used     end if
! Subprogram not used   end subroutine write_trc_restart

!-------------------------------------------------------------------------
! reads file names from restart file
!-------------------------------------------------------------------------
! Subprogram not used   subroutine read_trc_restart( whence, piofile, tr_file )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     character(len=*), intent(in) :: whence
! Subprogram not used     type(file_desc_t), intent(inout) :: piofile
! Subprogram not used     type(trfile), intent(inout) :: tr_file
! Subprogram not used     type(var_desc_t) :: vdesc
! Subprogram not used     character(len=64) :: name
! Subprogram not used     integer :: ioerr   ! error status
! Subprogram not used     integer :: slen
! Subprogram not used 
! Subprogram not used     call PIO_SetErrorHandling(piofile, PIO_BCAST_ERROR)
! Subprogram not used     name = trim(whence)//'_curr_fname'
! Subprogram not used     ioerr = pio_inq_varid(piofile, name, vdesc)
! Subprogram not used     if(ioerr==PIO_NOERR) then
! Subprogram not used        tr_file%curr_filename=' '
! Subprogram not used        ioerr = pio_get_att(piofile, vdesc, 'offset_time', tr_file%offset_time)
! Subprogram not used        ioerr = pio_get_att(piofile, vdesc, 'actual_len', slen)
! Subprogram not used        ioerr = pio_get_var(piofile, vdesc, tr_file%curr_filename)
! Subprogram not used        if(slen<SHR_KIND_CL) tr_file%curr_filename(slen+1:)=' '
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used     name = trim(whence)//'_next_fname'
! Subprogram not used     ioerr = pio_inq_varid(piofile, name, vdesc)
! Subprogram not used     if(ioerr==PIO_NOERR) then
! Subprogram not used        tr_file%next_filename=' '
! Subprogram not used        ioerr = pio_get_att(piofile, vdesc, 'actual_len', slen)
! Subprogram not used        ioerr = pio_get_var(piofile, vdesc, tr_file%next_filename)
! Subprogram not used        if(slen<SHR_KIND_CL) tr_file%next_filename(slen+1:)=' '
! Subprogram not used     end if
! Subprogram not used     call PIO_SetErrorHandling(piofile, PIO_INTERNAL_ERROR)
! Subprogram not used 
! Subprogram not used 
! Subprogram not used 
! Subprogram not used   end subroutine read_trc_restart
!------------------------------------------------------------------------------
! Subprogram not used    subroutine vert_interp_mixrat( ncol, nsrc, ntrg, trg_x, src, trg, p0, ps, hyai, hybi)
! Subprogram not used   
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used     integer, intent(in)   :: ncol 
! Subprogram not used     integer, intent(in)   :: nsrc                  ! dimension source array
! Subprogram not used     integer, intent(in)   :: ntrg                  ! dimension target array
! Subprogram not used     real(r8)              :: src_x(nsrc+1)         ! source coordinates
! Subprogram not used     real(r8), intent(in)      :: trg_x(pcols,ntrg+1)         ! target coordinates
! Subprogram not used     real(r8), intent(in)      :: src(pcols,nsrc)             ! source array
! Subprogram not used     real(r8), intent(out)     :: trg(pcols,ntrg)             ! target array
! Subprogram not used 
! Subprogram not used     real(r8) :: ps(pcols), p0, hyai(nsrc+1), hybi(nsrc+1)
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used     !   ... local variables
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used     integer  :: i, j, n
! Subprogram not used     integer  :: sil
! Subprogram not used     real(r8)     :: tl, y
! Subprogram not used     real(r8)     :: bot, top
! Subprogram not used    
! Subprogram not used   
! Subprogram not used     
! Subprogram not used     do n = 1,ncol
! Subprogram not used     
! Subprogram not used     do i=1,nsrc+1
! Subprogram not used      src_x(i) = p0*hyai(i)+ps(n)*hybi(i)
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used     do i = 1, ntrg
! Subprogram not used        tl = trg_x(n,i+1)
! Subprogram not used        if( (tl.gt.src_x(1)).and.(trg_x(n,i).lt.src_x(nsrc+1)) ) then
! Subprogram not used           do sil = 1,nsrc
! Subprogram not used              if( (tl-src_x(sil))*(tl-src_x(sil+1)).le.0.0_r8 ) then
! Subprogram not used                 exit
! Subprogram not used              end if
! Subprogram not used           end do
! Subprogram not used 
! Subprogram not used           if( tl.gt.src_x(nsrc+1)) sil = nsrc
! Subprogram not used 
! Subprogram not used           y = 0.0_r8
! Subprogram not used           bot = min(tl,src_x(nsrc+1))   
! Subprogram not used           top = trg_x(n,i)
! Subprogram not used           do j = sil,1,-1
! Subprogram not used            if( top.lt.src_x(j) ) then
! Subprogram not used              y = y+(bot-src_x(j))*src(n,j)
! Subprogram not used             bot = src_x(j)
! Subprogram not used            else
! Subprogram not used             y = y+(bot-top)*src(n,j)
! Subprogram not used             exit
! Subprogram not used            endif
! Subprogram not used           enddo
! Subprogram not used           trg(n,i) = y
! Subprogram not used        else
! Subprogram not used         trg(n,i) = 0.0_r8
! Subprogram not used        end if
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used     if( trg_x(n,ntrg+1).lt.src_x(nsrc+1) ) then
! Subprogram not used      top = trg_x(n,ntrg+1)
! Subprogram not used      bot = src_x(nsrc+1)
! Subprogram not used      y = 0.0_r8
! Subprogram not used      do j=nsrc,1,-1
! Subprogram not used       if( top.lt.src_x(j) ) then
! Subprogram not used        y = y+(bot-src_x(j))*src(n,j)
! Subprogram not used        bot = src_x(j)
! Subprogram not used       else
...
! Subprogram not used       endif
! Subprogram not used      enddo
! Subprogram not used      trg(n,ntrg) = trg(n,ntrg)+y
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used ! turn mass into mixing ratio 
! Subprogram not used     do i=1,ntrg
! Subprogram not used      trg(n,i) = trg(n,i)/(trg_x(n,i+1)-trg_x(n,i))
! Subprogram not used     enddo
! Subprogram not used     
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used    end subroutine vert_interp_mixrat
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
! Subprogram not used   subroutine vert_interp_ub( ncol, nlevs, plevs,  datain, dataout )
! Subprogram not used     use ref_pres, only : ptop_ref
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     !----------------------------------------------------------------------- 
! Subprogram not used     ! 
! Subprogram not used     ! Interpolate data from current time-interpolated values to top interface pressure
! Subprogram not used     !  -- from mo_tgcm_ubc.F90
! Subprogram not used     !--------------------------------------------------------------------------
! Subprogram not used     implicit none
! Subprogram not used     ! Arguments
! Subprogram not used     !
! Subprogram not used     integer,  intent(in)  :: ncol
! Subprogram not used     integer,  intent(in)  :: nlevs
! Subprogram not used     real(r8), intent(in)  :: plevs(nlevs)
! Subprogram not used     real(r8), intent(in)  :: datain(ncol,nlevs)
! Subprogram not used     real(r8), intent(out) :: dataout(ncol)   
! Subprogram not used 
! Subprogram not used     !
! Subprogram not used     ! local variables
! Subprogram not used     !
! Subprogram not used     integer  :: i,ku,kl,kk
! Subprogram not used     real(r8) :: pinterp, delp
! Subprogram not used     
! Subprogram not used     pinterp = ptop_ref
! Subprogram not used 
! Subprogram not used     if( pinterp <= plevs(1) ) then
! Subprogram not used        kl = 1
! Subprogram not used        ku = 1
! Subprogram not used        delp = 0._r8
! Subprogram not used     else if( pinterp >= plevs(nlevs) ) then
! Subprogram not used        kl = nlevs
! Subprogram not used        ku = nlevs
! Subprogram not used        delp = 0._r8
! Subprogram not used     else
! Subprogram not used 
! Subprogram not used        do kk = 2,nlevs
! Subprogram not used           if( pinterp <= plevs(kk) ) then
! Subprogram not used              ku = kk
! Subprogram not used              kl = kk - 1
! Subprogram not used              delp = log( pinterp/plevs(kk) ) / log( plevs(kk-1)/plevs(kk) )
! Subprogram not used              exit
! Subprogram not used           end if
! Subprogram not used        end do
! Subprogram not used 
...
! Subprogram not used        dataout(i) = datain(i,kl) + delp * (datain(i,ku) - datain(i,kl))
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end subroutine vert_interp_ub
!------------------------------------------------------------------------------

!------------------------------------------------------------------------------
!------------------------------------------------------------------------------
! Subprogram not used   subroutine advance_file(file)
! Subprogram not used 
! Subprogram not used     !------------------------------------------------------------------------------
! Subprogram not used     !   This routine advances to the next file
! Subprogram not used     !------------------------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used     !   local variables
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     character(len=shr_kind_cl) :: ctmp
! Subprogram not used     character(len=shr_kind_cl) :: loc_fname   
! Subprogram not used     integer            :: istat, astat
! Subprogram not used 
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !   close current file ...
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     call pio_closefile( file%curr_fileid )
! Subprogram not used 
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !   remove if requested
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     if( file%remove_trc_file ) then
! Subprogram not used        call getfil( file%curr_filename, loc_fname, 0 )
! Subprogram not used        write(iulog,*) 'advance_file: removing file = ',trim(loc_fname) 
! Subprogram not used        ctmp = 'rm -f ' // trim(loc_fname) 
! Subprogram not used        write(iulog,*) 'advance_file: fsystem issuing command - '
! Subprogram not used        write(iulog,*) trim(ctmp)
! Subprogram not used        call shr_sys_system( ctmp, istat )
! Subprogram not used     end if
! Subprogram not used    
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !   Advance the filename and file id
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     file%curr_filename = file%next_filename
! Subprogram not used     file%curr_fileid = file%next_fileid
! Subprogram not used    
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !   Advance the curr_data_times
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     deallocate( file%curr_data_times, stat=astat )
! Subprogram not used     if( astat/= 0 ) then
! Subprogram not used        write(iulog,*) 'advance_file: failed to deallocate file%curr_data_times array; error = ',astat
! Subprogram not used        call endrun
! Subprogram not used     end if
! Subprogram not used     allocate( file%curr_data_times( size( file%next_data_times ) ), stat=astat )
! Subprogram not used     if( astat/= 0 ) then
! Subprogram not used        write(iulog,*) 'advance_file: failed to allocate file%curr_data_times array; error = ',astat
! Subprogram not used        call endrun
! Subprogram not used     end if
! Subprogram not used     file%curr_data_times(:) = file%next_data_times(:)
! Subprogram not used     
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     !   delete information about next file (as was just assigned to current)
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used     file%next_filename = ''
! Subprogram not used     
! Subprogram not used     deallocate( file%next_data_times, stat=astat )
! Subprogram not used     if( astat/= 0 ) then
! Subprogram not used        write(iulog,*) 'advance_file: failed to deallocate file%next_data_times array; error = ',astat
! Subprogram not used        call endrun
! Subprogram not used     end if
! Subprogram not used     nullify( file%next_data_times )
! Subprogram not used 
! Subprogram not used   end subroutine advance_file
