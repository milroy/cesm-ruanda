...
! Subprogram not used  subroutine getIList_(item, ith, aVect)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_String, only : String
! Subprogram not used       use m_List,   only : get
! Subprogram not used 
! Subprogram not used       implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       integer,     intent(in)  :: ith
! Subprogram not used       type(AttrVect),intent(in) :: aVect
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       type(String),intent(out) :: item
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 24Apr98 - Jing Guo <guo@thunder> - initial prototype/prolog/code
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::getIList_'
! Subprogram not used 
! Subprogram not used   call get(item, ith, aVect%iList)
! Subprogram not used 
! Subprogram not used  end subroutine getIList_
...
! Subprogram not used  function getIListToChar_(ith, aVect)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_String, only : String
...
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used !
! Subprogram not used       character(len=size(aVect%iList%bf,1)) :: getIListToChar_
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 10Jan13 - T. Craig <tcraig@ucar.edu> - initial prototype/prolog/code
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   type(String) :: item
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::getIListToChar_'
! Subprogram not used 
! Subprogram not used   call get(item, ith, aVect%iList)
! Subprogram not used   getIListToChar_ = String_toChar(item)
! Subprogram not used   call String_clean(item)
! Subprogram not used 
! Subprogram not used  end function getIListToChar_
...
! Subprogram not used  subroutine appendIAttr_(aV, iList, status)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used !
! Subprogram not used       type(AttrVect),intent(inout)  :: aV
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       character(len=*), intent(in)  :: iList
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 08Jul03 - R. Jacob <jacob@mcs.anl.gov> - initial version
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::appendIAttr_'
! Subprogram not used 
! Subprogram not used   type(List) :: avRList,avIList        ! placeholders for the aV attributes
! Subprogram not used   type(List) :: addIlist               ! for the input string
! Subprogram not used   type(AttrVect) :: tempaV             ! placeholder for aV data.
! Subprogram not used   integer :: locsize                   ! size of aV
! Subprogram not used   integer :: rlstatus,cstatus           ! status flags
! Subprogram not used   integer :: ilstatus
! Subprogram not used 
! Subprogram not used   if(present(status)) status = 0
! Subprogram not used 
! Subprogram not used   call List_nullify(avIList)
! Subprogram not used   call List_nullify(avRList)
! Subprogram not used 
! Subprogram not used ! save the local size and current int and real attributes
! Subprogram not used   locsize = lsize_(aV)
! Subprogram not used   call exportRList_(aV,avRList,rlstatus)
! Subprogram not used   call exportIList_(aV,avIList,ilstatus)
! Subprogram not used 
! Subprogram not used ! create and fill a temporary AttrVect to hold any data currently in the aV
! Subprogram not used   call initv_(tempaV,aV,lsize=locsize)
! Subprogram not used   call Copy_(aV,tempaV)
! Subprogram not used 
! Subprogram not used ! create a List with the new attributes
! Subprogram not used   call List_init(addIlist,iList)
! Subprogram not used 
! Subprogram not used ! append addIlist to current avIList if it has attributes.
! Subprogram not used   if(List_allocated(avIList)) then
! Subprogram not used     call List_append(avIList,addIlist)
! Subprogram not used ! copy addIlist to avIList
! Subprogram not used   else
! Subprogram not used     call List_copy(avIList,addIlist)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used ! now delete the input aV and recreate it
! Subprogram not used   call clean_(aV,cstatus)
! Subprogram not used   call initl_(aV,avIList,avRList,locsize)
! Subprogram not used 
! Subprogram not used ! copy back the data
! Subprogram not used   call Copy_(tempaV,aV)
! Subprogram not used 
! Subprogram not used ! clean up.
! Subprogram not used   call List_clean(avRList,cstatus)
! Subprogram not used 
! Subprogram not used   call clean_(tempaV,cstatus)
! Subprogram not used   call List_clean(addIlist,cstatus)
! Subprogram not used   call List_clean(avIList,cstatus)
! Subprogram not used 
! Subprogram not used   if(present(status)) status = cstatus
! Subprogram not used 
! Subprogram not used  end subroutine appendIAttr_
...
! Subprogram not used  subroutine appendRAttr_(aV, rList, status)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_List,   only : List_init => init
...
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       character(len=*), intent(in)  :: rList
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used !
! Subprogram not used       integer,optional,intent(out)  :: status
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 04Jun03 - R. Jacob <jacob@mcs.anl.gov> - initial version
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::appendRAttr_'
! Subprogram not used 
! Subprogram not used   type(List) :: avRList,avIList        ! placeholders for the aV attributes
! Subprogram not used   type(List) :: addRlist               ! for the input string
! Subprogram not used   type(AttrVect) :: tempaV             ! placeholder for aV data.
! Subprogram not used   integer :: locsize                   ! size of aV
! Subprogram not used   integer :: rlstatus,cstatus           ! status flags
! Subprogram not used   integer :: ilstatus
...
! Subprogram not used 
! Subprogram not used ! create a List with the new attributes
! Subprogram not used   call List_init(addRlist,rList)
! Subprogram not used 
! Subprogram not used ! append addRlist to current avRList if it has attributes.
! Subprogram not used   if(List_allocated(avRList)) then
! Subprogram not used     call List_append(avRList,addRlist)
! Subprogram not used ! copy addRlist to avRList
! Subprogram not used   else
! Subprogram not used     call List_copy(avRList,addRlist)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used ! now delete the input aV and recreate it
! Subprogram not used   call clean_(aV,cstatus)
...
! Subprogram not used 
! Subprogram not used   call clean_(tempaV,cstatus)
! Subprogram not used   call List_clean(addRlist,cstatus)
! Subprogram not used   call List_clean(avRList,cstatus)
! Subprogram not used 
! Subprogram not used   if(present(status)) status = cstatus
! Subprogram not used 
! Subprogram not used  end subroutine appendRAttr_
...
! Subprogram not used  subroutine exportIList_(aV, outIList, status)
! Subprogram not used 
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used ! !INPUT PARAMETERS: 
! Subprogram not used 
! Subprogram not used       type(AttrVect),             intent(in)  :: aV
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used 
! Subprogram not used       type(List),                 intent(out) :: outIList
! Subprogram not used       integer,          optional, intent(out) :: status
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 14Dec01 - J.W. Larson <larson@mcs.anl.gov> - initial prototype.
! Subprogram not used !
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::exportIList_'
! Subprogram not used 
! Subprogram not used        ! Initialize status flag (if present) to success value of zero.
! Subprogram not used 
! Subprogram not used   if(present(status)) status = 0
! Subprogram not used 
! Subprogram not used   if(List_allocated(aV%iList)) then
! Subprogram not used      call List_copy(outIList, aV%iList)
! Subprogram not used   else
! Subprogram not used      call List_nullify(outIList)
...
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used  end subroutine exportIList_
...
! Subprogram not used  subroutine exportRList_(aV, outRList, status)
! Subprogram not used 
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used ! !OUTPUT PARAMETERS: 
! Subprogram not used 
! Subprogram not used       type(List),               intent(out) :: outRList
! Subprogram not used       integer,        optional, intent(out) :: status
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 14Dec01 - J.W. Larson <larson@mcs.anl.gov> - initial prototype.
...
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::exportRList_'
! Subprogram not used 
! Subprogram not used        ! Initialize status flag (if present) to success value of zero.
! Subprogram not used 
! Subprogram not used   if(present(status)) status = 0
! Subprogram not used 
! Subprogram not used   if(List_allocated(aV%rList)) then
! Subprogram not used      call List_copy(outRList, aV%rList)
! Subprogram not used   else
! Subprogram not used      call List_nullify(outRList)
! Subprogram not used      if(present(status)) then
! Subprogram not used 	status = 1
! Subprogram not used      else
! Subprogram not used 	call die(myname_)
...
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used  end subroutine exportRList_
...
! Subprogram not used  subroutine exportRAttrSP_(aV, AttrTag, outVect, lsize, perrWith, dieWith)
! Subprogram not used 
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 19Oct01 - J.W. Larson <larson@mcs.anl.gov> - initial (slow) 
! Subprogram not used !           prototype.
! Subprogram not used !  6May02 - J.W. Larson <larson@mcs.anl.gov> - added capability 
! Subprogram not used !           to work with pre-allocated outVect.
! Subprogram not used !
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::exportRAttrSP_'
! Subprogram not used 
! Subprogram not used   integer :: index, ierr, n, myLsize
! Subprogram not used   type(String) :: myTrace
! Subprogram not used 
! Subprogram not used   if(present(dieWith)) then ! Append onto TraceBack
! Subprogram not used      call GenTraceBackString(myTrace, dieWith, myname_)
! Subprogram not used   else
! Subprogram not used      if(present(perrWith)) then ! Append onto TraceBack
! Subprogram not used 	call GenTraceBackString(myTrace, perrWith, myname_)
! Subprogram not used      else ! Start a TraceBackString
! Subprogram not used 	call GenTraceBackString(myTrace, myname_)
! Subprogram not used      endif
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Index the attribute we wish to extract:
! Subprogram not used 
! Subprogram not used   index = indexRA_(aV, attrTag, dieWith=String_ToChar(myTrace))
! Subprogram not used 
! Subprogram not used        ! Determine the number of data points:
! Subprogram not used 
! Subprogram not used   myLsize = lsize_(aV)
! Subprogram not used 
! Subprogram not used        ! Allocate space for outVect (if it is not already dimensioned)
! Subprogram not used 
! Subprogram not used   if(associated(outVect)) then ! check the size of outVect
! Subprogram not used      if(size(outVect) < myLsize) then
! Subprogram not used 	write(stderr,'(3a,i8,a,i8)') myname_, &
! Subprogram not used 	    ':: ERROR length of output array outVect ', &
! Subprogram not used 	    ' less than length of aV.  size(outVect)=',size(outVect), &
! Subprogram not used 	    ', length of aV=',myLsize
! Subprogram not used 	write(stderr,'(2a)') 'Traceback:  ',String_ToChar(myTrace)
! Subprogram not used 	call die(myname_)
! Subprogram not used      endif
! Subprogram not used   else ! allocate space for outVect
! Subprogram not used      allocate(outVect(myLsize), stat=ierr)
! Subprogram not used      if(ierr /= 0) then
! Subprogram not used 	write(stderr,'(2a,i8)') myname_, &
! Subprogram not used 	     ':: Error - allocate(outVect(...) failed. ierr = ',ierr
! Subprogram not used 	write(stderr,'(2a)') 'Traceback:  ',String_ToChar(myTrace)	
! Subprogram not used 	call die(myname_)
! Subprogram not used      endif
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Copy the attribute data into outVect
! Subprogram not used 
! Subprogram not used !$OMP PARALLEL DO PRIVATE(n)
! Subprogram not used   do n=1,myLsize
! Subprogram not used      outVect(n) = aV%rAttr(index,n)
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used   call String_clean(myTrace)
! Subprogram not used 
! Subprogram not used   ! return optional argument lsize
! Subprogram not used   if(present(lsize)) lsize = myLsize
! Subprogram not used 
...
! Subprogram not used  subroutine importRAttrSP_(aV, AttrTag, inVect, lsize)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die ,          only : die
...
! Subprogram not used 
! Subprogram not used   integer :: index, aVsize, ierr, n, mysize
! Subprogram not used 
! Subprogram not used        ! Index the attribute we wish to extract:
! Subprogram not used 
! Subprogram not used   index = indexRA_(aV, attrTag)
! Subprogram not used 
! Subprogram not used        ! Determine the number of data points:
! Subprogram not used 
! Subprogram not used   aVsize = lsize_(aV)
! Subprogram not used 
! Subprogram not used        ! Check input array size vs. lsize_(aV):
! Subprogram not used 
! Subprogram not used   if(present(lsize)) then
! Subprogram not used      if(aVsize < lsize) then
! Subprogram not used 	write(stderr,'(3a,i8,a,i8)') myname_, &
! Subprogram not used 	               ':: ERROR--attempt to import too many entries ', &
! Subprogram not used                        'into AttrVect aV.  AttrVect_lsize(aV)=',aVsize, &
! Subprogram not used                        ', number of entries to be imported=',lsize
! Subprogram not used 	call die(myname_)
! Subprogram not used      endif
! Subprogram not used      mysize=lsize
! Subprogram not used   else
! Subprogram not used      if(aVsize < size(inVect)) then
! Subprogram not used 	write(stderr,'(3a,i8,a,i8)') myname_, &
! Subprogram not used 	               ':: ERROR--attempt to import too many entries ', &
! Subprogram not used                        'into AttrVect aV.  AttrVect_lsize(aV)=',aVsize, &
! Subprogram not used                        ' , number of entries to be imported=',size(inVect)
! Subprogram not used 	call die(myname_)
! Subprogram not used      endif
! Subprogram not used      mysize=aVsize
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Copy the attribute data into outVect
! Subprogram not used 
! Subprogram not used !$OMP PARALLEL DO PRIVATE(n)
! Subprogram not used   do n=1,mysize
! Subprogram not used      aV%rAttr(index,n) = inVect(n)
! Subprogram not used   end do
! Subprogram not used 
...
! Subprogram not used  subroutine SortPermute_(aV, key_list, descend, perrWith, dieWith)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die ,          only : die
...
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 24Oct00 - J.W. Larson <larson@mcs.anl.gov> - initial prototype
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used        ! Permutation array pointer perm(:)
! Subprogram not used   integer, dimension(:), pointer :: perm
! Subprogram not used        ! Error flag ierr
! Subprogram not used   integer :: ierr
! Subprogram not used 
! Subprogram not used        ! Step One: Generate the index permutation perm(:)
! Subprogram not used 
! Subprogram not used   if(present(descend)) then
! Subprogram not used      call Sort_(aV, key_list, perm, descend, perrWith, dieWith)
! Subprogram not used   else
! Subprogram not used      call Sort_(aV, key_list, perm, perrWith=perrWith, &
! Subprogram not used 	        dieWith=dieWith)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used        ! Step Two:  Apply the index permutation perm(:)
! Subprogram not used 
! Subprogram not used   call Permute_(aV, perm, perrWith, dieWith)
! Subprogram not used 
! Subprogram not used        ! Step Three:  deallocate temporary array used to 
! Subprogram not used        ! store the index permutation (this was allocated 
! Subprogram not used        ! in the routine Sort_()
! Subprogram not used 
...
! Subprogram not used  subroutine cleanSharedIndices_(sharedIndices, stat)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:   
! Subprogram not used !
! Subprogram not used       type(AVSharedIndices), intent(inout) :: sharedIndices
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 28Apr11 - W.J. Sacks <sacks@ucar.edu> - initial version
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::cleanSharedIndices_'
! Subprogram not used   integer :: ier
! Subprogram not used 
! Subprogram not used   if(present(stat)) stat=0
! Subprogram not used 
! Subprogram not used   call cleanSharedIndicesOneType_(sharedIndices%shared_real, stat=ier)
! Subprogram not used   if(present(stat) .and. ier /= 0) then
! Subprogram not used      stat = ier
! Subprogram not used   end if
! Subprogram not used 
! Subprogram not used   call cleanSharedIndicesOneType_(sharedIndices%shared_integer, stat=ier)
! Subprogram not used   if(present(stat) .and. ier /= 0) then
! Subprogram not used      stat = ier
! Subprogram not used   end if
! Subprogram not used 
! Subprogram not used  end subroutine cleanSharedIndices_
