...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockSetTimeStep(clock, TimeStep, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(inout) :: clock
! Subprogram not used       type(ESMF_TimeInterval), intent(in) :: TimeStep
! Subprogram not used       integer, intent(out), optional      :: rc
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Set an {\tt ESMF\_Clock}'s timestep interval
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to set the time step
! Subprogram not used !     \item[TimeStep]
! Subprogram not used !          The time step
...
! Subprogram not used !     TMG3.4.2
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used       clock%clockint%TimeStep = TimeStep
! Subprogram not used       IF ( PRESENT(rc) ) rc = ESMF_SUCCESS
! Subprogram not used 
! Subprogram not used       end subroutine ESMF_ClockSetTimeStep
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockSetCurrTime(clock, CurrTime, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(inout) :: clock
! Subprogram not used       type(ESMF_Time), intent(in) :: CurrTime
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Set an {\tt ESMF\_Clock}'s current time
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to set the current time from
! Subprogram not used !     \item[CurrTime]
! Subprogram not used !          The current time
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !     TMG3.4.3
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used       clock%clockint%CurrTime = CurrTime
! Subprogram not used       IF ( PRESENT(rc) ) rc = ESMF_SUCCESS
! Subprogram not used     
! Subprogram not used       end subroutine ESMF_ClockSetCurrTime
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockGetCurrSimTime(clock, CurrSimTime, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       type(ESMF_TimeInterval), intent(out) :: CurrSimTime
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Get an {\tt ESMF\_Clock}'s current simulation time
! Subprogram not used ! 
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to get the current simulation time from
! Subprogram not used !     \item[CurrSimTime]
! Subprogram not used !          The current simulation time
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !     TMG3.5.5
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockGetCurrSimTime not supported' )
! Subprogram not used       end subroutine ESMF_ClockGetCurrSimTime
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockGetPrevSimTime(clock, PrevSimTime, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       type(ESMF_TimeInterval), intent(out) :: PrevSimTime
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Get an {\tt ESMF\_Clock}'s previous simulation time
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to get the previous simulation time from
! Subprogram not used !     \item[PrevSimTime]
! Subprogram not used !          The previous simulation time
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !
...
! Subprogram not used !     TMG3.5.5
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockGetPrevSimTime not supported' )
! Subprogram not used       end subroutine ESMF_ClockGetPrevSimTime
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockSyncToWallClock(clock, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(inout) :: clock
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used     
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Set an {\tt ESMF\_Clock}'s current time to wall clock time     
! Subprogram not used !   
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to synchronize to wall clock time
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !   
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !     TMG3.4.5
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockSyncToWallClock not supported' )
! Subprogram not used       end subroutine ESMF_ClockSyncToWallClock
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockStopTimeDisable(clock, rc)
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       integer, intent(out), optional :: rc
...
! Subprogram not used 
! Subprogram not used       end subroutine ESMF_ClockStopTimeDisable
...
! !INTERFACE:
! Subprogram not used       function ESMF_ClockIsStopTime(clock, rc)
! Subprogram not used !
! Subprogram not used ! !RETURN VALUE:
! Subprogram not used       logical :: ESMF_ClockIsStopTime
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Return true if {\tt ESMF\_Clock} has reached its stop time, false 
! Subprogram not used !     otherwise     
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          The object instance to check
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used 
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !     TMG3.5.6
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used       if ( clock%clockint%CurrTime .GE. clock%clockint%StopTime ) THEN
! Subprogram not used         ESMF_ClockIsStopTime = .TRUE.
! Subprogram not used       else
! Subprogram not used         ESMF_ClockIsStopTime = .FALSE.
! Subprogram not used       endif
! Subprogram not used       IF ( PRESENT( rc ) ) rc = ESMF_SUCCESS
! Subprogram not used     
! Subprogram not used       end function ESMF_ClockIsStopTime
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockRead(clock, TimeStep, StartTime, StopTime, &
! Subprogram not used                                 RefTime, CurrTime, PrevTime, AdvanceCount, &
! Subprogram not used                                 AlarmList, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(out) :: clock
! Subprogram not used       type(ESMF_TimeInterval), intent(in) :: TimeStep
! Subprogram not used       type(ESMF_Time), intent(in) :: StartTime
! Subprogram not used       type(ESMF_Time), intent(in) :: StopTime
! Subprogram not used       type(ESMF_Time), intent(in) :: RefTime
! Subprogram not used       type(ESMF_Time), intent(in) :: CurrTime
! Subprogram not used       type(ESMF_Time), intent(in) :: PrevTime
! Subprogram not used       integer(ESMF_KIND_I8), intent(in) :: AdvanceCount
! Subprogram not used       type(ESMF_Alarm), dimension(MAX_ALARMS), intent(in) :: AlarmList
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used     
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Restore an {\tt ESMF\_Clock}
! Subprogram not used !     
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
...
! Subprogram not used !     \item[TimeStep]
! Subprogram not used !          The {\tt ESMF\_Clock}'s time step interval
! Subprogram not used !     \item[StartTime]
! Subprogram not used !          The {\tt ESMF\_Clock}'s starting time
! Subprogram not used !     \item[StopTime]
! Subprogram not used !          The {\tt ESMF\_Clock}'s stopping time
! Subprogram not used !     \item[RefTime]
! Subprogram not used !          The {\tt ESMF\_Clock}'s reference time
! Subprogram not used !     \item[CurrTime]
! Subprogram not used !          The {\tt ESMF\_Clock}'s current time
! Subprogram not used !     \item[PrevTime]
! Subprogram not used !          The {\tt ESMF\_Clock}'s previous time
! Subprogram not used !     \item[AdvanceCount]
! Subprogram not used !          The number of times the {\tt ESMF\_Clock} has been advanced
! Subprogram not used !     \item[AlarmList]
! Subprogram not used !          The {\tt ESMF\_Clock}'s {\tt ESMF\_Alarm} list
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !     
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockRead not supported' )
! Subprogram not used       end subroutine ESMF_ClockRead
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockWrite(clock, TimeStep, StartTime, StopTime, &
! Subprogram not used                             RefTime, CurrTime, PrevTime, AdvanceCount, &
! Subprogram not used                             AlarmList, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       type(ESMF_TimeInterval), intent(out) :: TimeStep
! Subprogram not used       type(ESMF_Time), intent(out) :: StartTime
! Subprogram not used       type(ESMF_Time), intent(out) :: StopTime
! Subprogram not used       type(ESMF_Time), intent(out) :: RefTime
! Subprogram not used       type(ESMF_Time), intent(out) :: CurrTime
! Subprogram not used       type(ESMF_Time), intent(out) :: PrevTime
! Subprogram not used       integer(ESMF_KIND_I8), intent(out) :: AdvanceCount
! Subprogram not used       type(ESMF_Alarm), dimension(MAX_ALARMS), intent(out) :: AlarmList
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used     
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Save an {\tt ESMF\_Clock}
! Subprogram not used !     
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
...
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockWrite not supported' )
! Subprogram not used       end subroutine ESMF_ClockWrite
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockValidate(clock, opts, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
...
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Perform a validation check on an {\tt ESMF\_Clock}'s properties
! Subprogram not used !
! Subprogram not used !     The arguments are:  
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          {\tt ESMF\_Clock} to validate
...
! Subprogram not used !EOP
! Subprogram not used       CALL wrf_error_fatal( 'ESMF_ClockValidate not supported' )
! Subprogram not used       end subroutine ESMF_ClockValidate
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_ClockPrint(clock, opts, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Clock), intent(in) :: clock
! Subprogram not used       character (len=*), intent(in), optional :: opts
...
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     To support testing/debugging, print out an {\tt ESMF\_Clock}'s
! Subprogram not used !     properties.
! Subprogram not used ! 
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[clock]
! Subprogram not used !          {\tt ESMF\_Clock} to print out
! Subprogram not used !     \item[{[opts]}]
...
! Subprogram not used !     TMGn.n.n
! Subprogram not used !EOP
! Subprogram not used       type(ESMF_Time) :: start_time
! Subprogram not used       type(ESMF_Time) :: stop_time
! Subprogram not used       type(ESMF_Time) :: curr_time
! Subprogram not used       type(ESMF_Time) :: ref_time
! Subprogram not used       type(ESMF_TimeInterval) :: timestep
! Subprogram not used 
! Subprogram not used       call ESMF_ClockGet( clock, startTime=start_time, &
! Subprogram not used                           stoptime=stop_time, currTime=curr_time, &
! Subprogram not used                           refTime=ref_time, timeStep=timestep, rc=rc )
! Subprogram not used       print *, 'Start time: '
! Subprogram not used       call ESMF_TimePrint( start_time )
! Subprogram not used       print *, 'Stop time: '
! Subprogram not used       call ESMF_TimePrint( stop_time )
! Subprogram not used       print *, 'Reference time: '
! Subprogram not used       call ESMF_TimePrint( ref_time )
! Subprogram not used       print *, 'Current time: '
! Subprogram not used       call ESMF_TimePrint( curr_time )
! Subprogram not used       print *, 'Time step: '
! Subprogram not used       call ESMF_TimeIntervalPrint( timestep)
! Subprogram not used       end subroutine ESMF_ClockPrint
