...
! Subprogram not used character(len=nlen) function get_dir( filepath )
! Subprogram not used 
! Subprogram not used ! Return the directory from a filename with a full path
! Subprogram not used 
! Subprogram not used    ! arguments
! Subprogram not used    character(len=*), intent(in) :: filepath ! Full path for a filename
! Subprogram not used 
! Subprogram not used    ! local variables
! Subprogram not used    integer :: filenameposition   ! Character position for last character of directory
! Subprogram not used    !-----------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    ! Get the directory name of the input dataset
! Subprogram not used    filenameposition = index( filepath, '/', back=.true. )
! Subprogram not used    if ( filenameposition == 0 )then
! Subprogram not used       get_dir  = './'
! Subprogram not used    else
! Subprogram not used       get_dir  = filepath(1:filenameposition)
! Subprogram not used    end if
! Subprogram not used 
! Subprogram not used end function get_dir
