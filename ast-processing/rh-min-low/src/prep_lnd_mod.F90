...
! Subprogram not used   subroutine prep_lnd_calc_g2x_lx(timer)
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used     ! Description
! Subprogram not used     ! Create g2x_lx (note that g2x_lx is a local module variable)
! Subprogram not used     !
...
! Subprogram not used     character(*), parameter :: subname = '(prep_lnd_calc_g2x_lx)'
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used        call seq_map_map(mapper_SFg2l, g2x_gx, g2x_lx(egi), norm=.true.)
! Subprogram not used     enddo
! Subprogram not used     call t_drvstopf  (trim(timer))
! Subprogram not used 
! Subprogram not used   end subroutine prep_lnd_calc_g2x_lx

  !================================================================================================

! Subprogram not used   function prep_lnd_get_a2x_lx()
! Subprogram not used     type(mct_aVect), pointer :: prep_lnd_get_a2x_lx(:)
! Subprogram not used     prep_lnd_get_a2x_lx => a2x_lx(:)   
! Subprogram not used   end function prep_lnd_get_a2x_lx 

! Subprogram not used   function prep_lnd_get_r2x_lx()
! Subprogram not used     type(mct_aVect), pointer :: prep_lnd_get_r2x_lx(:)
! Subprogram not used     prep_lnd_get_r2x_lx => r2x_lx(:)   
! Subprogram not used   end function prep_lnd_get_r2x_lx 

! Subprogram not used   function prep_lnd_get_g2x_lx()
! Subprogram not used     type(mct_aVect), pointer :: prep_lnd_get_g2x_lx(:)
! Subprogram not used     prep_lnd_get_g2x_lx => g2x_lx(:)   
! Subprogram not used   end function prep_lnd_get_g2x_lx 
...
! Subprogram not used   function prep_lnd_get_mapper_Fr2l()
! Subprogram not used     type(seq_map), pointer :: prep_lnd_get_mapper_Fr2l
! Subprogram not used     prep_lnd_get_mapper_Fr2l => mapper_Fr2l  
! Subprogram not used   end function prep_lnd_get_mapper_Fr2l

! Subprogram not used   function prep_lnd_get_mapper_SFg2l()
! Subprogram not used     type(seq_map), pointer :: prep_lnd_get_mapper_SFg2l
! Subprogram not used     prep_lnd_get_mapper_SFg2l => mapper_SFg2l  
! Subprogram not used   end function prep_lnd_get_mapper_SFg2l
