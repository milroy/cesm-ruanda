...
!-------------------------------------------------------------------
! Subprogram not used   subroutine aerodep_flx_set( cam_out, ncol, lchnk )
! Subprogram not used     use camsrfexch,       only : cam_out_t     
! Subprogram not used 
! Subprogram not used     type(cam_out_t),     intent(inout) :: cam_out
! Subprogram not used     integer,             intent(in)    :: ncol, lchnk
! Subprogram not used     
! Subprogram not used     if( .not. has_aerodep_flx ) return
! Subprogram not used     
! Subprogram not used     if (modal_fluxes) then
! Subprogram not used        call set_modal_fluxes( cam_out, ncol, lchnk )
! Subprogram not used     else
! Subprogram not used        call set_bulk_fluxes( cam_out, ncol, lchnk )
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used   end subroutine aerodep_flx_set
...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine set_bulk_fluxes( cam_out, ncol, lchnk )
! Subprogram not used     use camsrfexch,            only : cam_out_t     
! Subprogram not used 
...
! Subprogram not used     integer,         intent(in)    :: ncol, lchnk
! Subprogram not used 
! Subprogram not used     call set_fluxes( cam_out%bcphiwet, ibcphiwet, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%bcphidry, ibcphidry, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%bcphodry, ibcphodry, ncol, lchnk )
! Subprogram not used 
! Subprogram not used     call set_fluxes( cam_out%ocphiwet, iocphiwet, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%ocphidry, iocphidry, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%ocphodry, iocphodry, ncol, lchnk )
! Subprogram not used 
! Subprogram not used     call set_fluxes( cam_out%dstdry1, idstdry1, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstdry2, idstdry2, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstdry3, idstdry3, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstdry4, idstdry4, ncol, lchnk )
! Subprogram not used 
! Subprogram not used     call set_fluxes( cam_out%dstwet1, idstwet1, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstwet2, idstwet2, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstwet3, idstwet3, ncol, lchnk )
! Subprogram not used     call set_fluxes( cam_out%dstwet4, idstwet4, ncol, lchnk )
! Subprogram not used 
! Subprogram not used   end subroutine set_bulk_fluxes

!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine set_modal_fluxes( cam_out, ncol, lchnk )
! Subprogram not used     use camsrfexch,            only : cam_out_t     
! Subprogram not used     use modal_aero_deposition, only : set_srf_drydep, set_srf_wetdep
! Subprogram not used 
! Subprogram not used     ! Arguments
! Subprogram not used     type(cam_out_t), intent(inout) :: cam_out
! Subprogram not used     integer,         intent(in)    :: ncol, lchnk
...
! Subprogram not used     real(r8) :: aerdepdryis(pcols,nmodal_idxs)
! Subprogram not used     real(r8) :: aerdepdrycw(pcols,nmodal_idxs)
! Subprogram not used     real(r8) :: aerdepwetis(pcols,nmodal_idxs)
! Subprogram not used     real(r8) :: aerdepwetcw(pcols,nmodal_idxs)
! Subprogram not used 
! Subprogram not used     ! bin the fluxes as using modal_aero_deposition...
! Subprogram not used 
! Subprogram not used     aerdepdryis(:,:) = 0._r8
! Subprogram not used     aerdepdrycw(:,:) = 0._r8
! Subprogram not used     aerdepwetis(:,:) = 0._r8
! Subprogram not used     aerdepwetcw(:,:) = 0._r8
! Subprogram not used 
! Subprogram not used     call set_fluxes( aerdepwetis(:ncol,idx_bc1 ), idx_bc1_wetis , ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetcw(:ncol,idx_bc1 ), idx_bc1_wetcw , ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetis(:ncol,idx_pom1), idx_pom1_wetis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetcw(:ncol,idx_pom1), idx_pom1_wetcw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetis(:ncol,idx_soa1), idx_soa1_wetis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetcw(:ncol,idx_soa1), idx_soa1_wetcw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetis(:ncol,idx_dst1), idx_dst1_wetis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetcw(:ncol,idx_dst1), idx_dst1_wetcw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetis(:ncol,idx_dst3), idx_dst3_wetis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepwetcw(:ncol,idx_dst3), idx_dst3_wetcw, ncol, lchnk )
! Subprogram not used 
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_bc1 ), idx_bc1_dryis , ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_bc1 ), idx_bc1_drycw , ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_pom1), idx_pom1_dryis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_pom1), idx_pom1_drycw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_soa1), idx_soa1_dryis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_soa1), idx_soa1_drycw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_soa2), idx_soa2_dryis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_soa2), idx_soa2_drycw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_dst1), idx_dst1_dryis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_dst1), idx_dst1_drycw, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdryis(:ncol,idx_dst3), idx_dst3_dryis, ncol, lchnk )
! Subprogram not used     call set_fluxes( aerdepdrycw(:ncol,idx_dst3), idx_dst3_drycw, ncol, lchnk )
! Subprogram not used 
! Subprogram not used     call set_srf_drydep(aerdepdryis, aerdepdrycw, cam_out)
! Subprogram not used     call set_srf_wetdep(aerdepwetis, aerdepwetcw, cam_out)
! Subprogram not used 
! Subprogram not used   end  subroutine set_modal_fluxes
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------
! Subprogram not used !-------------------------------------------------------------------
! Subprogram not used   subroutine set_fluxes( fluxes, fld_indx, ncol, lchnk )
! Subprogram not used     use cam_history,  only : outfld
! Subprogram not used 
! Subprogram not used     real(r8), intent(inout) :: fluxes(:)
! Subprogram not used     integer,  intent(in)    :: fld_indx, ncol, lchnk
! Subprogram not used 
! Subprogram not used     integer :: i
! Subprogram not used 
! Subprogram not used     if (fld_indx<1) return
! Subprogram not used 
! Subprogram not used     do i = 1,ncol
! Subprogram not used        ! modal aero wet dep history fields are negative
! Subprogram not used        fluxes(i) = fields(fld_indx)%data(i,1,lchnk)
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used     call outfld(trim(fields(fld_indx)%fldnam)//'_D', fluxes(:ncol), ncol, lchnk )
! Subprogram not used 
! Subprogram not used   endsubroutine set_fluxes
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------
! Subprogram not used !-------------------------------------------------------------------
! Subprogram not used   integer function get_ndx( name, list )
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     character(len=*), intent(in) :: name
! Subprogram not used     character(len=*), intent(in) :: list(:)
! Subprogram not used 
! Subprogram not used     integer :: i
! Subprogram not used     integer :: maxnum
! Subprogram not used 
! Subprogram not used     maxnum = size(list)
! Subprogram not used 
! Subprogram not used     get_ndx = -1
! Subprogram not used     do i = 1, maxnum
! Subprogram not used       if ( trim(name) == trim(list(i)) ) then
...
! Subprogram not used 
! Subprogram not used end module aerodep_flx
