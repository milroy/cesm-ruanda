...
!---------------------------Local variables-----------------------------
   ...
   if (masterproc) then
     ...
     call handle_ncerr( nf90_open (trim(locfn), NF90_NOWRITE, ncid),subname,309)

     write(iulog,*)'GHG_RAMP_READ:  reading ramped greenhouse gas surface data from file ',trim(locfn)

     call handle_ncerr( nf90_inq_varid( ncid, 'date', date_id ),subname,313)
     call handle_ncerr( nf90_inq_varid( ncid, 'CO2', co2_id ),subname,314)
     call handle_ncerr( nf90_inq_varid( ncid, 'CH4', ch4_id ),subname,315)
     call handle_ncerr( nf90_inq_varid( ncid, 'N2O', n2o_id ),subname,316)
     call handle_ncerr( nf90_inq_varid( ncid, 'f11', f11_id ),subname,317)
     call handle_ncerr( nf90_inq_varid( ncid, 'f12', f12_id ),subname,318)
     call handle_ncerr( nf90_inq_varid( ncid, 'adj', adj_id ),subname,319)
     call handle_ncerr( nf90_inq_dimid( ncid, 'time', time_id ),subname,320)
     call handle_ncerr( nf90_inquire_dimension( ncid, time_id, len=ntim ),subname,321)
   ...
   if (masterproc) then
     call handle_ncerr( nf90_get_var (ncid, date_id, yrdata ),subname,335)
     yrdata = yrdata / 10000
     call handle_ncerr( nf90_get_var (ncid, co2_id, co2 ),subname,337)
     call handle_ncerr( nf90_get_var (ncid, ch4_id, ch4 ),subname,338)
     call handle_ncerr( nf90_get_var (ncid, n2o_id, n2o ),subname,339)
     call handle_ncerr( nf90_get_var (ncid, f11_id, f11 ),subname,340)
     call handle_ncerr( nf90_get_var (ncid, f12_id, f12 ),subname,341)
     call handle_ncerr( nf90_get_var (ncid, adj_id, adj ),subname,342)
     call handle_ncerr( nf90_close (ncid),subname,343)
