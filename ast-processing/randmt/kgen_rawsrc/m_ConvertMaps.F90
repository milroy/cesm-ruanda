...
!\begin{tabular}{|c|c|}
!\hline
!{\bf Value of {\tt status}} & {\bf Significance} \!\hline
!{\tt 0} & Map Conversion Successful \!\hline
!{\tt 1} & Unsuccessful--more than one segment per process, \! & or a negative numer of segments (ERROR) \!\hline
!{\tt 2} & Unsuccessful--{\tt GSMap} haloed \!\hline
!{\tt 3} & Unsuccessful--{\tt GSMap} segments out-of-order \! & with respect to resident process ID ranks \!\hline
!\end{tabular}
!\end{center}
!\end{table}
!
