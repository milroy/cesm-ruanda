...
! {\bf Quantity} & {\bf Stored in} & {\bf Referenced by}  \!  & {\bf Argument}    & {\bf Argument} \! \hline
! \hline 
! $ {a_i} $ & {\tt inAv1} & \! \hline
! $ {b_i} $ & {\tt inAv2} & \! \hline
! $ {c_i} $ & {\tt outAv} & \! \hline
! $ {\kappa_i^j}, j=1,\ldots,J $ & {\tt GGrid} & {\tt iMaskTags1}\! & & ($J$ items) \! \hline
! $ {\alpha_i^k}, k=1,\ldots,K $ & {\tt GGrid} & {\tt rMaskTags1}\! & & ($K$ items) \! \hline
! $ {\lambda_i^l}, l=1,\ldots,L $ & {\tt GGrid} & {\tt iMaskTags2}\! & & ($L$ items) \! \hline
! $ {\beta_i^m}, m=1,\ldots,M $ & {\tt GGrid} & {\tt rMaskTags2}\! & & ($M$ items) \! \hline
! $ {W_i} $ & {\tt WeightSum} & \! \hline
! \end{tabular}
! \end{center}
!
! !INTERFACE:
...
! $ {\lambda_i^l}, l=1,\ldots,L $ & {\tt GGrid} & {\tt iMaskTags2}\! & & ($L$ items) \! \hline
! $ {\beta_i^m}, m=1,\ldots,M $ & {\tt GGrid} & {\tt rMaskTags2}\! & & ($M$ items) \! \hline
! $ {\mu_i^p}, p=1,\ldots,P $ & {\tt GGrid} & {\tt iMaskTags3}\! & & ($L$ items) \! \hline
! $ {\gamma_i^q}, q=1,\ldots,Q $ & {\tt GGrid} & {\tt rMaskTags3}\! & & ($M$ items) \! \hline
! $ {W_i} $ & {\tt WeightSum} & \! \hline
! \end{tabular}
! \end{center}
!
...
! $ {\mu_i^p}, p=1,\ldots,P $ & {\tt GGrid} & {\tt iMaskTags3}\! & & ($L$ items) \! \hline
! $ {\gamma_i^q}, q=1,\ldots,Q $ & {\tt GGrid} & {\tt rMaskTags3}\! & & ($M$ items) \! \hline
! $ {\nu_i^r}, r=1,\ldots,R $ & {\tt GGrid} & {\tt iMaskTags4}\! & & ($L$ items) \! \hline
! $ {\delta_i^s}, s=1,\ldots,S $ & {\tt GGrid} & {\tt rMaskTags4}\! & & ($M$ items) \! \hline
! $ {W_i} $ & {\tt WeightSum} & \! \hline
! \end{tabular}
! \end{center}
!
