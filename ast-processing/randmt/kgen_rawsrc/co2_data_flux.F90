...
!  integer,  parameter :: totsz=2000           ! number greater than data time sample
  ...
  integer :: lonsiz  ! size of longitude dimension, dataset is 2d(lat,lon), in 1 grid
...
! 1: Master does all the work.  Sends needed info to slaves
