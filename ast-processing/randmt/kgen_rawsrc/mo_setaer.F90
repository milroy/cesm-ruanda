...
!    729.00- 743.60
!
! For aerosol types so4 and  ant data tabulated for 1 is used in wavelength bins for which it exists
...
! 
! note this treatment of dust is somewhat different than that made in 1, where each size bin
! has a different number median radius
!
! dust is not assumed to take up water. 
!
! refractive indexes are as in 1 (Fillmore...)
!
! ORGANIC CARBON
!
...
! In a different formulation than that followed in 1 we let hydrophillic soot grow.
!  The growth of organic carbon with relative humidity is assumed constant at all radii following
! hygrscopic growth given in Chen et al. : rel. hum: 0, 50, 70, 80, 90, 95, 98, 99
