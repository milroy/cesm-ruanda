...
!
! !REVISION HISTORY:
!  SVN:$Id: ice_broadcast.F90 100 2008-01-29 00:25:32Z eclare $
!
...
! Subprogram not used subroutine broadcast_array_real_1d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a real vector from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used !  same as module
! Subprogram not used 
! Subprogram not used ! !INCLUDES:
! Subprogram not used 
! Subprogram not used    include 'mpif.h'  ! MPI Fortran include file
! Subprogram not used 
! Subprogram not used ! !INPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    integer (int_kind), intent(in) :: &
! Subprogram not used      root_pe              ! processor number to broadcast from
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    real (real_kind), dimension(:), intent(inout) :: &
! Subprogram not used      array                ! array to be broadcast
! Subprogram not used 
...
! Subprogram not used      nelements,          &! size of array to be broadcast
! Subprogram not used      ierr                 ! local MPI error flag
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nelements = size(array)
! Subprogram not used 
! Subprogram not used    call MPI_BCAST(array, nelements, mpiR4, root_pe, MPI_COMM_ICE, ierr)
! Subprogram not used    call MPI_BARRIER(MPI_COMM_ICE, ierr)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_real_1d
...
! Subprogram not used subroutine broadcast_array_log_1d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a logical vector from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    logical (log_kind), dimension(:), intent(inout) :: &
! Subprogram not used      array                ! array to be broadcast
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used !BOC
...
! Subprogram not used       array_int            ! temporary array for MPI bcast
! Subprogram not used 
! Subprogram not used    integer (int_kind) :: &
! Subprogram not used       nelements,          &! size of array to be broadcast
! Subprogram not used       ierr                 ! local MPI error flag
...
! Subprogram not used 
! Subprogram not used    nelements = size(array)
! Subprogram not used    allocate(array_int(nelements))
! Subprogram not used 
! Subprogram not used    where (array)
! Subprogram not used      array_int = 1
! Subprogram not used    elsewhere
! Subprogram not used      array_int = 0
! Subprogram not used    end where
! Subprogram not used 
! Subprogram not used    call MPI_BCAST(array_int, nelements, MPI_INTEGER, root_pe, &
! Subprogram not used                   MPI_COMM_ICE, ierr)
! Subprogram not used    call MPI_BARRIER(MPI_COMM_ICE, ierr)
! Subprogram not used 
! Subprogram not used    where (array_int == 1)
! Subprogram not used      array = .true.
! Subprogram not used    elsewhere
! Subprogram not used      array = .false.
! Subprogram not used    end where
! Subprogram not used 
! Subprogram not used    deallocate(array_int)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_log_1d
...
! Subprogram not used  subroutine broadcast_array_real_2d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a real 2d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_real_2d
...
! Subprogram not used  subroutine broadcast_array_int_2d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a 2d integer array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used    nelements = size(array)
! Subprogram not used 
! Subprogram not used    call MPI_BCAST(array, nelements, MPI_INTEGER, root_pe, MPI_COMM_ICE, ierr)
! Subprogram not used    call MPI_BARRIER(MPI_COMM_ICE, ierr)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_int_2d
...
! Subprogram not used  subroutine broadcast_array_log_2d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a logical 2d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used 
! Subprogram not used    nelements = size(array)
! Subprogram not used    allocate(array_int(size(array,dim=1),size(array,dim=2)))
! Subprogram not used 
! Subprogram not used    where (array)
! Subprogram not used      array_int = 1
! Subprogram not used    elsewhere
...
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_log_2d
...
! Subprogram not used  subroutine broadcast_array_dbl_3d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a double 3d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used 
! Subprogram not used    integer (int_kind) :: &
! Subprogram not used      nelements,       &! size of array
! Subprogram not used      ierr              ! local MPI error flag
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    nelements = size(array)
! Subprogram not used 
! Subprogram not used    call MPI_BCAST(array, nelements, mpiR8, root_pe, MPI_COMM_ICE, ierr)
! Subprogram not used    call MPI_BARRIER(MPI_COMM_ICE, ierr)
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_dbl_3d
...
! Subprogram not used  subroutine broadcast_array_real_3d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a real 3d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_real_3d
...
! Subprogram not used  subroutine broadcast_array_int_3d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts an integer 3d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_int_3d
...
! Subprogram not used  subroutine broadcast_array_log_3d(array, root_pe)
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !  Broadcasts a logical 3d array from one processor (root_pe)
! Subprogram not used !  to all other processors. This is a specific instance of the generic
! Subprogram not used !  broadcast\_array interface.
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
...
! Subprogram not used 
! Subprogram not used    nelements = size(array)
! Subprogram not used    allocate(array_int(size(array,dim=1), &
! Subprogram not used                       size(array,dim=2), &
! Subprogram not used                       size(array,dim=3)))
! Subprogram not used 
! Subprogram not used    where (array)
! Subprogram not used      array_int = 1
! Subprogram not used    elsewhere
...
! Subprogram not used !EOC
! Subprogram not used 
! Subprogram not used  end subroutine broadcast_array_log_3d
