...
! Subprogram not used   subroutine UniqueNcolsP(elem,idxUnique,cid)    
! Subprogram not used     use element_mod, only : GetColumnIdP, element_t
! Subprogram not used     type (element_t), intent(in) :: elem
! Subprogram not used     type (index_t), intent(in) :: idxUnique
! Subprogram not used     integer,intent(out) :: cid(:)
! Subprogram not used     integer(kind=int_kind) :: i,j,ii
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     do ii=1,idxUnique%NumUniquePts
! Subprogram not used        i=idxUnique%ia(ii)
! Subprogram not used        j=idxUnique%ja(ii)
! Subprogram not used        cid(ii)=GetColumnIdP(elem,i,j)
! Subprogram not used     enddo
! Subprogram not used     
! Subprogram not used   end subroutine UniqueNcolsP
...
! ==========================================
! Subprogram not used   subroutine PrintDofP(elem)
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used    type (element_t), intent(in) :: elem(:)
! Subprogram not used 
! Subprogram not used    integer :: ie,nse,i,j
! Subprogram not used    
! Subprogram not used 
! Subprogram not used    nse = SIZE(elem)
! Subprogram not used  
! Subprogram not used    do ie=1,nse
! Subprogram not used       print *,'Element # ',elem(ie)%vertex%number
! Subprogram not used       do j=np,1,-1
! Subprogram not used          write(6,*) (elem(ie)%gdofP(i,j), i=1,np)
! Subprogram not used       enddo
! Subprogram not used    enddo
! Subprogram not used  10 format('I5')
! Subprogram not used 
! Subprogram not used  end subroutine PrintDofP
