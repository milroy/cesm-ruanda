...
!*************************************************************************
! Subprogram not used       real(kind=r8) function earth_sun(idn)
! Subprogram not used !*************************************************************************
! Subprogram not used !
! Subprogram not used !  Purpose: Function to calculate the correction factor of Earth's orbit
! Subprogram not used !  for current day of the year
! Subprogram not used 
! Subprogram not used !  idn        : Day of the year
! Subprogram not used !  earth_sun  : square of the ratio of mean to actual Earth-Sun distance
! Subprogram not used 
! Subprogram not used ! ------- Modules -------
! Subprogram not used 
! Subprogram not used       use rrsw_con, only : pi
! Subprogram not used 
! Subprogram not used       integer, intent(in) :: idn
! Subprogram not used 
! Subprogram not used       real(kind=r8) :: gamma
! Subprogram not used 
! Subprogram not used       gamma = 2._r8*pi*(idn-1)/365._r8
! Subprogram not used 
! Subprogram not used ! Use Iqbal's equation 1.2.1
! Subprogram not used 
! Subprogram not used       earth_sun = 1.000110_r8 + .034221_r8 * cos(gamma) + .001289_r8 * sin(gamma) + &
! Subprogram not used                    .000719_r8 * cos(2._r8*gamma) + .000077_r8 * sin(2._r8*gamma)
! Subprogram not used 
! Subprogram not used       end function earth_sun
