...
!
    ...
    if(file%iosystem%ioproc) then
       ...
       case(pio_iotype_pnetcdf)
          ...
          if(Debug.or.ierr/=PIO_noerr) print *,subname,105, &
               '  IAM: ',File%iosystem%io_rank,' start: ',start,' count: ',count,&
               ' size :',iodesc%Write%n_ElemTYPE, ' error: ',ierr, &
               iodesc%Write%ElemTYPE, request
!          if(Debug.or.ierr/=PIO_noerr) print *,subname,109, &
!               '  IAM: ',File%iosystem%io_rank,'minval: ',minval(IOBUF),'maxval: ',maxval(IOBUF)
       ...
       case(pio_iotype_netcdf,pio_iotype_netcdf4c)
          ...
          if(File%iosystem%num_iotasks>1) then
             if(Debug) print *,"/glade/u/home/milroy/cesm/cesm1_3_beta11/models/utils/pio/pionfwrite_mod.F90.in",123
             ...
             if(Debug) print *,"/glade/u/home/milroy/cesm/cesm1_3_beta11/models/utils/pio/pionfwrite_mod.F90.in",127,iobuf_size
          ...
          if (File%iosystem%io_rank==0) then 
             ...
             do i=1,File%iosystem%num_iotasks-1
	           ...
	           if(sum(temp_count(1:ndims))>0) then
                      ...
                      if(Debug) print *, subname,218,i,fh,vid, ierr
