...
!
! !INTERFACE:
! Subprogram not used   subroutine hfields_1dinfo(t, mode)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Write/define 1d info for history tape.
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used     use clmtype
! Subprogram not used     use decompMod   , only : ldecomp
! Subprogram not used     use domainMod   , only : ldomain, ldomain
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used     implicit none
! Subprogram not used     integer, intent(in) :: t                ! tape index
! Subprogram not used     character(len=*), intent(in) :: mode    ! 'define' or 'write'
! Subprogram not used !
...
! Subprogram not used     integer :: f                         ! field index
! Subprogram not used     integer :: k                         ! 1d index
! Subprogram not used     integer :: g,c,l,p                   ! indices
...
! Subprogram not used     integer :: ier                       ! errir status
! Subprogram not used     real(r8), pointer :: rgarr(:)        ! temporary
! Subprogram not used     real(r8), pointer :: rcarr(:)        ! temporary
! Subprogram not used     real(r8), pointer :: rlarr(:)        ! temporary
! Subprogram not used     real(r8), pointer :: rparr(:)        ! temporary
! Subprogram not used     integer , pointer :: igarr(:)        ! temporary
! Subprogram not used     integer , pointer :: icarr(:)        ! temporary
! Subprogram not used     integer , pointer :: ilarr(:)        ! temporary
! Subprogram not used     integer , pointer :: iparr(:)        ! temporary
! Subprogram not used     type(file_desc_t) :: ncid            ! netcdf file
...
! Subprogram not used     character(len=*),parameter :: subname = 'hfields_1dinfo'
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     ncid = nfid(t)
! Subprogram not used 
! Subprogram not used     if (mode == 'define') then
! Subprogram not used 
! Subprogram not used           ! Define gridcell info
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='grid1d_lon', xtype=ncd_double, dim1name=nameg, &
! Subprogram not used                long_name='gridcell longitude', units='degrees_east', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='grid1d_lat', xtype=ncd_double,  dim1name=nameg, &
! Subprogram not used                long_name='gridcell latitude', units='degrees_north', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='grid1d_ixy', xtype=ncd_int, dim1name=nameg, &
! Subprogram not used                long_name='2d longitude index of corresponding gridcell', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='grid1d_jxy', xtype=ncd_int, dim1name=nameg, &
! Subprogram not used                long_name='2d latitude index of corresponding gridcell', ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! Define landunit info
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_lon', xtype=ncd_double, dim1name=namel, &
! Subprogram not used                long_name='landunit longitude', units='degrees_east', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_lat', xtype=ncd_double, dim1name=namel, &
! Subprogram not used                long_name='landunit latitude', units='degrees_north', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_ixy', xtype=ncd_int, dim1name=namel, &
! Subprogram not used                long_name='2d longitude index of corresponding landunit', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_jxy', xtype=ncd_int, dim1name=namel, &
! Subprogram not used                long_name='2d latitude index of corresponding landunit', ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 --- Bug 1310
! Subprogram not used           !call ncd_defvar(varname='land1d_gi', xtype=ncd_int, dim1name='landunit', &
! Subprogram not used           !     long_name='1d grid index of corresponding landunit', ncid=ncid)
! Subprogram not used           ! ----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_wtgcell', xtype=ncd_double, dim1name=namel, &
! Subprogram not used                long_name='landunit weight relative to corresponding gridcell', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='land1d_ityplunit', xtype=ncd_int, dim1name=namel, &
! Subprogram not used                long_name='landunit type (vegetated,urban,lake,wetland,glacier or glacier_mec)', &
! Subprogram not used                   ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! Define column info
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_lon', xtype=ncd_double, dim1name=namec, &
! Subprogram not used                long_name='column longitude', units='degrees_east', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_lat', xtype=ncd_double, dim1name=namec, &
! Subprogram not used                long_name='column latitude', units='degrees_north', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_ixy', xtype=ncd_int, dim1name=namec, &
! Subprogram not used                long_name='2d longitude index of corresponding column', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_jxy', xtype=ncd_int, dim1name=namec, &
! Subprogram not used                long_name='2d latitude index of corresponding column', ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 --- Bug 1310
! Subprogram not used           !call ncd_defvar(varname='cols1d_gi', xtype=ncd_int, dim1name='column', &
! Subprogram not used           !     long_name='1d grid index of corresponding column', ncid=ncid)
! Subprogram not used 
! Subprogram not used           !call ncd_defvar(varname='cols1d_li', xtype=ncd_int, dim1name='column', &
! Subprogram not used           !     long_name='1d landunit index of corresponding column', ncid=ncid)
! Subprogram not used           ! ----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_wtgcell', xtype=ncd_double, dim1name=namec, &
! Subprogram not used                long_name='column weight relative to corresponding gridcell', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_wtlunit', xtype=ncd_double, dim1name=namec, &
! Subprogram not used                long_name='column weight relative to corresponding landunit', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='cols1d_itype_lunit', xtype=ncd_int, dim1name=namec, &
! Subprogram not used                long_name='column landunit type (vegetated,urban,lake,wetland,glacier or glacier_mec)', &
! Subprogram not used                   ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! Define pft info
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_lon', xtype=ncd_double, dim1name=namep, &
! Subprogram not used                long_name='pft longitude', units='degrees_east', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_lat', xtype=ncd_double, dim1name=namep, &
! Subprogram not used                long_name='pft latitude', units='degrees_north', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_ixy', xtype=ncd_int, dim1name=namep, &
! Subprogram not used                long_name='2d longitude index of corresponding pft', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_jxy', xtype=ncd_int, dim1name=namep, &
! Subprogram not used                long_name='2d latitude index of corresponding pft', ncid=ncid)
! Subprogram not used 
! Subprogram not used           ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 --- Bug 1310
! Subprogram not used           !call ncd_defvar(varname='pfts1d_gi', xtype=ncd_int, dim1name='pft', &
! Subprogram not used           !     long_name='1d grid index of corresponding pft', ncid=ncid)
! Subprogram not used 
! Subprogram not used           !call ncd_defvar(varname='pfts1d_li', xtype=ncd_int, dim1name='pft', &
! Subprogram not used           !     long_name='1d landunit index of corresponding pft', ncid=ncid)
! Subprogram not used 
! Subprogram not used           !call ncd_defvar(varname='pfts1d_ci', xtype=ncd_int, dim1name='pft', &
! Subprogram not used           !     long_name='1d column index of corresponding pft', ncid=ncid)
! Subprogram not used           ! ----------------------------------------------------------------
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_wtgcell', xtype=ncd_double, dim1name=namep, &
! Subprogram not used                long_name='pft weight relative to corresponding gridcell', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_wtlunit', xtype=ncd_double, dim1name=namep, &
! Subprogram not used                long_name='pft weight relative to corresponding landunit', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_wtcol', xtype=ncd_double, dim1name=namep, &
! Subprogram not used                long_name='pft weight relative to corresponding column', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_itype_veg', xtype=ncd_int, dim1name=namep, &
! Subprogram not used                long_name='pft vegetation type', ncid=ncid)
! Subprogram not used 
! Subprogram not used           call ncd_defvar(varname='pfts1d_itype_lunit', xtype=ncd_int, dim1name=namep, &
! Subprogram not used                long_name='pft landunit type (vegetated,urban,lake,wetland,glacier or glacier_mec)',  &
! Subprogram not used                   ncid=ncid)
! Subprogram not used 
! Subprogram not used     else if (mode == 'write') then
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used        ! Determine bounds
! Subprogram not used 
! Subprogram not used        call get_proc_bounds(begg, endg, begl, endl, begc, endc, begp, endp)
! Subprogram not used 
! Subprogram not used        allocate(rgarr(begg:endg),rlarr(begl:endl),rcarr(begc:endc),rparr(begp:endp),stat=ier)
! Subprogram not used        if (ier /= 0) call endrun('hfields_1dinfo allocation error of rarrs')
! Subprogram not used 
! Subprogram not used        allocate(igarr(begg:endg),ilarr(begl:endl),icarr(begc:endc),iparr(begp:endp),stat=ier)
! Subprogram not used        if (ier /= 0) call endrun('hfields_1dinfo allocation error of iarrs')
! Subprogram not used 
! Subprogram not used        ! Write gridcell info
! Subprogram not used 
! Subprogram not used        call ncd_io(varname='grid1d_lon', data=gptr%londeg, dim1name=nameg, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='grid1d_lat', data=gptr%latdeg, dim1name=nameg, ncid=ncid, flag='write')
! Subprogram not used        do g=begg,endg
! Subprogram not used          igarr(g)= mod(ldecomp%gdc2glo(g)-1,ldomain%ni) + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='grid1d_ixy', data=igarr      , dim1name=nameg, ncid=ncid, flag='write')
! Subprogram not used        do g=begg,endg
! Subprogram not used          igarr(g)= (ldecomp%gdc2glo(g) - 1)/ldomain%ni + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='grid1d_jxy', data=igarr      , dim1name=nameg, ncid=ncid, flag='write')
! Subprogram not used 
! Subprogram not used        ! Write landunit info
! Subprogram not used 
! Subprogram not used        do l=begl,endl
! Subprogram not used          rlarr(l) = gptr%londeg(lptr%gridcell(l))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='land1d_lon', data=rlarr, dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        do l=begl,endl
! Subprogram not used          rlarr(l) = gptr%latdeg(lptr%gridcell(l))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='land1d_lat', data=rlarr, dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        do l=begl,endl
! Subprogram not used          ilarr(l) = mod(ldecomp%gdc2glo(lptr%gridcell(l))-1,ldomain%ni) + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='land1d_ixy', data=ilarr, dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        do l=begl,endl
! Subprogram not used          ilarr(l) = (ldecomp%gdc2glo(lptr%gridcell(l))-1)/ldomain%ni + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='land1d_jxy'      , data=ilarr        , dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 Bug 1310
! Subprogram not used        !call ncd_io(varname='land1d_gi'       , data=lptr%gridcell, dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        ! ----------------------------------------------------------------
! Subprogram not used        call ncd_io(varname='land1d_wtgcell'  , data=lptr%wtgcell , dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='land1d_ityplunit', data=lptr%itype   , dim1name=namel, ncid=ncid, flag='write')
! Subprogram not used 
! Subprogram not used        ! Write column info
! Subprogram not used 
! Subprogram not used        do c=begc,endc
! Subprogram not used          rcarr(c) = gptr%londeg(cptr%gridcell(c))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='cols1d_lon', data=rcarr, dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        do c=begc,endc
! Subprogram not used          rcarr(c) = gptr%latdeg(cptr%gridcell(c))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='cols1d_lat', data=rcarr, dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        do c=begc,endc
! Subprogram not used          icarr(c) = mod(ldecomp%gdc2glo(cptr%gridcell(c))-1,ldomain%ni) + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='cols1d_ixy', data=icarr, dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        do c=begc,endc
! Subprogram not used          icarr(c) = (ldecomp%gdc2glo(cptr%gridcell(c))-1)/ldomain%ni + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='cols1d_jxy'    , data=icarr         ,dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 Bug 1310
! Subprogram not used        !call ncd_io(varname='cols1d_gi'     , data=cptr%gridcell, dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        !call ncd_io(varname='cols1d_li'     , data=cptr%landunit, dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        ! ----------------------------------------------------------------
! Subprogram not used        call ncd_io(varname='cols1d_wtgcell', data=cptr%wtgcell , dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='cols1d_wtlunit', data=cptr%wtlunit , dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used        do c=begc,endc
! Subprogram not used          icarr(c) = lptr%itype(cptr%landunit(c))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='cols1d_itype_lunit', data=icarr    , dim1name=namec, ncid=ncid, flag='write')
! Subprogram not used 
! Subprogram not used        ! Write pft info
! Subprogram not used 
! Subprogram not used        do p=begp,endp
! Subprogram not used          rparr(p) = gptr%londeg(pptr%gridcell(p))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='pfts1d_lon', data=rparr, dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        do p=begp,endp
! Subprogram not used          rparr(p) = gptr%latdeg(pptr%gridcell(p))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='pfts1d_lat', data=rparr, dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        do p=begp,endp
! Subprogram not used          iparr(p) = mod(ldecomp%gdc2glo(pptr%gridcell(p))-1,ldomain%ni) + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='pfts1d_ixy', data=iparr, dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        do p=begp,endp
! Subprogram not used          iparr(p) = (ldecomp%gdc2glo(pptr%gridcell(p))-1)/ldomain%ni + 1
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='pfts1d_jxy'      , data=iparr        , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        ! --- EBK Do NOT write out indices that are incorrect 4/1/2011 --- Bug 1310
! Subprogram not used        !call ncd_io(varname='pfts1d_gi'       , data=pptr%gridcell, dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        !call ncd_io(varname='pfts1d_li'       , data=pptr%landunit, dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        !call ncd_io(varname='pfts1d_ci'       , data=pptr%column  , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        ! ----------------------------------------------------------------
! Subprogram not used        call ncd_io(varname='pfts1d_wtgcell'  , data=pptr%wtgcell , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='pfts1d_wtlunit'  , data=pptr%wtlunit , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='pfts1d_wtcol'    , data=pptr%wtcol   , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used        call ncd_io(varname='pfts1d_itype_veg', data=pptr%itype   , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used 
! Subprogram not used        do p=begp,endp
! Subprogram not used           iparr(p) = lptr%itype(pptr%landunit(p))
! Subprogram not used        enddo
! Subprogram not used        call ncd_io(varname='pfts1d_itype_lunit', data=iparr      , dim1name=namep, ncid=ncid, flag='write')
! Subprogram not used 
! Subprogram not used        deallocate(rgarr,rlarr,rcarr,rparr)
! Subprogram not used        deallocate(igarr,ilarr,icarr,iparr)
! Subprogram not used 
! Subprogram not used     end if
! Subprogram not used 
! Subprogram not used   end subroutine hfields_1dinfo
...
!
! !INTERFACE:
! Subprogram not used integer function max_nFields()
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Get the maximum number of fields on all tapes.
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used      implicit none
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Erik Kluzek
! Subprogram not used !
! Subprogram not used !
! Subprogram not used ! !LOCAL VARIABLES:
! Subprogram not used !EOP
! Subprogram not used   integer :: t  ! index
! Subprogram not used   character(len=*),parameter :: subname = 'max_nFields'
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used   max_nFields = 0
! Subprogram not used   do t = 1,ntapes
! Subprogram not used      max_nFields = max(max_nFields, tape(t)%nflds)
! Subprogram not used   end do
! Subprogram not used 
! Subprogram not used   return
! Subprogram not used 
! Subprogram not used end function max_nFields
...
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Retrieve flag portion of inname. If an averaging flag separater character
! Subprogram not used ! is present (:) in inname, return the character after it as the flag
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used      implicit none
! Subprogram not used      character(len=*) inname   ! character string
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Jim Rosinski
! Subprogram not used !
! Subprogram not used !
! Subprogram not used ! !LOCAL VARIABLES:
! Subprogram not used !EOP
...
! Subprogram not used      character(len=*),parameter :: subname = 'getflag'
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used      length = len (inname)
! Subprogram not used 
! Subprogram not used      if (length < max_namlen .or. length > max_namlen+2) then
! Subprogram not used         write(iulog,*) trim(subname),' ERROR: bad length=',length
! Subprogram not used         call endrun()
! Subprogram not used      end if
! Subprogram not used 
! Subprogram not used      getflag = ' '
! Subprogram not used      do i = 1,length
...
!
! !INTERFACE:
! Subprogram not used   subroutine hist_add_subscript(name, dim)
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used ! Add a history variable to the output history tape.
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used     implicit none
! Subprogram not used     character(len=*), intent(in) :: name ! name of subscript
! Subprogram not used     integer         , intent(in) :: dim  ! dimension of subscript
! Subprogram not used !
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! Created by Mariana Vertenstein
! Subprogram not used !
...
! Subprogram not used ! !LOCAL VARIABLES:
! Subprogram not used !EOP
! Subprogram not used     character(len=*),parameter :: subname = 'hist_add_subscript'
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     num_subs = num_subs + 1
! Subprogram not used     if (num_subs > max_subs) then
! Subprogram not used        write(iulog,*) trim(subname),' ERROR: ',&
! Subprogram not used             ' num_subs = ',num_subs,' greater than max_subs= ',max_subs
! Subprogram not used        call endrun()
! Subprogram not used     endif
! Subprogram not used     subs_name(num_subs) = name
! Subprogram not used     subs_dim(num_subs) =  dim
! Subprogram not used 
! Subprogram not used   end subroutine hist_add_subscript
