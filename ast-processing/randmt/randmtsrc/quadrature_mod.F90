...
! Subprogram not used   subroutine test_gausslobatto(npts)
! Subprogram not used     use kinds, only : real_kind
! Subprogram not used     integer, intent(in) :: npts
! Subprogram not used     type (quadrature_t) :: gll
! Subprogram not used 
! Subprogram not used     integer i
! Subprogram not used     real (kind=real_kind) :: gllsum
! Subprogram not used     gll=gausslobatto(npts)
! Subprogram not used 
! Subprogram not used     print *
! Subprogram not used     print *,"============================================"
! Subprogram not used     print *,"      Testing Gauss-Lobatto Quadrature..."
! Subprogram not used     print *
! Subprogram not used     print *,"          points              weights"
! Subprogram not used     print *,"============================================"
! Subprogram not used     do i=1,npts
! Subprogram not used        print *,i,gll%points(i),gll%weights(i)
! Subprogram not used     end do
! Subprogram not used     print *,"============================================"
! Subprogram not used     gllsum=SUM(gll%weights(:))
! Subprogram not used     print *,"sum of Gauss-Lobatto weights=",gllsum
! Subprogram not used     print *,"============================================"
! Subprogram not used 
! Subprogram not used     deallocate(gll%points)
! Subprogram not used     deallocate(gll%weights)
! Subprogram not used 
! Subprogram not used   end subroutine test_gausslobatto
...
! Subprogram not used   function quad_norm(gquad,N) result(gamma)
! Subprogram not used     type (quadrature_t), intent(in) :: gquad
! Subprogram not used     integer            , intent(in) :: N
! Subprogram not used 
! Subprogram not used     real (kind=longdouble_kind) :: gamma(N)
! Subprogram not used 
! Subprogram not used     ! Local variables
! Subprogram not used     real (kind=longdouble_kind) :: leg(N)
! Subprogram not used     integer               :: i,k
! Subprogram not used 
! Subprogram not used     gamma(:)=0.0_longdouble_kind
! Subprogram not used 
! Subprogram not used     do i=1,N
! Subprogram not used        leg=legendre(gquad%points(i),N-1)
! Subprogram not used        do k=1,N
! Subprogram not used           gamma(k)= gamma(k)+leg(k)*leg(k)*gquad%weights(i)
! Subprogram not used        end do
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end function quad_norm
