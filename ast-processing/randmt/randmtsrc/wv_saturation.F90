...
! saturation vapor pressure and related calculations to 1.         !
!                                                                    !
...
! Subprogram not used elemental subroutine qsat_ice(t, p, es, qs, gam, dqsdt, enthalpy)
! Subprogram not used   !------------------------------------------------------------------!
...
! Subprogram not used   !   Optionally return various temperature derivatives or enthalpy  !
! Subprogram not used   !   at saturation.                                                 !
! Subprogram not used   !------------------------------------------------------------------!
! Subprogram not used 
! Subprogram not used   use wv_sat_methods, only: wv_sat_qsat_ice
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used   real(r8), intent(out), optional :: gam    ! (l/cpair)*(d(qs)/dt)
! Subprogram not used   real(r8), intent(out), optional :: dqsdt  ! (d(qs)/dt)
! Subprogram not used   real(r8), intent(out), optional :: enthalpy ! cpair*t + hltalt*q
! Subprogram not used 
! Subprogram not used   ! Local variables
! Subprogram not used   real(r8) :: hltalt       ! Modified latent heat for T derivatives
! Subprogram not used 
! Subprogram not used   call wv_sat_qsat_ice(t, p, es, qs)
! Subprogram not used 
! Subprogram not used   if (present(gam) .or. present(dqsdt) .or. present(enthalpy)) then
! Subprogram not used 
! Subprogram not used      ! For pure ice, just add latent heats.
! Subprogram not used      hltalt = latvap + latice
! Subprogram not used 
! Subprogram not used      if (present(enthalpy)) enthalpy = tq_enthalpy(t, qs, hltalt)
! Subprogram not used 
! Subprogram not used      ! For pure water/ice transition term is 0.
! Subprogram not used      call deriv_outputs(t, p, es, qs, hltalt, 0._r8, &
! Subprogram not used           gam=gam, dqsdt=dqsdt)
! Subprogram not used 
! Subprogram not used   end if
! Subprogram not used 
! Subprogram not used end subroutine qsat_ice
