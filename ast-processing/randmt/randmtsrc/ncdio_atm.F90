...
! Subprogram not used     use pio, only : pio_inq_dimid, pio_inq_dimlen
! Subprogram not used     !
...
! Subprogram not used     character(len=*), intent(in) :: dimname
! Subprogram not used     integer, intent(in) :: value
! Subprogram not used     !
...
! Subprogram not used     !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     ierr = PIO_inq_dimid (ncid, trim(dimname), dimid)
! Subprogram not used     ierr = PIO_inq_dimlen (ncid, dimid, dimlen)
! Subprogram not used     if (dimlen /= value) then
! Subprogram not used        write(iulog,*) 'CHECK_DIM error: mismatch of input dimension ',dimlen, &
