   ...
   ! Purpose:                                       !
   !                                                !
   ! 1 interface to the shallow convection scheme !
   !                                                !
   ! Author: D.B. Coleman                           !
...
! Subprogram not used function convect_shallow_implements_cnst(name)
! Subprogram not used 
! Subprogram not used    ! Return true if specified constituent is implemented by a shallow convetion package
! Subprogram not used 
! Subprogram not used    use unicon_cam, only: unicon_implements_cnst
! Subprogram not used 
! Subprogram not used    character(len=*), intent(in) :: name          ! constituent name
! Subprogram not used    logical :: convect_shallow_implements_cnst    ! return value
! Subprogram not used    
! Subprogram not used    integer :: m
! Subprogram not used    !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    select case (shallow_scheme)
! Subprogram not used 
! Subprogram not used    case('UNICON')
! Subprogram not used       convect_shallow_implements_cnst = unicon_implements_cnst(name)
! Subprogram not used 
! Subprogram not used    case default
! Subprogram not used       convect_shallow_implements_cnst = .false.
! Subprogram not used 
! Subprogram not used    end select
! Subprogram not used 
! Subprogram not used end function convect_shallow_implements_cnst

!==================================================================================================

! Subprogram not used subroutine convect_shallow_init_cnst(name, q, gcid)
! Subprogram not used 
! Subprogram not used   ! Initialize constituents if they are not read from the initial file
! Subprogram not used 
! Subprogram not used    use unicon_cam, only: unicon_init_cnst
! Subprogram not used 
! Subprogram not used    character(len=*), intent(in)  :: name     ! constituent name
...
! Subprogram not used 
! Subprogram not used    case('UNICON')
! Subprogram not used       call unicon_init_cnst(name, q, gcid)
! Subprogram not used 
! Subprogram not used    case default
! Subprogram not used 
! Subprogram not used    end select
! Subprogram not used 
! Subprogram not used end subroutine convect_shallow_init_cnst
