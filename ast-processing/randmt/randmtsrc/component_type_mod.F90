...
! Subprogram not used   function component_get_iamroot_compid(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp
! Subprogram not used     logical :: component_get_iamroot_compid
! Subprogram not used     component_get_iamroot_compid = comp%iamroot_compid
! Subprogram not used   end function component_get_iamroot_compid

! Subprogram not used   function component_get_suffix(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp
! Subprogram not used     character(len=CL) :: component_get_suffix
! Subprogram not used     component_get_suffix = comp%suffix
! Subprogram not used   end function component_get_suffix
...
! Subprogram not used   function component_get_cdata_cc(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp 
! Subprogram not used     type(seq_cdata), pointer :: component_get_cdata_cc
! Subprogram not used     component_get_cdata_cc => comp%cdata_cc
! Subprogram not used   end function component_get_cdata_cc

! Subprogram not used   function component_get_drv2mdl(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp 
! Subprogram not used     real(r8), pointer :: component_get_drv2mdl(:)
! Subprogram not used     component_get_drv2mdl => comp%drv2mdl
! Subprogram not used   end function component_get_drv2mdl

! Subprogram not used   function component_get_mdl2drv(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp 
! Subprogram not used     real(r8), pointer :: component_get_mdl2drv(:)
! Subprogram not used     component_get_mdl2drv => comp%mdl2drv
! Subprogram not used   end function component_get_mdl2drv
...
! Subprogram not used   function component_get_mapper_Cx2c(comp)
! Subprogram not used     type(component_type), intent(in), target :: comp 
! Subprogram not used     type(seq_map), pointer :: component_get_mapper_Cx2c
! Subprogram not used     component_get_mapper_Cx2c => comp%mapper_Cx2c
! Subprogram not used   end function component_get_mapper_Cx2c
