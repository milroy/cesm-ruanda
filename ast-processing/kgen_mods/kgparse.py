...
# Added by Dan to write processes files to disk
            outpath = '/glade/scratch/milroy/ufect.kgenparse.000/kgen_processed/' + os.path.basename(self.realpath)
            #print type(output), type(new_lines)
            with open(outpath + '_kgenout', 'w') as f:
                f.write(output)
