...
! !INTERFACE:
! Subprogram not used       subroutine ESMFold_TimeGetString( year, month, dayofmonth, &
! Subprogram not used                                         hour, minute, second, TimeString )
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       integer, intent(in) :: year
! Subprogram not used       integer, intent(in) :: month
! Subprogram not used       integer, intent(in) :: dayofmonth
! Subprogram not used       integer, intent(in) :: hour
! Subprogram not used       integer, intent(in) :: minute
! Subprogram not used       integer, intent(in) :: second
! Subprogram not used       character*(*), intent(out) :: TimeString
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Convert {\tt ESMF\_Time}'s value into ISO 8601 format YYYY-MM-DDThh:mm:ss
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[time]
...
! Subprogram not used !     TMG2.4.7
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  YR,S,Sn,Sd = ',time%YR,time%basetime%S,time%basetime%Sn,time%basetime%Sd
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  year = ',year
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  month, dayofmonth = ',month,dayofmonth
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  hour = ',hour
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  minute = ',minute
! Subprogram not used !PRINT *,'DEBUG:  ESMF_TimePrint():  second = ',second
! Subprogram not used 
! Subprogram not used !$$$here...  add negative sign for YR<0
! Subprogram not used !$$$here...  add Sn, Sd ??
! Subprogram not used       write(TimeString,FMT="(I4.4,'-',I2.2,'-',I2.2,'_',I2.2,':',I2.2,':',I2.2)") &
! Subprogram not used              year,month,dayofmonth,hour,minute,second
! Subprogram not used 
! Subprogram not used       end subroutine ESMFold_TimeGetString
...
!
! !INTERFACE:
! Subprogram not used       subroutine ESMF_TimeGetDayOfYearInteger(time, DayOfYear, rc)
! Subprogram not used !
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Time), intent(in) :: time
! Subprogram not used       integer, intent(out) :: DayOfYear
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used !
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     Get the day of the year the given {\tt ESMF\_Time} instant falls on
! Subprogram not used !     (1-365).  Returned as an integer value
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[time]
! Subprogram not used !          The object instance to query
! Subprogram not used !     \item[DayOfYear]
! Subprogram not used !          The {\tt ESMF\_Time} instant's day of the year (1-365)
! Subprogram not used !     \item[{[rc]}]
! Subprogram not used !          Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! Subprogram not used !     \end{description}
! Subprogram not used !
! Subprogram not used ! !REQUIREMENTS:
! Subprogram not used !EOP
! Subprogram not used       ! requires that time be normalized
! Subprogram not used !$$$ bug when Sn>0?  test
! Subprogram not used !$$$ add tests
! Subprogram not used       DayOfYear = ( time%basetime%S / 86400_ESMF_KIND_I8 ) + 1
! Subprogram not used       IF ( PRESENT( rc ) ) rc = ESMF_SUCCESS
! Subprogram not used       end subroutine ESMF_TimeGetDayOfYearInteger
...
! Subprogram not used    function ESMF_TimeInc2(timeinterval, time)
! Subprogram not used       type(ESMF_Time) :: ESMF_TimeInc2
! Subprogram not used       type(ESMF_Time), intent(in) :: time
! Subprogram not used       type(ESMF_TimeInterval), intent(in) :: timeinterval
! Subprogram not used       ESMF_TimeInc2 = ESMF_TimeInc( time, timeinterval )
! Subprogram not used    end function ESMF_TimeInc2
...
! this is added for certain compilers that don't deal with commutativity
!
! Subprogram not used    function ESMF_TimeDec2(timeinterval, time)
! Subprogram not used       type(ESMF_Time) :: ESMF_TimeDec2
! Subprogram not used       type(ESMF_Time), intent(in) :: time
! Subprogram not used       type(ESMF_TimeInterval), intent(in) :: timeinterval
! Subprogram not used       ESMF_TimeDec2 = ESMF_TimeDec( time, timeinterval )
! Subprogram not used    end function ESMF_TimeDec2
!
!------------------------------------------------------------------------------
!BOP
...
! !INTERFACE:
! Subprogram not used       subroutine ESMF_TimePrint(time, options, rc)
! Subprogram not used 
! Subprogram not used ! !ARGUMENTS:
! Subprogram not used       type(ESMF_Time), intent(in) :: time
! Subprogram not used       character (len=*), intent(in), optional :: options
! Subprogram not used       integer, intent(out), optional :: rc
! Subprogram not used       character (len=256) :: timestr
! Subprogram not used 
! Subprogram not used ! !DESCRIPTION:
! Subprogram not used !     To support testing/debugging, print out a {\tt ESMF\_Time}'s
! Subprogram not used !     properties.
! Subprogram not used !
! Subprogram not used !     The arguments are:
! Subprogram not used !     \begin{description}
! Subprogram not used !     \item[time]
! Subprogram not used !          {\tt ESMF\_Time} instant to print out
! Subprogram not used !     \item[{[options]}]
...
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used       ! Quick hack to mimic ESMF 2.0.1
! Subprogram not used       ! Really should check value of options...  
! Subprogram not used       IF ( PRESENT( options ) ) THEN
! Subprogram not used         CALL ESMF_TimeGet( time, timeString=timestr, rc=rc )
! Subprogram not used         timestr(11:11) = 'T'     ! ISO 8601 compatibility hack for debugging
! Subprogram not used         print *,' Time -----------------------------------'
! Subprogram not used         print *,' ',TRIM(timestr)
! Subprogram not used         print *,' end Time -------------------------------'
! Subprogram not used         print *
! Subprogram not used       ELSE
! Subprogram not used         call print_a_time (time)
! Subprogram not used       ENDIF
! Subprogram not used 
! Subprogram not used       end subroutine ESMF_TimePrint

!==============================================================================

! Subprogram not used SUBROUTINE print_a_time( time )
! Subprogram not used    IMPLICIT NONE
! Subprogram not used    type(ESMF_Time) time
! Subprogram not used    character*128 :: s
! Subprogram not used    integer rc
! Subprogram not used    CALL ESMF_TimeGet( time, timeString=s, rc=rc )
! Subprogram not used    print *,'Print a time|',TRIM(s),'|'
! Subprogram not used    write(0,*)'Print a time|',TRIM(s),'|'
! Subprogram not used    return
! Subprogram not used END SUBROUTINE print_a_time
