...
! Subprogram not used   function chem_implements_cnst(name)
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used ! 
...
! Subprogram not used ! 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     use chem_mods,       only : gas_pcnst, inv_lst, nfs
! Subprogram not used     use mo_tracname,     only : solsym
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !	... dummy arguments
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     character(len=*), intent(in) :: name   ! constituent name
! Subprogram not used     logical :: chem_implements_cnst        ! return value
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used !	... local variables
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     integer :: m
! Subprogram not used     
! Subprogram not used     chem_implements_cnst = .false.
! Subprogram not used     do m = 1,gas_pcnst
! Subprogram not used        if( trim(name) /= 'H2O' ) then
! Subprogram not used           if( trim(name) == solsym(m) ) then
! Subprogram not used              chem_implements_cnst = .true.
! Subprogram not used              exit
! Subprogram not used           end if
! Subprogram not used        end if
! Subprogram not used     end do
! Subprogram not used     do m = 1,nfs
! Subprogram not used        if( trim(name) /= 'H2O' ) then
! Subprogram not used           if( trim(name) == inv_lst(m) ) then
! Subprogram not used              chem_implements_cnst = .true.
! Subprogram not used              exit
! Subprogram not used           end if
...
! Subprogram not used 
! Subprogram not used   end function chem_implements_cnst
...
! Subprogram not used   subroutine chem_init_cnst( name, q, gcid)
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used ! 
! Subprogram not used ! Purpose: 
! Subprogram not used ! Specify initial mass mixing ratios
! Subprogram not used ! 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     use chem_mods, only : inv_lst
! Subprogram not used 
! Subprogram not used     use physconst,     only : mwdry, mwch4, mwn2o, mwf11, mwf12, mwh2o, mwo3
! Subprogram not used     use chem_surfvals, only : chem_surfvals_get
! Subprogram not used 
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     character(len=*), intent(in) :: name                   !  constituent name
! Subprogram not used     real(r8), intent(inout) :: q(:,:)           !  mass mixing ratio
...
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     
! Subprogram not used     real(r8) :: rmwn2o != mwn2o/mwdry ! ratio of mol weight n2o   to dry air
! Subprogram not used     real(r8) :: rmwch4 != mwch4/mwdry ! ratio of mol weight ch4   to dry air
! Subprogram not used     real(r8) :: rmwf11 != mwf11/mwdry ! ratio of mol weight cfc11 to dry air
! Subprogram not used     real(r8) :: rmwf12 != mwf12/mwdry ! ratio of mol weight cfc12 to dry air
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used ! initialize local variables
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     rmwn2o = mwn2o/mwdry 
! Subprogram not used     rmwch4 = mwch4/mwdry 
! Subprogram not used     rmwf11 = mwf11/mwdry 
! Subprogram not used     rmwf12 = mwf12/mwdry 
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used ! Get initial mixing ratios
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used     if ( any( inv_lst .eq. name ) ) then
! Subprogram not used        q(:,:) = 0.0_r8
! Subprogram not used     else
! Subprogram not used        q(:,:) = 1.e-38_r8
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used     if ( ghg_chem ) then
! Subprogram not used        select case (name)
! Subprogram not used        case ('N2O')
! Subprogram not used           q = rmwn2o * chem_surfvals_get('N2OVMR')
! Subprogram not used        case ('CH4')
! Subprogram not used           q = rmwch4 * chem_surfvals_get('CH4VMR')
! Subprogram not used        case ('CFC11')
! Subprogram not used           q = rmwf11 * chem_surfvals_get('F11VMR')
! Subprogram not used        case ('CFC12')
! Subprogram not used           q = rmwf12 * chem_surfvals_get('F12VMR')
! Subprogram not used        end select
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used   end subroutine chem_init_cnst
...
! Subprogram not used   subroutine chem_init_restart( File )
! Subprogram not used     use pio, only : file_desc_t
! Subprogram not used     use tracer_cnst,      only: init_tracer_cnst_restart
! Subprogram not used     use tracer_srcs,      only: init_tracer_srcs_restart
! Subprogram not used     use linoz_data, only : init_linoz_data_restart
! Subprogram not used     implicit none
! Subprogram not used     type(file_desc_t),intent(inout) :: File     ! pio File pointer
! Subprogram not used 
! Subprogram not used     !
! Subprogram not used     ! data for offline tracers
! Subprogram not used     !
! Subprogram not used     call init_tracer_cnst_restart(File)
! Subprogram not used     call init_tracer_srcs_restart(File)
! Subprogram not used     call init_linoz_data_restart(File)
! Subprogram not used   end subroutine chem_init_restart
!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine chem_write_restart( File )
! Subprogram not used     use tracer_cnst, only: write_tracer_cnst_restart
! Subprogram not used     use tracer_srcs, only: write_tracer_srcs_restart
! Subprogram not used     use linoz_data,  only: write_linoz_data_restart
! Subprogram not used     use pio, only : file_desc_t
! Subprogram not used     implicit none
...
! Subprogram not used     ! data for offline tracers
! Subprogram not used     !
! Subprogram not used     call write_tracer_cnst_restart(File)
! Subprogram not used     call write_tracer_srcs_restart(File)
! Subprogram not used     call write_linoz_data_restart(File)
! Subprogram not used   end subroutine chem_write_restart

!-------------------------------------------------------------------
!-------------------------------------------------------------------
! Subprogram not used   subroutine chem_read_restart( File )
! Subprogram not used     use tracer_cnst, only: read_tracer_cnst_restart
! Subprogram not used     use tracer_srcs, only: read_tracer_srcs_restart
! Subprogram not used     use linoz_data,  only: read_linoz_data_restart
! Subprogram not used 
! Subprogram not used     use pio, only : file_desc_t
! Subprogram not used     implicit none
! Subprogram not used     type(file_desc_t) :: File
...
! Subprogram not used     ! data for offline tracers
! Subprogram not used     !
! Subprogram not used     call read_tracer_cnst_restart(File)
! Subprogram not used     call read_tracer_srcs_restart(File)
! Subprogram not used     call read_linoz_data_restart(File)
! Subprogram not used   end subroutine chem_read_restart
