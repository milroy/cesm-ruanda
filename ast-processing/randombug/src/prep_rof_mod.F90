...
! Subprogram not used   function prep_rof_get_l2racc_lx()
! Subprogram not used     type(mct_aVect), pointer :: prep_rof_get_l2racc_lx(:)
! Subprogram not used     prep_rof_get_l2racc_lx => l2racc_lx(:)   
! Subprogram not used   end function prep_rof_get_l2racc_lx

! Subprogram not used   function prep_rof_get_l2racc_lx_cnt()
! Subprogram not used     integer, pointer :: prep_rof_get_l2racc_lx_cnt
! Subprogram not used     prep_rof_get_l2racc_lx_cnt => l2racc_lx_cnt
! Subprogram not used   end function prep_rof_get_l2racc_lx_cnt
