...
!! @private
!<
! Subprogram not used   subroutine bad_iotype(iotype,file,line)
! Subprogram not used     integer iotype
! Subprogram not used     character(len=*) file
! Subprogram not used     integer line
! Subprogram not used 
! Subprogram not used     print *,'Invalid iotype, value=',iotype
! Subprogram not used     call piodie(file,line,'Quitting')
! Subprogram not used 
! Subprogram not used   end subroutine bad_iotype
