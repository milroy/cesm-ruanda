...
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_getnthreads()
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer :: omp_get_num_threads
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_getnthreads) '
! Subprogram not used 
! Subprogram not used     seq_comm_getnthreads = -1
! Subprogram not used 
! Subprogram not used   end function seq_comm_getnthreads
!---------------------------------------------------------
...
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_iam(ID)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_iam) '
! Subprogram not used 
! Subprogram not used     seq_comm_iam = seq_comms(ID)%iam
! Subprogram not used 
! Subprogram not used   end function seq_comm_iam
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_gloiam(ID)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_gloiam) '
! Subprogram not used 
! Subprogram not used     seq_comm_gloiam = seq_comms(ID)%gloiam
! Subprogram not used 
! Subprogram not used   end function seq_comm_gloiam
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_gloroot(ID)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_gloroot) '
! Subprogram not used 
! Subprogram not used     seq_comm_gloroot = seq_comms(ID)%gloroot
! Subprogram not used 
! Subprogram not used   end function seq_comm_gloroot
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_cplpe(ID)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_cplpe) '
! Subprogram not used 
! Subprogram not used     seq_comm_cplpe = seq_comms(ID)%cplpe
! Subprogram not used 
! Subprogram not used   end function seq_comm_cplpe
!---------------------------------------------------------
! Subprogram not used   integer function seq_comm_cmppe(ID)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_cmppe) '
! Subprogram not used 
! Subprogram not used     seq_comm_cmppe = seq_comms(ID)%cmppe
! Subprogram not used 
! Subprogram not used   end function seq_comm_cmppe
!---------------------------------------------------------
...
!---------------------------------------------------------
! Subprogram not used   subroutine seq_comm_petlist(ID,petlist)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used     integer,intent(in) :: ID
! Subprogram not used     integer,pointer :: petlist(:)
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_petlist) '
! Subprogram not used 
! Subprogram not used     petlist => seq_comms(ID)%petlist
! Subprogram not used 
! Subprogram not used   end subroutine seq_comm_petlist
!---------------------------------------------------------
!---------------------------------------------------------
...
!---------------------------------------------------------
! Subprogram not used   subroutine seq_comm_mkname(oname,str1,num)
! Subprogram not used     implicit none
! Subprogram not used     character(len=*),intent(out) :: oname
! Subprogram not used     character(len=*),intent(in)  :: str1
! Subprogram not used     integer,intent(in)           :: num
! Subprogram not used     character(*),parameter :: subName =   '(seq_comm_mkname) '
! Subprogram not used 
! Subprogram not used     character(len=8) :: cnum
! Subprogram not used 
! Subprogram not used     write(cnum,'(i4.4)') num
! Subprogram not used     if (len_trim(str1) + len_trim(cnum) > len(oname)) then
! Subprogram not used        write(logunit,*) trim(subname),' ERROR in str lens ',len(oname),trim(str1),trim(cnum)
! Subprogram not used        call shr_sys_abort(trim(subname))
! Subprogram not used     endif
! Subprogram not used     oname = trim(str1)//trim(cnum)
! Subprogram not used 
! Subprogram not used   end subroutine seq_comm_mkname
!---------------------------------------------------------
