...
! Subprogram not used   integer function omp_get_max_threads()
! Subprogram not used     omp_get_max_threads=1
! Subprogram not used   end function omp_get_max_threads

! Subprogram not used   integer function omp_get_nested()
! Subprogram not used     omp_get_nested=0
! Subprogram not used   end function omp_get_nested
