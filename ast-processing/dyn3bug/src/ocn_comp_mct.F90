...
! Subprogram not used   subroutine ocn_run_mct( EClock, cdata,  x2o, o2x)
! Subprogram not used 
...
! Subprogram not used     type(seq_cdata)             ,intent(inout) :: cdata
! Subprogram not used     type(mct_aVect)             ,intent(inout) :: x2o        ! driver -> dead
! Subprogram not used     type(mct_aVect)             ,intent(inout) :: o2x        ! dead   -> driver
! Subprogram not used 
! Subprogram not used     !EOP
! Subprogram not used 
! Subprogram not used     character(*), parameter :: subName = "(ocn_run_mct) "
! Subprogram not used     !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     call docn_comp_run(EClock, cdata, x2o, o2x)
! Subprogram not used 
! Subprogram not used   end subroutine ocn_run_mct
