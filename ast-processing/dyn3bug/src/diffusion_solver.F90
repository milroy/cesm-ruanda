...
! Subprogram not used   type(vdiff_selector) function not(a)
! Subprogram not used     ! ------------------------------------------------------------- !
! Subprogram not used     ! This function extends .not. to operate on type vdiff_selector !
! Subprogram not used     ! ------------------------------------------------------------- !    
! Subprogram not used     type(vdiff_selector), intent(in)  :: a
! Subprogram not used     allocate(not%fields(size(a%fields)))
! Subprogram not used     not%fields = .not. a%fields
! Subprogram not used   end function not
