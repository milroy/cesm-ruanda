...
! Subprogram not used subroutine seq_timemgr_AlarmSetOn( EClock, alarmname)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used     type(ESMF_Clock), intent(INOUT) :: EClock      ! clock/alarm
! Subprogram not used     character(len=*), intent(IN), optional :: alarmname  ! alarmname
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used     !----- local -----
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_alarmSetOn) '
! Subprogram not used     character(len=*), parameter :: xalarm = 'unset'
! Subprogram not used     integer :: n
! Subprogram not used     integer :: rc
! Subprogram not used     logical :: found
! Subprogram not used     logical :: set
! Subprogram not used     character(len=64) :: name
! Subprogram not used     type(ESMF_Alarm),pointer :: EAlarm
! Subprogram not used     type(ESMF_Alarm),pointer :: EAlarm_list(:)
! Subprogram not used     integer(SHR_KIND_IN) :: AlarmCount ! Number of valid alarms
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes: The Alarm_list is returned and only a subset of the alarms may
! Subprogram not used !   be initialized.  In the esmf_wrf_timemgr, numalarms is not used internally,
! Subprogram not used !   and the alarm pointer is valid if it's associated.  If it's not associated
! Subprogram not used !   the AlarmGet calls will generally return an error code.  What we really
! Subprogram not used !   want is to ignore the unset alarms.  So below, we have to kind of kludge
! Subprogram not used !   this up.  We set name=xalarm, a special value, before the AlarmGet call so 
! Subprogram not used !   if Alarm_list(n) is not associated, the name will remain the value of 
! Subprogram not used !   xalarm.  Then we check whether it's a valid alarm by first checking
! Subprogram not used !   the name vs xalarm.  If name is not xalarm, then it must be a valid alarm
! Subprogram not used !   and we either set found to true if we are setting all alarms or we compare
! Subprogram not used !   the name returned to the alarm name we're looking for and only set found
! Subprogram not used !   to true if the names match.
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     set = .false.
! Subprogram not used 
! Subprogram not used     call seq_timemgr_EClockGetData(EClock, AlarmCount=AlarmCount)
! Subprogram not used     call ESMF_ClockGetAlarmList(EClock, EAlarm_list, rc=rc)
! Subprogram not used     call seq_timemgr_ESMFCodeCheck( rc, msg=subname//"Error from ESMF_ClockGetAlarmList" )
! Subprogram not used     do n = 1,AlarmCount
! Subprogram not used        found = .false.
! Subprogram not used        if (present(alarmname)) then
! Subprogram not used           call ESMF_AlarmGet(EAlarm_list(n), name=name)
! Subprogram not used           if (trim(name) == trim(alarmname)) found = .true.
! Subprogram not used        else
! Subprogram not used           found = .true.
! Subprogram not used        endif
! Subprogram not used        if (found) then
! Subprogram not used           set = .true.
! Subprogram not used           call ESMF_AlarmRingerOn( EAlarm_list(n), rc=rc )
! Subprogram not used           call seq_timemgr_ESMFCodeCheck( rc, msg=subname//"Error from ESMF_AlarmRingerOn" )
! Subprogram not used        endif
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used     if (present(alarmname) .and. .not. set) then
! Subprogram not used        write(logunit,*) subname,' ERROR in alarmname ',trim(alarmname)
! Subprogram not used        call shr_sys_abort()
! Subprogram not used     endif
! Subprogram not used 
! Subprogram not used end subroutine seq_timemgr_AlarmSetOn
...
! Subprogram not used subroutine seq_timemgr_restartAlarmSetOff( EClock)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used     !----- local -----
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_restartAlarmSetOff) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     call seq_timemgr_AlarmSetOff(EClock, seq_timemgr_alarm_restart)
! Subprogram not used 
! Subprogram not used end subroutine seq_timemgr_restartAlarmSetOff
...
! Subprogram not used subroutine seq_timemgr_runAlarmSetOff( EClock)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used     !----- local -----
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_runAlarmSetOff) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     call seq_timemgr_AlarmSetOff(EClock, seq_timemgr_alarm_run)
! Subprogram not used 
! Subprogram not used end subroutine seq_timemgr_runAlarmSetOff
...
! Subprogram not used subroutine seq_timemgr_historyAlarmSetOff( EClock)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used 
! Subprogram not used     !----- local -----
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_historyAlarmSetOff) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     call seq_timemgr_AlarmSetOff(EClock, seq_timemgr_alarm_history)
! Subprogram not used 
! Subprogram not used end subroutine seq_timemgr_historyAlarmSetOff
...
! Subprogram not used logical function seq_timemgr_runAlarmIsOn( EClock)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used     type(ESMF_Clock) , intent(IN) :: EClock     ! clock/alarm
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used     !----- local -----
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_runAlarmIsOn) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     seq_timemgr_runAlarmIsOn =  &
! Subprogram not used        seq_timemgr_alarmIsOn(EClock, alarmname=seq_timemgr_alarm_run)
! Subprogram not used 
! Subprogram not used end function seq_timemgr_runAlarmIsOn
!===============================================================================
!===============================================================================
...
! Subprogram not used logical function seq_timemgr_historyAlarmIsOn( EClock)
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
...
! Subprogram not used     !----- local -----
! Subprogram not used     integer :: rc
! Subprogram not used     character(len=*), parameter :: subname = '(seq_timemgr_historyAlarmIsOn) '
! Subprogram not used 
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used ! Notes:
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     seq_timemgr_historyAlarmIsOn =  &
! Subprogram not used        seq_timemgr_alarmIsOn(EClock, alarmname=seq_timemgr_alarm_history)
! Subprogram not used 
! Subprogram not used end function seq_timemgr_historyAlarmIsOn
...
! Subprogram not used subroutine seq_timemgr_ESMFDebug( EClock, ETime, ETimeInterval, istring )
! Subprogram not used 
! Subprogram not used    implicit none
! Subprogram not used 
! Subprogram not used ! !INPUT/OUTPUT PARAMETERS:
! Subprogram not used 
! Subprogram not used    type(ESMF_Clock), optional, intent(in) :: EClock    ! ESMF Clock
! Subprogram not used    type(ESMF_Time) , optional, intent(inout) :: ETime     ! ESMF Time
! Subprogram not used    type(ESMF_TimeInterval), optional, intent(inout) :: ETimeInterval  ! ESMF Time Interval
! Subprogram not used    character(len=*), optional, intent(in) :: istring
! Subprogram not used 
! Subprogram not used !EOP
! Subprogram not used 
! Subprogram not used    !----- local -----
! Subprogram not used    character(len=*), parameter :: subname = '(seq_timemgr_ESMFDebug) '
! Subprogram not used    character(len=128) :: timestring
! Subprogram not used    integer :: yy,mm,dd,s            ! ymds
! Subprogram not used    type(ESMF_Time) :: LTime
! Subprogram not used    type(ESMF_TimeInterval) :: LTimeInterval
! Subprogram not used    integer(SHR_KIND_I8) :: LStep
...
! Subprogram not used !-------------------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if (present(ETime)) then
! Subprogram not used       write(logunit,*) subname,' ETime ',trim(istring)
! Subprogram not used       call ESMF_TimeGet(ETime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    if (present(ETimeInterval)) then
! Subprogram not used       write(logunit,*) subname,' ETimeInterval ',trim(istring)
! Subprogram not used       call ESMF_TimeIntervalGet(ETimeInterval, yy=yy,mm=mm,d=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used    if (present(EClock)) then
! Subprogram not used       write(logunit,*) subname,' EClock ',trim(istring)
! Subprogram not used       call ESMF_ClockGet( EClock, StartTime=LTime )
! Subprogram not used       call ESMF_TimeGet(LTime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'start ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, CurrTime=LTime )
! Subprogram not used       call ESMF_TimeGet(LTime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'curr ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, StopTime=LTime )
! Subprogram not used       call ESMF_TimeGet(LTime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'stop ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, PrevTime=LTime )
! Subprogram not used       call ESMF_TimeGet(LTime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'prev ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, RefTime=LTime )
! Subprogram not used       call ESMF_TimeGet(LTime, yy=yy,mm=mm,dd=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'ref ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, TimeStep=LTimeInterval )
! Subprogram not used       call ESMF_TimeIntervalGet(LTimeInterval, yy=yy,mm=mm,d=dd,s=s,timestring=timestring,rc=rc)
! Subprogram not used       write(logunit,*) subname,rc,'tint ymds=',yy,mm,dd,s,trim(timestring)
! Subprogram not used       call ESMF_ClockGet( EClock, AdvanceCount=LStep )
! Subprogram not used       write(logunit,*) subname,rc,'advcnt =',LStep
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used end subroutine seq_timemgr_ESMFDebug
