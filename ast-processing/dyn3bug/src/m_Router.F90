...
! Subprogram not used  subroutine initd_(othercomp,GSMap,mycomm,Rout )
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_GlobalSegMap, only :GlobalSegMap
! Subprogram not used       use m_ExchangeMaps,only: MCT_ExGSMap => ExchangeMap
...
! Subprogram not used !
! Subprogram not used       integer, intent(in)	       :: othercomp
! Subprogram not used       integer, intent(in)	       :: mycomm
! Subprogram not used       type(GlobalSegMap),intent(in)    :: GSMap     ! of the calling comp
! Subprogram not used 
! Subprogram not used ! !OUTPUT PARAMETERS:
! Subprogram not used !
! Subprogram not used       type(Router), intent(out)        :: Rout
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 15Jan01 - R. Jacob <jacob@mcs.anl.gov> - initial prototype
! Subprogram not used ! 06Feb01 - R. Jacob <jacob@mcs.anl.gov> - Finish initialization
! Subprogram not used !           of the Router.  Router now works both ways.
! Subprogram not used ! 25Apr01 - R. Jacob <jacob@mcs.anl.gov> - Eliminate early 
! Subprogram not used !           custom code to exchange GSMap components and instead
! Subprogram not used !           the more general purpose routine in m_ExchangeMaps.
! Subprogram not used !           Use new subroutine OrderedPoints in m_GlobalSegMap
! Subprogram not used !           to construct the vector of local and remote GSMaps.
! Subprogram not used !           Clean-up code a little.
! Subprogram not used ! 03May01 - R. Jacob <jacob@mcs.anl.gov> - rename to initd and
! Subprogram not used !           move most of code to new initp routine
! Subprogram not used !
...
! Subprogram not used 
! Subprogram not used   type(GlobalSegMap)    :: RGSMap  !  the other GSMap
! Subprogram not used   integer ::		   ier
! Subprogram not used 
! Subprogram not used !--------------------------begin code-----------------------
! Subprogram not used 
! Subprogram not used !!!!!!!!!!!!!!!!!Exchange of global map data 
! Subprogram not used 
! Subprogram not used   call MCT_ExGSMap(GSMap,mycomm,RGSMap,othercomp,ier)
! Subprogram not used   if(ier /= 0) call die(myname_,'ExGSMap',ier)
! Subprogram not used 
! Subprogram not used !!!!!!!!!!!!!!!!!Begin comparison of globalsegmaps
! Subprogram not used 
! Subprogram not used   call initp_(GSMap,RGSMap, mycomm, Rout)
! Subprogram not used 
...
! Subprogram not used     subroutine clean_(Rout,stat)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die
...
! Subprogram not used       type(Router),      intent(inout) :: Rout
! Subprogram not used 
! Subprogram not used !OUTPUT PARAMETERS:
...
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 15Jan01 - R. Jacob <jacob@mcs.anl.gov> - initial prototype
! Subprogram not used ! 08Feb01 - R. Jacob <jacob@mcs.anl.gov> - add code to clean
! Subprogram not used !           the maxsize and locsize
! Subprogram not used ! 01Mar02 - E.T. Ong <eong@mcs.anl.gov> removed the die to prevent
! Subprogram not used !           crashes and added stat argument.
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used   character(len=*),parameter :: myname_=myname//'::clean_'
! Subprogram not used   integer :: ier
! Subprogram not used 
! Subprogram not used   deallocate(Rout%pe_list,Rout%num_segs,Rout%seg_starts, &
! Subprogram not used   Rout%locsize,Rout%seg_lengths,stat=ier)
! Subprogram not used   if(present(stat)) then
! Subprogram not used      stat=ier
! Subprogram not used   else
! Subprogram not used      if(ier /= 0) call warn(myname_,'deallocate(Rout%pe_list,...)',ier)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   deallocate(Rout%rreqs,Rout%ireqs,Rout%rstatus,&
! Subprogram not used    Rout%istatus,stat=ier)
! Subprogram not used   if(present(stat)) then
! Subprogram not used      stat=ier
! Subprogram not used   else
! Subprogram not used      if(ier /= 0) call warn(myname_,'deallocate(Rout%rreqs,...)',ier)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   deallocate(Rout%ip1,Rout%rp1,stat=ier)
! Subprogram not used   if(present(stat)) then
! Subprogram not used      stat=ier
! Subprogram not used   else
! Subprogram not used      if(ier /= 0) call warn(myname_,'deallocate(Rout%ip1,...)',ier)
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   if(associated(Rout%permarr)) then
! Subprogram not used      deallocate(Rout%permarr,stat=ier)
! Subprogram not used      if(present(stat)) then
! Subprogram not used         stat=ier
! Subprogram not used      else
! Subprogram not used         if(ier /= 0) call warn(myname_,'deallocate(Rout%ip1,...)',ier)
...
! Subprogram not used   endif
! Subprogram not used 
! Subprogram not used   Rout%comp1id = 0
! Subprogram not used   Rout%comp2id = 0
! Subprogram not used   Rout%nprocs = 0
! Subprogram not used   Rout%maxsize = 0
! Subprogram not used   Rout%lAvsize = 0
! Subprogram not used   Rout%numiatt = 0
! Subprogram not used   Rout%numratt = 0
! Subprogram not used 
! Subprogram not used 
...
! Subprogram not used     subroutine print_(rout,mycomm,lun)
! Subprogram not used !
! Subprogram not used ! !USES:
! Subprogram not used !
! Subprogram not used       use m_die
...
! Subprogram not used 
! Subprogram not used !INPUT/OUTPUT PARAMETERS:
! Subprogram not used       type(Router),      intent(in) :: Rout
! Subprogram not used       integer, intent(in)           :: mycomm
! Subprogram not used       integer, intent(in)           :: lun
! Subprogram not used 
! Subprogram not used ! !REVISION HISTORY:
! Subprogram not used ! 27Jul07 - R. Loy <rloy@mcs.anl.gov>  initial version
! Subprogram not used !EOP ___________________________________________________________________
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     integer iproc
! Subprogram not used     integer myrank
! Subprogram not used     integer ier
! Subprogram not used     character(len=*),parameter :: myname_=myname//'::print_'
! Subprogram not used   
! Subprogram not used     call MP_comm_rank(mycomm,myrank,ier)
! Subprogram not used     if(ier/=0) call MP_perr_die(myname_,'MP_comm_rank',ier)
! Subprogram not used 
! Subprogram not used 
! Subprogram not used     do iproc=1,rout%nprocs
! Subprogram not used       if (rout%num_segs(iproc) > 0) then
! Subprogram not used         write(lun,*) myrank,rout%pe_list(iproc),rout%locsize(iproc)
! Subprogram not used       endif
! Subprogram not used     end do        
! Subprogram not used 
! Subprogram not used 
! Subprogram not used   end subroutine print_
