...
contains
  ...
  !-------------------------------------------------------------------
  !-------------------------------------------------------------------
! Subprogram not used   subroutine gcr_ionization_get( ncol, lchnk, ionpairs )
! Subprogram not used 
! Subprogram not used     integer, intent(in) :: lchnk
! Subprogram not used     integer, intent(in) :: ncol
! Subprogram not used     real(r8), intent(out) :: ionpairs(:,:)
! Subprogram not used 
! Subprogram not used     ionpairs(:,:) = 0._r8
! Subprogram not used 
! Subprogram not used     if (.not.has_gcr_ionization) return
! Subprogram not used 
! Subprogram not used     ionpairs(:ncol,:) = fields(1)%data(:ncol,:,lchnk)
! Subprogram not used     call outfld( 'GCRION', ionpairs(:ncol,:), ncol, lchnk )
! Subprogram not used 
! Subprogram not used   end subroutine gcr_ionization_get
