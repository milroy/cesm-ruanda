...
! Subprogram not used   subroutine copy_par(par2,par1)
! Subprogram not used     type(parallel_t), intent(out) :: par2
! Subprogram not used     type(parallel_t), intent(in)  :: par1
! Subprogram not used 
! Subprogram not used     par2%rank       = par1%rank
! Subprogram not used     par2%root       = par1%root
! Subprogram not used     par2%nprocs     = par1%nprocs
! Subprogram not used     par2%comm       = par1%comm
! Subprogram not used     par2%intercomm  = par1%intercomm
! Subprogram not used     par2%masterproc = par1%masterproc
! Subprogram not used 
! Subprogram not used   end subroutine copy_par
...
! =========================================================
! Subprogram not used      subroutine abortmp(string)
! Subprogram not used        use abortutils, only : endrun ! _EXTERNAL
! Subprogram not used          character*(*) string
! Subprogram not used          call endrun(string)
! Subprogram not used      end subroutine abortmp
...
! Subprogram not used        subroutine haltmp(string)
! Subprogram not used          
! Subprogram not used          integer info
! Subprogram not used 
! Subprogram not used          character*(*) string
! Subprogram not used          if(iam .eq. 1) then 
! Subprogram not used               write(*,*) string
! Subprogram not used 	 endif
! Subprogram not used 
! Subprogram not used          call MPI_finalize(info)
! Subprogram not used          stop
! Subprogram not used        end subroutine haltmp
...
! Subprogram not used        function split(par,leader,lcl_component) result(newpar)
! Subprogram not used 
! Subprogram not used          type (parallel_t)  :: par
! Subprogram not used          type (parallel_t)  :: newpar
! Subprogram not used          integer            :: lcl_component
! Subprogram not used          integer            :: leader(0:ncomponents-1)
! Subprogram not used 
! Subprogram not used          integer ierr
! Subprogram not used          integer info
! Subprogram not used          integer            :: key
! Subprogram not used 
! Subprogram not used          lcl_component=ncomponents-1
! Subprogram not used          do while(leader(lcl_component) > par%rank)
! Subprogram not used             lcl_component=lcl_component-1
! Subprogram not used          end do
! Subprogram not used 
! Subprogram not used          key=par%rank   ! simplest key for most cases
! Subprogram not used 
! Subprogram not used          call MPI_comm_split(par%comm, lcl_component, key, newpar%comm,ierr);
! Subprogram not used 
! Subprogram not used          call MPI_comm_rank(newpar%comm,newpar%rank,info)
! Subprogram not used          call MPI_comm_size(newpar%comm,newpar%nprocs,info)
! Subprogram not used          newpar%root=0
! Subprogram not used 
! Subprogram not used        end function split
...
! Subprogram not used        subroutine connect(gbl_par, lcl_par, lcl_component, leader)
! Subprogram not used 
! Subprogram not used          type (parallel_t) :: gbl_par
! Subprogram not used          type (parallel_t) :: lcl_par
! Subprogram not used          integer           :: lcl_component
! Subprogram not used          integer           :: leader(0:ncomponents-1) ! leader rank in bridge group
! Subprogram not used 
! Subprogram not used          integer tag
! Subprogram not used          integer i
! Subprogram not used          integer ierr
! Subprogram not used 
! Subprogram not used          do i=0,ncomponents-1
! Subprogram not used 
! Subprogram not used             if (i > lcl_component) then
! Subprogram not used                tag=ncomponents*lcl_component + i
! Subprogram not used             else
! Subprogram not used                tag=ncomponents*i+lcl_component
! Subprogram not used             end if
! Subprogram not used             if (i .ne. lcl_component) then
! Subprogram not used                call MPI_Intercomm_create(lcl_par%comm, &
! Subprogram not used 	                                 lcl_par%root, &
! Subprogram not used                                          gbl_par%comm, &
! Subprogram not used                                          leader(i),    &
! Subprogram not used                                          tag,          &
! Subprogram not used                                          lcl_par%intercomm(i),  &
! Subprogram not used                                          ierr)  
! Subprogram not used             end if
! Subprogram not used          end do     
! Subprogram not used        end subroutine connect
...
! Subprogram not used        function pmin_1d(variable,par) result(res)
! Subprogram not used 	
! Subprogram not used        implicit none
! Subprogram not used 
! Subprogram not used        real(kind=real_kind),intent(in)  :: variable(:)
! Subprogram not used        type (parallel_t),intent(in)     :: par
! Subprogram not used        real(kind=real_kind)             :: res
! Subprogram not used      
! Subprogram not used        real(kind=real_kind)             :: local_sum
! Subprogram not used        integer                          :: ierr
! Subprogram not used 
! Subprogram not used        local_sum=MINVAL(variable)
! Subprogram not used 
! Subprogram not used        call MPI_Allreduce(local_sum,res,1,MPIreal_t, &
! Subprogram not used 			MPI_MIN,par%comm,ierr)
! Subprogram not used 
! Subprogram not used        end function pmin_1d
...
! Subprogram not used        function pmax_1d(variable,par) result(res)
! Subprogram not used 	
! Subprogram not used        implicit none
! Subprogram not used 
! Subprogram not used        real(kind=real_kind),intent(in)  :: variable(:)
...
! Subprogram not used        integer                          :: ierr
! Subprogram not used 
! Subprogram not used        local_sum=MAXVAL(variable)
! Subprogram not used        call MPI_Allreduce(local_sum,res,1,MPIreal_t, &
! Subprogram not used 			MPI_MAX,par%comm,ierr)
! Subprogram not used 
! Subprogram not used        end function pmax_1d
...
! Subprogram not used        function psum_1d(variable,par) result(res)
! Subprogram not used 	
! Subprogram not used        implicit none
! Subprogram not used 
! Subprogram not used        real(kind=real_kind),intent(in)  :: variable(:)
...
! Subprogram not used        call MPI_Allreduce(local_sum,res,1,MPIreal_t, &
! Subprogram not used 			MPI_SUM,par%comm,ierr)
! Subprogram not used 
! Subprogram not used        end function psum_1d
