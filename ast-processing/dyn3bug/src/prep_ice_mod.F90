...
! Subprogram not used   subroutine prep_ice_calc_r2x_ix(timer)
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used     ! Description
! Subprogram not used     ! Create r2x_ix (note that r2x_ix is a local module variable)
! Subprogram not used     !
...
! Subprogram not used     character(*), parameter :: subname = '(prep_ice_calc_r2x_ix)'
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used        call seq_map_map(mapper_Rr2i, r2x_rx, r2x_ix(eri), &
! Subprogram not used             fldlist='Firr_rofi', norm=.false.)
! Subprogram not used     enddo
! Subprogram not used     call t_drvstopf  (trim(timer))
! Subprogram not used 
! Subprogram not used   end subroutine prep_ice_calc_r2x_ix

  !================================================================================================

! Subprogram not used   subroutine prep_ice_calc_g2x_ix(timer)
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used     ! Description
! Subprogram not used     ! Create g2x_ix (note that g2x_ix is a local module variable)
! Subprogram not used     !
! Subprogram not used     ! Arguments
! Subprogram not used     character(len=*), intent(in) :: timer
! Subprogram not used     !
...
! Subprogram not used     character(*), parameter :: subname = '(prep_ice_calc_g2x_ix)'
! Subprogram not used     !---------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     call t_drvstartf (trim(timer),barrier=mpicom_CPLID)
! Subprogram not used     do egi = 1,num_inst_rof
! Subprogram not used        g2x_gx => component_get_c2x_cx(glc(egi))
! Subprogram not used        call seq_map_map(mapper_Rg2i, g2x_gx, g2x_ix(egi), norm=.true.)
! Subprogram not used     enddo
! Subprogram not used     call t_drvstopf  (trim(timer))
! Subprogram not used 
! Subprogram not used   end subroutine prep_ice_calc_g2x_ix

  !================================================================================================

! Subprogram not used   function prep_ice_get_a2x_ix()
! Subprogram not used     type(mct_aVect), pointer :: prep_ice_get_a2x_ix(:)
! Subprogram not used     prep_ice_get_a2x_ix => a2x_ix(:)   
! Subprogram not used   end function prep_ice_get_a2x_ix

! Subprogram not used   function prep_ice_get_o2x_ix()
! Subprogram not used     type(mct_aVect), pointer :: prep_ice_get_o2x_ix(:)
! Subprogram not used     prep_ice_get_o2x_ix => o2x_ix(:)   
! Subprogram not used   end function prep_ice_get_o2x_ix

! Subprogram not used   function prep_ice_get_g2x_ix()
! Subprogram not used     type(mct_aVect), pointer :: prep_ice_get_g2x_ix(:)
! Subprogram not used     prep_ice_get_g2x_ix => g2x_ix(:)   
! Subprogram not used   end function prep_ice_get_g2x_ix

! Subprogram not used   function prep_ice_get_r2x_ix()
! Subprogram not used     type(mct_aVect), pointer :: prep_ice_get_r2x_ix(:)
! Subprogram not used     prep_ice_get_r2x_ix => r2x_ix(:)   
! Subprogram not used   end function prep_ice_get_r2x_ix
...
! Subprogram not used   function prep_ice_get_mapper_Rg2i()
! Subprogram not used     type(seq_map), pointer :: prep_ice_get_mapper_Rg2i
! Subprogram not used     prep_ice_get_mapper_Rg2i => mapper_Rg2i  
! Subprogram not used   end function prep_ice_get_mapper_Rg2i
