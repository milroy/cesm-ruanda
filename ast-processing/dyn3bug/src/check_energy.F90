...
! Subprogram not used subroutine check_energy_get_integrals( tedif_glob_out, heat_glob_out )
! Subprogram not used 
! Subprogram not used !----------------------------------------------------------------------- 
! Subprogram not used ! Purpose: Return energy integrals
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used      real(r8), intent(out), optional :: tedif_glob_out
! Subprogram not used      real(r8), intent(out), optional :: heat_glob_out
! Subprogram not used 
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used    if ( present(tedif_glob_out) ) then
! Subprogram not used       tedif_glob_out = tedif_glob
! Subprogram not used    endif
! Subprogram not used    if ( present(heat_glob_out) ) then
! Subprogram not used       heat_glob_out = heat_glob
! Subprogram not used    endif
! Subprogram not used 
! Subprogram not used end subroutine check_energy_get_integrals
