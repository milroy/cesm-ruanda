...
WRITE(*,'(4A)') 'NAME: ', 'rad_TROP_P', ' FILE: radiation_data.F90',  ' LINE: call outfld(rad_TROP_P, tropp(:ncol), ncol, lchnk)' 
       call outfld('rad_TCORR', tcorr(:ncol,:), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'rad_TCORR', ' FILE: radiation_data.F90',  ' LINE: call outfld(rad_TCORR, tcorr(:ncol,:), ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', qrs_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(qrs_fldn, qrs, pcols, lchnk )' 
    call outfld(qrl_fldn, qrl, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', qrl_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(qrl_fldn, qrl, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', lndfrc_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(lndfrc_fldn, cam_in%landfrac,  pcols, lchnk)' 
    call outfld(icefrc_fldn, cam_in%icefrac,   pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', icefrc_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(icefrc_fldn, cam_in%icefrac,   pcols, lchnk)' 
    call outfld(snowh_fldn,  cam_in%snowhland, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', snowh_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(snowh_fldn,  cam_in%snowhland, pcols, lchnk)' 
    call outfld(temp_fldn,   state%t,               pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', temp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(temp_fldn,   state%t,               pcols, lchnk   )' 
    call outfld(pdel_fldn,   state%pdel,            pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', pdel_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(pdel_fldn,   state%pdel,            pcols, lchnk   )' 
    call outfld(pdeldry_fldn,state%pdeldry,         pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', pdeldry_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(pdeldry_fldn,state%pdeldry,         pcols, lchnk   )' 
    call outfld(watice_fldn, state%q(:,:,ixcldice), pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', watice_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(watice_fldn, state%q(:,:,ixcldice), pcols, lchnk   )' 
    call outfld(watliq_fldn, state%q(:,:,ixcldliq), pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', watliq_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(watliq_fldn, state%q(:,:,ixcldliq), pcols, lchnk   )' 
    call outfld(watvap_fldn, state%q(:,:,1),        pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', watvap_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(watvap_fldn, state%q(:,:,1),        pcols, lchnk   )' 
    call outfld(zint_fldn,   state%zi,              pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', zint_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(zint_fldn,   state%zi,              pcols, lchnk   )' 
    call outfld(pint_fldn,   state%pint,            pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', pint_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(pint_fldn,   state%pint,            pcols, lchnk   )' 
    call outfld(pmid_fldn,   state%pmid,            pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', pmid_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(pmid_fldn,   state%pmid,            pcols, lchnk   )' 

    call outfld(asdir_fldn, cam_in%asdir, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', asdir_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(asdir_fldn, cam_in%asdir, pcols, lchnk   )' 
    call outfld(asdif_fldn, cam_in%asdif, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', asdif_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(asdif_fldn, cam_in%asdif, pcols, lchnk   )' 
    call outfld(aldir_fldn, cam_in%aldir, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', aldir_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(aldir_fldn, cam_in%aldir, pcols, lchnk   )' 
    call outfld(aldif_fldn, cam_in%aldif, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', aldif_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(aldif_fldn, cam_in%aldif, pcols, lchnk   )' 

    call outfld(coszen_fldn, coszrs_pos, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', coszen_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(coszen_fldn, coszrs_pos, pcols, lchnk   )' 
    call outfld(asdir_pos_fldn, asdir_pos, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', asdir_pos_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(asdir_pos_fldn, asdir_pos, pcols, lchnk   )' 
    call outfld(asdif_pos_fldn, asdif_pos, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', asdif_pos_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(asdif_pos_fldn, asdif_pos, pcols, lchnk   )' 
    call outfld(aldir_pos_fldn, aldir_pos, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', aldir_pos_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(aldir_pos_fldn, aldir_pos, pcols, lchnk   )' 
    call outfld(aldif_pos_fldn, aldif_pos, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', aldif_pos_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(aldif_pos_fldn, aldif_pos, pcols, lchnk   )' 

    call outfld(lwup_fldn,  cam_in%lwup,  pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', lwup_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(lwup_fldn,  cam_in%lwup,  pcols, lchnk   )' 
    call outfld(ts_fldn,    cam_in%ts,    pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', ts_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(ts_fldn,    cam_in%ts,    pcols, lchnk   )' 

    itim_old = pbuf_old_tim_idx()

    call pbuf_get_field(pbuf, cld_ifld,    ptr, start=(/1,1,itim_old/), kount=(/pcols,pver,1/) )
    call outfld(cld_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', cld_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cld_fldn,    ptr, pcols, lchnk )' 

    call pbuf_get_field(pbuf, rel_ifld,    ptr )
    call outfld(rel_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', rel_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(rel_fldn,    ptr, pcols, lchnk )' 

    call pbuf_get_field(pbuf, rei_ifld,    ptr )
    call outfld(rei_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', rei_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(rei_fldn,    ptr, pcols, lchnk )' 
    
    if (mg_microphys) then

       call pbuf_get_field(pbuf,  dei_ifld, ptr     )
       call outfld(dei_fldn,      ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', dei_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(dei_fldn,      ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  des_ifld, ptr     )
       call outfld(des_fldn,      ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', des_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(des_fldn,      ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  mu_ifld, ptr      )
       call outfld(mu_fldn,       ptr, pcols, lchnk   ) 
WRITE(*,'(4A)') 'NAME: ', mu_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(mu_fldn,       ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  lambdac_ifld, ptr )
       call outfld(lambdac_fldn,  ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', lambdac_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(lambdac_fldn,  ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  iciwp_ifld, ptr   )
       call outfld(iciwp_fldn,    ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', iciwp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(iciwp_fldn,    ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  iclwp_ifld, ptr   )
       call outfld(iclwp_fldn,    ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', iclwp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(iclwp_fldn,    ptr, pcols, lchnk   )' 

       call pbuf_get_field(pbuf,  icswp_ifld, ptr   )
       call outfld(icswp_fldn,    ptr, pcols, lchnk   )       
WRITE(*,'(4A)') 'NAME: ', icswp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(icswp_fldn,    ptr, pcols, lchnk   )' 
...
WRITE(*,'(4A)') 'NAME: ', cldfsnow_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cldfsnow_fldn, ptr, pcols, lchnk   )' 

    else

       call pbuf_get_field(pbuf, cldemis_ifld,    ptr )
       call outfld(cldemis_fldn,   ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', cldemis_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cldemis_fldn,   ptr, pcols, lchnk )' 

       call pbuf_get_field(pbuf, cldtau_ifld,    ptr )
       call outfld(cldtau_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', cldtau_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cldtau_fldn,    ptr, pcols, lchnk )' 

       call pbuf_get_field(pbuf, cicewp_ifld,    ptr )
       call outfld(cicewp_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', cicewp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cicewp_fldn,    ptr, pcols, lchnk )' 

       call pbuf_get_field(pbuf, cliqwp_ifld,    ptr )
       call outfld(cliqwp_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', cliqwp_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(cliqwp_fldn,    ptr, pcols, lchnk )' 

       call pbuf_get_field(pbuf, nmxrgn_ifld,    iptr1d )
       rptr1d = dble(iptr1d)
       call outfld(nmxrgn_fldn,    rptr1d, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', nmxrgn_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(nmxrgn_fldn,    rptr1d, pcols, lchnk )' 

       call pbuf_get_field(pbuf, pmxrgn_ifld,    ptr )
       call outfld(pmxrgn_fldn,    ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', pmxrgn_fldn, ' FILE: radiation_data.F90',  ' LINE: call outfld(pmxrgn_fldn,    ptr, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', trim(name), ' FILE: radiation_data.F90',  ' LINE: call outfld(trim(name), mmr, pcols, lchnk)' 
    end do
...
WRITE(*,'(4A)') 'NAME: ', dgnumwet_fldn(m), ' FILE: radiation_data.F90',  ' LINE: call outfld( dgnumwet_fldn(m), ptr, pcols, lchnk )' 
          ptr => qaerwat_ptr(:,:,m)
          call outfld( qaerwat_fldn(m),  ptr, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', qaerwat_fldn(m), ' FILE: radiation_data.F90',  ' LINE: call outfld( qaerwat_fldn(m),  ptr, pcols, lchnk )' 
