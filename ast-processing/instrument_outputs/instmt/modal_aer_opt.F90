...
WRITE(*,'(4A)') 'NAME: ', trim(outname), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(trim(outname), burden, pcols, lchnk)' 

         write(outname,'(a,i1)') 'AODMODE', m
         call outfld(trim(outname), aodmode, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(outname), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(trim(outname), aodmode, pcols, lchnk)' 

         write(outname,'(a,i1)') 'AODDUST', m
         call outfld(trim(outname), dustaodmode, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(outname), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(trim(outname), dustaodmode, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'EXTINCT'//diag(list_idx), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(EXTINCT//diag(list_idx),  extinct, pcols, lchnk)' 
   call outfld('ABSORB'//diag(list_idx),   absorb,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ABSORB'//diag(list_idx), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(ABSORB//diag(list_idx),   absorb,  pcols, lchnk)' 
   call outfld('AODVIS'//diag(list_idx),   aodvis,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODVIS'//diag(list_idx), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODVIS//diag(list_idx),   aodvis,  pcols, lchnk)' 
   call outfld('AODABS'//diag(list_idx),   aodabs,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODABS'//diag(list_idx), ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODABS//diag(list_idx),   aodabs,  pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'SSAVIS', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(SSAVIS,        ssavis,        pcols, lchnk)' 

      call outfld('AODUV',         aoduv,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODUV', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODUV,         aoduv,         pcols, lchnk)' 
      call outfld('AODNIR',        aodnir,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODNIR', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODNIR,        aodnir,        pcols, lchnk)' 

      call outfld('BURDENDUST',    burdendust,    pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENDUST', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENDUST,    burdendust,    pcols, lchnk)' 
      call outfld('BURDENSO4' ,    burdenso4,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENSO4', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENSO4 ,    burdenso4,     pcols, lchnk)' 
      call outfld('BURDENPOM' ,    burdenpom,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENPOM', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENPOM ,    burdenpom,     pcols, lchnk)' 
      call outfld('BURDENSOA' ,    burdensoa,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENSOA', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENSOA ,    burdensoa,     pcols, lchnk)' 
      call outfld('BURDENBC'  ,    burdenbc,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENBC', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENBC  ,    burdenbc,      pcols, lchnk)' 
      call outfld('BURDENSEASALT', burdenseasalt, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BURDENSEASALT', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(BURDENSEASALT, burdenseasalt, pcols, lchnk)' 

      call outfld('AODABSBC',      aodabsbc,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODABSBC', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODABSBC,      aodabsbc,      pcols, lchnk)' 

      call outfld('AODDUST',       dustaod,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODDUST', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODDUST,       dustaod,       pcols, lchnk)' 
      call outfld('AODSO4',        so4aod,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODSO4', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODSO4,        so4aod,        pcols, lchnk)' 
      call outfld('AODPOM',        pomaod,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODPOM', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODPOM,        pomaod,        pcols, lchnk)' 
      call outfld('AODSOA',        soaaod,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODSOA', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODSOA,        soaaod,        pcols, lchnk)' 
      call outfld('AODBC',         bcaod,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODBC', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODBC,         bcaod,         pcols, lchnk)' 
      call outfld('AODSS',         seasaltaod,    pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AODSS', ' FILE: modal_aer_opt.F90',  ' LINE: call outfld(AODSS,         seasaltaod,    pcols, lchnk)' 
   end if
