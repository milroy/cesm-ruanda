...
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_gasaerexch.F90',  ' LINE: call outfld( fieldname, qsrflx(:,l,jsrf), pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_gasaerexch.F90',  ' LINE: call outfld( fieldname, qqcwsrflx(:,l,jsrf), pcols, lchnk )' 
	    end if
