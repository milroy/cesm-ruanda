...
WRITE(*,'(4A)') 'NAME: ', 'BPROD   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( BPROD   , bprod, pcols, lchnk )' 
       call outfld( 'SPROD   ', sprod, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SPROD   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( SPROD   , sprod, pcols, lchnk )' 
       call outfld( 'SFI     ', sfi,   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SFI     ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( SFI     , sfi,   pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'HB_ri', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( HB_ri,          ri,         pcols,   lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'ustar', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( ustar,   ustar(:), pcols, lchnk )' 
    call outfld( 'obklen', obklen(:), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'obklen', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( obklen, obklen(:), pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'WGUSTD', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( WGUSTD , wpert, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'qt_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qt_pre_PBL   , qt_prePBL,                 pcols, lchnk )' 
    call outfld( 'sl_pre_PBL   ', sl_prePBL,                 pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'sl_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( sl_pre_PBL   , sl_prePBL,                 pcols, lchnk )' 
    call outfld( 'slv_pre_PBL  ', slv_prePBL,                pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slv_pre_PBL  ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( slv_pre_PBL  , slv_prePBL,                pcols, lchnk )' 
    call outfld( 'u_pre_PBL    ', state%u,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'u_pre_PBL    ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( u_pre_PBL    , state%u,                   pcols, lchnk )' 
    call outfld( 'v_pre_PBL    ', state%v,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'v_pre_PBL    ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( v_pre_PBL    , state%v,                   pcols, lchnk )' 
    call outfld( 'qv_pre_PBL   ', state%q(:ncol,:,1),        pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qv_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qv_pre_PBL   , state%q(:ncol,:,1),        pcols, lchnk )' 
    call outfld( 'ql_pre_PBL   ', state%q(:ncol,:,ixcldliq), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ql_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( ql_pre_PBL   , state%q(:ncol,:,ixcldliq), pcols, lchnk )' 
    call outfld( 'qi_pre_PBL   ', state%q(:ncol,:,ixcldice), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qi_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qi_pre_PBL   , state%q(:ncol,:,ixcldice), pcols, lchnk )' 
    call outfld( 't_pre_PBL    ', state%t,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 't_pre_PBL    ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( t_pre_PBL    , state%t,                   pcols, lchnk )' 
    call outfld( 'rh_pre_PBL   ', ftem_prePBL,               pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rh_pre_PBL   ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( rh_pre_PBL   , ftem_prePBL,               pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'sl_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( sl_aft_PBL   , sl,                        pcols, lchnk )' 
    call outfld( 'qt_aft_PBL'   , qt,                        pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qt_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qt_aft_PBL   , qt,                        pcols, lchnk )' 
    call outfld( 'slv_aft_PBL'  , slv,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slv_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( slv_aft_PBL  , slv,                       pcols, lchnk )' 
    call outfld( 'u_aft_PBL'    , u_aft_PBL,                 pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'u_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( u_aft_PBL    , u_aft_PBL,                 pcols, lchnk )' 
    call outfld( 'v_aft_PBL'    , v_aft_PBL,                 pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'v_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( v_aft_PBL    , v_aft_PBL,                 pcols, lchnk )' 
    call outfld( 'qv_aft_PBL'   , qv_aft_PBL,                pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qv_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qv_aft_PBL   , qv_aft_PBL,                pcols, lchnk )' 
    call outfld( 'ql_aft_PBL'   , ql_aft_PBL,                pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ql_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( ql_aft_PBL   , ql_aft_PBL,                pcols, lchnk )' 
    call outfld( 'qi_aft_PBL'   , qi_aft_PBL,                pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qi_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qi_aft_PBL   , qi_aft_PBL,                pcols, lchnk )' 
    call outfld( 't_aft_PBL '   , t_aftPBL,                  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 't_aft_PBL ', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( t_aft_PBL    , t_aftPBL,                  pcols, lchnk )' 
    call outfld( 'rh_aft_PBL'   , ftem_aftPBL,               pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rh_aft_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( rh_aft_PBL   , ftem_aftPBL,               pcols, lchnk )' 
    call outfld( 'slflx_PBL'    , slflx,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slflx_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( slflx_PBL    , slflx,                     pcols, lchnk )' 
    call outfld( 'qtflx_PBL'    , qtflx,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qtflx_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qtflx_PBL    , qtflx,                     pcols, lchnk )' 
    call outfld( 'uflx_PBL'     , uflx,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uflx_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( uflx_PBL     , uflx,                      pcols, lchnk )' 
    call outfld( 'vflx_PBL'     , vflx,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'vflx_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( vflx_PBL     , vflx,                      pcols, lchnk )' 
    call outfld( 'slflx_cg_PBL' , slflx_cg,                  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slflx_cg_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( slflx_cg_PBL , slflx_cg,                  pcols, lchnk )' 
    call outfld( 'qtflx_cg_PBL' , qtflx_cg,                  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qtflx_cg_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qtflx_cg_PBL , qtflx_cg,                  pcols, lchnk )' 
    call outfld( 'uflx_cg_PBL'  , uflx_cg,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uflx_cg_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( uflx_cg_PBL  , uflx_cg,                   pcols, lchnk )' 
    call outfld( 'vflx_cg_PBL'  , vflx_cg,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'vflx_cg_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( vflx_cg_PBL  , vflx_cg,                   pcols, lchnk )' 
    call outfld( 'slten_PBL'    , slten,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( slten_PBL    , slten,                     pcols, lchnk )' 
    call outfld( 'qtten_PBL'    , qtten,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qtten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qtten_PBL    , qtten,                     pcols, lchnk )' 
    call outfld( 'uten_PBL'     , ptend%u(:ncol,:),          pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( uten_PBL     , ptend%u(:ncol,:),          pcols, lchnk )' 
    call outfld( 'vten_PBL'     , ptend%v(:ncol,:),          pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'vten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( vten_PBL     , ptend%v(:ncol,:),          pcols, lchnk )' 
    call outfld( 'qvten_PBL'    , ptend%q(:ncol,:,1),        pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qvten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qvten_PBL    , ptend%q(:ncol,:,1),        pcols, lchnk )' 
    call outfld( 'qlten_PBL'    , ptend%q(:ncol,:,ixcldliq), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qlten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qlten_PBL    , ptend%q(:ncol,:,ixcldliq), pcols, lchnk )' 
    call outfld( 'qiten_PBL'    , ptend%q(:ncol,:,ixcldice), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qiten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( qiten_PBL    , ptend%q(:ncol,:,ixcldice), pcols, lchnk )' 
    call outfld( 'tten_PBL'     , tten,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'tten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( tten_PBL     , tten,                      pcols, lchnk )' 
    call outfld( 'rhten_PBL'    , rhten,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rhten_PBL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( rhten_PBL    , rhten,                     pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QT', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( QT           , qt,                        pcols, lchnk )' 
    call outfld( 'SL'           , sl,                        pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SL', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( SL           , sl,                        pcols, lchnk )' 
    call outfld( 'SLV'          , slv,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SLV', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( SLV          , slv,                       pcols, lchnk )' 
    call outfld( 'SLFLX'        , slflx,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SLFLX', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( SLFLX        , slflx,                     pcols, lchnk )' 
    call outfld( 'QTFLX'        , qtflx,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QTFLX', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( QTFLX        , qtflx,                     pcols, lchnk )' 
    call outfld( 'UFLX'         , uflx,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UFLX', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( UFLX         , uflx,                      pcols, lchnk )' 
    call outfld( 'VFLX'         , vflx,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'VFLX', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( VFLX         , vflx,                      pcols, lchnk )' 
    call outfld( 'TKE'          , tke,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TKE', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( TKE          , tke,                       pcols, lchnk )' 

    call outfld( 'PBLH'         , pblh,                      pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PBLH', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( PBLH         , pblh,                      pcols, lchnk )' 
    call outfld( 'TPERT'        , tpert,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TPERT', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( TPERT        , tpert,                     pcols, lchnk )' 
    call outfld( 'QPERT'        , qpert,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QPERT', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( QPERT        , qpert,                     pcols, lchnk )' 
    call outfld( 'USTAR'        , ustar,                     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'USTAR', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( USTAR        , ustar,                     pcols, lchnk )' 
    call outfld( 'KVH'          , kvh,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'KVH', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( KVH          , kvh,                       pcols, lchnk )' 
    call outfld( 'KVT'          , kvt,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'KVT', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( KVT          , kvt,                       pcols, lchnk )' 
    call outfld( 'KVM'          , kvm,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'KVM', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( KVM          , kvm,                       pcols, lchnk )' 
    call outfld( 'CGS'          , cgs,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CGS', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( CGS          , cgs,                       pcols, lchnk )' 
    dtk(:ncol,:) = dtk(:ncol,:) / cpair              ! Normalize heating for history
    call outfld( 'DTVKE'        , dtk,                       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTVKE', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( DTVKE        , dtk,                       pcols, lchnk )' 
    dtk(:ncol,:) = ptend%s(:ncol,:) / cpair          ! Normalize heating for history using dtk
    call outfld( 'DTV'          , dtk,                       pcols, lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'DTV', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( DTV          , dtk,                       pcols, lchnk )' 
    call outfld( 'DUV'          , ptend%u,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DUV', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( DUV          , ptend%u,                   pcols, lchnk )' 
    call outfld( 'DVV'          , ptend%v,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DVV', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( DVV          , ptend%v,                   pcols, lchnk )' 
    do m = 1, pcnst
       call outfld( vdiffnam(m) , ptend%q(1,1,m),            pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', vdiffnam(m), ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( vdiffnam(m) , ptend%q(1,1,m),            pcols, lchnk )' 
    end do
    if( do_tms ) then
...
WRITE(*,'(4A)') 'NAME: ', 'TAUTMSX', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( TAUTMSX  , tautmsx,                   pcols, lchnk )' 
        call outfld( 'TAUTMSY'  , tautmsy,                   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TAUTMSY', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( TAUTMSY  , tautmsy,                   pcols, lchnk )' 
    end if
    if( do_molec_diff ) then
        call outfld( 'TTPXMLC'  , topflx,                    pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TTPXMLC', ' FILE: vertical_diffusion.F90',  ' LINE: call outfld( TTPXMLC  , topflx,                    pcols, lchnk )' 
    end if
