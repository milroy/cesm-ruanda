...
WRITE(*,'(4A)') 'NAME: ', rate_names(i), ' FILE: rate_diags.F90',  ' LINE: call outfld( rate_names(i), rxt_rates(:ncol,:,rxt_tag_map(i)), ncol, lchnk )' 
    enddo
...
WRITE(*,'(4A)') 'NAME: ', grps(i)%name, ' FILE: rate_diags.F90',  ' LINE: call outfld( grps(i)%name, group_rate(:ncol,:), ncol, lchnk )' 
    end do
