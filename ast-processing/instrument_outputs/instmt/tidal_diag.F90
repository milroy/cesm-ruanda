...
WRITE(*,'(4A)') 'NAME: ', 'T_24_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( T_24_SIN, state%t(:ncol,:)*dcoef(1), ncol, lchnk )' 
       call outfld( 'T_24_COS', state%t(:ncol,:)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'T_24_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( T_24_COS, state%t(:ncol,:)*dcoef(2), ncol, lchnk )' 
    endif
    if ( hist_fld_active('T_12_COS') .or. hist_fld_active('T_12_SIN') ) then
       call outfld( 'T_12_SIN', state%t(:ncol,:)*dcoef(3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'T_12_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( T_12_SIN, state%t(:ncol,:)*dcoef(3), ncol, lchnk )' 
       call outfld( 'T_12_COS', state%t(:ncol,:)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'T_12_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( T_12_COS, state%t(:ncol,:)*dcoef(4), ncol, lchnk )' 
    endif

    if ( hist_fld_active('U_24_COS') .or. hist_fld_active('U_24_SIN') ) then
       call outfld( 'U_24_SIN', state%u(:ncol,:)*dcoef(1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'U_24_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( U_24_SIN, state%u(:ncol,:)*dcoef(1), ncol, lchnk )' 
       call outfld( 'U_24_COS', state%u(:ncol,:)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'U_24_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( U_24_COS, state%u(:ncol,:)*dcoef(2), ncol, lchnk )' 
    endif
    if ( hist_fld_active('U_12_COS') .or. hist_fld_active('U_12_SIN') ) then
       call outfld( 'U_12_SIN', state%u(:ncol,:)*dcoef(3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'U_12_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( U_12_SIN, state%u(:ncol,:)*dcoef(3), ncol, lchnk )' 
       call outfld( 'U_12_COS', state%u(:ncol,:)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'U_12_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( U_12_COS, state%u(:ncol,:)*dcoef(4), ncol, lchnk )' 
    endif

    if ( hist_fld_active('V_24_COS') .or. hist_fld_active('V_24_SIN') ) then
       call outfld( 'V_24_SIN', state%v(:ncol,:)*dcoef(1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'V_24_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( V_24_SIN, state%v(:ncol,:)*dcoef(1), ncol, lchnk )' 
       call outfld( 'V_24_COS', state%v(:ncol,:)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'V_24_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( V_24_COS, state%v(:ncol,:)*dcoef(2), ncol, lchnk )' 
    endif
    if ( hist_fld_active('V_12_COS') .or. hist_fld_active('V_12_SIN') ) then
       call outfld( 'V_12_SIN', state%v(:ncol,:)*dcoef(3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'V_12_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( V_12_SIN, state%v(:ncol,:)*dcoef(3), ncol, lchnk )' 
       call outfld( 'V_12_COS', state%v(:ncol,:)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'V_12_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( V_12_COS, state%v(:ncol,:)*dcoef(4), ncol, lchnk )' 
    endif

    if ( hist_fld_active('PS_24_COS') .or. hist_fld_active('PS_24_SIN') ) then
       call outfld( 'PS_24_SIN', state%ps(:ncol)*dcoef(1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PS_24_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( PS_24_SIN, state%ps(:ncol)*dcoef(1), ncol, lchnk )' 
       call outfld( 'PS_24_COS', state%ps(:ncol)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PS_24_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( PS_24_COS, state%ps(:ncol)*dcoef(2), ncol, lchnk )' 
    endif
    if ( hist_fld_active('PS_12_COS') .or. hist_fld_active('PS_12_SIN') ) then
       call outfld( 'PS_12_SIN', state%ps(:ncol)*dcoef(3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PS_12_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( PS_12_SIN, state%ps(:ncol)*dcoef(3), ncol, lchnk )' 
       call outfld( 'PS_12_COS', state%ps(:ncol)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PS_12_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( PS_12_COS, state%ps(:ncol)*dcoef(4), ncol, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', 'OMEGA_24_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( OMEGA_24_SIN, state%omega(:ncol,:)*dcoef(1), ncol, lchnk )' 
       call outfld( 'OMEGA_24_COS', state%omega(:ncol,:)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'OMEGA_24_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( OMEGA_24_COS, state%omega(:ncol,:)*dcoef(2), ncol, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', 'OMEGA_12_SIN', ' FILE: tidal_diag.F90',  ' LINE: call outfld( OMEGA_12_SIN, state%omega(:ncol,:)*dcoef(3), ncol, lchnk )' 
       call outfld( 'OMEGA_12_COS', state%omega(:ncol,:)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'OMEGA_12_COS', ' FILE: tidal_diag.F90',  ' LINE: call outfld( OMEGA_12_COS, state%omega(:ncol,:)*dcoef(4), ncol, lchnk )' 
    endif
