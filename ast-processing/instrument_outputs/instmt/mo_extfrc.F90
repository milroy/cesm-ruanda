...
WRITE(*,'(4A)') 'NAME: ', xfcname, ' FILE: mo_extfrc.F90',  ' LINE: call outfld( xfcname, frcing(:ncol,:,n), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', xfcname, ' FILE: mo_extfrc.F90',  ' LINE: call outfld( xfcname, frcing_col(:ncol), ncol, lchnk )' 
