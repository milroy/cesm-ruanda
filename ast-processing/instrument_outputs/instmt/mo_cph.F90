...
WRITE(*,'(4A)') 'NAME: ', fldnames(i), ' FILE: mo_cph.F90',  ' LINE: call outfld( fldnames(i), cph_rate(:,:,i), ncol, lchnk )' 
       endif
    enddo

    call outfld( 'QCP', cph_tot(:,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QCP', ' FILE: mo_cph.F90',  ' LINE: call outfld( QCP, cph_tot(:,:), ncol, lchnk )' 
