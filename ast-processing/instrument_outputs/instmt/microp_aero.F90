...
WRITE(*,'(4A)') 'NAME: ', 'WSUB', ' FILE: microp_aero.F90',  ' LINE: call outfld( WSUB       , wsub,      pcols, lchnk )' 
   call outfld( 'WSUBI'      , wsubi,     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'WSUBI', ' FILE: microp_aero.F90',  ' LINE: call outfld( WSUBI      , wsubi,     pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'NIHF', ' FILE: microp_aero.F90',  ' LINE: call outfld(NIHF,   nihf, pcols, lchnk)' 
   call outfld('NIIMM', niimm, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'NIIMM', ' FILE: microp_aero.F90',  ' LINE: call outfld(NIIMM, niimm, pcols, lchnk)' 
   call outfld('NIDEP', nidep, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'NIDEP', ' FILE: microp_aero.F90',  ' LINE: call outfld(NIDEP, nidep, pcols, lchnk)' 
   call outfld('NIMEY', nimey, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'NIMEY', ' FILE: microp_aero.F90',  ' LINE: call outfld(NIMEY, nimey, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'LCLOUD', ' FILE: microp_aero.F90',  ' LINE: call outfld(LCLOUD, lcldn, pcols, lchnk)' 
