...
WRITE(*,'(4A)') 'NAME: ', trim(solsym(j))//'_CHMP', ' FILE: mo_imp_sol.F90',  ' LINE: call outfld( trim(solsym(j))//_CHMP, prod_out(:,:,i), ncol, lchnk )' 
       call outfld( trim(solsym(j))//'_CHML', loss_out(:,:,i), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(solsym(j))//'_CHML', ' FILE: mo_imp_sol.F90',  ' LINE: call outfld( trim(solsym(j))//_CHML, loss_out(:,:,i), ncol, lchnk )' 
!
...
WRITE(*,'(4A)') 'NAME: ', 'H_PEROX_CHMP', ' FILE: mo_imp_sol.F90',  ' LINE: call outfld( H_PEROX_CHMP, prod_hydrogen_peroxides_out(:,:), ncol, lchnk )' 
!
