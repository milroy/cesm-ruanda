...
subroutine micro_mg_cam_tend(state, ptend, dtime, pbuf)
  ...
  real(r8) :: am_evp_st(state%psetcols,pver)
...
WRITE(*,'(4A)') 'NAME: ', 'MPDW2V', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDW2V, ftem_grid, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MPDW2I', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDW2I, ftem_grid, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MPDW2P', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDW2P, ftem_grid, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MPDI2V', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDI2V, ftem_grid, pcols, lchnk)' 

  ftem_grid(:ngrdcol,top_lev:pver) = -melto_grid(:ngrdcol,top_lev:pver) + mnuccco_grid(:ngrdcol,top_lev:pver) &
       + mnuccto_grid(:ngrdcol,top_lev:pver) +  bergo_grid(:ngrdcol,top_lev:pver) + homoo_grid(:ngrdcol,top_lev:pver)&
       + msacwio_grid(:ngrdcol,top_lev:pver)
  call outfld( 'MPDI2W', ftem_grid, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MPDI2W', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDI2W, ftem_grid, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MPDI2P', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld( MPDI2P, ftem_grid, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MPICLWPI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPICLWPI,    iclwpi,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MPICIWPI',    iciwpi,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MPICIWPI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPICIWPI,    iciwpi,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('REFL',        refl,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'REFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(REFL,        refl,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('AREFL',       arefl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'AREFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AREFL,       arefl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('AREFLZ',      areflz,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'AREFLZ', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AREFLZ,      areflz,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FREFL',       frefl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FREFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FREFL,       frefl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('CSRFL',       csrfl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'CSRFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CSRFL,       csrfl,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('ACSRFL',      acsrfl,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'ACSRFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ACSRFL,      acsrfl,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FCSRFL',      fcsrfl,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FCSRFL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FCSRFL,      fcsrfl,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('RERCLD',      rercld,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'RERCLD', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(RERCLD,      rercld,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('NCAL',        ncal,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'NCAL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(NCAL,        ncal,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('NCAI',        ncai,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'NCAI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(NCAI,        ncai,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('AQRAIN',      qrout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'AQRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AQRAIN,      qrout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('AQSNOW',      qsout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'AQSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AQSNOW,      qsout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('ANRAIN',      nrout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'ANRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ANRAIN,      nrout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('ANSNOW',      nsout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'ANSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ANSNOW,      nsout2,      psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FREQR',       freqr,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FREQR', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FREQR,       freqr,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FREQS',       freqs,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FREQS', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FREQS,       freqs,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MPDT',        tlat,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MPDT', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPDT,        tlat,        psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MPDQ',        qvlat,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MPDQ', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPDQ,        qvlat,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MPDLIQ',      qcten,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MPDLIQ', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPDLIQ,      qcten,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MPDICE',      qiten,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MPDICE', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MPDICE,      qiten,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('EVAPSNOW',    evapsnow,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'EVAPSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(EVAPSNOW,    evapsnow,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('QCSEVAP',     qcsevap,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'QCSEVAP', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QCSEVAP,     qcsevap,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('QISEVAP',     qisevap,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'QISEVAP', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QISEVAP,     qisevap,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('QVRES',       qvres,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'QVRES', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QVRES,       qvres,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('VTRMC',       vtrmc,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'VTRMC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(VTRMC,       vtrmc,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('VTRMI',       vtrmi,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'VTRMI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(VTRMI,       vtrmi,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('QCSEDTEN',    qcsedten,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'QCSEDTEN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QCSEDTEN,    qcsedten,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('QISEDTEN',    qisedten,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'QISEDTEN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QISEDTEN,    qisedten,    psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MNUCCDO',     mnuccdo,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MNUCCDO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MNUCCDO,     mnuccdo,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MNUCCDOhet',  mnuccdohet,  psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MNUCCDOhet', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MNUCCDOhet,  mnuccdohet,  psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MNUCCRO',     mnuccro,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MNUCCRO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MNUCCRO,     mnuccro,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('PRACSO',      pracso ,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'PRACSO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRACSO,      pracso ,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('MELTSDT',     meltsdt,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'MELTSDT', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MELTSDT,     meltsdt,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FRZRDT',      frzrdt ,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FRZRDT', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FRZRDT,      frzrdt ,     psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 
  call outfld('FICE',        nfice,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)
WRITE(*,'(4A)') 'NAME: ', 'FICE', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FICE,        nfice,       psetcols, lchnk, avg_subcol_field=use_subcol_microp)' 

  ! Example subcolumn outfld call
  if (use_subcol_microp) then
     call outfld('FICE_SCOL',   nfice,       psubcols*pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FICE_SCOL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FICE_SCOL,   nfice,       psubcols*pcols, lchnk)' 
  end if


  ! Output fields which are already on the grid
  call outfld('QRAIN',       qrout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QRAIN,       qrout_grid,       pcols, lchnk)' 
  call outfld('QSNOW',       qsout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QSNOW,       qsout_grid,       pcols, lchnk)' 
  call outfld('NRAIN',       nrout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'NRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(NRAIN,       nrout_grid,       pcols, lchnk)' 
  call outfld('NSNOW',       nsout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'NSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(NSNOW,       nsout_grid,       pcols, lchnk)' 
  call outfld('CV_REFFLIQ',  cvreffliq_grid,   pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CV_REFFLIQ', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CV_REFFLIQ,  cvreffliq_grid,   pcols, lchnk)' 
  call outfld('CV_REFFICE',  cvreffice_grid,   pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CV_REFFICE', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CV_REFFICE,  cvreffice_grid,   pcols, lchnk)' 
  call outfld('LS_FLXPRC',   mgflxprc_grid,    pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LS_FLXPRC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(LS_FLXPRC,   mgflxprc_grid,    pcols, lchnk)' 
  call outfld('LS_FLXSNW',   mgflxsnw_grid,    pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LS_FLXSNW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(LS_FLXSNW,   mgflxsnw_grid,    pcols, lchnk)' 
  call outfld('CME',         qme_grid,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CME', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CME,         qme_grid,         pcols, lchnk)' 
  call outfld('PRODPREC',    prain_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PRODPREC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRODPREC,    prain_grid,       pcols, lchnk)' 
  call outfld('EVAPPREC',    nevapr_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'EVAPPREC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(EVAPPREC,    nevapr_grid,      pcols, lchnk)' 
  call outfld('QCRESO',      qcreso_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QCRESO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QCRESO,      qcreso_grid,      pcols, lchnk)' 
  call outfld('LS_REFFRAIN', mgreffrain_grid,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LS_REFFRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(LS_REFFRAIN, mgreffrain_grid,  pcols, lchnk)' 
  call outfld('LS_REFFSNOW', mgreffsnow_grid,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LS_REFFSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(LS_REFFSNOW, mgreffsnow_grid,  pcols, lchnk)' 
  call outfld('DSNOW',       des_grid,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(DSNOW,       des_grid,         pcols, lchnk)' 
  call outfld('ADRAIN',      drout2_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ADRAIN', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ADRAIN,      drout2_grid,      pcols, lchnk)' 
  call outfld('ADSNOW',      dsout2_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ADSNOW', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ADSNOW,      dsout2_grid,      pcols, lchnk)' 
  call outfld('PE',          pe_grid,          pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PE', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PE,          pe_grid,          pcols, lchnk)' 
  call outfld('PEFRAC',      pefrac_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PEFRAC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PEFRAC,      pefrac_grid,      pcols, lchnk)' 
  call outfld('APRL',        tpr_grid,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'APRL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(APRL,        tpr_grid,         pcols, lchnk)' 
  call outfld('VPRAO',       vprao_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'VPRAO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(VPRAO,       vprao_grid,       pcols, lchnk)' 
  call outfld('VPRCO',       vprco_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'VPRCO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(VPRCO,       vprco_grid,       pcols, lchnk)' 
  call outfld('RACAU',       racau_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'RACAU', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(RACAU,       racau_grid,       pcols, lchnk)' 
  call outfld('AREL',        efcout_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AREL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AREL,        efcout_grid,      pcols, lchnk)' 
  call outfld('AREI',        efiout_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AREI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AREI,        efiout_grid,      pcols, lchnk)' 
  call outfld('AWNC' ,       ncout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AWNC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AWNC ,       ncout_grid,       pcols, lchnk)' 
  call outfld('AWNI' ,       niout_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'AWNI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(AWNI ,       niout_grid,       pcols, lchnk)' 
  call outfld('FREQL',       freql_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FREQL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FREQL,       freql_grid,       pcols, lchnk)' 
  call outfld('FREQI',       freqi_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FREQI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FREQI,       freqi_grid,       pcols, lchnk)' 
  call outfld('ACTREL',      ctrel_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ACTREL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ACTREL,      ctrel_grid,       pcols, lchnk)' 
  call outfld('ACTREI',      ctrei_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ACTREI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ACTREI,      ctrei_grid,       pcols, lchnk)' 
  call outfld('ACTNL',       ctnl_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ACTNL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ACTNL,       ctnl_grid,        pcols, lchnk)' 
  call outfld('ACTNI',       ctni_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ACTNI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ACTNI,       ctni_grid,        pcols, lchnk)' 
  call outfld('FCTL',        fctl_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FCTL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FCTL,        fctl_grid,        pcols, lchnk)' 
  call outfld('FCTI',        fcti_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FCTI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(FCTI,        fcti_grid,        pcols, lchnk)' 
  call outfld('ICINC',       icinc_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICINC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ICINC,       icinc_grid,       pcols, lchnk)' 
  call outfld('ICWNC',       icwnc_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICWNC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ICWNC,       icwnc_grid,       pcols, lchnk)' 
  call outfld('EFFLIQ_IND',  rel_fn_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'EFFLIQ_IND', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(EFFLIQ_IND,  rel_fn_grid,      pcols, lchnk)' 
  call outfld('CDNUMC',      cdnumc_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CDNUMC', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CDNUMC,      cdnumc_grid,      pcols, lchnk)' 
  call outfld('REL',         rel_grid,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REL', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(REL,         rel_grid,         pcols, lchnk)' 
  call outfld('REI',         rei_grid,         pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REI', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(REI,         rei_grid,         pcols, lchnk)' 
  call outfld('ICIMRST',     icimrst_grid_out, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICIMRST', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ICIMRST,     icimrst_grid_out, pcols, lchnk)' 
  call outfld('ICWMRST',     icwmrst_grid_out, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICWMRST', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(ICWMRST,     icwmrst_grid_out, pcols, lchnk)' 
  call outfld('CMEIOUT',     cmeiout_grid,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CMEIOUT', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(CMEIOUT,     cmeiout_grid,     pcols, lchnk)' 
  call outfld('PRAO',        prao_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PRAO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRAO,        prao_grid,        pcols, lchnk)' 
  call outfld('PRCO',        prco_grid,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PRCO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRCO,        prco_grid,        pcols, lchnk)' 
  call outfld('MNUCCCO',     mnuccco_grid,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MNUCCCO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MNUCCCO,     mnuccco_grid,     pcols, lchnk)' 
  call outfld('MNUCCTO',     mnuccto_grid,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MNUCCTO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MNUCCTO,     mnuccto_grid,     pcols, lchnk)' 
  call outfld('MSACWIO',     msacwio_grid,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MSACWIO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MSACWIO,     msacwio_grid,     pcols, lchnk)' 
  call outfld('PSACWSO',     psacwso_grid,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PSACWSO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PSACWSO,     psacwso_grid,     pcols, lchnk)' 
  call outfld('BERGSO',      bergso_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BERGSO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(BERGSO,      bergso_grid,      pcols, lchnk)' 
  call outfld('BERGO',       bergo_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'BERGO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(BERGO,       bergo_grid,       pcols, lchnk)' 
  call outfld('MELTO',       melto_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MELTO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(MELTO,       melto_grid,       pcols, lchnk)' 
  call outfld('HOMOO',       homoo_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'HOMOO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(HOMOO,       homoo_grid,       pcols, lchnk)' 
  call outfld('PRCIO',       prcio_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PRCIO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRCIO,       prcio_grid,       pcols, lchnk)' 
  call outfld('PRAIO',       praio_grid,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PRAIO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(PRAIO,       praio_grid,       pcols, lchnk)' 
  call outfld('QIRESO',      qireso_grid,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QIRESO', ' FILE: micro_mg_cam.F90',  ' LINE: call outfld(QIRESO,      qireso_grid,      pcols, lchnk)' 
