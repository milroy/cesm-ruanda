...
WRITE(*,'(4A)') 'NAME: ', 'FUS     ', ' FILE: radsw.F90',  ' LINE: call outfld(FUS     ,fus * 1.e-3_r8 ,pcols,lchnk)' 
      call outfld('FDS     ',fds * 1.e-3_r8 ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FDS     ', ' FILE: radsw.F90',  ' LINE: call outfld(FDS     ,fds * 1.e-3_r8 ,pcols,lchnk)' 
      call outfld('FUSC    ',fusc,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FUSC    ', ' FILE: radsw.F90',  ' LINE: call outfld(FUSC    ,fusc,pcols,lchnk)' 
      call outfld('FDSC    ',fdsc,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FDSC    ', ' FILE: radsw.F90',  ' LINE: call outfld(FDSC    ,fdsc,pcols,lchnk)' 
   endif
