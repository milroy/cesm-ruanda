...
WRITE(*,'(4A)') 'NAME: ', 'FUL     ', ' FILE: radlw.F90',  ' LINE: call outfld(FUL     ,ful,pcols,lchnk)' 
      call outfld('FDL     ',fdl,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FDL     ', ' FILE: radlw.F90',  ' LINE: call outfld(FDL     ,fdl,pcols,lchnk)' 
      call outfld('FULC    ',fsul,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FULC    ', ' FILE: radlw.F90',  ' LINE: call outfld(FULC    ,fsul,pcols,lchnk)' 
      call outfld('FDLC    ',fsdl,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FDLC    ', ' FILE: radlw.F90',  ' LINE: call outfld(FDLC    ,fsdl,pcols,lchnk)' 
   endif
