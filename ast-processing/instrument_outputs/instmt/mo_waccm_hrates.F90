...
WRITE(*,'(4A)') 'NAME: ', 'CPAIR', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( CPAIR, cpair, ncol, lchnk )' 
#ifdef HRATES_DEBUG
      write(iulog,*) ' '
      write(iulog,*) '---------------------------------------------'
...
WRITE(*,'(4A)') 'NAME: ', 'QRS_SO2A', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_SO2A, qrs(:,:,1), ncol, lchnk )' 
      call outfld( 'QRS_SO2B', qrs(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_SO2B', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_SO2B, qrs(:,:,2), ncol, lchnk )' 
      call outfld( 'QRS_SO3A', qrs(:,:,3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_SO3A', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_SO3A, qrs(:,:,3), ncol, lchnk )' 
      call outfld( 'QRS_SO3B', qrs(:,:,4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_SO3B', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_SO3B, qrs(:,:,4), ncol, lchnk )' 
      call outfld( 'QRS_LO2B', qrl(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_LO2B', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_LO2B, qrl(:,:,2), ncol, lchnk )' 
      call outfld( 'QRS_LO3A', qrl(:,:,3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_LO3A', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_LO3A, qrl(:,:,3), ncol, lchnk )' 
      call outfld( 'QRS_LO3B', qrl(:,:,4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_LO3B', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_LO3B, qrl(:,:,4), ncol, lchnk )' 
      call outfld( 'QRS_LO3',  qrl(:,:,3)+qrl(:,:,4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_LO3', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_LO3,  qrl(:,:,3)+qrl(:,:,4), ncol, lchnk )' 
      call outfld( 'QRS_EUV', euv_hrate(:,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_EUV', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_EUV, euv_hrate(:,:), ncol, lchnk )' 
      call outfld( 'QRS_CO2NIR', co2_hrate(:,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_CO2NIR', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_CO2NIR, co2_hrate(:,:), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QRS_AUR', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_AUR, aur_hrate(:,:), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QTHERMAL', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QTHERMAL, qrs_tot, pcols, lchnk )' 
      do k = 1,kbot_hrates
         qrs_tot(:ncol,k) = qrs_tot(:ncol,k) &
                          + cphrate(:,k) + euv_hrate(:,k) + aur_hrate(:,k) + co2_hrate(:,k)
      end do
      call outfld( 'QRS_MLT', qrs_tot, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QRS_MLT', ' FILE: mo_waccm_hrates.F90',  ' LINE: call outfld( QRS_MLT, qrs_tot, pcols, lchnk )' 
