...
WRITE(*,'(4A)') 'NAME: ', 'AREA', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( AREA, area(:ncol),   ncol, lchnk )' 
    call outfld( 'MASS', mass(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'MASS', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( MASS, mass(:ncol,:), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', solsym(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( solsym(m), mmr(:ncol,:,m), ncol ,lchnk )' 
          call outfld( trim(solsym(m))//'_SRF', mmr(:ncol,pver,m), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(solsym(m))//'_SRF', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( trim(solsym(m))//_SRF, mmr(:ncol,pver,m), ncol ,lchnk )' 
       else
          call outfld( solsym(m), vmr(:ncol,:,m), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', solsym(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( solsym(m), vmr(:ncol,:,m), ncol ,lchnk )' 
          call outfld( trim(solsym(m))//'_SRF', vmr(:ncol,pver,m), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(solsym(m))//'_SRF', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( trim(solsym(m))//_SRF, vmr(:ncol,pver,m), ncol ,lchnk )' 
       endif

       call outfld( depvel_name(m), depvel(:ncol,m), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', depvel_name(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( depvel_name(m), depvel(:ncol,m), ncol ,lchnk )' 
       call outfld( depflx_name(m), depflx(:ncol,m), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', depflx_name(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( depflx_name(m), depflx(:ncol,m), ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', dtchem_name(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( dtchem_name(m), net_chem(:ncol,:), ncol, lchnk )' 
!
! CCMI
!
...
WRITE(*,'(4A)') 'NAME: ', 'DO3CHM_TRP', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld(DO3CHM_TRP,do3chm_trp(:ncol), ncol, lchnk )' 
          do3chm_lms(:) = 0._r8
          do i=1,ncol
             do k=1,pver
...
WRITE(*,'(4A)') 'NAME: ', 'DO3CHM_LMS', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld(DO3CHM_LMS,do3chm_lms(:ncol), ncol, lchnk )' 
       end if
!
    enddo
...
WRITE(*,'(4A)') 'NAME: ', 'NOX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( NOX,  vmr_nox  (:ncol,:), ncol, lchnk )' 
    call outfld( 'NOY',  vmr_noy  (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'NOY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( NOY,  vmr_noy  (:ncol,:), ncol, lchnk )' 
    call outfld( 'NOY_SRF',  vmr_noy(:ncol,pver),  ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'NOY_SRF', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( NOY_SRF,  vmr_noy(:ncol,pver),  ncol, lchnk )' 
    call outfld( 'CLOX', vmr_clox (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLOX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( CLOX, vmr_clox (:ncol,:), ncol, lchnk )' 
    call outfld( 'CLOY', vmr_cloy (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLOY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( CLOY, vmr_cloy (:ncol,:), ncol, lchnk )' 
    call outfld( 'BROX', vmr_brox (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'BROX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( BROX, vmr_brox (:ncol,:), ncol, lchnk )' 
    call outfld( 'BROY', vmr_broy (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'BROY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( BROY, vmr_broy (:ncol,:), ncol, lchnk )' 
    call outfld( 'TCLY', vmr_tcly (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TCLY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( TCLY, vmr_tcly (:ncol,:), ncol, lchnk )' 
    call outfld( 'TBRY', vmr_tbry (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TBRY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( TBRY, vmr_tbry (:ncol,:), ncol, lchnk )' 
    call outfld( 'FOY',  vmr_foy  (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FOY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( FOY,  vmr_foy  (:ncol,:), ncol, lchnk )' 
    call outfld( 'TFY',  vmr_tfy  (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TFY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( TFY,  vmr_tfy  (:ncol,:), ncol, lchnk )' 
    call outfld( 'TOTH', vmr_toth (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'TOTH', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( TOTH, vmr_toth (:ncol,:), ncol, lchnk )' 

    call outfld( 'NOY_mmr', mmr_noy(:ncol,:), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'NOY_mmr', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( NOY_mmr, mmr_noy(:ncol,:), ncol ,lchnk )' 
    call outfld( 'SOX_mmr', mmr_sox(:ncol,:), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SOX_mmr', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( SOX_mmr, mmr_sox(:ncol,:), ncol ,lchnk )' 
    call outfld( 'NHX_mmr', mmr_nhx(:ncol,:), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'NHX_mmr', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( NHX_mmr, mmr_nhx(:ncol,:), ncol ,lchnk )' 
    call outfld( 'DF_NOY', df_noy(:ncol), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DF_NOY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( DF_NOY, df_noy(:ncol), ncol ,lchnk )' 
    call outfld( 'DF_SOX', df_sox(:ncol), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DF_SOX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( DF_SOX, df_sox(:ncol), ncol ,lchnk )' 
    call outfld( 'DF_NHX', df_nhx(:ncol), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DF_NHX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( DF_NHX, df_nhx(:ncol), ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'PION_EUV', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PION_EUV, wrk, ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV1', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV1, wrk, ncol, lchnk )' 
       do k = 1,pver
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV1e', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV1e, wrk, ncol, lchnk )' 
       do k = 1,pver
          wrk(:,k) = vmr(:,k,id_n)*rxt_rates(:,k,rid_jeuv(4))
          wrk(:,k) = wrk(:,k) * invariants(:,k,indexm)
       end do
       call outfld( 'PEUV2', wrk, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PEUV2', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV2, wrk, ncol, lchnk )' 
       do k = 1,pver
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV3', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV3, wrk, ncol, lchnk )' 
       do k = 1,pver
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV3e', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV3e, wrk, ncol, lchnk )' 
       do k = 1,pver
          un2(:)   = 1._r8 - (vmr(:,k,id_o) + vmr(:,k,id_o2) + vmr(:,k,id_h))
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV4', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV4, wrk, ncol, lchnk )' 
       do k = 1,pver
          un2(:)   = 1._r8 - (vmr(:,k,id_o) + vmr(:,k,id_o2) + vmr(:,k,id_h))
...
WRITE(*,'(4A)') 'NAME: ', 'PEUV4e', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUV4e, wrk, ncol, lchnk )' 
       do k = 1,pver
          un2(:)   = 1._r8 - (vmr(:,k,id_o) + vmr(:,k,id_o2) + vmr(:,k,id_h))
...
WRITE(*,'(4A)') 'NAME: ', 'PEUVN2D', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUVN2D, wrk, ncol, lchnk )' 
       do k = 1,pver
          un2(:)   = 1._r8 - (vmr(:,k,id_o) + vmr(:,k,id_o2) + vmr(:,k,id_h))
...
WRITE(*,'(4A)') 'NAME: ', 'PEUVN2De', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PEUVN2De, wrk, ncol, lchnk )' 
    endif jeuvs
...
WRITE(*,'(4A)') 'NAME: ', 'PJNO_I', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PJNO_I, wrk, ncol, lchnk )' 
    endif
    if ( has_jno ) then
       do k = 1,pver
...
WRITE(*,'(4A)') 'NAME: ', 'PJNO', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( PJNO, wrk, ncol, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', wetdep_name(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( wetdep_name(m), wrk_wd(:ncol),               ncol, lchnk )' 
       call outfld( wtrate_name(m), het_rates(:ncol,:,m), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', wtrate_name(m), ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( wtrate_name(m), het_rates(:ncol,:,m), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'WD_NOY', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( WD_NOY, noy_wk(:ncol), ncol, lchnk )' 
    call outfld( 'WD_SOX', sox_wk(:ncol), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'WD_SOX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( WD_SOX, sox_wk(:ncol), ncol, lchnk )' 
    call outfld( 'WD_NHX', nhx_wk(:ncol), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'WD_NHX', ' FILE: mo_chm_diags.F90',  ' LINE: call outfld( WD_NHX, nhx_wk(:ncol), ncol, lchnk )' 
