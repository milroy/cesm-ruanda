...
WRITE(*,'(4A)') 'NAME: ', 'VOR', ' FILE: stepon.F90',  ' LINE: call outfld(VOR,ftmp(:,:,1),npsq,ie)' 
      enddo
   endif
...
WRITE(*,'(4A)') 'NAME: ', 'DIV', ' FILE: stepon.F90',  ' LINE: call outfld(DIV,ftmp(:,:,1),npsq,ie)' 
      enddo
   endif
#endif
   if (smooth_phis_numcycle>0) then
...
WRITE(*,'(4A)') 'NAME: ', 'PHIS_SM', ' FILE: stepon.F90',  ' LINE: call outfld(PHIS_SM,ftmp(:,1,1),npsq,ie)' 
         enddo
      endif
...
WRITE(*,'(4A)') 'NAME: ', 'SGH_SM', ' FILE: stepon.F90',  ' LINE: call outfld(SGH_SM,ftmp(:,1,1),npsq,ie)' 
         enddo
      endif
...
WRITE(*,'(4A)') 'NAME: ', 'SGH30_SM', ' FILE: stepon.F90',  ' LINE: call outfld(SGH30_SM,ftmp(:,1,1),npsq,ie)' 
         enddo
      endif
   end if
...
WRITE(*,'(4A)') 'NAME: ', 'FU', ' FILE: stepon.F90',  ' LINE: call outfld(FU,ftmp(:,:,1),npsq,ie)' 
         call outfld('FV',ftmp(:,:,2),npsq,ie)
WRITE(*,'(4A)') 'NAME: ', 'FV', ' FILE: stepon.F90',  ' LINE: call outfld(FV,ftmp(:,:,2),npsq,ie)' 
      end do
   endif
