...
WRITE(*,'(4A)') 'NAME: ', trim(name), ' FILE: rad_constituents.F90',  ' LINE: call outfld(trim(name), mass, pcols, lchnk)' 

      cb(:ncol) = sum(mass(:ncol,:),2)
      call outfld(trim(cbname), cb, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cbname), ' FILE: rad_constituents.F90',  ' LINE: call outfld(trim(cbname), cb, pcols, lchnk)' 
