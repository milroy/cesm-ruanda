...
WRITE(*,'(4A)') 'NAME: ', 'DTWR_'//trim(gas_wetdep_list(m)), ' FILE: mo_neu_wetdep.F90',  ' LINE: call outfld( DTWR_//trim(gas_wetdep_list(m)),dtwr(:,:,m),ncol,lchnk )' 
  end do
!
  if ( do_diag ) then
    call outfld('QT_RAIN_HNO3', qt_rain, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QT_RAIN_HNO3', ' FILE: mo_neu_wetdep.F90',  ' LINE: call outfld(QT_RAIN_HNO3, qt_rain, ncol, lchnk )' 
    call outfld('QT_RIME_HNO3', qt_rime, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QT_RIME_HNO3', ' FILE: mo_neu_wetdep.F90',  ' LINE: call outfld(QT_RIME_HNO3, qt_rime, ncol, lchnk )' 
    call outfld('QT_WASH_HNO3', qt_wash, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QT_WASH_HNO3', ' FILE: mo_neu_wetdep.F90',  ' LINE: call outfld(QT_WASH_HNO3, qt_wash, ncol, lchnk )' 
    call outfld('QT_EVAP_HNO3', qt_evap, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QT_EVAP_HNO3', ' FILE: mo_neu_wetdep.F90',  ' LINE: call outfld(QT_EVAP_HNO3, qt_evap, ncol, lchnk )' 
  end if
!
  return
