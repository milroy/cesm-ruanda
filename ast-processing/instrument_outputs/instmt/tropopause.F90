...
WRITE(*,'(4A)') 'NAME: ', 'hstobie_trop', ' FILE: tropopause.F90',  ' LINE: call outfld( hstobie_trop,   trop_output(:ncol,:),       ncol, pstate%lchnk )' 
    call outfld( 'hstobie_linoz',  trop_linoz_output(:ncol,:), ncol, pstate%lchnk )
WRITE(*,'(4A)') 'NAME: ', 'hstobie_linoz', ' FILE: tropopause.F90',  ' LINE: call outfld( hstobie_linoz,  trop_linoz_output(:ncol,:), ncol, pstate%lchnk )' 
    call outfld( 'hstobie_tropop', trop_trop_output(:ncol,:),  ncol, pstate%lchnk )
WRITE(*,'(4A)') 'NAME: ', 'hstobie_tropop', ' FILE: tropopause.F90',  ' LINE: call outfld( hstobie_tropop, trop_trop_output(:ncol,:),  ncol, pstate%lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'TROP_P', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_P,   tropP(:ncol),      ncol, lchnk)' 
    call outfld('TROP_T',   tropT(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP_T', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_T,   tropT(:ncol),      ncol, lchnk)' 
    call outfld('TROP_Z',   tropZ(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP_Z', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_Z,   tropZ(:ncol),      ncol, lchnk)' 
    call outfld('TROP_DZ',  tropDZ(:ncol, :), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP_DZ', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_DZ,  tropDZ(:ncol, :), ncol, lchnk)' 
    call outfld('TROP_PD',  tropPdf(:ncol, :), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP_PD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_PD,  tropPdf(:ncol, :), ncol, lchnk)' 
    call outfld('TROP_FD',  tropFound(:ncol),  ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP_FD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP_FD,  tropFound(:ncol),  ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TROPP_P', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_P,   tropP(:ncol),      ncol, lchnk)' 
    call outfld('TROPP_T',   tropT(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROPP_T', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_T,   tropT(:ncol),      ncol, lchnk)' 
    call outfld('TROPP_Z',   tropZ(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROPP_Z', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_Z,   tropZ(:ncol),      ncol, lchnk)' 
    call outfld('TROPP_DZ',  tropDZ(:ncol, :), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROPP_DZ', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_DZ,  tropDZ(:ncol, :), ncol, lchnk)' 
    call outfld('TROPP_PD',  tropPdf(:ncol, :), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROPP_PD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_PD,  tropPdf(:ncol, :), ncol, lchnk)' 
    call outfld('TROPP_FD',  tropFound(:ncol),  ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROPP_FD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROPP_FD,  tropFound(:ncol),  ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TROP' // TROP_LETTER(alg) // '_P', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP // TROP_LETTER(alg) // _P,   tropP(:ncol),      ncol, lchnk)' 
        call outfld('TROP' // TROP_LETTER(alg) // '_T',   tropT(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP' // TROP_LETTER(alg) // '_T', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP // TROP_LETTER(alg) // _T,   tropT(:ncol),      ncol, lchnk)' 
        call outfld('TROP' // TROP_LETTER(alg) // '_Z',   tropZ(:ncol),      ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP' // TROP_LETTER(alg) // '_Z', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP // TROP_LETTER(alg) // _Z,   tropZ(:ncol),      ncol, lchnk)' 
        call outfld('TROP' // TROP_LETTER(alg) // '_PD',  tropPdf(:ncol, :), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP' // TROP_LETTER(alg) // '_PD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP // TROP_LETTER(alg) // _PD,  tropPdf(:ncol, :), ncol, lchnk)' 
        call outfld('TROP' // TROP_LETTER(alg) // '_FD',  tropFound(:ncol),  ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TROP' // TROP_LETTER(alg) // '_FD', ' FILE: tropopause.F90',  ' LINE: call outfld(TROP // TROP_LETTER(alg) // _FD,  tropFound(:ncol),  ncol, lchnk)' 
      end do
    end if
