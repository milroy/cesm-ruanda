...
WRITE(*,'(4A)') 'NAME: ', 'NETDT', ' FILE: gw_drag.F90',  ' LINE: call outfld (NETDT, ttend_dp, pcols, lchnk)' 

        ! Diagnostic outputs.
        call outfld ('HDEPTH', hdepth, ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'HDEPTH', ' FILE: gw_drag.F90',  ' LINE: call outfld (HDEPTH, hdepth, ncol, lchnk)' 
        call outfld ('MAXQ0', maxq0, ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MAXQ0', ' FILE: gw_drag.F90',  ' LINE: call outfld (MAXQ0, maxq0, ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'FRONTGF', ' FILE: gw_drag.F90',  ' LINE: call outfld (FRONTGF, frontgf, pcols, lchnk)' 
        call outfld ('FRONTGFA', frontga, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FRONTGFA', ' FILE: gw_drag.F90',  ' LINE: call outfld (FRONTGFA, frontga, pcols, lchnk)' 

     end if

     call outfld ('EKGWSPEC', egwdffi_tot , ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'EKGWSPEC', ' FILE: gw_drag.F90',  ' LINE: call outfld (EKGWSPEC, egwdffi_tot , ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'UTGWORO', ' FILE: gw_drag.F90',  ' LINE: call outfld(UTGWORO, utgw,  ncol, lchnk)' 
     call outfld('VTGWORO', vtgw,  ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'VTGWORO', ' FILE: gw_drag.F90',  ' LINE: call outfld(VTGWORO, vtgw,  ncol, lchnk)' 
     call outfld('TTGWORO', ttgw,  ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TTGWORO', ' FILE: gw_drag.F90',  ' LINE: call outfld(TTGWORO, ttgw,  ncol, lchnk)' 
     tau0x = tau(:,0,pver) * xv * effgw_oro
     tau0y = tau(:,0,pver) * yv * effgw_oro
     call outfld('TAUGWX', tau0x, ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TAUGWX', ' FILE: gw_drag.F90',  ' LINE: call outfld(TAUGWX, tau0x, ncol, lchnk)' 
     call outfld('TAUGWY', tau0y, ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TAUGWY', ' FILE: gw_drag.F90',  ' LINE: call outfld(TAUGWY, tau0y, ncol, lchnk)' 
     call outfld('SGH   ',   sgh,pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SGH   ', ' FILE: gw_drag.F90',  ' LINE: call outfld(SGH   ,   sgh,pcols, lchnk)' 

  end if

  ! Write total temperature tendency to history file
  call outfld ('TTGW', ptend%s/cpairv(:,:,lchnk),  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TTGW', ' FILE: gw_drag.F90',  ' LINE: call outfld (TTGW, ptend%s/cpairv(:,:,lchnk),  pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTEND1', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//UTEND1, utb(:,:,1), ncol, lchnk)' 
  call outfld(trim(prefix)//'UTEND2', utb(:,:,2), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTEND2', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//UTEND2, utb(:,:,2), ncol, lchnk)' 
  call outfld(trim(prefix)//'UTEND3', utb(:,:,3), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTEND3', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//UTEND3, utb(:,:,3), ncol, lchnk)' 
  call outfld(trim(prefix)//'UTEND4', utb(:,:,4), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTEND4', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//UTEND4, utb(:,:,4), ncol, lchnk)' 
  call outfld(trim(prefix)//'UTEND5', utb(:,:,5), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTEND5', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//UTEND5, utb(:,:,5), ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TTGWSDF', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//TTGWSDF, dttdf / cpair, ncol, lchnk)' 
  call outfld(trim(prefix)//'TTGWSKE', dttke / cpair, ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TTGWSKE', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//TTGWSKE, dttke / cpair, ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', dumc1x, ' FILE: gw_drag.F90',  ' LINE: call outfld(dumc1x,dummyx,ncol,lchnk)' 
     call outfld(dumc1y,dummyy,ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', dumc1y, ' FILE: gw_drag.F90',  ' LINE: call outfld(dumc1y,dummyy,ncol,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'WMF', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//WMF,mf(:,:,west),ncol,lchnk)' 
  call outfld(trim(prefix)//'EMF',mf(:,:,east),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'EMF', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//EMF,mf(:,:,east),ncol,lchnk)' 
  call outfld(trim(prefix)//'SMF',mf(:,:,south),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'SMF', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//SMF,mf(:,:,south),ncol,lchnk)' 
  call outfld(trim(prefix)//'NMF',mf(:,:,north),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'NMF', ' FILE: gw_drag.F90',  ' LINE: call outfld(trim(prefix)//NMF,mf(:,:,north),ncol,lchnk)' 

  ! Simple output fields written to history file.
  ! Total wind tendencies.
  call outfld (trim(prefix)//'UTGWSPEC', utgw , ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'UTGWSPEC', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//UTGWSPEC, utgw , ncol, lchnk)' 
  call outfld (trim(prefix)//'VTGWSPEC', vtgw , ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'VTGWSPEC', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//VTGWSPEC, vtgw , ncol, lchnk)' 

  ! Tau in each direction.
  call outfld (trim(prefix)//'TAUE', taucd(:,:,east), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TAUE', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//TAUE, taucd(:,:,east), ncol, lchnk)' 
  call outfld (trim(prefix)//'TAUW', taucd(:,:,west), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TAUW', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//TAUW, taucd(:,:,west), ncol, lchnk)' 
  call outfld (trim(prefix)//'TAUN', taucd(:,:,north), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TAUN', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//TAUN, taucd(:,:,north), ncol, lchnk)' 
  call outfld (trim(prefix)//'TAUS', taucd(:,:,south), ncol, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TAUS', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//TAUS, taucd(:,:,south), ncol, lchnk)' 

  call outfld (trim(prefix)//'TAUNET', taucd(:,:,east)+taucd(:,:,west), &
WRITE(*,'(4A)') 'NAME: ', trim(prefix)//'TAUNET', ' FILE: gw_drag.F90',  ' LINE: call outfld (trim(prefix)//TAUNET, taucd(:,:,east)+taucd(:,:,west), &' 
       ncol, lchnk)
