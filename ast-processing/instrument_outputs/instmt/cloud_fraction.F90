...
WRITE(*,'(4A)') 'NAME: ', 'SH_CLD  ', ' FILE: cloud_fraction.F90',  ' LINE: call outfld( SH_CLD  , shallowcu   , pcols, lchnk )' 
    call outfld( 'DP_CLD  ', deepcu      , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DP_CLD  ', ' FILE: cloud_fraction.F90',  ' LINE: call outfld( DP_CLD  , deepcu      , pcols, lchnk )' 
