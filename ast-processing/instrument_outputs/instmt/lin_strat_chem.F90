...
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_DO3', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_DO3    , do3_linoz              , ncol, lchnk )' 
    call outfld( 'LINOZ_DO3_PSC', do3_linoz_psc          , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_DO3_PSC', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_DO3_PSC, do3_linoz_psc          , ncol, lchnk )' 
    call outfld( 'LINOZ_SSO3'   , ss_o3                  , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_SSO3', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_SSO3   , ss_o3                  , ncol, lchnk )' 
    call outfld( 'LINOZ_O3COL'  , o3col_du_diag          , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_O3COL', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_O3COL  , o3col_du_diag          , ncol, lchnk )' 
    call outfld( 'LINOZ_O3CLIM' , o3clim_linoz_diag      , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_O3CLIM', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_O3CLIM , o3clim_linoz_diag      , ncol, lchnk )' 
    call outfld( 'LINOZ_SZA'    ,(sza*radians_to_degrees), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LINOZ_SZA', ' FILE: lin_strat_chem.F90',  ' LINE: call outfld( LINOZ_SZA    ,(sza*radians_to_degrees), ncol, lchnk )' 
