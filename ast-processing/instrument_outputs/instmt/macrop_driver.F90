...
WRITE(*,'(4A)') 'NAME: ', 'DPDLFLIQ ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( DPDLFLIQ , dpdlfliq, pcols, lchnk )' 
   call outfld( 'DPDLFICE ', dpdlfice, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DPDLFICE ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( DPDLFICE , dpdlfice, pcols, lchnk )' 
   call outfld( 'SHDLFLIQ ', shdlfliq, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SHDLFLIQ ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( SHDLFLIQ , shdlfliq, pcols, lchnk )' 
   call outfld( 'SHDLFICE ', shdlfice, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SHDLFICE ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( SHDLFICE , shdlfice, pcols, lchnk )' 
   call outfld( 'DPDLFT   ', dpdlft  , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DPDLFT   ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( DPDLFT   , dpdlft  , pcols, lchnk )' 
   call outfld( 'SHDLFT   ', shdlft  , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SHDLFT   ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( SHDLFT   , shdlft  , pcols, lchnk )' 

   call outfld( 'ZMDLF',     dlf     , pcols, state_loc%lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ZMDLF', ' FILE: macrop_driver.F90',  ' LINE: call outfld( ZMDLF,     dlf     , pcols, state_loc%lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'MACPDT   ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( MACPDT   , tlat ,  pcols, lchnk )' 
   call outfld( 'MACPDQ   ', qvlat,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'MACPDQ   ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( MACPDQ   , qvlat,  pcols, lchnk )' 
   call outfld( 'MACPDLIQ ', qcten,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'MACPDLIQ ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( MACPDLIQ , qcten,  pcols, lchnk )' 
   call outfld( 'MACPDICE ', qiten,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'MACPDICE ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( MACPDICE , qiten,  pcols, lchnk )' 
   call outfld( 'CLDVAPADJ', qvadj,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDVAPADJ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDVAPADJ, qvadj,  pcols, lchnk )' 
   call outfld( 'CLDLIQADJ', qladj,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDLIQADJ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDLIQADJ, qladj,  pcols, lchnk )' 
   call outfld( 'CLDICEADJ', qiadj,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDICEADJ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDICEADJ, qiadj,  pcols, lchnk )' 
   call outfld( 'CLDLIQDET', dlf_ql, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDLIQDET', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDLIQDET, dlf_ql, pcols, lchnk )' 
   call outfld( 'CLDICEDET', dlf_qi, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDICEDET', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDICEDET, dlf_qi, pcols, lchnk )' 
   call outfld( 'CLDLIQLIM', qllim,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDLIQLIM', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDLIQLIM, qllim,  pcols, lchnk )' 
   call outfld( 'CLDICELIM', qilim,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDICELIM', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDICELIM, qilim,  pcols, lchnk )' 

   call outfld( 'ICECLDF ', aist,   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICECLDF ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( ICECLDF , aist,   pcols, lchnk )' 
   call outfld( 'LIQCLDF ', alst,   pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LIQCLDF ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( LIQCLDF , alst,   pcols, lchnk )' 
   call outfld( 'AST',      ast,    pcols, lchnk )   
WRITE(*,'(4A)') 'NAME: ', 'AST', ' FILE: macrop_driver.F90',  ' LINE: call outfld( AST,      ast,    pcols, lchnk )' 

   call outfld( 'CONCLD  ', concld, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CONCLD  ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CONCLD  , concld, pcols, lchnk )' 
   call outfld( 'CLDST   ', cldst,  pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDST   ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDST   , cldst,  pcols, lchnk )' 

   call outfld( 'CMELIQ'  , cmeliq, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMELIQ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CMELIQ  , cmeliq, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'CLDLIQSTR  ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDLIQSTR  , mr_lsliq,    pcols, lchnk )' 
   call outfld( 'CLDICESTR  ', mr_lsice,    pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDICESTR  ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDICESTR  , mr_lsice,    pcols, lchnk )' 
   call outfld( 'CLDLIQCON  ', mr_ccliq,    pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDLIQCON  ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDLIQCON  , mr_ccliq,    pcols, lchnk )' 
   call outfld( 'CLDICECON  ', mr_ccice,    pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDICECON  ', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDICECON  , mr_ccice,    pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'CLDSICE', ' FILE: macrop_driver.F90',  ' LINE: call outfld( CLDSICE    , cldsice,   pcols, lchnk )' 
