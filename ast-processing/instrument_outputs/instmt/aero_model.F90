...
WRITE(*,'(4A)') 'NAME: ', 'airFV', ' FILE: aero_model.F90',  ' LINE: call outfld( airFV, fv(:), pcols, lchnk )' 
    call outfld( 'RAM1', ram1(:), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'RAM1', ' FILE: aero_model.F90',  ' LINE: call outfld( RAM1, ram1(:), pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'DDV', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//DDV, pvmzaer(:,2:pverp), pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'DDF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//DDF, sflx, pcols, lchnk)' 
             call outfld( trim(cnst_name(mm))//'TBF', dep_trb, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'TBF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//TBF, dep_trb, pcols, lchnk )' 
             call outfld( trim(cnst_name(mm))//'GVF', dep_grv, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'GVF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//GVF, dep_grv, pcols, lchnk )' 
             call outfld( trim(cnst_name(mm))//'DTQ', ptend%q(:,:,mm), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'DTQ', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//DTQ, ptend%q(:,:,mm), pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'DDF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//DDF, sflx, pcols, lchnk)' 
             call outfld( trim(cnst_name_cw(mm))//'TBF', dep_trb, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'TBF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//TBF, dep_trb, pcols, lchnk )' 
             call outfld( trim(cnst_name_cw(mm))//'GVF', dep_grv, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'GVF', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//GVF, dep_grv, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'WET', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//WET, dqdt_tmp(:,:), pcols, lchnk)' 
                call outfld( trim(cnst_name(mm))//'SIC', icscavt, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SIC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SIC, icscavt, pcols, lchnk)' 
                call outfld( trim(cnst_name(mm))//'SIS', isscavt, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SIS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SIS, isscavt, pcols, lchnk)' 
                call outfld( trim(cnst_name(mm))//'SBC', bcscavt, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SBC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SBC, bcscavt, pcols, lchnk)' 
                call outfld( trim(cnst_name(mm))//'SBS', bsscavt, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SBS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SBS, bsscavt, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SFWET', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SFWET, sflx, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SFSIC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SFSIC, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SFSIS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SFSIS, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SFSBC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SFSBC, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(mm))//'SFSBS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name(mm))//SFSBS, sflx, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'SFWET', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//SFWET, sflx, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'SFSIC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//SFSIC, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
                      sflx(i)=sflx(i)+isscavt(i,k)*state%pdel(i,k)/gravit
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'SFSIS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//SFSIS, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
                      sflx(i)=sflx(i)+bcscavt(i,k)*state%pdel(i,k)/gravit
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'SFSBC', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//SFSBC, sflx, pcols, lchnk)' 
                sflx(:)=0._r8
                do k=1,pver
                   do i=1,ncol
                      sflx(i)=sflx(i)+bsscavt(i,k)*state%pdel(i,k)/gravit
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(mm))//'SFSBS', ' FILE: aero_model.F90',  ' LINE: call outfld( trim(cnst_name_cw(mm))//SFSBS, sflx, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', dgnum_name(n), ' FILE: aero_model.F90',  ' LINE: call outfld(dgnum_name(n),dgnumwet(1:ncol,1:pver,n), ncol, lchnk )' 
    end do
...
WRITE(*,'(4A)') 'NAME: ', name, ' FILE: aero_model.F90',  ' LINE: call outfld( name, wrk(:ncol), ncol, lchnk )' 
    enddo
...
WRITE(*,'(4A)') 'NAME: ', cnst_name_cw(n), ' FILE: aero_model.F90',  ' LINE: call outfld( cnst_name_cw(n), fldcw(:,:), pcols, lchnk )' 
       endif
    end do
...
WRITE(*,'(4A)') 'NAME: ', trim(dust_names(m))//'SF', ' FILE: aero_model.F90',  ' LINE: call outfld(trim(dust_names(m))//SF,cam_in%cflx(:,mm),pcols, lchnk)' 
       enddo
       call outfld('DSTSFMBL',sflx(:),pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DSTSFMBL', ' FILE: aero_model.F90',  ' LINE: call outfld(DSTSFMBL,sflx(:),pcols,lchnk)' 
       call outfld('LND_MBL',soil_erod_tmp(:),pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LND_MBL', ' FILE: aero_model.F90',  ' LINE: call outfld(LND_MBL,soil_erod_tmp(:),pcols, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', trim(seasalt_names(m))//'SF', ' FILE: aero_model.F90',  ' LINE: call outfld(trim(seasalt_names(m))//SF,cam_in%cflx(:,mm),pcols,lchnk)' 
       enddo
       call outfld('SSTSFMBL',sflx(:),pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SSTSFMBL', ' FILE: aero_model.F90',  ' LINE: call outfld(SSTSFMBL,sflx(:),pcols,lchnk)' 
    endif
