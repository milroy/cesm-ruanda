...
WRITE(*,'(4A)') 'NAME: ', 'SZA', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SZA,   sza,    ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'HNO3_TOTAL', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HNO3_TOTAL, vmr(:ncol,:,hno3_ndx), ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QDSAD', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( QDSAD, wrk(:,:), ncol, lchnk )' 
!
       call outfld( 'SAD', strato_sad    (:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SAD', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SAD, strato_sad    (:ncol,:), ncol, lchnk )' 
       call outfld( 'SAD_SULFC',  sad_strat(:,:,1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SAD_SULFC', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SAD_SULFC,  sad_strat(:,:,1), ncol, lchnk )' 
       call outfld( 'SAD_LNAT',   sad_strat(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SAD_LNAT', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SAD_LNAT,   sad_strat(:,:,2), ncol, lchnk )' 
       call outfld( 'SAD_ICE',    sad_strat(:,:,3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SAD_ICE', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SAD_ICE,    sad_strat(:,:,3), ncol, lchnk )' 
!
       call outfld( 'RAD_SULFC',  radius_strat(:,:,1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'RAD_SULFC', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( RAD_SULFC,  radius_strat(:,:,1), ncol, lchnk )' 
       call outfld( 'RAD_LNAT',   radius_strat(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'RAD_LNAT', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( RAD_LNAT,   radius_strat(:,:,2), ncol, lchnk )' 
       call outfld( 'RAD_ICE',    radius_strat(:,:,3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'RAD_ICE', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( RAD_ICE,    radius_strat(:,:,3), ncol, lchnk )' 
!
       call outfld( 'HNO3_GAS',   vmr(:ncol,:,hno3_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HNO3_GAS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HNO3_GAS,   vmr(:ncol,:,hno3_ndx), ncol, lchnk )' 
       call outfld( 'HNO3_STS',   hno3_cond(:,:,1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HNO3_STS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HNO3_STS,   hno3_cond(:,:,1), ncol, lchnk )' 
       call outfld( 'HNO3_NAT',   hno3_cond(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HNO3_NAT', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HNO3_NAT,   hno3_cond(:,:,2), ncol, lchnk )' 
!
       call outfld( 'HCL_TOTAL',  vmr(:ncol,:,hcl_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HCL_TOTAL', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HCL_TOTAL,  vmr(:ncol,:,hcl_ndx), ncol, lchnk )' 
       call outfld( 'HCL_GAS',    hcl_gas (:,:), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HCL_GAS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HCL_GAS,    hcl_gas (:,:), ncol ,lchnk )' 
       call outfld( 'HCL_STS',    hcl_cond(:,:), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HCL_STS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HCL_STS,    hcl_cond(:,:), ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'SAD_TROP', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( SAD_TROP, sad_total(:ncol,:), ncol, lchnk )' 

    if (het1_ndx>0) then
       call outfld( 'het1_total', reaction_rates(:,:,het1_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'het1_total', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( het1_total, reaction_rates(:,:,het1_ndx), ncol, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', rxn_names(i-phtcnt), ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( rxn_names(i-phtcnt), reaction_rates(:,:,i), ncol, lchnk )' 
    enddo
...
WRITE(*,'(4A)') 'NAME: ', 'DTCBS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTCBS,   dt_diag(:ncol,1), ncol, lchnk )' 
       call outfld('DTOCS',   dt_diag(:ncol,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTOCS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTOCS,   dt_diag(:ncol,2), ncol, lchnk )' 
       call outfld('DTSO4',   dt_diag(:ncol,3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTSO4', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTSO4,   dt_diag(:ncol,3), ncol, lchnk )' 
       call outfld('DTANT',   dt_diag(:ncol,4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTANT', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTANT,   dt_diag(:ncol,4), ncol, lchnk )' 
       call outfld('DTSAL',   dt_diag(:ncol,5), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTSAL', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTSAL,   dt_diag(:ncol,5), ncol, lchnk )' 
       call outfld('DTDUST',  dt_diag(:ncol,6), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTDUST', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTDUST,  dt_diag(:ncol,6), ncol, lchnk )' 
       call outfld('DTSOA',   dt_diag(:ncol,7), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTSOA', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTSOA,   dt_diag(:ncol,7), ncol, lchnk )' 
       call outfld('DTTOTAL', dt_diag(:ncol,8), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTTOTAL', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(DTTOTAL, dt_diag(:ncol,8), ncol, lchnk )' 
       call outfld('FRACDAY', fracday(:ncol), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FRACDAY', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(FRACDAY, fracday(:ncol), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', pht_names(i), ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( pht_names(i), reaction_rates(:ncol,:,i), ncol, lchnk )' 
       call outfld( tag_names(i), reaction_rates(:ncol,:,rxt_tag_map(i)), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', tag_names(i), ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( tag_names(i), reaction_rates(:ncol,:,rxt_tag_map(i)), ncol, lchnk )' 
    enddo
...
WRITE(*,'(4A)') 'NAME: ', extfrc_name(m), ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( extfrc_name(m), extfrc(:ncol,:,m), ncol, lchnk )' 
    end do
...
WRITE(*,'(4A)') 'NAME: ', 'H2O_GAS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: if( h2o_ndx>0) call outfld( H2O_GAS,  vmr(1,1,h2o_ndx),  ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'O3S_LOSS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( O3S_LOSS,  o3s_loss,  ncol ,lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'QDCHEM', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( QDCHEM,   wrk(:ncol,:),         ncol, lchnk )' 
       call outfld( 'HNO3_GAS', vmr(:ncol,:,hno3_ndx), ncol ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HNO3_GAS', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( HNO3_GAS, vmr(:ncol,:,hno3_ndx), ncol ,lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QDSETT', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld( QDSETT, wrk(:,:), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'PM25_SRF', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(PM25_SRF,pm25(:ncol) , ncol, lchnk )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', 'Q_SRF', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(Q_SRF,qh2o(:ncol,pver) , ncol, lchnk )' 
    call outfld('U_SRF',ufld(:ncol,pver) , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'U_SRF', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(U_SRF,ufld(:ncol,pver) , ncol, lchnk )' 
    call outfld('V_SRF',vfld(:ncol,pver) , ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'V_SRF', ' FILE: mo_gas_phase_chemdr.F90',  ' LINE: call outfld(V_SRF,vfld(:ncol,pver) , ncol, lchnk )' 
!
