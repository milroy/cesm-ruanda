...
WRITE(*,'(4A)') 'NAME: ', 'SSLTA', ' FILE: sslt_rebin.F90',  ' LINE: call outfld( SSLTA, sslta(:ncol,:), ncol, lchnk )' 
    call outfld( 'SSLTC', ssltc(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'SSLTC', ' FILE: sslt_rebin.F90',  ' LINE: call outfld( SSLTC, ssltc(:ncol,:), ncol, lchnk )' 
