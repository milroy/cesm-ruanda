...
WRITE(*,'(4A)') 'NAME: ', 'UW_errorPBL', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_errorPBL,    errorPBL,   pcols,   lchnk )' 

    call outfld( 'UW_n2',          n2,         pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_n2', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_n2,          n2,         pcols,   lchnk )' 
    call outfld( 'UW_s2',          s2,         pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_s2', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_s2,          s2,         pcols,   lchnk )' 
    call outfld( 'UW_ri',          ri,         pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ri', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ri,          ri,         pcols,   lchnk )' 

    call outfld( 'UW_sfuh',        sfuh,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sfuh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sfuh,        sfuh,       pcols,   lchnk )' 
    call outfld( 'UW_sflh',        sflh,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sflh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sflh,        sflh,       pcols,   lchnk )' 
    call outfld( 'UW_sfi',         sfi,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sfi', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sfi,         sfi,        pcols,   lchnk )' 

    call outfld( 'UW_cldn',        cldn,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_cldn', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_cldn,        cldn,       pcols,   lchnk )' 
    call outfld( 'UW_qrl',         qrl,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_qrl', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_qrl,         qrl,        pcols,   lchnk )' 
    call outfld( 'UW_ql',          qlfd,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ql', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ql,          qlfd,       pcols,   lchnk )' 

    call outfld( 'UW_chu',         chu,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_chu', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_chu,         chu,        pcols,   lchnk )' 
    call outfld( 'UW_chs',         chs,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_chs', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_chs,         chs,        pcols,   lchnk )' 
    call outfld( 'UW_cmu',         cmu,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_cmu', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_cmu,         cmu,        pcols,   lchnk )' 
    call outfld( 'UW_cms',         cms,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_cms', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_cms,         cms,        pcols,   lchnk )' 

    call outfld( 'UW_tke',         tke,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_tke', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_tke,         tke,        pcols,   lchnk )' 
    call outfld( 'UW_wcap',        wcap,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wcap', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wcap,        wcap,       pcols,   lchnk )' 
    call outfld( 'UW_bprod',       bprod,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_bprod', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_bprod,       bprod,      pcols,   lchnk )' 
    call outfld( 'UW_sprod',       sprod,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sprod', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sprod,       sprod,      pcols,   lchnk )' 

    call outfld( 'UW_kvh',         kvh_out,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_kvh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_kvh,         kvh_out,    pcols,   lchnk )' 
    call outfld( 'UW_kvm',         kvm_out,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_kvm', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_kvm,         kvm_out,    pcols,   lchnk )' 

    call outfld( 'UW_pblh',        pblh,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_pblh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_pblh,        pblh,       pcols,   lchnk )' 
    call outfld( 'UW_pblhp',       pblhp,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_pblhp', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_pblhp,       pblhp,      pcols,   lchnk )' 
    call outfld( 'UW_tpert',       tpert,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_tpert', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_tpert,       tpert,      pcols,   lchnk )' 
    call outfld( 'UW_qpert',       qpert,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_qpert', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_qpert,       qpert,      pcols,   lchnk )' 
    call outfld( 'UW_wpert',       wpert,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wpert', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wpert,       wpert,      pcols,   lchnk )' 

    call outfld( 'UW_ustar',       ustar,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ustar', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ustar,       ustar,      pcols,   lchnk )' 
    call outfld( 'UW_tkes',        tkes,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_tkes', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_tkes,        tkes,       pcols,   lchnk )' 
    call outfld( 'UW_minpblh',     minpblh,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_minpblh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_minpblh,     minpblh,    pcols,   lchnk )' 

    call outfld( 'UW_turbtype',    real(turbtype,r8),   pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_turbtype', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_turbtype,    real(turbtype,r8),   pcols,   lchnk )' 

    call outfld( 'UW_kbase_o',     kbase_o,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_kbase_o', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_kbase_o,     kbase_o,    pcols,   lchnk )' 
    call outfld( 'UW_ktop_o',      ktop_o,     pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ktop_o', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ktop_o,      ktop_o,     pcols,   lchnk )' 
    call outfld( 'UW_ncvfin_o',    ncvfin_o,   pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ncvfin_o', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ncvfin_o,    ncvfin_o,   pcols,   lchnk )' 

    call outfld( 'UW_kbase_mg',    kbase_mg,   pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_kbase_mg', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_kbase_mg,    kbase_mg,   pcols,   lchnk )' 
    call outfld( 'UW_ktop_mg',     ktop_mg,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ktop_mg', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ktop_mg,     ktop_mg,    pcols,   lchnk )' 
    call outfld( 'UW_ncvfin_mg',   ncvfin_mg,  pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ncvfin_mg', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ncvfin_mg,   ncvfin_mg,  pcols,   lchnk )' 

    call outfld( 'UW_kbase_f',     kbase_f,    pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_kbase_f', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_kbase_f,     kbase_f,    pcols,   lchnk )' 
    call outfld( 'UW_ktop_f',      ktop_f,     pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ktop_f', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ktop_f,      ktop_f,     pcols,   lchnk )' 
    call outfld( 'UW_ncvfin_f',    ncvfin_f,   pcols,   lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'UW_ncvfin_f', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ncvfin_f,    ncvfin_f,   pcols,   lchnk )' 

    call outfld( 'UW_wet',         wet,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wet', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wet,         wet,        pcols,   lchnk )' 
    call outfld( 'UW_web',         web,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_web', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_web,         web,        pcols,   lchnk )' 
    call outfld( 'UW_jtbu',        jtbu,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_jtbu', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_jtbu,        jtbu,       pcols,   lchnk )' 
    call outfld( 'UW_jbbu',        jbbu,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_jbbu', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_jbbu,        jbbu,       pcols,   lchnk )' 
    call outfld( 'UW_evhc',        evhc,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_evhc', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_evhc,        evhc,       pcols,   lchnk )' 
    call outfld( 'UW_jt2slv',      jt2slv,     pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_jt2slv', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_jt2slv,      jt2slv,     pcols,   lchnk )' 
    call outfld( 'UW_n2ht',        n2ht,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_n2ht', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_n2ht,        n2ht,       pcols,   lchnk )' 
    call outfld( 'UW_n2hb',        n2hb,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_n2hb', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_n2hb,        n2hb,       pcols,   lchnk )' 
    call outfld( 'UW_lwp',         lwp,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_lwp', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_lwp,         lwp,        pcols,   lchnk )' 
    call outfld( 'UW_optdepth',    opt_depth,  pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_optdepth', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_optdepth,    opt_depth,  pcols,   lchnk )' 
    call outfld( 'UW_radfrac',     radinvfrac, pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_radfrac', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_radfrac,     radinvfrac, pcols,   lchnk )' 
    call outfld( 'UW_radf',        radf,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_radf', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_radf,        radf,       pcols,   lchnk )' 
    call outfld( 'UW_wstar',       wstar,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wstar', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wstar,       wstar,      pcols,   lchnk )' 
    call outfld( 'UW_wstar3fact',  wstar3fact, pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wstar3fact', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wstar3fact,  wstar3fact, pcols,   lchnk )' 
    call outfld( 'UW_ebrk',        ebrk,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ebrk', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ebrk,        ebrk,       pcols,   lchnk )' 
    call outfld( 'UW_wbrk',        wbrk,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wbrk', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wbrk,        wbrk,       pcols,   lchnk )' 
    call outfld( 'UW_lbrk',        lbrk,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_lbrk', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_lbrk,        lbrk,       pcols,   lchnk )' 
    call outfld( 'UW_ricl',        ricl,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ricl', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ricl,        ricl,       pcols,   lchnk )' 
    call outfld( 'UW_ghcl',        ghcl,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ghcl', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ghcl,        ghcl,       pcols,   lchnk )' 
    call outfld( 'UW_shcl',        shcl,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_shcl', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_shcl,        shcl,       pcols,   lchnk )' 
    call outfld( 'UW_smcl',        smcl,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_smcl', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_smcl,        smcl,       pcols,   lchnk )' 

    call outfld( 'UW_gh',          ghi,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_gh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_gh,          ghi,        pcols,   lchnk )' 
    call outfld( 'UW_sh',          shi,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sh', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sh,          shi,        pcols,   lchnk )' 
    call outfld( 'UW_sm',          smi,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_sm', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_sm,          smi,        pcols,   lchnk )' 
    call outfld( 'UW_ria',         rii,        pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_ria', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_ria,         rii,        pcols,   lchnk )' 
    call outfld( 'UW_leng',        lengi,      pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_leng', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_leng,        lengi,      pcols,   lchnk )' 

    call outfld( 'UW_wsed',        wsed,       pcols,   lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UW_wsed', ' FILE: eddy_diff.F90',  ' LINE: call outfld( UW_wsed,        wsed,       pcols,   lchnk )' 
