...
WRITE(*,'(4A)') 'NAME: ', 'ICLMRCU ', ' FILE: conv_water.F90',  ' LINE: call outfld( ICLMRCU , conv_liq  , pcols, lchnk )' 
   call outfld( 'ICIMRCU ', conv_ice  , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICIMRCU ', ' FILE: conv_water.F90',  ' LINE: call outfld( ICIMRCU , conv_ice  , pcols, lchnk )' 
   call outfld( 'ICLMRTOT', tot_liq   , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICLMRTOT', ' FILE: conv_water.F90',  ' LINE: call outfld( ICLMRTOT, tot_liq   , pcols, lchnk )' 
   call outfld( 'ICIMRTOT', tot_ice   , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICIMRTOT', ' FILE: conv_water.F90',  ' LINE: call outfld( ICIMRTOT, tot_ice   , pcols, lchnk )' 
