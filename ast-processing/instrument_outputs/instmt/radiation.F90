...
WRITE(*,'(4A)') 'NAME: ', 'CLDFSNOW', ' FILE: radiation.F90',  ' LINE: call outfld(CLDFSNOW,cldfsnow,pcols,lchnk)' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', 'QRS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(QRS//diag(icall),ftem  ,pcols,lchnk)' 
                  ftem(:ncol,:pver) = qrsc(:ncol,:pver)/cpair
                  call outfld('QRSC'//diag(icall),ftem  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QRSC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(QRSC//diag(icall),ftem  ,pcols,lchnk)' 
                  call outfld('SOLIN'//diag(icall),solin ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SOLIN'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SOLIN//diag(icall),solin ,pcols,lchnk)' 
                  call outfld('FSDS'//diag(icall),fsds  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSDS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSDS//diag(icall),fsds  ,pcols,lchnk)' 
                  call outfld('FSNIRTOA'//diag(icall),fsnirt,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNIRTOA'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNIRTOA//diag(icall),fsnirt,pcols,lchnk)' 
                  call outfld('FSNRTOAC'//diag(icall),fsnrtc,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNRTOAC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNRTOAC//diag(icall),fsnrtc,pcols,lchnk)' 
                  call outfld('FSNRTOAS'//diag(icall),fsnirtsq,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNRTOAS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNRTOAS//diag(icall),fsnirtsq,pcols,lchnk)' 
                  call outfld('FSNT'//diag(icall),fsnt  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNT'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNT//diag(icall),fsnt  ,pcols,lchnk)' 
                  call outfld('FSNS'//diag(icall),fsns  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNS//diag(icall),fsns  ,pcols,lchnk)' 
                  call outfld('FSNTC'//diag(icall),fsntc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNTC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNTC//diag(icall),fsntc ,pcols,lchnk)' 
                  call outfld('FSNSC'//diag(icall),fsnsc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNSC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNSC//diag(icall),fsnsc ,pcols,lchnk)' 
                  call outfld('FSDSC'//diag(icall),fsdsc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSDSC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSDSC//diag(icall),fsdsc ,pcols,lchnk)' 
                  call outfld('FSNTOA'//diag(icall),fsntoa,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNTOA'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNTOA//diag(icall),fsntoa,pcols,lchnk)' 
                  call outfld('FSUTOA'//diag(icall),fsutoa,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSUTOA'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSUTOA//diag(icall),fsutoa,pcols,lchnk)' 
                  call outfld('FSNTOAC'//diag(icall),fsntoac,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNTOAC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSNTOAC//diag(icall),fsntoac,pcols,lchnk)' 
                  call outfld('SOLS'//diag(icall),cam_out%sols  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SOLS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SOLS//diag(icall),cam_out%sols  ,pcols,lchnk)' 
                  call outfld('SOLL'//diag(icall),cam_out%soll  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SOLL'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SOLL//diag(icall),cam_out%soll  ,pcols,lchnk)' 
                  call outfld('SOLSD'//diag(icall),cam_out%solsd ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SOLSD'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SOLSD//diag(icall),cam_out%solsd ,pcols,lchnk)' 
                  call outfld('SOLLD'//diag(icall),cam_out%solld ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SOLLD'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SOLLD//diag(icall),cam_out%solld ,pcols,lchnk)' 
                  call outfld('FSN200'//diag(icall),fsn200,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSN200'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSN200//diag(icall),fsn200,pcols,lchnk)' 
                  call outfld('FSN200C'//diag(icall),fsn200c,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSN200C'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FSN200C//diag(icall),fsn200c,pcols,lchnk)' 
                  call outfld('SWCF'//diag(icall),swcf  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SWCF'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(SWCF//diag(icall),swcf  ,pcols,lchnk)' 
                  call outfld('FSNR',fsnr,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FSNR', ' FILE: radiation.F90',  ' LINE: call outfld(FSNR,fsnr,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TOT_CLD_VISTAU', ' FILE: radiation.F90',  ' LINE: call outfld(TOT_CLD_VISTAU, tot_cld_vistau, pcols, lchnk)' 
          call outfld('TOT_ICLD_VISTAU', tot_icld_vistau, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TOT_ICLD_VISTAU', ' FILE: radiation.F90',  ' LINE: call outfld(TOT_ICLD_VISTAU, tot_icld_vistau, pcols, lchnk)' 
          call outfld('LIQ_ICLD_VISTAU', liq_icld_vistau, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LIQ_ICLD_VISTAU', ' FILE: radiation.F90',  ' LINE: call outfld(LIQ_ICLD_VISTAU, liq_icld_vistau, pcols, lchnk)' 
          call outfld('ICE_ICLD_VISTAU', ice_icld_vistau, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICE_ICLD_VISTAU', ' FILE: radiation.F90',  ' LINE: call outfld(ICE_ICLD_VISTAU, ice_icld_vistau, pcols, lchnk)' 
          if (cldfsnow_idx > 0) then
             call outfld('SNOW_ICLD_VISTAU', snow_icld_vistau, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SNOW_ICLD_VISTAU', ' FILE: radiation.F90',  ' LINE: call outfld(SNOW_ICLD_VISTAU, snow_icld_vistau, pcols, lchnk)' 
          endif
       end if   ! dosw
...
WRITE(*,'(4A)') 'NAME: ', 'QRL'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(QRL//diag(icall),qrl (:ncol,:)/cpair,ncol,lchnk)' 
                  call outfld('QRLC'//diag(icall),qrlc(:ncol,:)/cpair,ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QRLC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(QRLC//diag(icall),qrlc(:ncol,:)/cpair,ncol,lchnk)' 
                  call outfld('FLNT'//diag(icall),flnt  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLNT'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLNT//diag(icall),flnt  ,pcols,lchnk)' 
                  call outfld('FLUT'//diag(icall),flut  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLUT'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLUT//diag(icall),flut  ,pcols,lchnk)' 
                  call outfld('FLUTC'//diag(icall),flutc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLUTC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLUTC//diag(icall),flutc ,pcols,lchnk)' 
                  call outfld('FLNTC'//diag(icall),flntc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLNTC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLNTC//diag(icall),flntc ,pcols,lchnk)' 
                  call outfld('FLNS'//diag(icall),flns  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLNS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLNS//diag(icall),flns  ,pcols,lchnk)' 
                  
                  call outfld('FLDSC'//diag(icall),fldsc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLDSC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLDSC//diag(icall),fldsc ,pcols,lchnk)' 
                  call outfld('FLNSC'//diag(icall),flnsc ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLNSC'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLNSC//diag(icall),flnsc ,pcols,lchnk)' 
                  call outfld('LWCF'//diag(icall),lwcf  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LWCF'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(LWCF//diag(icall),lwcf  ,pcols,lchnk)' 
                  call outfld('FLN200'//diag(icall),fln200,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLN200'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLN200//diag(icall),fln200,pcols,lchnk)' 
                  call outfld('FLN200C'//diag(icall),fln200c,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLN200C'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLN200C//diag(icall),fln200c,pcols,lchnk)' 
                  call outfld('FLDS'//diag(icall),cam_out%flwds ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLDS'//diag(icall), ' FILE: radiation.F90',  ' LINE: call outfld(FLDS//diag(icall),cam_out%flwds ,pcols,lchnk)' 
                  call outfld('FLNR',flnr,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'FLNR', ' FILE: radiation.F90',  ' LINE: call outfld(FLNR,flnr,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', hirsname(i), ' FILE: radiation.F90',  ' LINE: call outfld(hirsname(i),tb_ir(1,i),pcols,lchnk)' 
          end do
          do i = 1, pnf_msu
             call outfld(msuname(i),britemp(1,i),pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', msuname(i), ' FILE: radiation.F90',  ' LINE: call outfld(msuname(i),britemp(1,i),pcols,lchnk)' 
          end do
...
WRITE(*,'(4A)') 'NAME: ', 'EMIS', ' FILE: radiation.F90',  ' LINE: call outfld(EMIS, emis, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'HR      ', ' FILE: radiation.F90',  ' LINE: call outfld(HR      ,ftem    ,pcols   ,lchnk   )' 
