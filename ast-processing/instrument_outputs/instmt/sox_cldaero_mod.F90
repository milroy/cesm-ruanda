...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(m))//'AQSO4', ' FILE: sox_cldaero_mod.F90',  ' LINE: call outfld( trim(cnst_name_cw(m))//AQSO4, sflx(:ncol), ncol, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name_cw(m))//'AQH2SO4', ' FILE: sox_cldaero_mod.F90',  ' LINE: call outfld( trim(cnst_name_cw(m))//AQH2SO4, sflx(:ncol), ncol, lchnk)' 
       endif
    end do
...
WRITE(*,'(4A)') 'NAME: ', 'AQSO4_H2O2', ' FILE: sox_cldaero_mod.F90',  ' LINE: call outfld( AQSO4_H2O2, sflx(:ncol), ncol, lchnk)' 
    sflx(:)=0._r8
    do k=1,pver
       do i=1,ncol
...
WRITE(*,'(4A)') 'NAME: ', 'AQSO4_O3', ' FILE: sox_cldaero_mod.F90',  ' LINE: call outfld( AQSO4_O3, sflx(:ncol), ncol, lchnk)' 
