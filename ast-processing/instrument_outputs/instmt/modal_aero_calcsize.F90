...
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,l,1,jac), pcols, lchnk)' 
         
         fieldname = trim(tmpnamea) // '_sfcsiz2'
         call outfld( fieldname, qsrflx(:,l,2,jac), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,l,2,jac), pcols, lchnk)' 
      end do   ! jac = ...
...
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,lsfrm,3,jac), pcols, lchnk)' 

         fieldname = trim(tmpnameb) // '_sfcsiz3'
         call outfld( fieldname, qsrflx(:,lstoo,3,jac), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,lstoo,3,jac), pcols, lchnk)' 

         fieldname = trim(tmpnamea) // '_sfcsiz4'
         call outfld( fieldname, qsrflx(:,lsfrm,4,jac), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,lsfrm,4,jac), pcols, lchnk)' 

         fieldname = trim(tmpnameb) // '_sfcsiz4'
         call outfld( fieldname, qsrflx(:,lstoo,4,jac), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', fieldname, ' FILE: modal_aero_calcsize.F90',  ' LINE: call outfld( fieldname, qsrflx(:,lstoo,4,jac), pcols, lchnk)' 
