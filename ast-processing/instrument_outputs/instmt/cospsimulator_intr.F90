...
WRITE(*,'(4A)') 'NAME: ', 'PS_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(PS_COSP,gbx%psfc,ncol,lchnk)' 
      call outfld('TS_COSP',gbx%skt,ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TS_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TS_COSP,gbx%skt,ncol,lchnk)' 
      call outfld ('P_COSP',gbx%p(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'P_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld (P_COSP,gbx%p(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld ('PH_COSP',gbx%ph(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PH_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld (PH_COSP,gbx%ph(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld ('ZLEV_COSP',gbx%zlev(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ZLEV_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld (ZLEV_COSP,gbx%zlev(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld ('ZLEV_HALF_COSP',gbx%zlev_half(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ZLEV_HALF_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld (ZLEV_HALF_COSP,gbx%zlev_half(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('T_COSP',gbx%T(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'T_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(T_COSP,gbx%T(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('RH_COSP',gbx%q(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'RH_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(RH_COSP,gbx%q(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('Q_COSP',gbx%sh(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'Q_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(Q_COSP,gbx%sh(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('CONCLD_COSP',gbx%cca(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CONCLD_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CONCLD_COSP,gbx%cca(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('CLD_COSP',gbx%tca(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLD_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLD_COSP,gbx%tca(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('O3_COSP',gbx%mr_ozone(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'O3_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(O3_COSP,gbx%mr_ozone(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('U_COSP',gbx%u_wind,ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'U_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(U_COSP,gbx%u_wind,ncol,lchnk)' 
      call outfld('V_COSP',gbx%v_wind,ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'V_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(V_COSP,gbx%v_wind,ncol,lchnk)' 
      call outfld('LSCLIQ_COSP',gbx%mr_hydro(:,pver:1:-1,I_LSCLIQ),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LSCLIQ_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(LSCLIQ_COSP,gbx%mr_hydro(:,pver:1:-1,I_LSCLIQ),ncol,lchnk)' 
      call outfld('LSCICE_COSP',gbx%mr_hydro(:,pver:1:-1,I_LSCICE),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LSCICE_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(LSCICE_COSP,gbx%mr_hydro(:,pver:1:-1,I_LSCICE),ncol,lchnk)' 
      call outfld('CVCLIQ_COSP',gbx%mr_hydro(:,pver:1:-1,I_CVCLIQ),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CVCLIQ_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CVCLIQ_COSP,gbx%mr_hydro(:,pver:1:-1,I_CVCLIQ),ncol,lchnk)' 
      call outfld('CVCICE_COSP',gbx%mr_hydro(:,pver:1:-1,I_CVCICE),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CVCICE_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CVCICE_COSP,gbx%mr_hydro(:,pver:1:-1,I_CVCICE),ncol,lchnk)' 
      call outfld('RAIN_LS_COSP',gbx%rain_ls(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'RAIN_LS_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(RAIN_LS_COSP,gbx%rain_ls(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('SNOW_LS_COSP',gbx%snow_ls(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SNOW_LS_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(SNOW_LS_COSP,gbx%snow_ls(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('GRPL_LS_COSP',gbx%grpl_ls(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'GRPL_LS_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(GRPL_LS_COSP,gbx%grpl_ls(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('RAIN_CV_COSP',gbx%rain_cv(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'RAIN_CV_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(RAIN_CV_COSP,gbx%rain_cv(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('SNOW_CV_COSP',gbx%snow_cv(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SNOW_CV_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(SNOW_CV_COSP,gbx%snow_cv(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('REFF_COSP_1',gbx%Reff(:,pver:1:-1,1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_1', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_1,gbx%Reff(:,pver:1:-1,1),ncol,lchnk)' 
      call outfld('REFF_COSP_2',gbx%Reff(:,pver:1:-1,2),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_2', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_2,gbx%Reff(:,pver:1:-1,2),ncol,lchnk)' 
      call outfld('REFF_COSP_3',gbx%Reff(:,pver:1:-1,3),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_3', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_3,gbx%Reff(:,pver:1:-1,3),ncol,lchnk)' 
      call outfld('REFF_COSP_4',gbx%Reff(:,pver:1:-1,4),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_4', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_4,gbx%Reff(:,pver:1:-1,4),ncol,lchnk)' 
      call outfld('REFF_COSP_5',gbx%Reff(:,pver:1:-1,5),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_5', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_5,gbx%Reff(:,pver:1:-1,5),ncol,lchnk)' 
      call outfld('REFF_COSP_6',gbx%Reff(:,pver:1:-1,6),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_6', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_6,gbx%Reff(:,pver:1:-1,6),ncol,lchnk)' 
      call outfld('REFF_COSP_7',gbx%Reff(:,pver:1:-1,7),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_7', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_7,gbx%Reff(:,pver:1:-1,7),ncol,lchnk)' 
      call outfld('REFF_COSP_8',gbx%Reff(:,pver:1:-1,8),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_8', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_8,gbx%Reff(:,pver:1:-1,8),ncol,lchnk)' 
      call outfld('REFF_COSP_9',gbx%Reff(:,pver:1:-1,9),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'REFF_COSP_9', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFF_COSP_9,gbx%Reff(:,pver:1:-1,9),ncol,lchnk)' 
      call outfld('DTAU_S_COSP',gbx%dtau_s(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DTAU_S_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DTAU_S_COSP,gbx%dtau_s(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('DTAU_C_COSP',gbx%dtau_c(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DTAU_C_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DTAU_C_COSP,gbx%dtau_c(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('DEM_S_COSP',gbx%dem_s(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DEM_S_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DEM_S_COSP,gbx%dem_s(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('DEM_C_COSP',gbx%dem_c(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DEM_C_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DEM_C_COSP,gbx%dem_c(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('DTAU_S_COSP_SNOW',gbx%dtau_s_snow(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DTAU_S_COSP_SNOW', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DTAU_S_COSP_SNOW,gbx%dtau_s_snow(1:ncol,pver:1:-1),ncol,lchnk)' 
      call outfld('DEM_S_COSP_SNOW',gbx%dem_s_snow(1:ncol,pver:1:-1),ncol,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'DEM_S_COSP_SNOW', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DEM_S_COSP_SNOW,gbx%dem_s_snow(1:ncol,pver:1:-1),ncol,lchnk)' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', 'FISCCP1_COSP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(FISCCP1_COSP,clisccp2, pcols,lchnk)' 
      call outfld('CLDTOT_ISCCP',cldtot_isccp    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDTOT_ISCCP,cldtot_isccp    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'MEANCLDALB_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MEANCLDALB_ISCCP,meancldalb_isccp,pcols,lchnk)' 
      call outfld('MEANPTOP_ISCCP',meanptop_isccp    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MEANPTOP_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MEANPTOP_ISCCP,meanptop_isccp    ,pcols,lchnk)' 
      call outfld('MEANTAU_ISCCP',meantau_isccp  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MEANTAU_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MEANTAU_ISCCP,meantau_isccp  ,pcols,lchnk)' 
      call outfld('MEANTB_ISCCP',     meantb_isccp   ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MEANTB_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MEANTB_ISCCP,     meantb_isccp   ,pcols,lchnk)' 
      call outfld('MEANTBCLR_ISCCP',  meantbclr_isccp ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MEANTBCLR_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MEANTBCLR_ISCCP,  meantbclr_isccp ,pcols,lchnk)' 
   end if

!!! LIDAR SIMULATOR OUTPUTS
   if (llidar_sim) then
      call outfld('CLDLOW_CAL',cldlow_cal    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDLOW_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDLOW_CAL,cldlow_cal    ,pcols,lchnk)' 
      call outfld('CLDMED_CAL',cldmed_cal    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDMED_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDMED_CAL,cldmed_cal    ,pcols,lchnk)' 
      call outfld('CLDHGH_CAL',cldhgh_cal    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDHGH_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDHGH_CAL,cldhgh_cal    ,pcols,lchnk)' 
      call outfld('CLDTOT_CAL',cldtot_cal    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDTOT_CAL,cldtot_cal    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'CLD_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLD_CAL,cld_cal    ,pcols,lchnk)  !! fails check_accum if A' 
      call outfld('MOL532_CAL',mol532_cal    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'MOL532_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(MOL532_CAL,mol532_cal    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'CFAD_SR532_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CFAD_SR532_CAL,cfad_sr532_cal    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'RFL_PARASOL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(RFL_PARASOL,refl_parasol   ,pcols,lchnk) !!' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', 'CFAD_DBZE94_CS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CFAD_DBZE94_CS,cfad_dbze94_cs    ,pcols,lchnk)' 
      call outfld('CLDTOT_CALCS',cldtot_calcs    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT_CALCS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDTOT_CALCS,cldtot_calcs    ,pcols,lchnk)' 
      call outfld('CLDTOT_CS',cldtot_cs    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT_CS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDTOT_CS,cldtot_cs    ,pcols,lchnk)' 
      call outfld('CLDTOT_CS2',cldtot_cs2    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT_CS2', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDTOT_CS2,cldtot_cs2    ,pcols,lchnk)' 
      call outfld('CLD_CAL_NOTCS',cld_cal_notcs    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLD_CAL_NOTCS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLD_CAL_NOTCS,cld_cal_notcs    ,pcols,lchnk)' 
   end if

!!! MISR SIMULATOR OUTPUTS
   if (lmisr_sim) then
      call outfld('CLD_MISR',cld_misr    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLD_MISR', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLD_MISR,cld_misr    ,pcols,lchnk)' 
   end if

!!! MODIS SIMULATOR OUTPUTS
   if (lmodis_sim) then
      call outfld('CLTMODIS',cltmodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLTMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLTMODIS,cltmodis    ,pcols,lchnk)' 
      call outfld('CLWMODIS',clwmodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLWMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLWMODIS,clwmodis    ,pcols,lchnk)' 
      call outfld('CLIMODIS',climodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLIMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLIMODIS,climodis    ,pcols,lchnk)' 
      call outfld('CLHMODIS',clhmodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLHMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLHMODIS,clhmodis    ,pcols,lchnk)' 
      call outfld('CLMMODIS',clmmodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLMMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLMMODIS,clmmodis    ,pcols,lchnk)' 
      call outfld('CLLMODIS',cllmodis    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLLMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLLMODIS,cllmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUTMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUTMODIS,tautmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUWMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUWMODIS,tauwmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUIMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUIMODIS,tauimodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUTLOGMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUTLOGMODIS,tautlogmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUWLOGMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUWLOGMODIS,tauwlogmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TAUILOGMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAUILOGMODIS,tauilogmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'REFFCLWMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFFCLWMODIS,reffclwmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'REFFCLIMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(REFFCLIMODIS,reffclimodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'PCTMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(PCTMODIS,pctmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'LWPMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(LWPMODIS,lwpmodis    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'IWPMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(IWPMODIS,iwpmodis    ,pcols,lchnk)' 

      call outfld('CLMODIS',clmodis_cam    ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLMODIS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLMODIS,clmodis_cam    ,pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'SCOPS_OUT', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(SCOPS_OUT,scops_out   ,pcols,lchnk)!!!-1.00000E+30 !! fails check_accum if A' 
      if (lisccp_sim) then
         call outfld('TAU_ISCCP',tau_isccp    ,pcols,lchnk) !! fails check_accum if 'A'
WRITE(*,'(4A)') 'NAME: ', 'TAU_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(TAU_ISCCP,tau_isccp    ,pcols,lchnk) !! fails check_accum if A' 
         call outfld('CLDPTOP_ISCCP',cldptop_isccp    ,pcols,lchnk) !! fails check_accum if 'A'
WRITE(*,'(4A)') 'NAME: ', 'CLDPTOP_ISCCP', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(CLDPTOP_ISCCP,cldptop_isccp    ,pcols,lchnk) !! fails check_accum if A' 
      end if
      if (llidar_sim) then
         call outfld('ATB532_CAL',atb532_cal    ,pcols,lchnk) !! fails check_accum if 'A'
WRITE(*,'(4A)') 'NAME: ', 'ATB532_CAL', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(ATB532_CAL,atb532_cal    ,pcols,lchnk) !! fails check_accum if A' 
      end if
      if (lradar_sim) then
         call outfld('DBZE_CS',dbze_cs   ,pcols,lchnk) !! fails check_accum if 'A'
WRITE(*,'(4A)') 'NAME: ', 'DBZE_CS', ' FILE: cospsimulator_intr.F90',  ' LINE: call outfld(DBZE_CS,dbze_cs   ,pcols,lchnk) !! fails check_accum if A' 
      end if
   end if
