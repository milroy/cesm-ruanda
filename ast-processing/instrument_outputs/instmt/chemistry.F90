...
WRITE(*,'(4A)') 'NAME: ', 'MEG_'//trim(shr_megan_mechcomps(n)%name), ' FILE: chemistry.F90',  ' LINE: call outfld(MEG_//trim(shr_megan_mechcomps(n)%name), megflx(:ncol), ncol, lchnk)' 
       enddo
...
WRITE(*,'(4A)') 'NAME: ', sflxnam(m), ' FILE: chemistry.F90',  ' LINE: call outfld( sflxnam(m), cam_in%cflx(:ncol,m), ncol,lchnk )' 
       endif
    enddo
...
WRITE(*,'(4A)') 'NAME: ', srcnam(m), ' FILE: chemistry.F90',  ' LINE: call outfld( srcnam(m), ptend%q(:,:,n), pcols, lchnk )' 
       end if
...
WRITE(*,'(4A)') 'NAME: ', 'CT_H2O_GHG', ' FILE: chemistry.F90',  ' LINE: call outfld( CT_H2O_GHG, ptend%q(:,:,1), pcols, lchnk )' 
    endif

    call outfld( 'HEIGHT', state%zi(:ncol,:),  ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HEIGHT', ' FILE: chemistry.F90',  ' LINE: call outfld( HEIGHT, state%zi(:ncol,:),  ncol, lchnk )' 
