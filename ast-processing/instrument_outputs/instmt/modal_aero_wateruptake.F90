...
WRITE(*,'(4A)') 'NAME: ', 'wat_a'//trnum(3:3), ' FILE: modal_aero_wateruptake.F90',  ' LINE: call outfld( wat_a//trnum(3:3),  qaerwat(:,:,m),     pcols, lchnk)' 
         call outfld( 'dgnd_a'//trnum(2:3), dgncur_a(:,:,m),    pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'dgnd_a'//trnum(2:3), ' FILE: modal_aero_wateruptake.F90',  ' LINE: call outfld( dgnd_a//trnum(2:3), dgncur_a(:,:,m),    pcols, lchnk)' 
         call outfld( 'dgnw_a'//trnum(2:3), dgncur_awet(:,:,m), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'dgnw_a'//trnum(2:3), ' FILE: modal_aero_wateruptake.F90',  ' LINE: call outfld( dgnw_a//trnum(2:3), dgncur_awet(:,:,m), pcols, lchnk)' 
      end do
