...
WRITE(*,'(4A)') 'NAME: ', 'LNO_PROD', ' FILE: mo_lightning.F90',  ' LINE: call outfld( LNO_PROD,     prod_no(:,:,c),        pcols, lchnk )' 
       call outfld( 'LNO_COL_PROD', glob_prod_no_col(:,c), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LNO_COL_PROD', ' FILE: mo_lightning.F90',  ' LINE: call outfld( LNO_COL_PROD, glob_prod_no_col(:,c), pcols, lchnk )' 
       call outfld( 'FLASHFRQ',     flash_freq(:,c),       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FLASHFRQ', ' FILE: mo_lightning.F90',  ' LINE: call outfld( FLASHFRQ,     flash_freq(:,c),       pcols, lchnk )' 
       call outfld( 'FLASHENGY',    flash_energy(:,c),     pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FLASHENGY', ' FILE: mo_lightning.F90',  ' LINE: call outfld( FLASHENGY,    flash_energy(:,c),     pcols, lchnk )' 
       call outfld( 'CLDHGT',       cldhgt(:,c),           pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDHGT', ' FILE: mo_lightning.F90',  ' LINE: call outfld( CLDHGT,       cldhgt(:,c),           pcols, lchnk )' 
       call outfld( 'DCHGZONE',     dchgzone(:,c),         pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DCHGZONE', ' FILE: mo_lightning.F90',  ' LINE: call outfld( DCHGZONE,     dchgzone(:,c),         pcols, lchnk )' 
       call outfld( 'CGIC',         cgic(:,c),             pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CGIC', ' FILE: mo_lightning.F90',  ' LINE: call outfld( CGIC,         cgic(:,c),             pcols, lchnk )' 
    enddo
