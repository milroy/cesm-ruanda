...
WRITE(*,'(4A)') 'NAME: ', 'NO_Lightning', ' FILE: mo_setext.F90',  ' LINE: call outfld( NO_Lightning, no_lgt(:ncol,:), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'AOA_NH_XFRC', ' FILE: mo_setext.F90',  ' LINE: call outfld(AOA_NH_XFRC,extfrc(:ncol,:,aoa_nh_ndx), ncol, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'P_Op', ' FILE: mo_setext.F90',  ' LINE: call outfld( P_Op,  extfrc(:,:,op_ndx), ncol, lchnk )' 
       call outfld( 'P_O2p', extfrc(:,:,o2p_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'P_O2p', ' FILE: mo_setext.F90',  ' LINE: call outfld( P_O2p, extfrc(:,:,o2p_ndx), ncol, lchnk )' 
       call outfld( 'P_Np',  extfrc(:,:,np_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'P_Np', ' FILE: mo_setext.F90',  ' LINE: call outfld( P_Np,  extfrc(:,:,np_ndx), ncol, lchnk )' 
       call outfld( 'P_N2p', extfrc(:,:,n2p_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'P_N2p', ' FILE: mo_setext.F90',  ' LINE: call outfld( P_N2p, extfrc(:,:,n2p_ndx), ncol, lchnk )' 
       call outfld( 'P_IONS',extfrc(:,:,n2d_ndx), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'P_IONS', ' FILE: mo_setext.F90',  ' LINE: call outfld( P_IONS,extfrc(:,:,n2d_ndx), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'N2D_SPE', ' FILE: mo_setext.F90',  ' LINE: call outfld( N2D_SPE, 0.7_r8*spe_nox, ncol, lchnk ) ! N(2D) produciton (molec/cm3/s)' 
       call outfld( 'N4S_SPE',0.55_r8*spe_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'N4S_SPE', ' FILE: mo_setext.F90',  ' LINE: call outfld( N4S_SPE,0.55_r8*spe_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)' 
       call outfld( 'N2D_GCR', 0.7_r8*gcr_nox, ncol, lchnk ) ! N(2D) produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'N2D_GCR', ' FILE: mo_setext.F90',  ' LINE: call outfld( N2D_GCR, 0.7_r8*gcr_nox, ncol, lchnk ) ! N(2D) produciton (molec/cm3/s)' 
       call outfld( 'N4S_GCR',0.55_r8*gcr_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'N4S_GCR', ' FILE: mo_setext.F90',  ' LINE: call outfld( N4S_GCR,0.55_r8*gcr_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)' 
    elseif ( no_ndx > 0 .and. n_ndx>0 ) then
...
WRITE(*,'(4A)') 'NAME: ', 'NO_SPE', ' FILE: mo_setext.F90',  ' LINE: call outfld( NO_SPE,  0.7_r8*spe_nox, ncol, lchnk ) ! NO produciton (molec/cm3/s)' 
       call outfld( 'N4S_SPE',0.55_r8*spe_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'N4S_SPE', ' FILE: mo_setext.F90',  ' LINE: call outfld( N4S_SPE,0.55_r8*spe_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)' 
       call outfld( 'NO_GCR',  0.7_r8*gcr_nox, ncol, lchnk ) ! NO produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'NO_GCR', ' FILE: mo_setext.F90',  ' LINE: call outfld( NO_GCR,  0.7_r8*gcr_nox, ncol, lchnk ) ! NO produciton (molec/cm3/s)' 
       call outfld( 'N4S_GCR',0.55_r8*gcr_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'N4S_GCR', ' FILE: mo_setext.F90',  ' LINE: call outfld( N4S_GCR,0.55_r8*gcr_nox, ncol, lchnk ) ! N(4S) produciton (molec/cm3/s)' 
    endif
    if ( oh_ndx > 0 ) then
...
WRITE(*,'(4A)') 'NAME: ', 'OH_SPE', ' FILE: mo_setext.F90',  ' LINE: call outfld( OH_SPE ,        spe_hox, ncol, lchnk ) ! HOX produciton (molec/cm3/s)' 
       call outfld( 'OH_GCR' ,        gcr_hox, ncol, lchnk ) ! HOX produciton (molec/cm3/s)
WRITE(*,'(4A)') 'NAME: ', 'OH_GCR', ' FILE: mo_setext.F90',  ' LINE: call outfld( OH_GCR ,        gcr_hox, ncol, lchnk ) ! HOX produciton (molec/cm3/s)' 
    endif
