...
WRITE(*,'(4A)') 'NAME: ', 'ALONM', ' FILE: mo_aurora.F90',  ' LINE: call outfld( ALONM, r2d*alonm(:ncol,lchnk), pcols, lchnk )' 
      call outfld( 'ALATM', r2d*alatm(:ncol,lchnk), pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ALATM', ' FILE: mo_aurora.F90',  ' LINE: call outfld( ALATM, r2d*alatm(:ncol,lchnk), pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'QSUM', ' FILE: mo_aurora.F90',  ' LINE: call outfld( QSUM, wrk, ncol, lchnk )' 
