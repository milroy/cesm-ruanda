...
WRITE(*,'(4A)') 'NAME: ', 'qtflx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qtflx_Cu        , qtflx_out(:,mkx:0:-1),    mix,    lchnk )' 
     call outfld( 'slflx_Cu'        , slflx_out(:,mkx:0:-1),    mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'slflx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( slflx_Cu        , slflx_out(:,mkx:0:-1),    mix,    lchnk )' 
     call outfld( 'uflx_Cu'         , uflx_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'uflx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( uflx_Cu         , uflx_out,                 mix,    lchnk )' 
     call outfld( 'vflx_Cu'         , vflx_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'vflx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( vflx_Cu         , vflx_out,                 mix,    lchnk )' 

     call outfld( 'qtten_Cu'        , qtten_out,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'qtten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qtten_Cu        , qtten_out,                mix,    lchnk )' 
     call outfld( 'slten_Cu'        , slten_out,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'slten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( slten_Cu        , slten_out,                mix,    lchnk )' 
     call outfld( 'uten_Cu'         , uten_out(:,mkx:1:-1),     mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'uten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( uten_Cu         , uten_out(:,mkx:1:-1),     mix,    lchnk )' 
     call outfld( 'vten_Cu'         , vten_out(:,mkx:1:-1),     mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'vten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( vten_Cu         , vten_out(:,mkx:1:-1),     mix,    lchnk )' 
     call outfld( 'qvten_Cu'        , qvten_out(:,mkx:1:-1),    mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'qvten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qvten_Cu        , qvten_out(:,mkx:1:-1),    mix,    lchnk )' 
     call outfld( 'qlten_Cu'        , qlten_out(:,mkx:1:-1),    mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qlten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qlten_Cu        , qlten_out(:,mkx:1:-1),    mix,    lchnk )' 
     call outfld( 'qiten_Cu'        , qiten_out(:,mkx:1:-1),    mix,    lchnk )   
WRITE(*,'(4A)') 'NAME: ', 'qiten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qiten_Cu        , qiten_out(:,mkx:1:-1),    mix,    lchnk )' 

     call outfld( 'cbmf_Cu'         , cbmf_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'cbmf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cbmf_Cu         , cbmf_out,                 mix,    lchnk )' 
     call outfld( 'ufrcinvbase_Cu'  , ufrcinvbase_out,          mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'ufrcinvbase_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ufrcinvbase_Cu  , ufrcinvbase_out,          mix,    lchnk )' 
     call outfld( 'ufrclcl_Cu'      , ufrclcl_out,              mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'ufrclcl_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ufrclcl_Cu      , ufrclcl_out,              mix,    lchnk )' 
     call outfld( 'winvbase_Cu'     , winvbase_out,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'winvbase_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( winvbase_Cu     , winvbase_out,             mix,    lchnk )' 
     call outfld( 'wlcl_Cu'         , wlcl_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'wlcl_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( wlcl_Cu         , wlcl_out,                 mix,    lchnk )' 
     call outfld( 'plcl_Cu'         , plcl_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'plcl_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( plcl_Cu         , plcl_out,                 mix,    lchnk )' 
     call outfld( 'pinv_Cu'         , pinv_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'pinv_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( pinv_Cu         , pinv_out,                 mix,    lchnk )' 
     call outfld( 'plfc_Cu'         , plfc_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'plfc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( plfc_Cu         , plfc_out,                 mix,    lchnk )' 
     call outfld( 'pbup_Cu'         , pbup_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'pbup_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( pbup_Cu         , pbup_out,                 mix,    lchnk )' 
     call outfld( 'ppen_Cu'         , ppen_out,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'ppen_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ppen_Cu         , ppen_out,                 mix,    lchnk )' 
     call outfld( 'qtsrc_Cu'        , qtsrc_out,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'qtsrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qtsrc_Cu        , qtsrc_out,                mix,    lchnk )' 
     call outfld( 'thlsrc_Cu'       , thlsrc_out,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'thlsrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( thlsrc_Cu       , thlsrc_out,               mix,    lchnk )' 
     call outfld( 'thvlsrc_Cu'      , thvlsrc_out,              mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'thvlsrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( thvlsrc_Cu      , thvlsrc_out,              mix,    lchnk )' 
     call outfld( 'emfkbup_Cu'      , emfkbup_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'emfkbup_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( emfkbup_Cu      , emfkbup_out,              mix,    lchnk )' 
     call outfld( 'cin_Cu'          , cinh_out,                 mix,    lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'cin_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cin_Cu          , cinh_out,                 mix,    lchnk )' 
     call outfld( 'cinlcl_Cu'       , cinlclh_out,              mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'cinlcl_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cinlcl_Cu       , cinlclh_out,              mix,    lchnk )' 
     call outfld( 'cbmflimit_Cu'    , cbmflimit_out,            mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'cbmflimit_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cbmflimit_Cu    , cbmflimit_out,            mix,    lchnk )' 
     call outfld( 'tkeavg_Cu'       , tkeavg_out,               mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'tkeavg_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( tkeavg_Cu       , tkeavg_out,               mix,    lchnk )' 
     call outfld( 'zinv_Cu'         , zinv_out,                 mix,    lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'zinv_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( zinv_Cu         , zinv_out,                 mix,    lchnk )' 
     call outfld( 'rcwp_Cu'         , rcwp_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rcwp_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( rcwp_Cu         , rcwp_out,                 mix,    lchnk )' 
     call outfld( 'rlwp_Cu'         , rlwp_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rlwp_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( rlwp_Cu         , rlwp_out,                 mix,    lchnk )' 
     call outfld( 'riwp_Cu'         , riwp_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'riwp_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( riwp_Cu         , riwp_out,                 mix,    lchnk )' 
     call outfld( 'tophgt_Cu'       , cush_inout,               mix,    lchnk )   
WRITE(*,'(4A)') 'NAME: ', 'tophgt_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( tophgt_Cu       , cush_inout,               mix,    lchnk )' 

     call outfld( 'wu_Cu'           , wu_out,                   mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'wu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( wu_Cu           , wu_out,                   mix,    lchnk )' 
     call outfld( 'ufrc_Cu'         , ufrc_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ufrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ufrc_Cu         , ufrc_out,                 mix,    lchnk )' 
     call outfld( 'qtu_Cu'          , qtu_out,                  mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qtu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qtu_Cu          , qtu_out,                  mix,    lchnk )' 
     call outfld( 'thlu_Cu'         , thlu_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'thlu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( thlu_Cu         , thlu_out,                 mix,    lchnk )' 
     call outfld( 'thvu_Cu'         , thvu_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'thvu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( thvu_Cu         , thvu_out,                 mix,    lchnk )' 
     call outfld( 'uu_Cu'           , uu_out,                   mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( uu_Cu           , uu_out,                   mix,    lchnk )' 
     call outfld( 'vu_Cu'           , vu_out,                   mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'vu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( vu_Cu           , vu_out,                   mix,    lchnk )' 
     call outfld( 'qtu_emf_Cu'      , qtu_emf_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qtu_emf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qtu_emf_Cu      , qtu_emf_out,              mix,    lchnk )' 
     call outfld( 'thlu_emf_Cu'     , thlu_emf_out,             mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'thlu_emf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( thlu_emf_Cu     , thlu_emf_out,             mix,    lchnk )' 
     call outfld( 'uu_emf_Cu'       , uu_emf_out,               mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uu_emf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( uu_emf_Cu       , uu_emf_out,               mix,    lchnk )' 
     call outfld( 'vu_emf_Cu'       , vu_emf_out,               mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'vu_emf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( vu_emf_Cu       , vu_emf_out,               mix,    lchnk )' 
     call outfld( 'umf_Cu'          , umf_out(:,mkx:0:-1),      mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'umf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( umf_Cu          , umf_out(:,mkx:0:-1),      mix,    lchnk )' 
     call outfld( 'uemf_Cu'         , uemf_out,                 mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'uemf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( uemf_Cu         , uemf_out,                 mix,    lchnk )' 
     call outfld( 'qcu_Cu'          , qcu_out(:,mkx:1:-1),      mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qcu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qcu_Cu          , qcu_out(:,mkx:1:-1),      mix,    lchnk )' 
     call outfld( 'qlu_Cu'          , qlu_out(:,mkx:1:-1),      mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qlu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qlu_Cu          , qlu_out(:,mkx:1:-1),      mix,    lchnk )' 
     call outfld( 'qiu_Cu'          , qiu_out(:,mkx:1:-1),      mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qiu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qiu_Cu          , qiu_out(:,mkx:1:-1),      mix,    lchnk )' 
     call outfld( 'cufrc_Cu'        , cufrc_out(:,mkx:1:-1),    mix,    lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'cufrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cufrc_Cu        , cufrc_out(:,mkx:1:-1),    mix,    lchnk )' 
     call outfld( 'fer_Cu'          , fer_out,                  mix,    lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'fer_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( fer_Cu          , fer_out,                  mix,    lchnk )' 
     call outfld( 'fdr_Cu'          , fdr_out,                  mix,    lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'fdr_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( fdr_Cu          , fdr_out,                  mix,    lchnk )' 

     call outfld( 'dwten_Cu'        , dwten_out,                mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'dwten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( dwten_Cu        , dwten_out,                mix,    lchnk )' 
     call outfld( 'diten_Cu'        , diten_out,                mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'diten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( diten_Cu        , diten_out,                mix,    lchnk )' 
     call outfld( 'qrten_Cu'        , qrten_out(:,mkx:1:-1),    mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qrten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qrten_Cu        , qrten_out(:,mkx:1:-1),    mix,    lchnk )' 
     call outfld( 'qsten_Cu'        , qsten_out(:,mkx:1:-1),    mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qsten_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( qsten_Cu        , qsten_out(:,mkx:1:-1),    mix,    lchnk )' 
     call outfld( 'flxrain_Cu'      , flxrain_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'flxrain_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( flxrain_Cu      , flxrain_out,              mix,    lchnk )' 
     call outfld( 'flxsnow_Cu'      , flxsnow_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'flxsnow_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( flxsnow_Cu      , flxsnow_out,              mix,    lchnk )' 
     call outfld( 'ntraprd_Cu'      , ntraprd_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ntraprd_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ntraprd_Cu      , ntraprd_out,              mix,    lchnk )' 
     call outfld( 'ntsnprd_Cu'      , ntsnprd_out,              mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ntsnprd_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ntsnprd_Cu      , ntsnprd_out,              mix,    lchnk )' 

     call outfld( 'excessu_Cu'      , excessu_arr_out,          mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'excessu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( excessu_Cu      , excessu_arr_out,          mix,    lchnk )' 
     call outfld( 'excess0_Cu'      , excess0_arr_out,          mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'excess0_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( excess0_Cu      , excess0_arr_out,          mix,    lchnk )' 
     call outfld( 'xc_Cu'           , xc_arr_out,               mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'xc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( xc_Cu           , xc_arr_out,               mix,    lchnk )' 
     call outfld( 'aquad_Cu'        , aquad_arr_out,            mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'aquad_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( aquad_Cu        , aquad_arr_out,            mix,    lchnk )' 
     call outfld( 'bquad_Cu'        , bquad_arr_out,            mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'bquad_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( bquad_Cu        , bquad_arr_out,            mix,    lchnk )' 
     call outfld( 'cquad_Cu'        , cquad_arr_out,            mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'cquad_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( cquad_Cu        , cquad_arr_out,            mix,    lchnk )' 
     call outfld( 'bogbot_Cu'       , bogbot_arr_out,           mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'bogbot_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( bogbot_Cu       , bogbot_arr_out,           mix,    lchnk )' 
     call outfld( 'bogtop_Cu'       , bogtop_arr_out,           mix,    lchnk )
WRITE(*,'(4A)') 'NAME: ', 'bogtop_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( bogtop_Cu       , bogtop_arr_out,           mix,    lchnk )' 

     call outfld( 'exit_UWCu_Cu'    , exit_UWCu,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_UWCu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_UWCu_Cu    , exit_UWCu,                mix,    lchnk )' 
     call outfld( 'exit_conden_Cu'  , exit_conden,              mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_conden_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_conden_Cu  , exit_conden,              mix,    lchnk )' 
     call outfld( 'exit_klclmkx_Cu' , exit_klclmkx,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_klclmkx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_klclmkx_Cu , exit_klclmkx,             mix,    lchnk )' 
     call outfld( 'exit_klfcmkx_Cu' , exit_klfcmkx,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_klfcmkx_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_klfcmkx_Cu , exit_klfcmkx,             mix,    lchnk )' 
     call outfld( 'exit_ufrc_Cu'    , exit_ufrc,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_ufrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_ufrc_Cu    , exit_ufrc,                mix,    lchnk )' 
     call outfld( 'exit_wtw_Cu'     , exit_wtw,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_wtw_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_wtw_Cu     , exit_wtw,                 mix,    lchnk )' 
     call outfld( 'exit_drycore_Cu' , exit_drycore,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_drycore_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_drycore_Cu , exit_drycore,             mix,    lchnk )' 
     call outfld( 'exit_wu_Cu'      , exit_wu,                  mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_wu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_wu_Cu      , exit_wu,                  mix,    lchnk )' 
     call outfld( 'exit_cufilter_Cu', exit_cufilter,            mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_cufilter_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_cufilter_Cu, exit_cufilter,            mix,    lchnk )' 
     call outfld( 'exit_kinv1_Cu'   , exit_kinv1,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_kinv1_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_kinv1_Cu   , exit_kinv1,               mix,    lchnk )' 
     call outfld( 'exit_rei_Cu'     , exit_rei,                 mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'exit_rei_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( exit_rei_Cu     , exit_rei,                 mix,    lchnk )' 

     call outfld( 'limit_shcu_Cu'   , limit_shcu,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_shcu_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_shcu_Cu   , limit_shcu,               mix,    lchnk )' 
     call outfld( 'limit_negcon_Cu' , limit_negcon,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_negcon_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_negcon_Cu , limit_negcon,             mix,    lchnk )' 
     call outfld( 'limit_ufrc_Cu'   , limit_ufrc,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_ufrc_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_ufrc_Cu   , limit_ufrc,               mix,    lchnk )' 
     call outfld( 'limit_ppen_Cu'   , limit_ppen,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_ppen_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_ppen_Cu   , limit_ppen,               mix,    lchnk )' 
     call outfld( 'limit_emf_Cu'    , limit_emf,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_emf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_emf_Cu    , limit_emf,                mix,    lchnk )' 
     call outfld( 'limit_cinlcl_Cu' , limit_cinlcl,             mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_cinlcl_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_cinlcl_Cu , limit_cinlcl,             mix,    lchnk )' 
     call outfld( 'limit_cin_Cu'    , limit_cin,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_cin_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_cin_Cu    , limit_cin,                mix,    lchnk )' 
     call outfld( 'limit_cbmf_Cu'   , limit_cbmf,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_cbmf_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_cbmf_Cu   , limit_cbmf,               mix,    lchnk )' 
     call outfld( 'limit_rei_Cu'    , limit_rei,                mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'limit_rei_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( limit_rei_Cu    , limit_rei,                mix,    lchnk )' 
     call outfld( 'ind_delcin_Cu'   , ind_delcin,               mix,    lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'ind_delcin_Cu', ' FILE: uwshcu.F90',  ' LINE: call outfld( ind_delcin_Cu   , ind_delcin,               mix,    lchnk )' 
