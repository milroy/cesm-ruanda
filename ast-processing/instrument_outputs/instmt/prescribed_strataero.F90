...
WRITE(*,'(4A)') 'NAME: ', dens_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( dens_name,         mass(:,:),     pcols, state(c)%lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', mmr_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( mmr_name,         mass(:,:),     pcols, state(c)%lchnk)' 
       call outfld( mass_name,        volcmass(:,:), pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', mass_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( mass_name,        volcmass(:,:), pcols, state(c)%lchnk)' 
       call outfld( mass_column_name, columnmass(:), pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', mass_column_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( mass_column_name, columnmass(:), pcols, state(c)%lchnk)' 
       call outfld( rad_name,         radius(:,:),   pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', rad_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( rad_name,         radius(:,:),   pcols, state(c)%lchnk)' 
       call outfld( sad_name,         area(:,:),     pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', sad_name, ' FILE: prescribed_strataero.F90',  ' LINE: call outfld( sad_name,         area(:,:),     pcols, state(c)%lchnk)' 
