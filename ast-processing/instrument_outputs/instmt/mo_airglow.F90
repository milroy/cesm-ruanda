...
WRITE(*,'(4A)') 'NAME: ', 'AG1', ' FILE: mo_airglow.F90',  ' LINE: call outfld( AG1, ag_rate(:,:,1), ncol, lchnk )' 
      call outfld( 'AG2', ag_rate(:,:,2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'AG2', ' FILE: mo_airglow.F90',  ' LINE: call outfld( AG2, ag_rate(:,:,2), ncol, lchnk )' 
      call outfld( 'AGTOT', ag_tot, ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'AGTOT', ' FILE: mo_airglow.F90',  ' LINE: call outfld( AGTOT, ag_tot, ncol, lchnk )' 
