...
WRITE(*,'(4A)') 'NAME: ', 'NSTEP   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (NSTEP   ,timestep, pcols, lchnk)' 

    call outfld('T       ',state%t , pcols   ,lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'T       ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T       ,state%t , pcols   ,lchnk   )' 
    call outfld('PS      ',state%ps, pcols   ,lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'PS      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PS      ,state%ps, pcols   ,lchnk   )' 
    call outfld('U       ',state%u , pcols   ,lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'U       ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U       ,state%u , pcols   ,lchnk   )' 
    call outfld('V       ',state%v , pcols   ,lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'V       ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(V       ,state%v , pcols   ,lchnk   )' 
    do m=1,pcnst
       if ( cnst_cam_outfld(m) ) then
          call outfld(cnst_name(m),state%q(1,1,m),pcols ,lchnk )
WRITE(*,'(4A)') 'NAME: ', cnst_name(m), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(cnst_name(m),state%q(1,1,m),pcols ,lchnk )' 
       end if
    end do
...
WRITE(*,'(4A)') 'NAME: ', trim(cnst_name(c_i(m)))//'_BOT', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(trim(cnst_name(c_i(m)))//_BOT, state%q(1,pver,c_i(m)), pcols, lchnk)' 
       end do
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'PDELDRY ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PDELDRY ,state%pdeldry, pcols, lchnk)' 
       call outfld('PSDRY',   state%psdry,   pcols, lchnk) 
WRITE(*,'(4A)') 'NAME: ', 'PSDRY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PSDRY,   state%psdry,   pcols, lchnk)' 
    end if

    call outfld('PHIS    ',state%phis,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'PHIS    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PHIS    ,state%phis,    pcols,   lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'Z3      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z3      ,z3,pcols,lchnk)' 
!           
...
WRITE(*,'(4A)') 'NAME: ', 'Z1000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z1000    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z700    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z700    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z500    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z500    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z300    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z300    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z200    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z200    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z100    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z100    , p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Z050    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Z050    , p_surf, pcols, lchnk)' 
    end if
!
...
WRITE(*,'(4A)') 'NAME: ', 'ZZ      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ZZ      ,ftem,pcols,lchnk)' 

    ftem(:ncol,:) = z3(:ncol,:)*state%v(:ncol,:)*gravit
    call outfld('VZ      ',ftem,  pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'VZ      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(VZ      ,ftem,  pcols,lchnk)' 
!
! Meridional advection fields
!
    ftem(:ncol,:) = state%v(:ncol,:)*state%t(:ncol,:)
    call outfld ('VT      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'VT      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (VT      ,ftem    ,pcols   ,lchnk     )' 

    ftem(:ncol,:) = state%v(:ncol,:)*state%q(:ncol,:,1)
    call outfld ('VQ      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'VQ      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (VQ      ,ftem    ,pcols   ,lchnk     )' 

    ftem(:ncol,:) = state%q(:ncol,:,1)*state%q(:ncol,:,1)
    call outfld ('QQ      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'QQ      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (QQ      ,ftem    ,pcols   ,lchnk     )' 

    ftem(:ncol,:) = state%v(:ncol,:)**2
    call outfld ('VV      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'VV      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (VV      ,ftem    ,pcols   ,lchnk     )' 

    ftem(:ncol,:) = state%v(:ncol,:) * state%u(:ncol,:)
    call outfld ('VU      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'VU      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (VU      ,ftem    ,pcols   ,lchnk     )' 

! zonal advection

    ftem(:ncol,:) = state%u(:ncol,:)**2
    call outfld ('UU      ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'UU      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (UU      ,ftem    ,pcols   ,lchnk     )' 

! Wind speed
    ftem(:ncol,:) = sqrt( state%u(:ncol,:)**2 + state%v(:ncol,:)**2)
    call outfld ('WSPEED  ',ftem    ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'WSPEED  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (WSPEED  ,ftem    ,pcols   ,lchnk     )' 
    call outfld ('WSPDSRFMX',ftem(:,pver)   ,pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'WSPDSRFMX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (WSPDSRFMX,ftem(:,pver)   ,pcols   ,lchnk     )' 
    call outfld ('WSPDSRFAV',ftem(:,pver)   ,pcols   ,lchnk     ) 
WRITE(*,'(4A)') 'NAME: ', 'WSPDSRFAV', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (WSPDSRFAV,ftem(:,pver)   ,pcols   ,lchnk     )' 

! Vertical velocity and advection

    if (single_column) then
       call outfld('OMEGA   ',wfld,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMEGA   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGA   ,wfld,    pcols,   lchnk     )' 
    else
       call outfld('OMEGA   ',state%omega,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMEGA   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGA   ,state%omega,    pcols,   lchnk     )' 
    endif
...
WRITE(*,'(4A)') 'NAME: ', 'OMEGAT  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGAT  ,ftem,    pcols,   lchnk     )' 
    ftem(:ncol,:) = state%omega(:ncol,:)*state%u(:ncol,:)
    call outfld('OMEGAU  ',ftem,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMEGAU  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGAU  ,ftem,    pcols,   lchnk     )' 
    ftem(:ncol,:) = state%omega(:ncol,:)*state%v(:ncol,:)
    call outfld('OMEGAV  ',ftem,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMEGAV  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGAV  ,ftem,    pcols,   lchnk     )' 
    ftem(:ncol,:) = state%omega(:ncol,:)*state%q(:ncol,:,1)
    call outfld('OMEGAQ  ',ftem,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMEGAQ  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGAQ  ,ftem,    pcols,   lchnk     )' 
    ftem(:ncol,:) = state%omega(:ncol,:)*state%omega(:ncol,:)
    call outfld('OMGAOMGA',ftem,    pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'OMGAOMGA', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMGAOMGA,ftem,    pcols,   lchnk     )' 
!
...
WRITE(*,'(4A)') 'NAME: ', 'OMEGA850', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGA850, p_surf, pcols, lchnk)' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'OMEGA500', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OMEGA500, p_surf, pcols, lchnk)' 
    end if
!     
...
WRITE(*,'(4A)') 'NAME: ', 'MQ      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (MQ      ,ftem    ,pcols   ,lchnk     )' 

    do k=2,pver
       ftem(:ncol,1) = ftem(:ncol,1) + ftem(:ncol,k)
    end do
    call outfld ('TMQ     ',ftem, pcols   ,lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'TMQ     ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (TMQ     ,ftem, pcols   ,lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'RELHUM  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (RELHUM  ,ftem    ,pcols   ,lchnk     )' 
       end if
...
WRITE(*,'(4A)') 'NAME: ', 'RHW  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (RHW  ,ftem    ,pcols   ,lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'RHI  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (RHI  ,ftem1    ,pcols   ,lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'RHCFMIP  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (RHCFMIP  ,ftem2    ,pcols   ,lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'PSL     ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (PSL     ,psl_tmp  ,pcols, lchnk     )' 
       if (present(psl)) then	
...
WRITE(*,'(4A)') 'NAME: ', 'T850    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T850    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T500    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T500    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T300    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T300    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T200    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T200    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Q850    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Q850    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'Q200    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Q200    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'U850    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U850    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'U250    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U250    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'U200    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U200    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'U010    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U010    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'V850    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(V850    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'V250    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(V250    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'V200    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(V200    , p_surf, pcols, lchnk )' 
    end if

    ftem(:ncol,:) = state%t(:ncol,:)*state%t(:ncol,:)
    call outfld('TT      ',ftem    ,pcols   ,lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'TT      ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TT      ,ftem    ,pcols   ,lchnk   )' 
!
! Output U, V, T, Q, P and Z at bottom level
!
    call outfld ('UBOT    ', state%u(1,pver)  ,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'UBOT    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (UBOT    , state%u(1,pver)  ,  pcols, lchnk)' 
    call outfld ('VBOT    ', state%v(1,pver)  ,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'VBOT    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (VBOT    , state%v(1,pver)  ,  pcols, lchnk)' 
    call outfld ('QBOT    ', state%q(1,pver,1),  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QBOT    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (QBOT    , state%q(1,pver,1),  pcols, lchnk)' 
    call outfld ('ZBOT    ', state%zm(1,pver) , pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ZBOT    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (ZBOT    , state%zm(1,pver) , pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'ATMEINT   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (ATMEINT   ,ftem(:ncol,1)  ,pcols   ,lchnk     )' 
...
WRITE(*,'(4A)') 'NAME: ', 'T1000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T1000    , p_surf_t1, pcols, lchnk )' 
    end if

    if (hist_fld_active('T925')) then
       call outfld('T925    ', p_surf_t2, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'T925    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T925    , p_surf_t2, pcols, lchnk )' 
    end if

    if (hist_fld_active('Q1000')) then
       call outfld('Q1000    ', p_surf_q1, pcols, lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'Q1000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Q1000    , p_surf_q1, pcols, lchnk )' 
    end if

    if (hist_fld_active('Q925')) then
       call outfld('Q925    ', p_surf_q2, pcols, lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'Q925    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Q925    , p_surf_q2, pcols, lchnk )' 
    end if

    if (hist_fld_active('T9251000')) then
       p_surf = p_surf_t2-p_surf_t1  
       call outfld('T9251000    ', p_surf, pcols, lchnk ) 
WRITE(*,'(4A)') 'NAME: ', 'T9251000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T9251000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'TH9251000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TH9251000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'THE9251000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(THE9251000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T8501000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T8501000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'TH8501000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TH8501000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'THE8501000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(THE8501000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T700    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T700    , p_surf_t2, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T7001000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T7001000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'TH7001000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TH7001000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'THE7001000    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(THE7001000    , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'T010           ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(T010           , p_surf, pcols, lchnk )' 
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'PRECC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECC   , precc, pcols, lchnk )' 
   call outfld('PRECL   ', precl, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECL   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECL   , precl, pcols, lchnk )' 
   call outfld('PREC_PCW', prec_pcw,pcols   ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PREC_PCW', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PREC_PCW, prec_pcw,pcols   ,lchnk )' 
   call outfld('PREC_zmc', prec_dp ,pcols   ,lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PREC_zmc', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PREC_zmc, prec_dp ,pcols   ,lchnk )' 
   call outfld('PRECSC  ', snowc, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECSC  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECSC  , snowc, pcols, lchnk )' 
   call outfld('PRECSL  ', snowl, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECSL  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECSL  , snowl, pcols, lchnk )' 
   call outfld('PRECT   ', prect, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECT   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECT   , prect, pcols, lchnk )' 
   call outfld('PRECTMX ', prect, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECTMX ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECTMX , prect, pcols, lchnk )' 

   call outfld('PRECLav ', precl, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECLav ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECLav , precl, pcols, lchnk )' 
   call outfld('PRECCav ', precc, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECCav ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PRECCav , precc, pcols, lchnk )' 

#if ( defined BFB_CAM_SCAM_IOP )
   call outfld('Prec   ' , prect, pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Prec   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(Prec    , prect, pcols, lchnk )' 
#endif
...
WRITE(*,'(4A)') 'NAME: ', 'DTCOND  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(DTCOND  , dtcond(:,:,lchnk), pcols, lchnk)' 

   ! output tidal coefficients
   call get_tidal_coeffs( dcoef )
   call outfld( 'DTCOND_24_SIN', dtcond(:ncol,:,lchnk)*dcoef(1), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTCOND_24_SIN', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld( DTCOND_24_SIN, dtcond(:ncol,:,lchnk)*dcoef(1), ncol, lchnk )' 
   call outfld( 'DTCOND_24_COS', dtcond(:ncol,:,lchnk)*dcoef(2), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTCOND_24_COS', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld( DTCOND_24_COS, dtcond(:ncol,:,lchnk)*dcoef(2), ncol, lchnk )' 
   call outfld( 'DTCOND_12_SIN', dtcond(:ncol,:,lchnk)*dcoef(3), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTCOND_12_SIN', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld( DTCOND_12_SIN, dtcond(:ncol,:,lchnk)*dcoef(3), ncol, lchnk )' 
   call outfld( 'DTCOND_12_COS', dtcond(:ncol,:,lchnk)*dcoef(4), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DTCOND_12_COS', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld( DTCOND_12_COS, dtcond(:ncol,:,lchnk)*dcoef(4), ncol, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', dcconnam(m), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(dcconnam(m), dqcond(m)%cnst(:,:,lchnk), pcols, lchnk)' 
      end if
   end do
...
WRITE(*,'(4A)') 'NAME: ', 'SHFLX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(SHFLX,    cam_in%shf,       pcols, lchnk)' 
    call outfld('LHFLX',    cam_in%lhf,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LHFLX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(LHFLX,    cam_in%lhf,       pcols, lchnk)' 
    call outfld('QFLX',     cam_in%cflx(1,1), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QFLX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(QFLX,     cam_in%cflx(1,1), pcols, lchnk)' 

    call outfld('TAUX',     cam_in%wsx,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TAUX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TAUX,     cam_in%wsx,       pcols, lchnk)' 
    call outfld('TAUY',     cam_in%wsy,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TAUY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TAUY,     cam_in%wsy,       pcols, lchnk)' 
    call outfld('TREFHT  ', cam_in%tref,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TREFHT  ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TREFHT  , cam_in%tref,      pcols, lchnk)' 
    call outfld('TREFHTMX', cam_in%tref,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TREFHTMX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TREFHTMX, cam_in%tref,      pcols, lchnk)' 
    call outfld('TREFHTMN', cam_in%tref,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TREFHTMN', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TREFHTMN, cam_in%tref,      pcols, lchnk)' 
    call outfld('QREFHT',   cam_in%qref,      pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QREFHT', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(QREFHT,   cam_in%qref,      pcols, lchnk)' 
    call outfld('U10',      cam_in%u10,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'U10', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(U10,      cam_in%u10,       pcols, lchnk)' 
! 
...
WRITE(*,'(4A)') 'NAME: ', 'RHREFHT', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(RHREFHT,   ftem,      pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'LANDFRAC', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(LANDFRAC, cam_in%landfrac, pcols, lchnk)' 
    call outfld('ICEFRAC',  cam_in%icefrac,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICEFRAC', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ICEFRAC,  cam_in%icefrac,  pcols, lchnk)' 
    call outfld('OCNFRAC',  cam_in%ocnfrac,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'OCNFRAC', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(OCNFRAC,  cam_in%ocnfrac,  pcols, lchnk)' 
!
...
WRITE(*,'(4A)') 'NAME: ', 'TREFMXAV', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TREFMXAV, trefmxav,pcols,   lchnk     )' 
       call outfld('TREFMNAV', trefmnav,pcols,   lchnk     )
WRITE(*,'(4A)') 'NAME: ', 'TREFMNAV', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TREFMNAV, trefmnav,pcols,   lchnk     )' 
       trefmxav(:ncol) = -1.0e36_r8
       trefmnav(:ncol) =  1.0e36_r8
    endif

    call outfld('TBOT',     cam_out%tbot,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TBOT', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TBOT,     cam_out%tbot,     pcols, lchnk)' 
    call outfld('TS',       cam_in%ts,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TS', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TS,       cam_in%ts,        pcols, lchnk)' 
    call outfld('TSMN',     cam_in%ts,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TSMN', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TSMN,     cam_in%ts,        pcols, lchnk)' 
    call outfld('TSMX',     cam_in%ts,        pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TSMX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TSMX,     cam_in%ts,        pcols, lchnk)' 
    call outfld('SNOWHLND', cam_in%snowhland, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SNOWHLND', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(SNOWHLND, cam_in%snowhland, pcols, lchnk)' 
    call outfld('SNOWHICE', cam_in%snowhice,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SNOWHICE', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(SNOWHICE, cam_in%snowhice,  pcols, lchnk)' 
    call outfld('ASDIR',    cam_in%asdir,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ASDIR', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ASDIR,    cam_in%asdir,     pcols, lchnk)' 
    call outfld('ASDIF',    cam_in%asdif,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ASDIF', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ASDIF,    cam_in%asdif,     pcols, lchnk)' 
    call outfld('ALDIR',    cam_in%aldir,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ALDIR', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ALDIR,    cam_in%aldir,     pcols, lchnk)' 
    call outfld('ALDIF',    cam_in%aldif,     pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ALDIF', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(ALDIF,    cam_in%aldif,     pcols, lchnk)' 
    call outfld('SST',      cam_in%sst,       pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'SST', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(SST,      cam_in%sst,       pcols, lchnk)' 

    if (co2_transport()) then
       do m = 1,4
          call outfld(sflxnam(c_i(m)), cam_in%cflx(:,c_i(m)), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', sflxnam(c_i(m)), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(sflxnam(c_i(m)), cam_in%cflx(:,c_i(m)), pcols, lchnk)' 
       end do
    end if
...
WRITE(*,'(4A)') 'NAME: ', 'a2x_BCPHIWET', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_BCPHIWET, cam_out%bcphiwet, pcols, lchnk)' 
   call outfld('a2x_BCPHIDRY', cam_out%bcphidry, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_BCPHIDRY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_BCPHIDRY, cam_out%bcphidry, pcols, lchnk)' 
   call outfld('a2x_BCPHODRY', cam_out%bcphodry, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_BCPHODRY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_BCPHODRY, cam_out%bcphodry, pcols, lchnk)' 
   call outfld('a2x_OCPHIWET', cam_out%ocphiwet, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_OCPHIWET', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_OCPHIWET, cam_out%ocphiwet, pcols, lchnk)' 
   call outfld('a2x_OCPHIDRY', cam_out%ocphidry, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_OCPHIDRY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_OCPHIDRY, cam_out%ocphidry, pcols, lchnk)' 
   call outfld('a2x_OCPHODRY', cam_out%ocphodry, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_OCPHODRY', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_OCPHODRY, cam_out%ocphodry, pcols, lchnk)' 
   call outfld('a2x_DSTWET1',  cam_out%dstwet1,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTWET1', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTWET1,  cam_out%dstwet1,  pcols, lchnk)' 
   call outfld('a2x_DSTDRY1',  cam_out%dstdry1,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTDRY1', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTDRY1,  cam_out%dstdry1,  pcols, lchnk)' 
   call outfld('a2x_DSTWET2',  cam_out%dstwet2,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTWET2', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTWET2,  cam_out%dstwet2,  pcols, lchnk)' 
   call outfld('a2x_DSTDRY2',  cam_out%dstdry2,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTDRY2', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTDRY2,  cam_out%dstdry2,  pcols, lchnk)' 
   call outfld('a2x_DSTWET3',  cam_out%dstwet3,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTWET3', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTWET3,  cam_out%dstwet3,  pcols, lchnk)' 
   call outfld('a2x_DSTDRY3',  cam_out%dstdry3,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTDRY3', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTDRY3,  cam_out%dstdry3,  pcols, lchnk)' 
   call outfld('a2x_DSTWET4',  cam_out%dstwet4,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTWET4', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTWET4,  cam_out%dstwet4,  pcols, lchnk)' 
   call outfld('a2x_DSTDRY4',  cam_out%dstdry4,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'a2x_DSTDRY4', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(a2x_DSTDRY4,  cam_out%dstdry4,  pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'QCWAT&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(QCWAT&IC   ,cwat_var, pcols,lchnk)' 
      end if
...
WRITE(*,'(4A)') 'NAME: ', 'TCWAT&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TCWAT&IC   ,cwat_var, pcols,lchnk)' 
      end if
...
WRITE(*,'(4A)') 'NAME: ', 'LCWAT&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(LCWAT&IC   ,cwat_var, pcols,lchnk)' 
      end if

      call pbuf_get_field(pbuf, cld_idx,    cwat_var, start=(/1,1,itim_old/), kount=(/pcols,pver,1/) )
      call outfld('CLOUD&IC   ',cwat_var, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLOUD&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(CLOUD&IC   ,cwat_var, pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'CONCLD&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(CONCLD&IC   ,cwat_var, pcols,lchnk)' 

      call pbuf_get_field(pbuf, tke_idx, conv_var_3d)
      call outfld('TKE&IC    ',conv_var_3d, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TKE&IC    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TKE&IC    ,conv_var_3d, pcols,lchnk)' 

      call pbuf_get_field(pbuf, kvm_idx,  conv_var_3d)
      call outfld('KVM&IC    ',conv_var_3d, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'KVM&IC    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(KVM&IC    ,conv_var_3d, pcols,lchnk)' 

      call pbuf_get_field(pbuf, kvh_idx,  conv_var_3d)
      call outfld('KVH&IC    ',conv_var_3d, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'KVH&IC    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(KVH&IC    ,conv_var_3d, pcols,lchnk)' 
 
      call pbuf_get_field(pbuf, cush_idx, conv_var_2d ,(/1,itim_old/),  (/pcols,1/))
      call outfld('CUSH&IC   ',conv_var_2d, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CUSH&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(CUSH&IC   ,conv_var_2d, pcols,lchnk)' 

      if (qpert_idx > 0) then 
         call pbuf_get_field(pbuf, qpert_idx, qpert)
         call outfld('QPERT&IC   ', qpert, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'QPERT&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(QPERT&IC   , qpert, pcols, lchnk)' 
      end if

      call pbuf_get_field(pbuf, pblh_idx,  pblh)
      call outfld('PBLH&IC    ', pblh,  pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'PBLH&IC    ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PBLH&IC    , pblh,  pcols, lchnk)' 

      call pbuf_get_field(pbuf, tpert_idx, tpert)
      call outfld('TPERT&IC   ', tpert, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TPERT&IC   ', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TPERT&IC   , tpert, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'PTTEND_RESID', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PTTEND_RESID, tmp_t, pcols, lchnk   )' 
   end if
   call outfld('TAP', state%t, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'TAP', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TAP, state%t, pcols, lchnk   )' 
   call outfld('UAP', state%u, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'UAP', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(UAP, state%u, pcols, lchnk   )' 
   call outfld('VAP', state%v, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'VAP', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(VAP, state%v, pcols, lchnk   )' 

   if ( cnst_cam_outfld(       1) ) call outfld (apcnst(       1), state%q(1,1,       1), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', apcnst(       1), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(       1) ) call outfld (apcnst(       1), state%q(1,1,       1), pcols, lchnk)' 
   if ( cnst_cam_outfld(ixcldliq) ) call outfld (apcnst(ixcldliq), state%q(1,1,ixcldliq), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', apcnst(ixcldliq), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldliq) ) call outfld (apcnst(ixcldliq), state%q(1,1,ixcldliq), pcols, lchnk)' 
   if ( cnst_cam_outfld(ixcldice) ) call outfld (apcnst(ixcldice), state%q(1,1,ixcldice), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', apcnst(ixcldice), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldice) ) call outfld (apcnst(ixcldice), state%q(1,1,ixcldice), pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TFIX', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TFIX, ftem2, pcols, lchnk   )' 
...
WRITE(*,'(4A)') 'NAME: ', 'PTTEND', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(PTTEND,ftem3, pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', dmetendnam(       1), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(       1) ) call outfld (dmetendnam(       1), tmp_q     , pcols, lchnk)' 
      if ( cnst_cam_outfld(ixcldliq) ) call outfld (dmetendnam(ixcldliq), tmp_cldliq, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', dmetendnam(ixcldliq), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldliq) ) call outfld (dmetendnam(ixcldliq), tmp_cldliq, pcols, lchnk)' 
      if ( cnst_cam_outfld(ixcldice) ) call outfld (dmetendnam(ixcldice), tmp_cldice, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', dmetendnam(ixcldice), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldice) ) call outfld (dmetendnam(ixcldice), tmp_cldice, pcols, lchnk)' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', ptendnam(       1), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (ptendnam(       1), ftem3, pcols, lchnk)' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', ptendnam(ixcldliq), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (ptendnam(ixcldliq), ftem3, pcols, lchnk)' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', ptendnam(ixcldice), ' FILE: cam_diagnostics.F90',  ' LINE: call outfld (ptendnam(ixcldice), ftem3, pcols, lchnk)' 
   end if
...
WRITE(*,'(4A)') 'NAME: ', 'TTEND_TOT', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TTEND_TOT, ftem3, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'TBP', ' FILE: cam_diagnostics.F90',  ' LINE: call outfld(TBP, state%t, pcols, lchnk   )' 
   if ( cnst_cam_outfld(       1) ) call outfld (bpcnst(       1), state%q(1,1,       1), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', bpcnst(       1), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(       1) ) call outfld (bpcnst(       1), state%q(1,1,       1), pcols, lchnk)' 
   if ( cnst_cam_outfld(ixcldliq) ) call outfld (bpcnst(ixcldliq), state%q(1,1,ixcldliq), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', bpcnst(ixcldliq), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldliq) ) call outfld (bpcnst(ixcldliq), state%q(1,1,ixcldliq), pcols, lchnk)' 
   if ( cnst_cam_outfld(ixcldice) ) call outfld (bpcnst(ixcldice), state%q(1,1,ixcldice), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', bpcnst(ixcldice), ' FILE: cam_diagnostics.F90',  ' LINE: if ( cnst_cam_outfld(ixcldice) ) call outfld (bpcnst(ixcldice), state%q(1,1,ixcldice), pcols, lchnk)' 
