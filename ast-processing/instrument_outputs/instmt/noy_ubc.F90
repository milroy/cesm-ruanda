...
WRITE(*,'(4A)') 'NAME: ', ubc_name(m), ' FILE: noy_ubc.F90',  ' LINE: call outfld( ubc_name(m), vmr(:ncol,1,n), ncol, lchnk )' 
       enddo
    endif
!
...
WRITE(*,'(4A)') 'NAME: ', ubc_name(m1), ' FILE: noy_ubc.F90',  ' LINE: call outfld( ubc_name(m1), vmr(:ncol,1,map(m1)), ncol, lchnk )' 
       call outfld( ubc_name(m2), vmr(:ncol,1,map(m2)), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', ubc_name(m2), ' FILE: noy_ubc.F90',  ' LINE: call outfld( ubc_name(m2), vmr(:ncol,1,map(m2)), ncol, lchnk )' 
    end if
!
