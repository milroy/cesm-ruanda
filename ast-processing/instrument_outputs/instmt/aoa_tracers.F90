...
WRITE(*,'(4A)') 'NAME: ', src_names(1), ' FILE: aoa_tracers.F90',  ' LINE: call outfld (src_names(1), ptend%q(:,:,ixaoa1), pcols, lchnk)' 
    call outfld (src_names(2), ptend%q(:,:,ixaoa2), pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', src_names(2), ' FILE: aoa_tracers.F90',  ' LINE: call outfld (src_names(2), ptend%q(:,:,ixaoa2), pcols, lchnk)' 
    call outfld (src_names(3), ptend%q(:,:,ixht),   pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', src_names(3), ' FILE: aoa_tracers.F90',  ' LINE: call outfld (src_names(3), ptend%q(:,:,ixht),   pcols, lchnk)' 
    call outfld (src_names(4), ptend%q(:,:,ixvt),   pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', src_names(4), ' FILE: aoa_tracers.F90',  ' LINE: call outfld (src_names(4), ptend%q(:,:,ixvt),   pcols, lchnk)' 
