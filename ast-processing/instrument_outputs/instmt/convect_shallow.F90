...
WRITE(*,'(4A)') 'NAME: ', 'PRECSH', ' FILE: convect_shallow.F90',  ' LINE: call outfld( PRECSH , precc  , pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'ICWMRSH ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( ICWMRSH , icwmr                    , pcols   , lchnk )' 

   call outfld( 'CMFDT  ', ftem                      , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFDT  ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFDT  , ftem                      , pcols   , lchnk )' 
   call outfld( 'CMFDQ  ', ptend_loc%q(1,1,1)        , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFDQ  ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFDQ  , ptend_loc%q(1,1,1)        , pcols   , lchnk )' 
   call outfld( 'CMFDICE', ptend_loc%q(1,1,ixcldice) , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFDICE', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFDICE, ptend_loc%q(1,1,ixcldice) , pcols   , lchnk )' 
   call outfld( 'CMFDLIQ', ptend_loc%q(1,1,ixcldliq) , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFDLIQ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFDLIQ, ptend_loc%q(1,1,ixcldliq) , pcols   , lchnk )' 
   call outfld( 'CMFMC'  , cmfmc                     , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFMC', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFMC  , cmfmc                     , pcols   , lchnk )' 
   call outfld( 'QC'     , qc2                       , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'QC', ' FILE: convect_shallow.F90',  ' LINE: call outfld( QC     , qc2                       , pcols   , lchnk )' 
   call outfld( 'CMFDQR' , rprdsh                    , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFDQR', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFDQR , rprdsh                    , pcols   , lchnk )' 
   call outfld( 'CMFSL'  , cmfsl                     , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFSL', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFSL  , cmfsl                     , pcols   , lchnk )' 
   call outfld( 'CMFLQ'  , cmflq                     , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CMFLQ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CMFLQ  , cmflq                     , pcols   , lchnk )' 
   call outfld( 'DQP'    , qc2                       , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'DQP', ' FILE: convect_shallow.F90',  ' LINE: call outfld( DQP    , qc2                       , pcols   , lchnk )' 
   call outfld( 'CLDTOP' , cnt                       , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDTOP', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CLDTOP , cnt                       , pcols   , lchnk )' 
   call outfld( 'CLDBOT' , cnb                       , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CLDBOT', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CLDBOT , cnb                       , pcols   , lchnk )' 
   call outfld( 'PCLDTOP', pcnt                      , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PCLDTOP', ' FILE: convect_shallow.F90',  ' LINE: call outfld( PCLDTOP, pcnt                      , pcols   , lchnk )' 
   call outfld( 'PCLDBOT', pcnb                      , pcols   , lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'PCLDBOT', ' FILE: convect_shallow.F90',  ' LINE: call outfld( PCLDBOT, pcnb                      , pcols   , lchnk )' 
   call outfld( 'FREQSH' , freqsh                    , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FREQSH', ' FILE: convect_shallow.F90',  ' LINE: call outfld( FREQSH , freqsh                    , pcols   , lchnk )' 

   if( shallow_scheme .eq. 'UW' ) then
      call outfld( 'CBMF'   , cbmf                      , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CBMF', ' FILE: convect_shallow.F90',  ' LINE: call outfld( CBMF   , cbmf                      , pcols   , lchnk )' 
      call outfld( 'UWFLXPRC', flxprec                  , pcols   , lchnk )  
WRITE(*,'(4A)') 'NAME: ', 'UWFLXPRC', ' FILE: convect_shallow.F90',  ' LINE: call outfld( UWFLXPRC, flxprec                  , pcols   , lchnk )' 
      call outfld( 'UWFLXSNW' , flxsnow                 , pcols   , lchnk )
WRITE(*,'(4A)') 'NAME: ', 'UWFLXSNW', ' FILE: convect_shallow.F90',  ' LINE: call outfld( UWFLXSNW , flxsnow                 , pcols   , lchnk )' 
   endif
...
WRITE(*,'(4A)') 'NAME: ', 'qt_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qt_pre_Cu      , qt_preCu               , pcols, lchnk )' 
   call outfld( 'sl_pre_Cu      ', sl_preCu               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'sl_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( sl_pre_Cu      , sl_preCu               , pcols, lchnk )' 
   call outfld( 'slv_pre_Cu     ', slv_preCu              , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slv_pre_Cu     ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( slv_pre_Cu     , slv_preCu              , pcols, lchnk )' 
   call outfld( 'u_pre_Cu       ', state1%u               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'u_pre_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( u_pre_Cu       , state1%u               , pcols, lchnk )' 
   call outfld( 'v_pre_Cu       ', state1%v               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'v_pre_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( v_pre_Cu       , state1%v               , pcols, lchnk )' 
   call outfld( 'qv_pre_Cu      ', state1%q(:,:,1)        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qv_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qv_pre_Cu      , state1%q(:,:,1)        , pcols, lchnk )' 
   call outfld( 'ql_pre_Cu      ', state1%q(:,:,ixcldliq) , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ql_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( ql_pre_Cu      , state1%q(:,:,ixcldliq) , pcols, lchnk )' 
   call outfld( 'qi_pre_Cu      ', state1%q(:,:,ixcldice) , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qi_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qi_pre_Cu      , state1%q(:,:,ixcldice) , pcols, lchnk )' 
   call outfld( 't_pre_Cu       ', state1%t               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 't_pre_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( t_pre_Cu       , state1%t               , pcols, lchnk )' 
   call outfld( 'rh_pre_Cu      ', ftem_preCu             , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rh_pre_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( rh_pre_Cu      , ftem_preCu             , pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'qt_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qt_aft_Cu      , qt                     , pcols, lchnk )' 
   call outfld( 'sl_aft_Cu      ', sl                     , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'sl_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( sl_aft_Cu      , sl                     , pcols, lchnk )' 
   call outfld( 'slv_aft_Cu     ', slv                    , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'slv_aft_Cu     ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( slv_aft_Cu     , slv                    , pcols, lchnk )' 
   call outfld( 'u_aft_Cu       ', state1%u               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'u_aft_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( u_aft_Cu       , state1%u               , pcols, lchnk )' 
   call outfld( 'v_aft_Cu       ', state1%v               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'v_aft_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( v_aft_Cu       , state1%v               , pcols, lchnk )' 
   call outfld( 'qv_aft_Cu      ', state1%q(:,:,1)        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qv_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qv_aft_Cu      , state1%q(:,:,1)        , pcols, lchnk )' 
   call outfld( 'ql_aft_Cu      ', state1%q(:,:,ixcldliq) , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ql_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( ql_aft_Cu      , state1%q(:,:,ixcldliq) , pcols, lchnk )' 
   call outfld( 'qi_aft_Cu      ', state1%q(:,:,ixcldice) , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'qi_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( qi_aft_Cu      , state1%q(:,:,ixcldice) , pcols, lchnk )' 
   call outfld( 't_aft_Cu       ', state1%t               , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 't_aft_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( t_aft_Cu       , state1%t               , pcols, lchnk )' 
   call outfld( 'rh_aft_Cu      ', ftem                   , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rh_aft_Cu      ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( rh_aft_Cu      , ftem                   , pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'tten_Cu        ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( tten_Cu        , tten                           , pcols, lchnk )' 
   call outfld( 'rhten_Cu       ', rhten                          , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'rhten_Cu       ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( rhten_Cu       , rhten                          , pcols, lchnk )' 
...
WRITE(*,'(4A)') 'NAME: ', 'EVAPTCM ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( EVAPTCM        , ftem                           , pcols, lchnk )' 
   ftem(:ncol,:pver) = tend_s_snwprd(:ncol,:pver) / cpair
   call outfld( 'FZSNTCM '       , ftem                           , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'FZSNTCM ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( FZSNTCM        , ftem                           , pcols, lchnk )' 
   ftem(:ncol,:pver) = tend_s_snwevmlt(:ncol,:pver) / cpair
   call outfld( 'EVSNTCM '       , ftem                           , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'EVSNTCM ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( EVSNTCM        , ftem                           , pcols, lchnk )' 
   call outfld( 'EVAPQCM '       , ptend_loc%q(1,1,1)             , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'EVAPQCM ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( EVAPQCM        , ptend_loc%q(1,1,1)             , pcols, lchnk )' 
   call outfld( 'PRECSH  '       , precc                          , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'PRECSH  ', ' FILE: convect_shallow.F90',  ' LINE: call outfld( PRECSH         , precc                          , pcols, lchnk )' 
   call outfld( 'HKFLXPRC'       , flxprec                        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HKFLXPRC', ' FILE: convect_shallow.F90',  ' LINE: call outfld( HKFLXPRC       , flxprec                        , pcols, lchnk )' 
   call outfld( 'HKFLXSNW'       , flxsnow                        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HKFLXSNW', ' FILE: convect_shallow.F90',  ' LINE: call outfld( HKFLXSNW       , flxsnow                        , pcols, lchnk )' 
   call outfld( 'HKNTPRPD'       , ntprprd                        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HKNTPRPD', ' FILE: convect_shallow.F90',  ' LINE: call outfld( HKNTPRPD       , ntprprd                        , pcols, lchnk )' 
   call outfld( 'HKNTSNPD'       , ntsnprd                        , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HKNTSNPD', ' FILE: convect_shallow.F90',  ' LINE: call outfld( HKNTSNPD       , ntsnprd                        , pcols, lchnk )' 
   call outfld( 'HKEIHEAT'       , ptend_loc%s                    , pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'HKEIHEAT', ' FILE: convect_shallow.F90',  ' LINE: call outfld( HKEIHEAT       , ptend_loc%s                    , pcols, lchnk )' 
