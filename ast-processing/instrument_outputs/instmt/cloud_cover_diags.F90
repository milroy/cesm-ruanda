...
WRITE(*,'(4A)') 'NAME: ', 'CLDTOT  ', ' FILE: cloud_cover_diags.F90',  ' LINE: call outfld(CLDTOT  ,cltot  ,pcols,lchnk)' 
  call outfld('CLDLOW  ',cllow  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDLOW  ', ' FILE: cloud_cover_diags.F90',  ' LINE: call outfld(CLDLOW  ,cllow  ,pcols,lchnk)' 
  call outfld('CLDMED  ',clmed  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDMED  ', ' FILE: cloud_cover_diags.F90',  ' LINE: call outfld(CLDMED  ,clmed  ,pcols,lchnk)' 
  call outfld('CLDHGH  ',clhgh  ,pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'CLDHGH  ', ' FILE: cloud_cover_diags.F90',  ' LINE: call outfld(CLDHGH  ,clhgh  ,pcols,lchnk)' 

  call outfld('CLOUD   ',cld    ,pcols,lchnk) 
WRITE(*,'(4A)') 'NAME: ', 'CLOUD   ', ' FILE: cloud_cover_diags.F90',  ' LINE: call outfld(CLOUD   ,cld    ,pcols,lchnk)' 
