...
WRITE(*,'(4A)') 'NAME: ', 'NO_Aircraft', ' FILE: mo_airplane.F90',  ' LINE: call outfld( NO_Aircraft,  no_air(:ncol,:), ncol, lchnk )' 
    call outfld( 'CO_Aircraft',  co_air(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'CO_Aircraft', ' FILE: mo_airplane.F90',  ' LINE: call outfld( CO_Aircraft,  co_air(:ncol,:), ncol, lchnk )' 
