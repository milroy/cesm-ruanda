...
WRITE(*,'(4A)') 'NAME: ', 'dei_cloud', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(dei_cloud,dei(:,:),pcols,lchnk)' 
       call outfld('mu_cloud',mu(:,:),pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'mu_cloud', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(mu_cloud,mu(:,:),pcols,lchnk)' 
       call outfld('lambda_cloud',lambda(:,:),pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'lambda_cloud', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(lambda_cloud,lambda(:,:),pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'rel_cloud', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(rel_cloud, rel, pcols, lchnk)' 
       call outfld('rei_cloud', rei, pcols, lchnk)
WRITE(*,'(4A)') 'NAME: ', 'rei_cloud', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(rei_cloud, rei, pcols, lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'EFFCLD', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(EFFCLD  ,effcld , pcols,lchnk)' 
       if (camrt_rad) then
          call outfld('EMIS' ,cldemis, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'EMIS', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(EMIS ,cldemis, pcols,lchnk)' 
       else
          call outfld('EMISCLD' ,cldemis, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'EMISCLD', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(EMISCLD ,cldemis, pcols,lchnk)' 
       endif
...
WRITE(*,'(4A)') 'NAME: ', 'IWC', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld( IWC      , iwc,         pcols, lchnk )' 
       call outfld( 'LWC'      , lwc,         pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'LWC', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld( LWC      , lwc,         pcols, lchnk )' 
       call outfld( 'ICIMR'    , icimr,       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICIMR', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld( ICIMR    , icimr,       pcols, lchnk )' 
       call outfld( 'ICWMR'    , icwmr,       pcols, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'ICWMR', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld( ICWMR    , icwmr,       pcols, lchnk )' 

    endif

    call outfld('GCLDLWP' ,gwp    , pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'GCLDLWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(GCLDLWP ,gwp    , pcols,lchnk)' 
    call outfld('TGCLDCWP',tgwp   , pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TGCLDCWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(TGCLDCWP,tgwp   , pcols,lchnk)' 
    call outfld('TGCLDLWP',tgliqwp, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TGCLDLWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(TGCLDLWP,tgliqwp, pcols,lchnk)' 
    call outfld('TGCLDIWP',tgicewp, pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'TGCLDIWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(TGCLDIWP,tgicewp, pcols,lchnk)' 
    call outfld('ICLDTWP' ,cwp    , pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICLDTWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(ICLDTWP ,cwp    , pcols,lchnk)' 
    call outfld('ICLDIWP' ,cicewp , pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'ICLDIWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(ICLDIWP ,cicewp , pcols,lchnk)' 
...
WRITE(*,'(4A)') 'NAME: ', 'SETLWP', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(SETLWP  ,clwpold, pcols,lchnk)' 
    call outfld('LWSH'    ,hl     , pcols,lchnk)
WRITE(*,'(4A)') 'NAME: ', 'LWSH', ' FILE: cloud_diagnostics.F90',  ' LINE: call outfld(LWSH    ,hl     , pcols,lchnk)' 
