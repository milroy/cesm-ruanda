...
WRITE(*,'(4A)') 'NAME: ', 'Qbkgndtot', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgndtot, qbktot(:ncol,:),ncol, lchnk )' 
       call outfld( 'Qbkgnd_o1', qbko1(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Qbkgnd_o1', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgnd_o1, qbko1(:ncol,:), ncol, lchnk )' 
       call outfld( 'Qbkgnd_o2', qbko2(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Qbkgnd_o2', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgnd_o2, qbko2(:ncol,:), ncol, lchnk )' 
       call outfld( 'Qbkgnd_n2', qbkn2(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Qbkgnd_n2', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgnd_n2, qbkn2(:ncol,:), ncol, lchnk )' 
       call outfld( 'Qbkgnd_n1', qbkn1(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Qbkgnd_n1', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgnd_n1, qbkn1(:ncol,:), ncol, lchnk )' 
       call outfld( 'Qbkgnd_no', qbkno(:ncol,:), ncol, lchnk )
WRITE(*,'(4A)') 'NAME: ', 'Qbkgnd_no', ' FILE: mo_photo.F90',  ' LINE: call outfld( Qbkgnd_no, qbkno(:ncol,:), ncol, lchnk )' 
    endif
