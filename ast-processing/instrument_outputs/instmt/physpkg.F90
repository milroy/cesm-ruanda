...
WRITE(*,'(4A)') 'NAME: ', 'Tg', ' FILE: physpkg.F90',  ' LINE: call outfld(Tg,cam_in(c)%ts,pcols   ,c     )' 
       end do
#endif
...
WRITE(*,'(4A)') 'NAME: ', 'TEOUT', ' FILE: physpkg.F90',  ' LINE: call outfld(TEOUT, teout       , pcols, lchnk   )' 
    call outfld('TEINP', state%te_ini, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'TEINP', ' FILE: physpkg.F90',  ' LINE: call outfld(TEINP, state%te_ini, pcols, lchnk   )' 
    call outfld('TEFIX', state%te_cur, pcols, lchnk   )
WRITE(*,'(4A)') 'NAME: ', 'TEFIX', ' FILE: physpkg.F90',  ' LINE: call outfld(TEFIX, state%te_cur, pcols, lchnk   )' 
...
WRITE(*,'(4A)') 'NAME: ', 'DTCORE', ' FILE: physpkg.F90',  ' LINE: call outfld( DTCORE, dtcore, pcols, lchnk )' 
    end if
