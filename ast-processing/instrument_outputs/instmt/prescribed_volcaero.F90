...
WRITE(*,'(4A)') 'NAME: ', volcaero_name, ' FILE: prescribed_volcaero.F90',  ' LINE: call outfld( volcaero_name,        data(:,:),     pcols, state(c)%lchnk)' 
       call outfld( volcrad_name,         radius(:,:),   pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', volcrad_name, ' FILE: prescribed_volcaero.F90',  ' LINE: call outfld( volcrad_name,         radius(:,:),   pcols, state(c)%lchnk)' 
       call outfld( volcmass_name,        volcmass(:,:), pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', volcmass_name, ' FILE: prescribed_volcaero.F90',  ' LINE: call outfld( volcmass_name,        volcmass(:,:), pcols, state(c)%lchnk)' 
       call outfld( volcmass_column_name, columnmass(:), pcols, state(c)%lchnk)
WRITE(*,'(4A)') 'NAME: ', volcmass_column_name, ' FILE: prescribed_volcaero.F90',  ' LINE: call outfld( volcmass_column_name, columnmass(:), pcols, state(c)%lchnk)' 
