...
! Subprogram not used 
! Subprogram not used 
! Subprogram not used   ! No compiler-provided erf, so call local version.
! Subprogram not used   call calerf_r4(x, res, 0)
! Subprogram not used 
! Subprogram not used 
...
! Subprogram not used   real(r4) :: res
! Subprogram not used 
! Subprogram not used   ! No intrinsic.
! Subprogram not used   call calerf_r4(x, res, 2)
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used   ! No intrinsic.
! Subprogram not used   call calerf_r8(x, res, 2)
! Subprogram not used 
! Subprogram not used end function shr_spfn_erfc_scaled_r8

! Subprogram not used elemental function shr_spfn_gamma_r8(x) result(res)
! Subprogram not used   real(r8), intent(in) :: x
! Subprogram not used   real(r8) :: res
! Subprogram not used 
! Subprogram not used   ! No intrinsic
! Subprogram not used   res = shr_spfn_gamma_nonintrinsic_r8(x)
! Subprogram not used 
! Subprogram not used end function shr_spfn_gamma_r8
