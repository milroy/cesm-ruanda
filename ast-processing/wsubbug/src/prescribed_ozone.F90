...
! Subprogram not used   subroutine init_prescribed_ozone_restart( piofile )
...
! Subprogram not used 
! Subprogram not used     call init_trc_restart( 'prescribed_ozone', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine init_prescribed_ozone_restart
!-------------------------------------------------------------------
! Subprogram not used   subroutine write_prescribed_ozone_restart( piofile )
...
! Subprogram not used 
! Subprogram not used   end subroutine write_prescribed_ozone_restart

!-------------------------------------------------------------------
! Subprogram not used   subroutine read_prescribed_ozone_restart( pioFile )
...
! Subprogram not used     type(file_desc_t) :: piofile
! Subprogram not used     
! Subprogram not used     call read_trc_restart( 'prescribed_ozone', piofile, file )
! Subprogram not used 
! Subprogram not used   end subroutine read_prescribed_ozone_restart
