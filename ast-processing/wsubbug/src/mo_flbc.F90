...
! Subprogram not used 
! Subprogram not used   subroutine flbc_set( vmr, ncol, lchnk, map )
! Subprogram not used     !--------------------------------------------------------
! Subprogram not used     !	... set the lower bndy values
! Subprogram not used     !--------------------------------------------------------
! Subprogram not used 
! Subprogram not used     implicit none
! Subprogram not used 
...
! Subprogram not used     integer,  intent(in)    ::   map(:)
! Subprogram not used     real(r8), intent(inout) ::   vmr(:,:,:)    ! lower bndy concentrations( mol/mol )
! Subprogram not used 
! Subprogram not used     !--------------------------------------------------------
! Subprogram not used     !	... local variables
! Subprogram not used     !--------------------------------------------------------
! Subprogram not used     integer  :: m, n
! Subprogram not used     integer  :: last, next
! Subprogram not used     real(r8) :: dels
! Subprogram not used 
! Subprogram not used     if( flbc_cnt < 1 ) then
! Subprogram not used        return
! Subprogram not used     end if
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used     do m = 1,flbc_cnt
! Subprogram not used        if ( flbcs(m)%spc_ndx > 0 ) then
! Subprogram not used           n = map( flbcs(m)%spc_ndx )
! Subprogram not used           vmr(:ncol,pver,n) = flbcs(m)%vmr(:ncol,lchnk,last) &
! Subprogram not used                + dels * (flbcs(m)%vmr(:ncol,lchnk,next) - flbcs(m)%vmr(:ncol,lchnk,last))
! Subprogram not used        endif
! Subprogram not used     end do
! Subprogram not used 
! Subprogram not used   end subroutine flbc_set
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used end module mo_flbc
