...
! Subprogram not used  integer function get_aircraft_ndx( name )
! Subprogram not used 
...
! Subprogram not used 
! Subprogram not used     get_aircraft_ndx = 0
! Subprogram not used     do i = 1,N_AERO
! Subprogram not used       if ( trim(name) == trim(aero_names(i)) ) then
! Subprogram not used         get_aircraft_ndx = i
! Subprogram not used         return
! Subprogram not used       endif
! Subprogram not used     enddo
! Subprogram not used 
! Subprogram not used   end function get_aircraft_ndx
