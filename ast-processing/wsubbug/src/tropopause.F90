...
! Subprogram not used   
! Subprogram not used   ! This routine originates with Stobie at NASA Goddard, but does not have a
! Subprogram not used   ! known reference. It was supplied by Philip Cameron-Smith of LLNL.
! Subprogram not used   !
