...
! Subprogram not used   subroutine physconst_update(mmr, t, cnst_mw_o, cnst_mw_o2, cnst_mw_h, cnst_mw_n, ixo, ixo2, ixh, ncnst, lchnk, ncol)
! Subprogram not used   
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used ! Update the physics "constants" that vary
! Subprogram not used !-----------------------------------------------------------------------
! Subprogram not used 
! Subprogram not used !------------------------------Arguments--------------------------------------------------------------
! Subprogram not used 
! Subprogram not used     integer, intent(in)  :: ncnst           ! number of constituents in mmr array
! Subprogram not used     real(r8), intent(in) :: mmr(pcols,pver,ncnst) ! constituents q array from state structure
! Subprogram not used     real(r8), intent(in) :: t(pcols,pver)   ! temperature t array from state structure
! Subprogram not used 
! Subprogram not used     real(r8), intent(in) :: cnst_mw_o, cnst_mw_o2, cnst_mw_h, cnst_mw_n  ! Molecular weight of O, O2, H, and N
! Subprogram not used 
! Subprogram not used     integer, intent(in)  :: ixo, ixo2, ixh  ! indices for O, O2, and H
! Subprogram not used     integer, intent(in)  :: lchnk           ! Chunk number
! Subprogram not used     integer, intent(in)  :: ncol            ! number of columns
! Subprogram not used !
! Subprogram not used !---------------------------Local storage-------------------------------------------------------------
! Subprogram not used     integer :: i,k                                 ! column,level,constituent indices
! Subprogram not used 
! Subprogram not used     real(r8):: mmro, mmro2, mmrh, mmrn2            ! Mass mixing ratios of O, O2, H, and N
! Subprogram not used     real(r8):: mbarvi, tint                        ! Mean mass, temperature, and specific heat on interface levels
! Subprogram not used     real(r8):: dof1, dof2                          ! Degress of freedom for cpairv calculation
! Subprogram not used     real(r8):: kv1, kv2, kv3, kv4                  ! Coefficients for kmvis calculation
! Subprogram not used     real(r8):: kc1, kc2, kc3, kc4                  ! Coefficients for kmcnd calculation
! Subprogram not used     !--------------------------------------------
! Subprogram not used     ! Set constants needed for updates
! Subprogram not used     !--------------------------------------------
! Subprogram not used     dof1 = 5._r8 
! Subprogram not used     dof2 = 7._r8
! Subprogram not used     kv1  = 4.03_r8
! Subprogram not used     kv2  = 3.42_r8
! Subprogram not used     kv3  = 3.9_r8
! Subprogram not used     kv4  = 0.69_r8
! Subprogram not used     kc1  = 56._r8
! Subprogram not used     kc2  = 56._r8
! Subprogram not used     kc3  = 75.9_r8
! Subprogram not used     kc4  = 0.69_r8
! Subprogram not used 
! Subprogram not used      !--------------------------------------------
! Subprogram not used      ! update cpairv, rairv, mbarv, and cappav
! Subprogram not used      !--------------------------------------------
! Subprogram not used      do k=1,pver
! Subprogram not used         do i=1,ncol
! Subprogram not used            mmro = mmr(i,k, ixo)
! Subprogram not used            mmro2 = mmr(i,k, ixo2)
! Subprogram not used            mmrh = mmr(i,k, ixh)
! Subprogram not used            mmrn2 = 1._r8-mmro-mmro2-mmrh
! Subprogram not used            mbarv(i,k,lchnk) = 1._r8/(mmro/cnst_mw_o +      &
! Subprogram not used                                      mmro2/cnst_mw_o2 +    &
! Subprogram not used                                      mmrn2/cnst_mw_n/2._r8 + &
! Subprogram not used                                      mmrh/cnst_mw_h)
! Subprogram not used            rairv(i,k,lchnk) = shr_const_rgas / mbarv(i,k,lchnk)
! Subprogram not used            cpairv(i,k,lchnk) = 0.5_r8*shr_const_rgas*    &
! Subprogram not used                                  (dof1*mmro/cnst_mw_o+        &
! Subprogram not used                                   dof2*mmro2/cnst_mw_o2+     &
! Subprogram not used                                   dof2*mmrn2/cnst_mw_n/2._r8+ &
! Subprogram not used                                      dof1*mmrh/cnst_mw_h)
! Subprogram not used            cappav(i,k,lchnk) = rairv(i,k,lchnk)/cpairv(i,k,lchnk)
! Subprogram not used         enddo
! Subprogram not used      enddo
! Subprogram not used 
! Subprogram not used      do k=2,pver
! Subprogram not used         do i=1,ncol
! Subprogram not used            mmro = .5_r8*(mmr(i,k-1, ixo)+mmr(i,k,ixo))
! Subprogram not used            mmro2 = .5_r8*(mmr(i,k-1, ixo2)+mmr(i,k,ixo2))
! Subprogram not used            mmrn2 = 1._r8-mmro-mmro2
! Subprogram not used            mbarvi = .5_r8*(mbarv(i,k-1,lchnk)+mbarv(i,k,lchnk))
! Subprogram not used            tint = .5_r8*(t(i,k-1)+t(i,k))
! Subprogram not used  
! Subprogram not used            kmvis(i,k,lchnk) = (kv1*mmro2/cnst_mw_o2+             &
! Subprogram not used                                kv2*mmrn2/cnst_mw_n/2._r8+        &
! Subprogram not used                                kv3*mmro/cnst_mw_o)*mbarvi*       &
! Subprogram not used                                tint**kv4 * 1.e-7_r8
! Subprogram not used            kmcnd(i,k,lchnk) = (kc1*mmro2/cnst_mw_o2+             &
! Subprogram not used                                kc2*mmrn2/cnst_mw_n/2._r8+        &
! Subprogram not used                                kc3*mmro/cnst_mw_o)*mbarvi*   &
! Subprogram not used                                tint**kc4 * 1.e-5_r8
! Subprogram not used         enddo
! Subprogram not used      enddo
! Subprogram not used      do i=1,ncol
! Subprogram not used         kmvis(i,1,lchnk) = 1.5_r8*kmvis(i,2,lchnk)-.5_r8*kmvis(i,3,lchnk)
! Subprogram not used         kmcnd(i,1,lchnk) = 1.5_r8*kmcnd(i,2,lchnk)-.5_r8*kmcnd(i,3,lchnk)
! Subprogram not used         kmvis(i,pverp,lchnk) = kmvis(i,pver,lchnk)
! Subprogram not used         kmcnd(i,pverp,lchnk) = kmcnd(i,pver,lchnk)
! Subprogram not used      enddo
! Subprogram not used 
! Subprogram not used    end subroutine physconst_update
