...
!
   ...
   !          tauc_lw(:,:,:) = 0.
   ! Or, pass in 1 cloud longwave optical depth to RRTMG_LW
   ! do nbnd = 1, nbndlw
   ...
   ! These fields are no longer supplied by 1.
   cicewp = 0.0_r8
   cliqwp = 0.0_r8
   rei = 0.0_r8
   rel = 0.0_r8
   ...
   ! Input 1 cloud optical depth directly
   inflglw = 0
   iceflglw = 0
   liqflglw = 0
   ...
   ! extra layer above model top with vertical indexing from bottom to top.
   ! Heating units are converted to J/kg/s below for use in 1. 
   ...
   !
   ! Reverse vertical indexing here for 1 arrays to go from top to bottom.
   !
   ful = 0._r8
   fdl = 0._r8
   fsul = 0._r8
   ...
   ! Pass longwave heating to 1 arrays and convert from K/d to J/kg/s
   qrl = 0._r8
   qrlc = 0._r8
