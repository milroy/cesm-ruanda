...
#gmsYr = baseYr.variables['global_mean'][:, :50].T.astype(np.float64)
...
global_means_test = hydro_baseflow
tstep = 0
l = {}
...
for i in testGms:
  ...
  hydro_baseflow[i[0]] = sim

  ['DTV', 'VD01', 'LHFLX', 'QFLX', 'QREFHT', 'SHFLX', 'SNOWHLND', 'TAUGWX', 'TAUGWY', 'TAUX', 'TAUY', 'TREFHT', 'TS', 'U10', 'WGUSTD']