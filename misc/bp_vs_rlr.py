...
baseuf = nio.open_file('/home/milroy/NCAR/sz750-ufect_T.nc', 'r')
varsuf = []

baseyr= nio.open_file('/home/milroy/NCAR/sz300.intel-gnu-pgi-rand1_V6.nc', 'r')
varsyr = []
...
rlruf = ['V', 'VV', 'VT', 'CLDHGH', 'UU', 'VQ', 'soa_a2_SRF', 'T', 'Z3', 'FREQS', 'OMEGA', 'num_a2_SRF', 'DMS_SRF', 'dst_a1_SRF', 'FREQI', 'U']
bpuf = ['UU', 'V', 'VT', 'VV']
bpyr = []
rlryr = []
...
sns.plt.savefig('hypervis-subcycle.pdf')
